...
Evidence path: formal/toe_formal/ToeFormal/Variational/PairingContract.lean; formal/toe_formal/ToeFormal/Variational/FirstVariationUniqueness.lean; formal/toe_formal/ToeFormal/Variational/FirstVariationDeclared.lean; formal/toe_formal/ToeFormal/Variational/DiscreteField.lean; formal/toe_formal/ToeFormal/Variational/PairingConcreteGrid.lean; formal/toe_formal/ToeFormal/Variational/FirstVariationRepDefFieldRep.lean; formal/toe_formal/ToeFormal/Variational/FirstVariationUniquenessFieldRep.lean; formal/toe_formal/ToeFormal/Variational/FirstVariationDeclaredFieldRep.lean; formal/toe_formal/ToeFormal/Variational/FieldRepresentationPairingContract.lean; formal/toe_formal/ToeFormal/Variational/ActionToFirstVariationBridgeRep32.lean; formal/python/tests/test_lean_non_tautological_el_derivation_rep32.py; formal/python/tests/test_lean_non_tautological_el_derivation_rep32_build_guard.py
...
Exit criteria: Deterministic record + blocked-on-missing; reason-coded negative controls; surface contract freeze tests enforced.
Notes: `OV-RL-02` is `discriminative_candidate` and `within_rep_only`; cross-rep promotion is blocked pending non-alias eligibility proofs; governance suite green on 2026-02-11 (354 passed).
...
Exit criteria: Deterministic record + blocked-on-missing; reason-coded negative controls; surface contract freeze tests enforced.
Notes: This lane asserts a bounded Poisson-type correspondence only; no GR/EFE or external gravity claim; governance suite green on 2026-02-11 (354 passed).
...
Exit criteria: Deterministic record + blocked-on-missing; reason-coded negative controls; surface contract freeze tests enforced.
Notes: This lane asserts a bounded continuity-equation correspondence only; no external truth claim; governance suite green on 2026-02-11 (354 passed).
...
Exit criteria: Deterministic record + blocked-on-missing; reason-coded negative controls; surface contract freeze tests enforced.
Notes: This lane asserts a bounded wave-equation correspondence only; no external truth claim; governance suite green on 2026-02-11 (354 passed).
...
Notes: This lane asserts bounded integer-winding detection on a periodic ring only; negative control pass is expectation-aware (non-integer winding is a pass); no external truth claim; governance suite green on 2026-02-11 (354 passed).
...
Notes: This lane asserts bounded discrete energy conservation vs dissipative break only; negative control pass is expectation-aware; no external truth claim; governance suite green on 2026-02-11 (354 passed).
...
Exit criteria: Deterministic record + blocked-on-missing; expectation-aware pass semantics; surface contract freeze tests enforced.
Notes: This lane asserts bounded gauge redundancy invariance vs explicit break only; negative control pass is expectation-aware; no external truth claim; governance suite green on 2026-02-11 (354 passed).
...
Exit criteria: Deterministic record + blocked-on-missing; expectation-aware pass semantics; surface contract freeze tests enforced.
Notes: This lane asserts bounded band-topology winding vs dispersion structure only; negative control pass is expectation-aware; no external truth claim; governance suite green on 2026-02-11 (354 passed).
...
Exit criteria: Deterministic record + blocked-on-missing; expectation-aware pass semantics; surface contract freeze tests enforced.
Notes: This lane asserts bounded detailed-balance behavior vs irreversible circulation only; negative control pass is expectation-aware; no external truth claim; governance suite green on 2026-02-11 (354 passed).
...
Exit criteria: Deterministic record + blocked-on-missing; expectation-aware pass semantics; surface contract freeze tests enforced.
Notes: This lane asserts bounded signal-cone admissibility vs CFL-violating leakage only; negative control pass is expectation-aware; no external truth claim; governance suite green on 2026-02-11 (354 passed).
...
Exit criteria: Deterministic record + blocked-on-missing; expectation-aware pass semantics; surface contract freeze tests enforced.
Notes: This lane asserts bounded Lorentz/Poincare boost invariance vs explicit break only; negative control pass is expectation-aware; no external truth claim; governance suite green on 2026-02-11 (354 passed).
...
Exit criteria: Deterministic record + blocked-on-missing; expectation-aware pass semantics; surface contract freeze tests enforced.
Notes: This lane asserts bounded velocity-addition group-law consistency vs explicit break only; negative control pass is expectation-aware; no external truth claim; governance suite green on 2026-02-11 (354 passed).
...
Exit criteria: Deterministic record + blocked-on-missing; expectation-aware pass semantics; surface contract freeze tests enforced.
Notes: This lane asserts bounded time-dilation proxy vs no-dilation break only; negative control pass is expectation-aware; no external truth claim; governance suite green on 2026-02-11 (354 passed).
...
Exit criteria: Deterministic record + blocked-on-missing; expectation-aware pass semantics; surface contract freeze tests enforced.
Notes: This lane asserts bounded length-contraction proxy vs no-contraction break only; negative control pass is expectation-aware; no external truth claim; governance suite green on 2026-02-11 (354 passed).
...
Exit criteria: Deterministic record + blocked-on-missing; expectation-aware pass semantics; surface contract freeze tests enforced.
Notes: This lane asserts bounded simultaneity-shift proxy vs no-shift break only; negative control pass is expectation-aware; no external truth claim; governance suite green on 2026-02-11 (354 passed). Hard stop: RL16 closes this lane sequence; further expansion requires explicit governance reset.
...
Exit criteria: Deterministic record + blocked-on-missing; expectation-aware pass semantics; surface contract freeze tests enforced.
Notes: This conditional theorem asserts bounded internal propagation vs signal-cone bound only; negative control pass is expectation-aware; no external truth claim; governance suite green on 2026-02-11 (354 passed).
...
Exit criteria: Deterministic record + blocked-on-missing; expectation-aware pass semantics; surface contract freeze tests enforced.
Notes: This conditional theorem asserts bounded internal energy drift plus CFL admissibility only; negative control pass is expectation-aware; no external truth claim; governance suite green on 2026-02-11 (354 passed).
...
Exit criteria: Deterministic record + blocked-on-missing; expectation-aware pass semantics; surface contract freeze tests enforced.
Notes: This conditional theorem asserts energy-drift and CFL admissibility under an alternate energy representation only; negative control pass is expectation-aware; no external truth claim; governance suite green on 2026-02-11 (354 passed).
...
Exit criteria: Deterministic record + blocked-on-missing; expectation-aware pass semantics; surface contract freeze tests enforced.
Notes: This conditional theorem asserts a minimality no-go under CFL bound removal only; negative control pass is expectation-aware; no external truth claim; governance suite green on 2026-02-11 (354 passed).
...
Exit criteria: Deterministic record + blocked-on-missing; expectation-aware pass semantics; surface contract freeze tests enforced.
Notes: This conditional theorem asserts representation-invariant admissibility and bound status under CT-02/CT-03 plus RL11 only; negative control pass is expectation-aware; no external truth claim; governance suite green on 2026-02-11 (354 passed).
...
Notes: This conditional theorem asserts external-anchor dispersion reproducibility under a pinned dataset and preprocessing only; negative control pass is expectation-aware failure detection; no external truth claim; governance suite green on 2026-02-11 (354 passed).
...
Notes: This conditional theorem asserts low-k slice external-anchor reproducibility under pinned quantile slicing only; it is explicitly non-independent of CT-06 (`non_independent_of_CT06`); no external truth claim; governance suite green on 2026-02-11 (354 passed).
...
Notes: This conditional theorem asserts high-k slice external-anchor reproducibility under pinned quantile slicing only; it is explicitly non-independent of CT-06 (`non_independent_of_CT06`); no external truth claim; governance suite green on 2026-02-11 (354 passed).
...
Status: Implemented (selection/admission gate + intake scaffold + doc gate)
Owner ticket/module: formal/docs/programs/CT10_independent_external_anchor_selection_filter_v0.md
Evidence path: formal/docs/programs/CT10_independent_external_anchor_selection_filter_v0.md; formal/python/tests/test_ct10_independent_external_anchor_selection_filter_doc.py; formal/external_evidence/ct10_independent_external_anchor_tbd/README.md; formal/external_evidence/ct10_independent_external_anchor_tbd/dataset_metadata.template.json; formal/docs/programs/CONDITIONAL_THEOREMS_PROGRAM_v0.md
...
Notes: Governance-only pre-activation filter for external-anchor multiplication pressure; no CT-10 comparator claim yet; scope remains `external_anchor_only` with no external truth claim; governance suite green on 2026-02-11 (354 passed).
