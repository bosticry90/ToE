/-
ToeFormal/Bridges/QFT_GR_RenormalizedStressEnergyObjectAssumptionReductionPacketResultReview.lean

Lean-side marker for the QFT-GR RN-ASSUMP-001 renormalized stress-energy
object assumption-reduction packet result review. The review accepts the packet
and authorizes one bounded reduction attempt only; it does not define or
...
namespace ToeFormal
namespace Bridges
namespace QFTGRRenormalizedStressEnergyObjectAssumptionReductionPacketResultReview
...
end QFTGRRenormalizedStressEnergyObjectAssumptionReductionPacketResultReview
end Bridges
end ToeFormal
