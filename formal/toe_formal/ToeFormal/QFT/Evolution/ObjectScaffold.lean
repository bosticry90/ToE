...
theorem _holds
  ...
  trivial
def 
    {Time State : Type}
    (_ctx : EvolutionContextObject Time State)
    (_initialState : FieldStateObject State)
    (_finalState : FieldStateObject State) : Prop :=
...
theorem _holds
    {Time State : Type}
    (ctx : EvolutionContextObject Time State)
    (initialState : FieldStateObject State)
    (finalState : FieldStateObject State) :
     ctx initialState finalState := by
  trivial
...
theorem qft_evol_generator_canonical_momentum_invariant_of_hamiltonian_compatibility_v0
    ...
    CanonicalMomentumInvariantUnderStep canonicalMomentum generator.step := by
  intro state
  calc
    canonicalMomentum.map (generator.step state) = canonicalMomentum.map (hamiltonian.step state) := by
      rw [hCompat state]
    _ = canonicalMomentum.map state := hHamiltonianInvariant state
...
theorem qft_evol_generator_unitarity_from_reflective_canonical_momentum_route_v0
    ...
    (hHamiltonianInvariant : CanonicalMomentumInvariantUnderStep canonicalMomentum hamiltonian.step) :
    UnitarityStatementOnly generator.step := by
  exact qft_evol_unitarity_of_canonical_momentum_reflective_invariant_step_v0
    canonicalMomentum
    generator.step
    hReflectsState
...
theorem qft_evol_generator_unitarity_route_normalization_v0
    ...
    qft_evol_generator_unitarity_via_hamiltonian_reflective_canonical_momentum_route_v0
      ...
      qft_evol_generator_unitarity_from_reflective_canonical_momentum_route_v0
        ...
        hCompat
        hHamiltonianInvariant := by
  exact (qft_evol_generator_unitarity_route_coherence_v0
    canonicalMomentum
    hamiltonian
    generator
    hReflectsState
...
theorem qft_evol_generator_unitarity_route_coherence_normalization_alignment_v0
    ...
    (qft_evol_generator_unitarity_route_coherence_v0
      ...
      qft_evol_generator_unitarity_route_normalization_v0
        ...
        hCompat
        hHamiltonianInvariant := by
  exact (qft_evol_generator_unitarity_route_normalization_coherence_alignment_v0
    canonicalMomentum
    hamiltonian
    generator
    hReflectsState
...
theorem qft_evol_generator_unitarity_route_alignment_symmetry_witness_normalization_v0
    ...
    (qft_evol_generator_unitarity_route_normalization_coherence_alignment_v0
      ...
      qft_evol_generator_unitarity_route_coherence_normalization_alignment_v0
        ...
        hCompat
        hHamiltonianInvariant := by
  exact (qft_evol_generator_unitarity_route_alignment_symmetry_witness_v0
    canonicalMomentum
    hamiltonian
    generator
    hReflectsState
...
theorem qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_normalization_v0
    ...
    (qft_evol_generator_unitarity_route_alignment_symmetry_witness_v0
      ...
      qft_evol_generator_unitarity_route_alignment_symmetry_witness_normalization_v0
        ...
        hCompat
        hHamiltonianInvariant := by
  exact (qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_alignment_v0
    canonicalMomentum
    hamiltonian
    generator
    hReflectsState
...
theorem qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_symmetry_witness_normalization_v0
    ...
    (qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_alignment_v0
      ...
      qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_normalization_v0
        ...
        hCompat
        hHamiltonianInvariant := by
  exact (qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_symmetry_witness_v0
    canonicalMomentum
    hamiltonian
    generator
    hReflectsState
...
theorem qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_symmetry_witness_alignment_normalization_v0
    ...
    (qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_symmetry_witness_v0
      ...
      qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_symmetry_witness_normalization_v0
        ...
        hCompat
        hHamiltonianInvariant := by
  exact (qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_symmetry_witness_alignment_v0
    canonicalMomentum
    hamiltonian
    generator
    hReflectsState
...
theorem qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_symmetry_witness_alignment_symmetry_witness_normalization_v0
    ...
    (qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_symmetry_witness_alignment_v0
      ...
      qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_symmetry_witness_alignment_normalization_v0
        ...
        hCompat
        hHamiltonianInvariant := by
  exact (qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_symmetry_witness_alignment_symmetry_witness_v0
    canonicalMomentum
    hamiltonian
    generator
    hReflectsState
...
theorem qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_symmetry_witness_alignment_symmetry_witness_alignment_normalization_v0
    ...
    (qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_symmetry_witness_alignment_symmetry_witness_v0
      ...
      qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_symmetry_witness_alignment_symmetry_witness_normalization_v0
        ...
        hCompat
        hHamiltonianInvariant := by
  exact (qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_symmetry_witness_alignment_symmetry_witness_alignment_v0
    canonicalMomentum
    hamiltonian
    generator
    hReflectsState
...
theorem qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_symmetry_witness_alignment_symmetry_witness_alignment_symmetry_witness_normalization_v0
    ...
    (qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_symmetry_witness_alignment_symmetry_witness_alignment_v0
      ...
      qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_symmetry_witness_alignment_symmetry_witness_alignment_normalization_v0
        ...
        hCompat
        hHamiltonianInvariant := by
  exact (qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_symmetry_witness_alignment_symmetry_witness_alignment_symmetry_witness_v0
    canonicalMomentum
    hamiltonian
    generator
    hReflectsState
...
theorem qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_symmetry_witness_alignment_symmetry_witness_alignment_symmetry_witness_alignment_normalization_v0
    ...
    (qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_symmetry_witness_alignment_symmetry_witness_alignment_symmetry_witness_v0
      ...
      qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_symmetry_witness_alignment_symmetry_witness_alignment_symmetry_witness_normalization_v0
        ...
        hCompat
        hHamiltonianInvariant := by
  exact (qft_evol_generator_unitarity_route_alignment_symmetry_witness_coherence_symmetry_witness_alignment_symmetry_witness_alignment_symmetry_witness_alignment_v0
    canonicalMomentum
    hamiltonian
    generator
    hReflectsState
