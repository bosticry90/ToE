...
/-- Previous live target consumed by the psi-A U(1) C_exchange functional-embedding packet. -/
def previousLiveNextStrictTargetV0 : String :=
  "prepare_toe_native_psi_A_u1_cexchange_functional_embedding_packet"

/-- Current live target after the psi-A U(1) C_exchange functional-embedding packet. -/
def currentLiveNextStrictTargetV0 : String :=
  "review_toe_native_psi_A_u1_cexchange_functional_embedding_packet_result"
