...
/-- Previous live target consumed by the psi-A U(1) matter-sector exchange route packet. -/
def previousLiveNextStrictTargetV0 : String :=
  "prepare_toe_native_psi_A_u1_matter_sector_exchange_route_packet"

/-- Current live target after the psi-A U(1) matter-sector exchange route packet. -/
def currentLiveNextStrictTargetV0 : String :=
  "review_toe_native_psi_A_u1_matter_sector_exchange_route_packet_result"
