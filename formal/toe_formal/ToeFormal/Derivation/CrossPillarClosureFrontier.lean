...
/-- Previous live target consumed by the master-action C_k family status review. -/
def previousLiveNextStrictTargetV0 : String :=
  "review_master_action_ck_family_status_synthesis_after_phi_A_and_psi_A_result"

/-- Current live target after the master-action C_k family status synthesis review. -/
def currentLiveNextStrictTargetV0 : String :=
  "select_next_master_action_surface_after_ck_family_status_synthesis"
