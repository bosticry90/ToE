...
/-- Previous live target consumed by the psi-A total conservation obligation packet. -/
def previousLiveNextStrictTargetV0 : String :=
  "prepare_psi_A_total_conservation_theorem_linkage_obligation_packet"

/-- Current live target after the psi-A total conservation obligation packet. -/
def currentLiveNextStrictTargetV0 : String :=
  "review_psi_A_total_conservation_theorem_linkage_obligation_packet_result"
