...
/-- Previous live target consumed by the nonzero-curvature calculation result review. -/
def previousLiveNextStrictTargetV0 : String :=
  "review_calc_scalar_stress_energy_covariant_divergence_identity_nonzero_curvature_background_v0_result"

/-- Current live target after the nonzero-curvature calculation result review. -/
def currentLiveNextStrictTargetV0 : String :=
  "prepare_scalar_stress_energy_covariant_divergence_identity_higher_dimensional_curved_background_guardrail_packet"
