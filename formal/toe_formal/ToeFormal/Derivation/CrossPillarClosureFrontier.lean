...
/-- Previous live target consumed by the phi bridge theorem-linkage attempt preparation. -/
def previousLiveNextStrictTargetV0 : String :=
  "prepare_phi_bridge_theorem_linkage_attempt_from_standalone_phi_bridge_route"

/-- Current live target after the phi bridge theorem-linkage attempt preparation. -/
def currentLiveNextStrictTargetV0 : String :=
  "review_phi_bridge_theorem_linkage_attempt_from_standalone_phi_bridge_route_result"
