...
def crossPillarClosureFrontierV0 :
  ...
  , { row := .qftGRSeam
      current_strongest_surface :=
        "QFT-GR covariant conservation proof-object obstruction refinement packet narrowed the accepted proof-object obstruction to insufficient assumptions for conservation, with no proof object construction, conservation witness construction, source admissibility claim, Bianchi compatibility, empirical validation, or QFT-GR seam closure"
      retained_blocker :=
...
/-- Previous live target consumed by the QFT-GR covariant conservation proof-object obstruction refinement packet. -/
def previousLiveNextStrictTargetV0 : String :=
  "prepare_qft_gr_covariant_conservation_proof_object_obstruction_refinement_packet"

/-- Current live target after QFT-GR covariant conservation proof-object obstruction refinement packet. -/
def currentLiveNextStrictTargetV0 : String :=
  "review_qft_gr_covariant_conservation_proof_object_obstruction_refinement_packet_result"
