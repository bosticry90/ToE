...
/-- Previous live target consumed by the selected CCFT source-applicability gap-resolution strategy packet. -/
def previousLiveNextStrictTargetV0 : String :=
...
/-- Current live target after the selected CCFT baseline-component equation source-applicability gap-resolution strategy packet. -/
def currentLiveNextStrictTargetV0 : String :=
  "review_selected_ccft_empirical_discriminator_baseline_component_equation_source_applicability_gap_resolution_strategy_packet_result"
