...
/-- Previous live target consumed by the QFT-GR selected-operator/action assumption-reduction packet result review. -/
def previousLiveNextStrictTargetV0 : String :=
  "review_qft_gr_selected_operator_action_assumption_reduction_packet_result"

/-- Current live target after QFT-GR selected-operator/action assumption-reduction packet result review. -/
def currentLiveNextStrictTargetV0 : String :=
  "execute_qft_gr_selected_operator_action_assumption_reduction_attempt"
