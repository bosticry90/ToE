...
/-- Previous live target consumed by the QFT-GR operator-domain assumption-reduction packet. -/
def previousLiveNextStrictTargetV0 : String :=
  "prepare_qft_gr_operator_domain_assumption_reduction_packet"

/-- Current live target after QFT-GR operator-domain assumption-reduction packet preparation. -/
def currentLiveNextStrictTargetV0 : String :=
  "review_qft_gr_operator_domain_assumption_reduction_packet_result"
