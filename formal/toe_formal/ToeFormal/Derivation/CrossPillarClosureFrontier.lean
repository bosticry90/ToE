...
/-- Previous live target consumed by the psi-A U(1) current-conservation packet. -/
def previousLiveNextStrictTargetV0 : String :=
  "prepare_toe_native_psi_A_u1_current_conservation_from_dirac_pair_packet"

/-- Current live target after the psi-A U(1) current-conservation packet. -/
def currentLiveNextStrictTargetV0 : String :=
  "prepare_toe_native_psi_A_u1_sourced_maxwell_route_packet"
