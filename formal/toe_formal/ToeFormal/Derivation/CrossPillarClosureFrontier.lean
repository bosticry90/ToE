...
/-- Previous live target consumed by the C_exchange theorem-linkage attempt execution result review. -/
def previousLiveNextStrictTargetV0 : String :=
  "review_cexchange_theorem_linkage_attempt_from_total_conservation_route_result"

/-- Current live target after the C_exchange theorem-linkage attempt execution result review. -/
def currentLiveNextStrictTargetV0 : String :=
  "prepare_cexchange_theorem_linkage_obligation_closeout"
