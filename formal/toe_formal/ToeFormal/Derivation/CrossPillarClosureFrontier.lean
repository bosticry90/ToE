...
/-- Previous live target consumed by the A-source closeout selector review. -/
def previousLiveNextStrictTargetV0 : String :=
  "review_ck_family_theorem_linkage_obligation_selection_after_A_source_closeout_result"

/-- Current live target after standalone A-source closeout selector review. -/
def currentLiveNextStrictTargetV0 : String :=
  "prepare_phi_source_theorem_linkage_obligation_packet"
