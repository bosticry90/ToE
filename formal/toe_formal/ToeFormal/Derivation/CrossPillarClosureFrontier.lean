...
/-- Previous live target consumed by the psi-A U(1) sourced Maxwell route packet. -/
def previousLiveNextStrictTargetV0 : String :=
  "prepare_toe_native_psi_A_u1_sourced_maxwell_route_packet"

/-- Current live target after the psi-A U(1) sourced Maxwell route packet. -/
def currentLiveNextStrictTargetV0 : String :=
  "prepare_toe_native_psi_A_u1_stress_energy_and_exchange_obligation_packet"
