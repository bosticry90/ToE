...
/-- Previous live target consumed by the psi-A U(1) stress-energy definition policy packet. -/
def previousLiveNextStrictTargetV0 : String :=
  "prepare_toe_native_psi_A_u1_stress_energy_definition_policy_packet"

/-- Current live target after the psi-A U(1) stress-energy definition policy packet. -/
def currentLiveNextStrictTargetV0 : String :=
  "review_toe_native_psi_A_u1_stress_energy_definition_policy_packet_result"
