...
/-- Previous live target consumed by the matter-sector exchange execution result review. -/
def previousLiveNextStrictTargetV0 : String :=
  "review_psi_A_matter_sector_exchange_theorem_linkage_attempt_from_dirac_pair_result"

/-- Current live target after the matter-sector exchange execution result review. -/
def currentLiveNextStrictTargetV0 : String :=
  "prepare_psi_A_matter_sector_exchange_theorem_linkage_obligation_closeout"
