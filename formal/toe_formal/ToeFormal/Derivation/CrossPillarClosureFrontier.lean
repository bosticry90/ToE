...
/--
Previous live target consumed by the conformal-background calculation execution.
-/
def previousLiveNextStrictTargetV0 : String :=
  "execute_calc_scalar_stress_energy_covariant_divergence_identity_conformal_background_v0"

/--
Current live target after the conformal-background calculation execution.
-/
def currentLiveNextStrictTargetV0 : String :=
  "review_calc_scalar_stress_energy_covariant_divergence_identity_conformal_background_v0_result"
