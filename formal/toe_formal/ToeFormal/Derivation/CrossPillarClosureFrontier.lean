...
/-- Previous live target consumed by the psi-A U(1) C_exchange candidate review. -/
def previousLiveNextStrictTargetV0 : String :=
  "review_toe_native_psi_A_u1_cexchange_constraint_candidate_packet_result"

/-- Current live target after the psi-A U(1) C_exchange candidate review. -/
def currentLiveNextStrictTargetV0 : String :=
  "prepare_toe_native_psi_A_u1_cexchange_functional_embedding_packet"
