...
/-- Previous live target consumed by the C_exchange theorem-linkage attempt execution. -/
def previousLiveNextStrictTargetV0 : String :=
  "execute_cexchange_theorem_linkage_attempt_from_total_conservation_route"

/-- Current live target after the C_exchange theorem-linkage attempt execution. -/
def currentLiveNextStrictTargetV0 : String :=
  "review_cexchange_theorem_linkage_attempt_from_total_conservation_route_result"
