...
/-- Previous live target consumed by the psi-A U(1) C_exchange admissibility-rule closeout. -/
def previousLiveNextStrictTargetV0 : String :=
  "prepare_toe_native_psi_A_u1_cexchange_admissibility_rule_closeout"

/-- Current live target after the psi-A U(1) C_exchange admissibility-rule closeout. -/
def currentLiveNextStrictTargetV0 : String :=
  "review_toe_native_psi_A_u1_cexchange_admissibility_rule_closeout_result"
