...
/-- Previous live target consumed by the interaction exchange chain closeout result review. -/
def previousLiveNextStrictTargetV0 : String :=
  "review_psi_A_interaction_exchange_theorem_linkage_chain_closeout_result"

/-- Current live target after the interaction exchange chain closeout result review. -/
def currentLiveNextStrictTargetV0 : String :=
  "select_next_ck_family_theorem_linkage_obligation_after_psi_A_exchange_chain_closeout"
