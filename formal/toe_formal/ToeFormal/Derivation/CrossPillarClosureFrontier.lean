...
/-- Previous live target consumed by the psi-A U(1) interaction exchange synthesis packet. -/
def previousLiveNextStrictTargetV0 : String :=
  "prepare_toe_native_psi_A_u1_interaction_exchange_rule_family_synthesis_packet"

/-- Current live target after the psi-A U(1) interaction exchange synthesis packet. -/
def currentLiveNextStrictTargetV0 : String :=
  "review_toe_native_psi_A_u1_interaction_exchange_rule_family_synthesis_packet_result"
