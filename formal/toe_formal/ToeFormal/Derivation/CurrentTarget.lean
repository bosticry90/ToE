...
def currentEvidencePacketId : String :=
  DiracMaxwellFullZeroModeDescendantNecessityAndRobustnessPacketResultReview.reviewId

theorem current_target_points_to_descendant_necessity_and_robustness_guardrail_v0 :
    currentLiveTarget =
