...
theorem current_target_points_to_psi_a_u1_current_derivation_from_A_variation_packet_result_review :
    currentLiveTarget =
      "review_toe_native_psi_A_u1_current_derivation_from_A_variation_packet_result" := by
  rfl
