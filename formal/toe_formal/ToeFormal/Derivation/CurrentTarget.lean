...
def currentEvidencePacketId : String :=
  DiracMaxwellFullZeroModeReductionWithTransverseFieldsPacketResultReview.reviewId

theorem current_target_points_to_full_zero_mode_numerical_guardrail_v0 :
    currentLiveTarget =
