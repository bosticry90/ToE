...
def currentEvidencePacketId : String :=
  DiracMaxwellFullZeroModeDescendantNecessityAndRobustnessCalibrationAndParameterFreezePacketV2.packetId

theorem current_target_points_to_independent_v2_freeze_review :
    currentLiveTarget =
