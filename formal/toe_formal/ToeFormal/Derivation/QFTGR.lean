...
def currentScopedResult : String :=
  ...
  SOURCE_REQUIREMENT_REFINEMENT_PACKET_PREPARED_REFINES_OPEN_SYSTEM_DECOHERENCE_\
  SOURCE_REQUIREMENTS_ONLY_NO_SOURCE_VALIDATION_OR_EQUATION_ADOPTION"

def currentPacketId : String :=
  "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_\
  SOURCE_APPLICABILITY_GAP_RESOLUTION_OPEN_SYSTEM_DECOHERENCE_\
  SOURCE_REQUIREMENT_REFINEMENT_PACKET_v0"
...
theorem qft_gr_lane_aggregate_exposes_current_scoped_result :
    scalarSandboxTargetId = "ToeFormal.Derivation.QFTGRScalarSandbox" ∧
      currentScopedResult =
        ...
        SOURCE_APPLICABILITY_GAP_RESOLUTION_OPEN_SYSTEM_DECOHERENCE_\
        SOURCE_REQUIREMENT_REFINEMENT_PACKET_PREPARED_REFINES_OPEN_SYSTEM_DECOHERENCE_\
        SOURCE_REQUIREMENTS_ONLY_NO_SOURCE_VALIDATION_OR_EQUATION_ADOPTION" := by
  constructor
  · rfl
  · rfl
