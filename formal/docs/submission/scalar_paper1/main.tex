...
\begin{figure}[h]
\centering
\fbox{\parbox{0.9\linewidth}{\centering Figure placeholder: bounded scalar route flow (master action to low-energy Schrodinger-class limit).}}
\caption{Canonical placeholder for scalar-route derivation flow.}
