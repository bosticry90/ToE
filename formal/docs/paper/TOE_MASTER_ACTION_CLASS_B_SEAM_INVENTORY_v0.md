...
- `SEAM_EM_QFT_CURRENT_PHYSICS_BLOCKER_TARGET_v0: extract_em_qft_physics_blocker_into_protocol_row`
- `SEAM_EM_QFT_CURRENT_PHYSICS_BLOCKER_BOUNDARY_v0: NONCLAIM_EXTRACTION_TARGET_NO_EM_QFT_SEAM_CLOSURE_NO_MASTER_ACTION_PROMOTION`
