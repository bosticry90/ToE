...
- `CURRENT_LIVE_NEXT_TARGET_v0: execute_qft_gr_minimal_working_model_construction_attempt`
- `MASTER_ACTION_CURRENT_CITATION_TARGET_v0: execute_qft_gr_minimal_working_model_construction_attempt`
