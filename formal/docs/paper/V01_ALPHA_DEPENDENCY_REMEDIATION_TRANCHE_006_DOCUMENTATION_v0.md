...
- Selected finding: `V01-ALPHA-DEP-REM-006`
- Selected tranche: `V01-ALPHA-DEP-REM-TRANCHE-006`
- Selected dependency: `supplied_alignment_constructs_sr_cosmo_regime_transport_package_v0`
- Lean audit target: `ToeFormal.Bridges.SRCosmologyRegimeTransport.supplied_alignment_constructs_sr_cosmo_regime_transport_package_v0`
...
- Lean evidence command: `#print axioms ToeFormal.Bridges.SRCosmologyRegimeTransport.supplied_alignment_constructs_sr_cosmo_regime_transport_package_v0`
...
The standard Lean axioms propext, Classical.choice, and Quot.sound are acceptable for the v0.1-alpha dependency posture of supplied_alignment_constructs_sr_cosmo_regime_transport_package_v0 when no project-local axioms are used, provided the release materials document this standard-axiom posture.

A later documentation packet and result review must record that tranche 006 depends only on standard Lean axioms [propext, Classical.choice, Quot.sound] and no project-local axioms before blocker movement can be considered.
...
Blocker movement still requires result review of this documentation packet, later status adjudication, and a separate movement-registration path. This documentation packet prepares the evidence surface only; it does not downgrade, clear, or otherwise move tranche 006.
...
- Tranche 005 dependency: `supplied_interface_alignment_semantics_construct_bridge_package_v0`
