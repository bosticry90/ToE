...
- `CURRENT_LIVE_NEXT_TARGET_v0: review_qft_gr_operator_domain_assumption_reduction_packet_result`
- `MASTER_ACTION_CURRENT_CITATION_TARGET_v0: review_qft_gr_operator_domain_assumption_reduction_packet_result`
