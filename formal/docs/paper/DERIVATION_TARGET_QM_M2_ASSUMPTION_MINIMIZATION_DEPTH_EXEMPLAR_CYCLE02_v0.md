# Derivation Target: QM M2 Assumption Minimization Depth Exemplar Cycle02 v0

Spec ID:
- `DERIVATION_TARGET_QM_M2_ASSUMPTION_MINIMIZATION_DEPTH_EXEMPLAR_CYCLE02_v0`

Target ID:
- `TARGET-QM-M2-ASSUMPTION-MINIMIZATION-DEPTH-EXEMPLAR-CYCLE02-v0`

Classification:
- `P-POLICY`

Purpose:
- Add one depth-completion exemplar lane for QM M2 assumption minimization.
...
- artifact path: `formal/output/qm_m2_assumption_minimization_depth_exemplar_cycle02_v0.json`
- gate path: `formal/python/tests/test_qm_m2_assumption_minimization_depth_exemplar_cycle02_gate.py`
