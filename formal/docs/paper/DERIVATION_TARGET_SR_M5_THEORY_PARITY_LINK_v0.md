...
- artifact path: `formal/output/sr_m5_theory_parity_link_cycle32_v0.json`
- coupling gate path: `formal/python/tests/test_sr_m5_theory_parity_link_cycle32_gate.py`
