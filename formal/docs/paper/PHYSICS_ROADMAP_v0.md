...
- Next strict scalar/QFT target: derive the A2A15A1A13 graph-channel relation and actual stencil-error sequence from concrete refinement data, rather than from the zero-error normal form. Full A1A closure and Phase 2 remain unauthorized.
