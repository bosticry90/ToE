...
- Next strict scalar/QFT target: derive the actual graph/Taylor stencil-error sequence and its uniform order-`h^2` bound from the two-sided endpoint package. Full A1A closure and Phase 2 remain unauthorized.
