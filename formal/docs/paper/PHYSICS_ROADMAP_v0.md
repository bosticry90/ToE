...
- Next strict scalar/QFT target: derive the A2A15A1A11 uniform mesh convergence evidence from a concrete refinement family and analytic estimates, or expose the next precise retained obstruction. Full A1A closure and Phase 2 remain unauthorized.
