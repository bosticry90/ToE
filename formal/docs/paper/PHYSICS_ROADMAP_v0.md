...
- Post-GR01 unlock queue (frozen order intent):
  ...
  - activation snapshot (2026-02-21): downstream prerequisites for `PILLAR-QFT` are satisfied; `PILLAR-QFT` is the single `ACTIVE` downstream lane.
...
| `PILLAR-QFT` | `ACTIVE` | `TARGET-QFT-GAUGE-PLAN;TARGET-QFT-EVOL-PLAN;TARGET-QFT-FULL-DERIVATION-DISCHARGE-v0` | `formal/docs/paper/DERIVATION_TARGET_QFT_GAUGE_OBJECT_v0.md;formal/docs/paper/DERIVATION_TARGET_QFT_EVOLUTION_OBJECT_v0.md;formal/docs/paper/DERIVATION_TARGET_QFT_FULL_DERIVATION_DISCHARGE_v0.md` | `TARGET-EM-U1-PLAN;TARGET-SR-COV-PLAN` | Scaffold saturation is frozen at QFT-EVOL MICRO-01..52; cycle-2 through cycle-14 semantic-hardening milestones are pinned; discharge kickoff remains bounded/non-claim (no quantization closure claim, no dynamics derivation closure claim, and no external truth claim). |
