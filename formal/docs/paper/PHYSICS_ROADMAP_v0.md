...
| `PILLAR-QFT` | `ACTIVE` | `TARGET-QFT-GAUGE-PLAN;TARGET-QFT-EVOL-PLAN` | `formal/docs/paper/DERIVATION_TARGET_QFT_GAUGE_OBJECT_v0.md;formal/docs/paper/DERIVATION_TARGET_QFT_EVOLUTION_OBJECT_v0.md` | `TARGET-EM-U1-PLAN;TARGET-SR-COV-PLAN` | Scaffold-first contract/object activation lane only; no quantization claim, no dynamics claim, and no over-claim. |
...
- Required governance suite (minimum):
  ...
  - `formal/python/tests/test_qft_evol_micro_tranche_01_50_completeness_gate.py`
