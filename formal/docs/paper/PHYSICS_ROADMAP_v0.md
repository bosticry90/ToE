...
- Lean aggregate pointer: `formal/toe_formal/ToeFormal.lean`; focused Lean checks for the new QFT-GR operator-domain semantics slice and direct frontier dependencies are targeted for this tranche. No full aggregate build is intended unless focused validation escalates.
