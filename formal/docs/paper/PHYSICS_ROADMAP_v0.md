...
- Next strict cross-pillar target: `review_qft_gr_source_map_semantics_protocol_row_readiness`. Global SR/COSMO bridge closure, cosmology pillar closure, SR pillar promotion, A2A15A1/A2A15 closure, QM-STAT seam closure, QFT-GR seam closure, EM-QFT seam closure, master-action promotion, empirical claims, broader theorem-work authorization, target-entropy semantics, transport-map semantics, coarse-graining/irreversibility, residual-package semantic closure, source-map semantic closure, semiclassical-gravity claims, Einstein-equation derivation claims, and Phase 2 remain unauthorized.
- Lean aggregate pointer: `formal/toe_formal/ToeFormal.lean`; focused Lean checks for the QFT-GR protocol row and direct frontier dependencies are green as of 2026-05-02. No full aggregate build was run for this protocol-row tranche.
