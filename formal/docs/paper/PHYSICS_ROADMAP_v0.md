...
- Next strict cross-pillar target: `review_qm_stat_transport_semantics_protocol_row_readiness`. Global SR/COSMO bridge closure, cosmology pillar closure, SR pillar promotion, A2A15A1/A2A15 closure, QM-STAT seam closure, QFT-GR seam closure, EM-QFT seam closure, master-action promotion, empirical claims, theorem-work authorization, lane reopening, and Phase 2 remain unauthorized.
- Lean aggregate pointer: `formal/toe_formal/ToeFormal.lean`; focused Lean checks for the QM-STAT transport semantics protocol row and direct frontier dependencies are green as of 2026-05-02. No full aggregate build was run for this protocol-row tranche.
