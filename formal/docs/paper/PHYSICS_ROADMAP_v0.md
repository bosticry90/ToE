...
- QFT-GR source-map status: `QFT_GR_StressEnergyExpectationSourceMap.lean` defines the QFT stress-energy object, expectation/state functional, GR source object, covariance/conservation assumptions, and residual/error interface; supplied expectation/source and weak-curvature/source alignments construct a zero-residual source-map package.
- Next strict cross-pillar target: rotate to QFT-GR stress-energy source-map semantics after the QM-STAT post-budget review. A2A15A1/A2A15 closure, QM-STAT seam closure, QFT-GR seam closure, semiclassical gravity, Einstein-equation derivation, master-action promotion, empirical claims, and Phase 2 remain unauthorized.
