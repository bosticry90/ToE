...
- Next strict scalar/QFT target: prove the A2A15A1A10 uniform mesh convergence theorem from the recorded contract, or expose the next precise retained obstruction. Full A1A closure and Phase 2 remain unauthorized.
