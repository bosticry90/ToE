...
- Next strict cross-pillar target: `derive_or_refute_qft_gr_stress_energy_operator_domain_semantics`. Global SR/COSMO bridge closure, cosmology pillar closure, SR pillar promotion, A2A15A1/A2A15 closure, QM-STAT seam closure, QFT-GR seam closure, EM-QFT seam closure, master-action promotion, empirical claims, broader theorem-work authorization beyond the bounded QFT-GR operator-domain slice, target-entropy semantics, transport-map semantics, coarse-graining/irreversibility, residual-package semantic closure, source-map semantic closure, semiclassical-gravity claims, Einstein-equation derivation claims, and Phase 2 remain unauthorized.
- Lean aggregate pointer: `formal/toe_formal/ToeFormal.lean`; focused Lean checks for the QFT-GR readiness review and direct frontier dependencies are green as of 2026-05-02. No full aggregate build was run for this readiness-review tranche.
