...
- Next strict scalar/QFT target: review and close the parent graph-channel semantics needed to lift the identified actual stencil-error sequence into full A1A closure. Full A1A closure and Phase 2 remain unauthorized.
