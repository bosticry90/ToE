...
- Next strict cross-pillar target: rotate to QM-STAT transport residual semantics. A2A15A1/A2A15 closure, QFT-GR seam closure, semiclassical gravity, Einstein-equation derivation, master-action promotion, empirical claims, and Phase 2 remain unauthorized.
