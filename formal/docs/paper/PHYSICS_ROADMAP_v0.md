...
- Next strict scalar/QFT target: identify the endpoint-package stencil-error sequence with the actual graph-Laplacian action and prove the graph-channel relation. Full A1A closure and Phase 2 remain unauthorized.
