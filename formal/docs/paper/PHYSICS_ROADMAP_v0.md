...
- Latest branch-health checkpoint: full pytest checkpoint is green with `6597 passed, 230 skipped`; full `lake build ToeFormal` is green with `7983` jobs and no warnings.
