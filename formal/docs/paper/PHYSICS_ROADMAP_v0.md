...
- `THEORY_RESTART_SLICE_v0: WS-10-T06_GR_QM_POST_COMPLETION_HANDOFF_BOUNDARY`
- `THEORY_RESTART_ACTIVE_PILLAR_v0: SEAM-GR-QM`
- `THEORY_RESTART_ACTIVE_TARGET_v0: GR_QM_POST_COMPLETION_HANDOFF_BOUNDARY_v0`
- `THEORY_RESTART_ACTIVE_STATUS_v0: ACTIVE_BOUNDED_v0`
- `THEORY_RESTART_ACTIVE_VERIFICATION_v0: STATE_ROADMAP_SEAM_STATUS_PARITY_PLUS_GR_QM_FIVE_GATE_REGRESSION_BASELINE_v0`
