...
- `THEORY_RESTART_SLICE_v0: WS-10-T05_GR_QM_COMPLETION_PARITY_WIDER_TRANCHE`
...
- `THEORY_RESTART_ACTIVE_VERIFICATION_v0: GR_QM_FIVE_GATE_COMPLETION_PARITY_LADDER_v0`
...
- Restart scope note: the first bounded GR01 theorem-deepening slice is closed and the GR-QM seam discharge tranche is now the active bounded follow-up; phase2 seam-completion closeout control surfaces are pinned before the next GR-QM target decision.
