...
- Next strict scalar/QFT target: finish A2A15A1A9 endpoint-package derivation by constructing the two-sided endpoint package. Uniform mesh convergence remains downstream until that endpoint package is fully derived or explicitly blocked.
