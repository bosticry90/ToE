...
- Next strict scalar/QFT target: instantiate the A2A15A1A12 chosen uniform mesh order-`h^2` mode from a concrete refinement family, stencil-error sequence, endpoint-package-to-uniform estimate, and graph-channel relation. Full A1A closure and Phase 2 remain unauthorized.
