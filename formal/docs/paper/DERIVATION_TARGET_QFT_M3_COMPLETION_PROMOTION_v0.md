...
- `QFT_M3_ACTION_STAGE_STATUS_v0: COMPLETE_BOUNDED_v0`
- `QFT_M3_VARIATION_STAGE_STATUS_v0: COMPLETE_BOUNDED_v0`
- `QFT_M3_BRIDGE_STAGE_STATUS_v0: COMPLETE_BOUNDED_v0`
- `QFT_M3_OPERATOR_STAGE_STATUS_v0: COMPLETE_BOUNDED_v0`
- `QFT_M3_TRANSPORT_STAGE_STATUS_v0: COMPLETE_BOUNDED_v0`
- `QFT_M3_RESIDUAL_LAW_STAGE_STATUS_v0: COMPLETE_BOUNDED_v0`
- `QFT_M3_REGIME_LIMIT_STAGE_STATUS_v0: COMPLETE_BOUNDED_v0`

Prediction scaffold token (Phase 2 C3):
- `QFT_M3_PREDICTION_SCAFFOLD_STATUS_v0: SCAFFOLD_PINNED_NONCLAIM`
