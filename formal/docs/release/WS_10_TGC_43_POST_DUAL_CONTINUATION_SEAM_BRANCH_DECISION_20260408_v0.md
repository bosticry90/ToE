# WS-10 TGC-43 Post-Dual-Continuation Seam Branch Decision (2026-04-08)
...
- Result: `28 passed in 6.72s`

## Decision state
- `TGC43_BRANCH_DECISION_STATE_v0: NEXT_DUAL_PATH_CONTINUATION_PACKAGE_PINNED`
- `TGC43_QM_STAT_ROW_STATE_v0: CONTINUE_BOUNDED`
- `TGC43_COSMO_SR_ROW_STATE_v0: CONTINUE_BOUNDED`
- `TGC43_SCOPE_BOUNDARY_v0: EXISTING_SEAM_SURFACES_ONLY_NO_NEW_AUTHORITY_RESIDENCY`
...
- Checkpoint JSON pointer: formal/output/ws10_tgc43_post_dual_continuation_seam_branch_decision_checkpoint_20260408_v0.json
