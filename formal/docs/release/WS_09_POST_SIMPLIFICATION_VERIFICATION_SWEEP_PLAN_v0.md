...
| WS-09-T03 | Run targeted post-simplification checks | ACTIVE | WS-09-T02 | Targeted check results with pass counts | Command outputs recorded in CE-05 checkpoint artifact |
