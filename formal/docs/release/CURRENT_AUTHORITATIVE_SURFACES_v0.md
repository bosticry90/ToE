...
- `PREVIOUS_LIVE_NEXT_TARGET_v0: review_qft_gr_covariant_conservation_proof_object_attempt_result`
- `ACTIVE_LANE_v0: qft_gr_covariant_conservation_proof_object_attempt_result_review`
- `CURRENT_LIVE_TARGET_AUTHORITY_v0: formal/docs/release/LOOP_CONTROL_REGISTRY_v0.json`
- `CURRENT_LIVE_TARGET_FRONTIER_MIRROR_v0: formal/toe_formal/ToeFormal/Derivation/CrossPillarClosureFrontier.lean`
- `CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/toe_formal/ToeFormal/Bridges/QFT_GR_CovariantConservationProofObjectAttemptResultReview.lean`
- `CURRENT_LIVE_TARGET_REPORT_v0: formal/docs/release/QFT_GR_COVARIANT_CONSERVATION_PROOF_OBJECT_ATTEMPT_RESULT_REVIEW_20260525_v0.json`
