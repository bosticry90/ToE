...
- `PREVIOUS_LIVE_NEXT_TARGET_v0: prepare_qft_gr_conserved_renormalized_stress_energy_source_witness_obstruction_refinement_packet`
- `ACTIVE_LANE_v0: qft_gr_conserved_renormalized_stress_energy_source_witness_obstruction_refinement_packet`
- `CURRENT_LIVE_TARGET_AUTHORITY_v0: formal/docs/release/LOOP_CONTROL_REGISTRY_v0.json`
- `CURRENT_LIVE_TARGET_FRONTIER_MIRROR_v0: formal/toe_formal/ToeFormal/Derivation/CrossPillarClosureFrontier.lean`
- `CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/toe_formal/ToeFormal/Bridges/QFT_GR_ConservedRenormalizedStressEnergySourceWitnessObstructionRefinementPacket.lean`
- `CURRENT_LIVE_TARGET_REPORT_v0: formal/docs/release/QFT_GR_CONSERVED_RENORMALIZED_STRESS_ENERGY_SOURCE_WITNESS_OBSTRUCTION_REFINEMENT_PACKET_20260525_v0.json`
