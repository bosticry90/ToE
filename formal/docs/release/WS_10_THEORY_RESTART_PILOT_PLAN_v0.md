...
| WS-10-T05 | Open next bounded theory slice: larger GR-QM discharge tranche | ACTIVE | WS-10-T04 | Control-surface activation plus first bounded larger-tranche scientific checkpoint anchored on `0d023e1` | Bounded diff evidence plus targeted parity verification |
