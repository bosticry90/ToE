# VPC v6 Linux egress-denied qualification run procedure
...
10. Require the frozen computation, graph, runtime-certificate, Lean-envelope,
    receipt, and dependency-closure identifiers.
...
- graph `ddf90108673cf88b2e075d02bb399ce53045b1e8307bdb741b5e5c3ed2c68b13`;
...
- receipt `200720b0bb761941c9facc206f3dd72ffad38b9b474234d120101ecd5c88ed9e`;
...
Environment metadata and the Linux bundle's overall content address may differ.
Exact scientific values, graph evidence, challenge outcomes, certificate
commitments, and non-promotion state may not.
