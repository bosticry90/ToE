# WS_10_T18_COSMO_SR_CYCLE08_ADDITIVE_CANDIDATE_v0
...
## Objective
Declare one bounded additive candidate payload for COSMO-SR while the lane remains paused pending explicit authorization.
...
- `WS_10_T18_COSMO_SR_CYCLE08_ADDITIVE_CANDIDATE_STATUS_v0: DECLARED_BOUNDED_NONREDUNDANT_PAYLOAD_v0`.
