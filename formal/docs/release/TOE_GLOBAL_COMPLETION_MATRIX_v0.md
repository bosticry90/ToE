...
| ROW-PILLAR-QM-001 | pillar | QM_DERIVATION_CHAIN | THEOREM_GAP_CLOSURE_INCREMENT_EXECUTION_CHECKPOINT_PINNED | THEOREM_GAP | formal/docs/paper/DERIVATION_TARGET_QM_EMPIRICAL_COMPARISON_PACKET_04_v0.md | formal/output/qm_empirical_comparison_packet_04_v0.json | formal/python/tests/test_qm_empirical_comparison_packet_04_gate.py | NOT_APPLICABLE_PILLAR_ROW | THEOREM_GAP_OPEN | PATH_PINNED_RUNTIME_RECORDED |
