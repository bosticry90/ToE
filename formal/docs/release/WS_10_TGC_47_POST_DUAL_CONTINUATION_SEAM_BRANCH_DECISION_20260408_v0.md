# WS-10 TGC-47 Post-Dual-Continuation Seam Branch Decision (2026-04-08)
...
- Result: `28 passed in 6.98s`

## Decision state
- `TGC47_BRANCH_DECISION_STATE_v0: NEXT_DUAL_PATH_CONTINUATION_PACKAGE_PINNED`
- `TGC47_QM_STAT_ROW_STATE_v0: CONTINUE_BOUNDED`
- `TGC47_COSMO_SR_ROW_STATE_v0: CONTINUE_BOUNDED`
- `TGC47_SCOPE_BOUNDARY_v0: EXISTING_SEAM_SURFACES_ONLY_NO_NEW_AUTHORITY_RESIDENCY`
...
- Checkpoint JSON pointer: formal/output/ws10_tgc47_post_dual_continuation_seam_branch_decision_checkpoint_20260408_v0.json
