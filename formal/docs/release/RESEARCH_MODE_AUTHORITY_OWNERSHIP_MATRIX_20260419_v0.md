...
- `RESEARCH_MODE_AUTHORITY_MATRIX_ROW_COUNT_v0: 5`
...
| research_formalization_routing_contract | formal/docs/release/RESEARCH_FORMALIZATION_ROUTING_CONTRACT_20260420_v0.md | State_of_the_Theory.md + formal/docs/paper/PHYSICS_ROADMAP_v0.md | formal/python/tests/test_research_mode_formalization_routing_contract_gate.py |
