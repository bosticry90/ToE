"""OV-04x: fit-family robustness gate on DS-02 low-k external dataset.
...
Note
- OV-04x is intended to be robustness-only and must not be used for β inference.
"""
...
def ov04_fit_family_robustness_gate(
