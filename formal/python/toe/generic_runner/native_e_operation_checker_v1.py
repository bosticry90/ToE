"""Independent native-E operations relative to the admitted N8/F4 premises.
...
from formal.python.toe.generic_runner import c03_physical_dag_verifier_v1 as pv
...
def witness(r,target):
    ...
    require(r.T*solution==target,'NATIVE_RELATION_WITNESS')
...
def operation(key,parents):
    ...
    if suffix=='RESIDUAL':
        ...
        require(remainder==r.T*sp.Matrix(w['coefficients']) and remainder==sp.Matrix(part),'NATIVE_REMAINDER_WITNESS_MISMATCH')
