...
SCHEMA_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_STATUS_ADJUDICATION_20260515_v0"
EXECUTION_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_STATUS_ADJUDICATION_v0"
OUTCOME_ID = (
...
EXPECTED_SELECTED_TARGET = "execute_v01_alpha_dependency_remediation_tranche_001_status_adjudication"
...
NEXT_TARGET = "review_v01_alpha_dependency_remediation_tranche_001_status_adjudication_result"
...
def build_adjudication(
    *,
    ...
    status_decision = {
        ...
        "meaning": (
            "Tranche 001 has enough dependency-policy evidence to be treated as a documented "
            "dependency status candidate, pending result review."
        ),
    ...
    acceptance_criteria = {
        ...
        == SELECTED_DEPENDENCY,
        "adjudicates_only_tranche_001": status_decision["selected_remediation_finding_id"]
        == SELECTED_REMEDIATION_FINDING_ID
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_STATUS_ADJUDICATION_BLOCKED",
        ...
        "tranche_001_status_candidate": STATUS_DECISION,
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_STATUS_ADJUDICATION",
        ...
        "candidate_next_targets": [
            ...
            },
            {
                ...
                "decision": "deferred",
                "reason": "The next remediation tranche remains deferred until tranche 001 status execution is result-reviewed.",
            },
            {
                "target": "prepare_v01_alpha_release_readiness_adjudication_packet",
                "decision": "deferred",
                "reason": "Release-readiness adjudication remains blocked by status result review and five other blockers.",
            },
        ],
        "acceptance_criteria": acceptance_criteria,
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 001 status adjudication decides only "
            "that the selected dependency can be treated as a documented dependency status "
            "candidate pending result review. It does not clear or move the blocker by itself, "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_001_status_adjudication_report: "
