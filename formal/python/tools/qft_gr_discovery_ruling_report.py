...
SCHEMA_ID = "QFT_GR_DISCOVERY_RULING_REPORT_20260411_v0"
...
DEFAULT_DECLARATION_PATH = (
    ...
    / "docs"
    / "release"
    / "QFT_GR_DISCOVERY_RULING_20260411_v0.json"
)
...
def build_report(*, declaration_path: Path, captured_at_utc: str | None) -> dict[str, Any]:
    ...
    return {
        ...
        "non_claim_boundary": "Repository-local QFT-GR discovery ruling report only; no scientific adequacy claim.",
    }


def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate QFT-GR discovery ruling report.")
    parser.add_argument("--declaration", type=Path, default=DEFAULT_DECLARATION_PATH)
    parser.add_argument(
        "--out",
        type=Path,
        default=REPO_ROOT / "formal" / "output" / "reports" / "qft_gr_discovery_ruling_report_20260411_v0.json",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "qft_gr_discovery_ruling_report: "
