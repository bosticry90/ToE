"""CLI for OV-UCFF-06 temporal spectral entropy trends audit scaffold.

Usage
  .\py.ps1 -m formal.python.tools.ovucff06_temporal_spectral_entropy_trends_audit --report --demo mixed
  .\py.ps1 -m formal.python.tools.ovucff06_temporal_spectral_entropy_trends_audit --report --pinned
  .\py.ps1 -m formal.python.tools.ovucff06_temporal_spectral_entropy_trends_audit --write
...
def main(argv: list[str] | None = None) -> int:
    ...
    p.add_argument(
        ...
        action="store_true",
        help=(
            "Use the canonical pinned input artifact for OV-UCFF-06. "
    ...
    if args.write:
        out = write_ovucff06_entropy_trends_artifact()
