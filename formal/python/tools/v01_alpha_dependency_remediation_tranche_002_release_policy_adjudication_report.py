...
EXECUTION_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_RELEASE_POLICY_ADJUDICATION_v0"
OUTCOME_ID = (
    ...
    *,
    ...
    policy_decision = {
        ...
        "decision": (
            ...
            "acceptable for the v0.1-alpha dependency posture of stationary_implies_operator_zero "
            "when no project-local axioms are used, provided the release materials document this "
            "standard-axiom posture."
        ),
        "documentation_requirement": (
            "A later documentation packet and result review must record that tranche 002 depends "
    ...
    acceptance_criteria = {
        ...
        == POLICY_QUESTION,
        "adjudicates_only_tranche_002": policy_decision["classification"]
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_RELEASE_POLICY_ADJUDICATION_BLOCKED",
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_RELEASE_POLICY_ADJUDICATION",
        ...
        "candidate_next_targets": [
            ...
            {
                "target": "prepare_v01_alpha_dependency_remediation_tranche_002_documentation_packet",
                "decision": "deferred",
        ...
        "non_claim_boundary": (
            ...
            "are acceptable for stationary_implies_operator_zero with a documentation requirement "
            "and no project-local axioms. It does not close remediation, move blockers, assemble "
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Generate the v0.1-alpha dependency remediation tranche 002 release-policy adjudication."
        )
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_002_release_policy_adjudication_report: "
