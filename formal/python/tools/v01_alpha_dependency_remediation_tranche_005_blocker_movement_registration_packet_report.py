...
def build_packet(
    *,
    ...
    acceptance_criteria = {
        ...
        "movement_proposal_is_tranche_005_only": movement_proposal["selected_tranche_id"]
        == SELECTED_TRANCHE_ID
        ...
        and movement_proposal["movement_scope"] == "tranche_005_only",
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_BLOCKER_MOVEMENT_REGISTRATION_PACKET_BLOCKED",
        ...
        "movement_registration_acceptance_criteria": [
            "The proposed movement is only for V01-ALPHA-DEP-REM-005.",
        ...
        "movement_registration_failure_criteria": [
            "The proposal touches any dependency other than supplied_interface_alignment_semantics_construct_bridge_package_v0.",
            ...
            "The proposal moves retained tranche 004 or modifies tranche 006.",
        ],
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_BLOCKER_MOVEMENT_REGISTRATION_PACKET",
        ...
        "non_claim_boundary": (
            ...
            "dependency status for V01-ALPHA-DEP-REM-005 only. It does not register blocker "
            "movement, clear tranche 005, move retained tranche 004, assemble the release packet, "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_005_blocker_movement_registration_packet_report: "
