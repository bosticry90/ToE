...
SCHEMA_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_RELEASE_POLICY_ADJUDICATION_20260515_v0"
)
EXECUTION_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_RELEASE_POLICY_ADJUDICATION_v0"
OUTCOME_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_RELEASE_POLICY_ADJUDICATED_"
    ...
    return [
        {
            ...
            "modified_by_tranche_005_policy_adjudication": False,
        },
        {
    ...
    *,
    ...
    policy_decision = {
        ...
        "decision": (
            ...
            "supplied_interface_alignment_semantics_construct_bridge_package_v0 when no "
            "project-local axioms are used, provided the release materials document this "
            "standard-axiom posture."
        ),
        "decision_basis": [
            "Tranche 005 packet result review accepted the policy-question preparation.",
            "The selected dependency is supplied_interface_alignment_semantics_construct_bridge_package_v0.",
            ...
            "The decision is specific to V01-ALPHA-DEP-REM-005 and is not inferred by analogy alone.",
        ],
        "documentation_requirement": (
            "A later documentation packet and result review must record that tranche 005 depends "
    ...
    acceptance_criteria = {
        ...
        == POLICY_QUESTION,
        "adjudicates_only_tranche_005": policy_decision["classification"]
        ...
        "decision_basis_is_tranche_005_specific": any(
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_RELEASE_POLICY_ADJUDICATION_BLOCKED",
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_RELEASE_POLICY_ADJUDICATION",
        ...
        "candidate_next_targets": [
            ...
            {
                "target": "prepare_v01_alpha_dependency_remediation_tranche_005_documentation_packet",
                "decision": "deferred",
            ...
            },
            {
                ...
                "decision": "deferred",
                "reason": "Release-readiness adjudication remains blocked by retained tranche 004 and tracked tranche 006.",
            },
        ],
        ...
        "non_claim_boundary": (
            ...
            "are acceptable for supplied_interface_alignment_semantics_construct_bridge_package_v0 "
            "with a documentation requirement and no project-local axioms. It carries tranche 004 "
            "as retained/release-blocking and keeps tranche 006 tracked. It does not close "
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Generate the v0.1-alpha dependency remediation tranche 005 release-policy adjudication."
        )
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_report: "
