...
OUTCOME_ID = (
    ...
    "TRANCHE_002_MOVEMENT_WITH_NO_RELEASE_PROMOTION"
)
...
TRANCHE_002_DEPENDENCY = "stationary_implies_operator_zero"
SELECTED_NEXT_TRANCHE_ID = "V01-ALPHA-DEP-REM-TRANCHE-003"
SELECTED_NEXT_FINDING_ID = "V01-ALPHA-DEP-REM-003"
SELECTED_NEXT_DEPENDENCY = "finite_transport_theorems_construct_residual_package_v0"
...
def _selection_row(row: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "selection_reason": (
            "After tranche 002 movement, this is the first remaining carried-forward "
            "release-blocking obligation in the remediation ledger."
        ),
...
def build_packet(
    *,
    ...
    acceptance_criteria = {
        "consumes_expected_tranche_002_result_review": result_review.get("review_id")
        == EXPECTED_RESULT_REVIEW_ID,
        "tranche_002_result_review_accepted": result_review.get("accepted") is True,
        "tranche_002_result_review_outcome_expected": result_review.get("outcome_id")
        == EXPECTED_RESULT_REVIEW_OUTCOME,
        "tranche_002_result_review_selected_this_packet": result_review.get(
        ...
        == TRANCHE_001_STATUS,
        "tranche_002_documented_nonblocking_accepted": result_review.get(
            "tranche_002_formal_movement_accepted"
        )
        is True
        and result_review.get("tranche_002_release_blocker_status") == TRANCHE_002_STATUS,
        "tranche_002_identity_preserved": result_review.get("selected_remediation_finding_id")
        == TRANCHE_002_FINDING_ID
        and result_review.get("selected_dependency") == TRANCHE_002_DEPENDENCY,
        "global_release_still_blocked": result_review.get(
            "global_release_readiness_still_blocked"
        )
        is True
        and result_review.get("release_blocking_obligation_count_after_review") == 4,
        "four_obligations_tracked_unmodified": _remaining_obligations_are_unmodified(
        ...
        == "stable_order_first_remaining_release_blocking_obligation"
        and remaining_obligations[0].get("dependency_finding_id")
        == SELECTED_NEXT_FINDING_ID,
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_NEXT_TRANCHE_SELECTION_PACKET_AFTER_TRANCHE_002_MOVEMENT_BLOCKED",
        "consumes_tranche_002_result_review": EXPECTED_RESULT_REVIEW_ID,
        "consumes_tranche_002_result_review_pointer": _ptr(result_review_path),
        "consumed_result_review_schema_id": result_review.get("schema_id"),
        "packet_scope": (
            "PREPARE_NEXT_REMEDIATION_TRANCHE_SELECTION_PACKET_AFTER_TRANCHE_002_MOVEMENT_ONLY_NO_REMEDIATION_EXECUTION_OR_RELEASE_PROMOTION"
        ),
        "tranche_001_status": TRANCHE_001_STATUS,
        "tranche_002_status": TRANCHE_002_STATUS,
        "tranche_002_formal_movement_accepted": True,
        "tranche_002_dependency_policy_remediation_satisfied": True,
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_NEXT_TRANCHE_SELECTION_PACKET_AFTER_TRANCHE_002_MOVEMENT",
        ...
        "candidate_next_targets": [
            ...
            {
                "target": "prepare_v01_alpha_dependency_remediation_tranche_003_execution_packet",
                "decision": "deferred",
                "reason": "Tranche 003 execution-packet preparation requires result-review acceptance of this selection packet.",
            },
            {
                "target": "prepare_v01_alpha_release_readiness_adjudication_packet",
                "decision": "deferred",
                "reason": "Release-readiness adjudication remains blocked by four remaining release-blocking obligations.",
            },
        ],
        "acceptance_criteria": acceptance_criteria,
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation next-tranche selection packet after "
            "tranche 002 movement selects only one remaining release-blocking obligation for "
            "the next bounded remediation tranche. It does not execute remediation, prepare "
            "the tranche-specific execution packet, assemble the release packet, mark "
            "v0.1-alpha readiness, discharge Lean theorem debt, reduce axiom/spec-backed "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_002_movement_report: "
