...
NEXT_TARGET = "execute_v01_alpha_dependency_remediation_tranche_006_blocker_movement_registration"
...
def build_result_review(
    *,
    ...
    acceptance_criteria = {
        ...
        "movement_scope_tranche_006_only": movement_proposal.get("movement_scope")
        == "tranche_006_only"
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_BLOCKER_MOVEMENT_REGISTRATION_PACKET_RESULT_REVIEW_BLOCKED",
        ...
        "movement_proposal": {
            ...
            "tranche_005_status": movement_proposal.get("tranche_005_status"),
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_BLOCKER_MOVEMENT_REGISTRATION_PACKET_RESULT_REVIEW",
        ...
        "non_claim_boundary": (
            ...
            "registration execution. It does not register blocker movement, clear tranche 006, "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_006_blocker_movement_registration_packet_result_review_report: "
