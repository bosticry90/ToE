...
SCHEMA_ID = (
    ...
    "RETEST_REFINEMENT_CONSERVATION_RETEST_REFINEMENT_REFINEMENT_RESULT_REVIEW_20260614_v0"
)
REVIEW_ID = (
    "QFT_GR_MINIMAL_WORKING_MODEL_CONSERVATION_RETEST_PACKET_AFTER_POST_"
...
NEXT_TARGET_KIND = (
    ...
    "refinement_conservation_retest_refinement_refinement_execution_only"
)
AUTHORIZED_CONSERVATION_RETEST_ATTEMPT_CLASSIFICATIONS = [
    (
        ...
        "retest_refinement_conservation_retest_refinement_refinement_executed_pending_"
        "result_review"
    ),
    (
    ...
    return [
        {
            ...
            "decision": "selected",
            "reason": (
                "The v4 conservation-retest packet is accepted as a bounded "
        ...
        },
        {
            ...
            "reason": (
                "This v4 conservation-retest packet result-review target is "
                "consumed here."
            ),
        },
        {
...
def build_qft_gr_minimal_working_model_conservation_retest_packet_after_post_retest_refinement_conservation_retest_refinement_refinement_result_review(
    *,
    ...
    return {
        ...
        "next_action_scope": (
            ...
            "AFTER_POST_RETEST_REFINEMENT_CONSERVATION_RETEST_REFINEMENT_REFINEMENT_ONLY_"
        ...
        "non_claim_boundary": (
            "This result review accepts only the prepared v4 conservation-"
...
def write_qft_gr_minimal_working_model_conservation_retest_packet_after_post_retest_refinement_conservation_retest_refinement_refinement_result_review(
    *,
    packet_path: Path = DEFAULT_PACKET_PATH,
    out: Path = DEFAULT_OUT,
    captured_at_utc: str = DEFAULT_CAPTURED_AT_UTC,
) -> dict[str, Any]:
    payload = build_qft_gr_minimal_working_model_conservation_retest_packet_after_post_retest_refinement_conservation_retest_refinement_refinement_result_review(
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = write_qft_gr_minimal_working_model_conservation_retest_packet_after_post_retest_refinement_conservation_retest_refinement_refinement_result_review(
        packet_path=packet_path,
        out=out,
