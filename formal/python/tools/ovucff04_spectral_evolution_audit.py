"""CLI for OV-UCFF-04 spectral evolution audit scaffold.

Usage
  .\py.ps1 -m formal.python.tools.ovucff04_spectral_evolution_audit --report --demo drift
  .\py.ps1 -m formal.python.tools.ovucff04_spectral_evolution_audit --report --pinned
  .\py.ps1 -m formal.python.tools.ovucff04_spectral_evolution_audit --write
...
def main(argv: list[str] | None = None) -> int:
    ...
    p.add_argument(
        ...
        action="store_true",
        help=(
            "Use the canonical pinned input artifact for OV-UCFF-04. "
            "Ignored if --input-json is provided."
        ),
    )
    p.add_argument("--demo", default="drift", choices=["constant", "drift", "noise"], help="Demo input selection")
    ...
    if args.write:
        out = write_ovucff04_spectral_evolution_artifact()
