...
SCHEMA_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_DOCUMENTATION_PACKET_20260515_v0"
PACKET_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_DOCUMENTATION_PACKET_v0"
OUTCOME_ID = (
...
NEXT_TARGET = "review_v01_alpha_dependency_remediation_tranche_002_documentation_packet_result"
...
def build_packet(
    *,
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_DOCUMENTATION_PACKET_BLOCKED",
        ...
        "documentation_purpose": (
            "Record the standard Lean axiom posture for tranche 002 after policy adjudication "
            "accepted it with a documentation requirement."
        ),
        "documentation_scope": (
            "Selected finding V01-ALPHA-DEP-REM-002 and dependency "
            "stationary_implies_operator_zero only."
        ),
        ...
        "documentation_sections": [
            ...
            "blocker movement boundary",
            "tranche 001 carry-forward",
            "other four blockers carried forward unchanged",
        ],
        "what_this_documentation_does_not_prove": [
            "It does not prove the selected theorem.",
            "It does not discharge Lean theorem debt or proof debt.",
            "It does not discharge retained assumptions.",
            "It does not clear or downgrade tranche 002 by itself.",
            "It does not register blocker movement for tranche 002.",
        ...
        "blocker_movement_boundary": (
            "Tranche 002 remains blocking until documentation result review, later status "
        ...
        "tranche_002_release_blocker_status": "still_blocking_pending_documentation_packet_result_review",
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_DOCUMENTATION_PACKET",
        ...
        "candidate_next_targets": [
            {
                "target": NEXT_TARGET,
                "decision": "selected",
                "reason": "The prepared tranche 002 documentation packet must be reviewed before status adjudication or blocker movement can be considered.",
            },
            {
                "target": "prepare_v01_alpha_dependency_remediation_tranche_002_status_adjudication_packet",
                "decision": "deferred",
                "reason": "Status adjudication remains deferred until tranche 002 documentation is reviewed.",
            },
            {
                "target": "prepare_v01_alpha_release_readiness_adjudication_packet",
                "decision": "deferred",
                "reason": "Release-readiness adjudication remains blocked by tranche 002 documentation result review and tracked blockers.",
            },
        ],
        "acceptance_criteria": acceptance_criteria,
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 002 documentation packet prepares a "
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate the v0.1-alpha dependency remediation tranche 002 documentation packet."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_002_documentation_packet_report: "
