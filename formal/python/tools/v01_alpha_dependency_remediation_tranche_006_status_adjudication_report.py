...
SCHEMA_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_STATUS_ADJUDICATION_20260522_v0"
EXECUTION_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_STATUS_ADJUDICATION_v0"
OUTCOME_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_STATUS_ADJUDICATED_PENDING_RESULT_REVIEW_"
...
EXPECTED_SELECTED_TARGET = "execute_v01_alpha_dependency_remediation_tranche_006_status_adjudication"
...
NEXT_TARGET = "review_v01_alpha_dependency_remediation_tranche_006_status_adjudication_result"
...
def build_adjudication(
    *,
    ...
    status_decision = {
        ...
        "meaning": (
            "Tranche 006 has enough dependency-policy evidence to be treated as a documented "
    ...
    acceptance_criteria = {
        ...
        "adjudicates_only_tranche_006": status_decision["selected_tranche_id"]
        == SELECTED_TRANCHE_ID
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_STATUS_ADJUDICATION_BLOCKED",
        ...
        "tranche_006_status_candidate": STATUS_DECISION,
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_STATUS_ADJUDICATION",
        ...
        "candidate_next_targets": [
            {
                ...
                "decision": "selected",
                "reason": (
                    "The status adjudication execution must be reviewed before any Tranche 006 "
            ...
            },
            {
                ...
                "decision": "deferred",
                "reason": (
                    "Blocker movement registration requires acceptance of the Tranche 006 "
        ...
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 006 status adjudication decides only "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_006_status_adjudication_report: "
