...
def build_packet(
    *,
    ...
    acceptance_criteria = {
        ...
        "movement_proposal_is_tranche_002_only": movement_proposal["selected_tranche_id"]
        == SELECTED_TRANCHE_ID
        and movement_proposal["selected_remediation_finding_id"]
        == SELECTED_REMEDIATION_FINDING_ID
        and movement_proposal["selected_dependency"] == SELECTED_DEPENDENCY
        and movement_proposal["movement_scope"] == "tranche_002_only",
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_BLOCKER_MOVEMENT_REGISTRATION_PACKET_BLOCKED",
        ...
        "movement_registration_inputs": [
            ...
            "other four release-blocking obligations tracked and unmodified",
        ],
        "movement_registration_acceptance_criteria": [
            "The proposed movement is only for V01-ALPHA-DEP-REM-002.",
        ...
        "movement_registration_failure_criteria": [
            "The proposal touches any dependency other than stationary_implies_operator_zero.",
            ...
            "The proposal modifies tranche 001 or any non-selected remaining blocker.",
        ],
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_BLOCKER_MOVEMENT_REGISTRATION_PACKET",
        ...
        "candidate_next_targets": [
            ...
            {
                "target": "execute_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration",
                "decision": "deferred",
        ...
        "non_claim_boundary": (
            ...
            "dependency status for V01-ALPHA-DEP-REM-002 only. It does not register blocker "
            "movement, clear tranche 002, assemble the release packet, mark v0.1-alpha readiness, "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_packet_report: "
