...
EXECUTION_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_BLOCKER_MOVEMENT_REGISTRATION_v0"
OUTCOME_ID = (
...
NEXT_TARGET = "review_v01_alpha_dependency_remediation_tranche_003_blocker_movement_registration_result"
...
def build_registration(
    *,
    ...
    acceptance_criteria = {
        ...
        "registers_only_tranche_003": registered_movement[
            "selected_remediation_finding_id"
        ]
        == SELECTED_REMEDIATION_FINDING_ID
        and registered_movement["selected_dependency"] == SELECTED_DEPENDENCY
        and registered_movement["movement_scope"] == "tranche_003_only",
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_BLOCKER_MOVEMENT_REGISTRATION_BLOCKED",
        ...
        "tranche_003_formal_movement_accepted": False,
        ...
        "remaining_release_blocking_obligation_count_excluding_tranche_003_candidate": (
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_BLOCKER_MOVEMENT_REGISTRATION",
        ...
        "candidate_next_targets": [
            {
                "target": NEXT_TARGET,
                "decision": "selected",
                "reason": "The movement registration execution must be reviewed before tranche 003 movement is formally accepted.",
            },
            {
                "target": "prepare_v01_alpha_dependency_remediation_next_tranche_selection_packet",
                "decision": "deferred",
                "reason": "The next remediation tranche selection remains deferred until tranche 003 movement registration is result-reviewed.",
            },
            {
        ...
        "non_claim_boundary": (
            ...
            "execution registers only V01-ALPHA-DEP-REM-003 as documented/nonblocking pending "
            "result review. It does not clear tranche 003 for global release readiness, assemble "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_003_blocker_movement_registration_report: "
