...
creates the future experiment root, or calls the evolution. Freeze v2
preserves the accepted six physical configurations and corrects only the
source-closure identity, layered execution identity, and field-specific
diagnostic contracts blocked by the independent v1 freeze review.
"""
...
SCRIPT_RELATIVE_PATH = (
    ...
    "robustness_instrumented_r13_mechanism_experiment_numerical_freeze_packet_v2.py"
)
PACKET_RELATIVE_PATH = (
    "formal/output/DIRAC-MAXWELL-FULL-ZERO-MODE-DESCENDANT-NECESSITY-AND-"
    "ROBUSTNESS-INSTRUMENTED-R13-MECHANISM-EXPERIMENT-NUMERICAL-FREEZE-PACKET-v2.json"
)
RUN_MATRIX_RELATIVE_PATH = (
    "formal/output/DIRAC-MAXWELL-FULL-ZERO-MODE-DESCENDANT-NECESSITY-AND-"
    "ROBUSTNESS-INSTRUMENTED-R13-MECHANISM-EXPERIMENT-NUMERICAL-FREEZE-RUN-MATRIX-v2.json"
)
...
MANIFEST_RELATIVE_PATH = (
    "formal/output/DIRAC-MAXWELL-FULL-ZERO-MODE-DESCENDANT-NECESSITY-AND-"
    "ROBUSTNESS-INSTRUMENTED-R13-MECHANISM-EXPERIMENT-NUMERICAL-FREEZE-MANIFEST-v2.json"
)
...
PREDECESSOR_PACKET_RELATIVE_PATH = predecessor_v1.PACKET_RELATIVE_PATH
PREDECESSOR_MATRIX_RELATIVE_PATH = predecessor_v1.RUN_MATRIX_RELATIVE_PATH
PREDECESSOR_IDENTITY_RELATIVE_PATH = predecessor_v1.IDENTITY_RELATIVE_PATH
PREDECESSOR_REPORT_RELATIVE_PATH = predecessor_v1.REPORT_RELATIVE_PATH
PREDECESSOR_REVIEW_RELATIVE_PATH = (
    "formal/docs/release/DIRAC_MAXWELL_FULL_ZERO_MODE_DESCENDANT_NECESSITY_AND_"
    "ROBUSTNESS_INSTRUMENTED_R13_MECHANISM_EXPERIMENT_NUMERICAL_FREEZE_PACKET_"
    "REVIEW_20260715_v1.json"
)
DESIGN_REVIEW_RELATIVE_PATH = predecessor_v1.DESIGN_REVIEW_RELATIVE_PATH
CANONICAL_MATRIX_RELATIVE_PATH = predecessor_v1.CANONICAL_MATRIX_RELATIVE_PATH
...
EXPERIMENT_OUTPUT_ROOT = predecessor_v1.EXPERIMENT_OUTPUT_ROOT
CANONICAL_OUTPUT_ROOT = predecessor_v1.CANONICAL_OUTPUT_ROOT
EXPECTED_CANONICAL_ROOT_DIGEST = predecessor_v1.EXPECTED_CANONICAL_ROOT_DIGEST
EXPECTED_CANONICAL_DIRECTORY_TREE_SHA256 = (
    predecessor_v1.EXPECTED_CANONICAL_DIRECTORY_TREE_SHA256
)

EXECUTOR_RELATIVE_PATH = executor_custody_v2.MODULE_PATH_BY_NAME[
    executor_custody_v2.EXECUTOR_MODULE
]
CUSTODY_RELATIVE_PATH = executor_custody_v2.MODULE_PATH_BY_NAME[
    executor_custody_v2.CUSTODY_MODULE
]
V0_IMPLEMENTATION_RELATIVE_PATH = executor_custody_v2.MODULE_PATH_BY_NAME[
    executor_custody_v2.V0_IMPLEMENTATION_MODULE
]
HISTORICAL_EVOLUTION_RELATIVE_PATH = executor_custody_v2.MODULE_PATH_BY_NAME[
    executor_custody_v2.HISTORICAL_EVOLUTION_MODULE
]
HISTORICAL_PACK_RELATIVE_PATH = executor_custody_v2.MODULE_PATH_BY_NAME[
    executor_custody_v2.HISTORICAL_PACK_MODULE
]
SEMANTIC_RELATIVE_PATH = semantic_v1.SCRIPT_RELATIVE_PATH
ASSEMBLER_RELATIVE_PATH = evidence_v2.SCRIPT_RELATIVE_PATH
CLASSIFIER_RELATIVE_PATH = classifier_v2.SCRIPT_RELATIVE_PATH

RUNTIME_MODULES = (
    (executor_custody_v2.EXECUTOR_MODULE, EXECUTOR_RELATIVE_PATH, "EXECUTION"),
    (executor_custody_v2.CUSTODY_MODULE, CUSTODY_RELATIVE_PATH, "EXECUTION"),
    (
        executor_custody_v2.V0_IMPLEMENTATION_MODULE,
    ...
    (
        "formal.python.tools.dirac_maxwell_full_zero_mode_descendant_necessity_"
        "and_robustness_instrumented_r13_mechanism_experiment_raw_evidence_assembler_v2",
        ASSEMBLER_RELATIVE_PATH,
        "CLASSIFICATION",
    ),
    (
        "formal.python.tools.dirac_maxwell_full_zero_mode_descendant_necessity_"
        "and_robustness_instrumented_r13_mechanism_experiment_classifier_v2",
...
DECISION_IDS = (
    ...
    "blocked_freeze_v1_review_authorizes_only_versioned_freeze_correction",
    ...
    "packet_rotates_only_to_independent_freeze_v2_review",
)
...
def _runtime_source_binding() -> dict[str, Any]:
    ...
    runtime_source_closure = {
        "schema_id": "R13_MECHANISM_RUNTIME_SOURCE_CLOSURE_v2",
        "modules": bindings,
    ...
    return {
        "schema_id": "R13_MECHANISM_FREEZE_RUNTIME_SOURCE_BINDING_v2",
...
def _attest_preparation_loaded_sources(
    ...
    v0 = modules[executor_custody_v2.V0_IMPLEMENTATION_MODULE]
    evolution = modules[executor_custody_v2.HISTORICAL_EVOLUTION_MODULE]
    historical_pack = modules[executor_custody_v2.HISTORICAL_PACK_MODULE]
...
def build_physical_configuration_core(
    ...
    return executor_v2.build_physical_configuration_core(
...
def build_scientific_input_core(
    ...
    reconstructed_physical = executor_v2.build_physical_configuration_core(
        record, runtime_source_closure_sha256
    )
    ...
    return executor_v2.build_scientific_input_core(
        record, runtime_source_closure_sha256
    )


def scientific_input_hash(core: Mapping[str, Any]) -> str:
    return executor_v2.scientific_input_hash(core)
...
def _authority_basis() -> dict[str, Any]:
    ...
    if predecessor_review.get("verdict") != "BLOCK_INPUT_HASH_RECONSTRUCTION":
        raise ValueError("blocked freeze-v1 review is not authoritative")
    if predecessor_review.get("selected_next_target") != TARGET:
        raise ValueError("freeze-v1 review did not authorize v2 preparation")
    return {
        "accepted_design_v1_review": _file_binding(DESIGN_REVIEW_RELATIVE_PATH),
        "blocked_freeze_v1_review": _file_binding(PREDECESSOR_REVIEW_RELATIVE_PATH),
...
def _build_run_matrix(implementation: Mapping[str, Any]) -> dict[str, Any]:
    ...
    result["schema_id"] = (
        ...
        "INSTRUMENTED_R13_MECHANISM_EXPERIMENT_NUMERICAL_FREEZE_RUN_MATRIX_v2"
    )
    ...
    for record in result["records"]:
        ...
        complete_execution = executor_v2.build_complete_execution_identity_core(
            record, closure_digest
        )
        complete_execution_hash = executor_v2.complete_execution_identity_sha256(
            record, closure_digest
        )
    ...
    result["generation_policy"] = (
        "fixed accepted six-run matrix; v2 changes only frozen source identity and "
        "layered execution identity contracts; no dynamic discovery, retry, "
...
def _build_identity(matrix: Mapping[str, Any]) -> dict[str, Any]:
    ...
    identity["schema_id"] = (
        "DIRAC_MAXWELL_FULL_ZERO_MODE_DESCENDANT_NECESSITY_AND_ROBUSTNESS_"
        "INSTRUMENTED_R13_MECHANISM_EXPERIMENT_EXPECTED_OUTPUT_IDENTITY_MANIFEST_v2"
    )
...
def _identity_mutation_diagnostic_audit(
    ...
    if semantic_v1.IDENTITY_MUTATION_FIELDS != executor_v2.IDENTITY_DIAGNOSTIC_FIELDS:
        raise ValueError("v2 diagnostic field order differs from the reviewed 20-field domain")
    probes: list[dict[str, Any]] = []
    for field in executor_v2.IDENTITY_DIAGNOSTIC_FIELDS:
        ...
        observed = executor_v2.strict_validate_matrix(candidate, matrix)
    ...
    closure.update(
        {
            ...
            "payload_field": (
                "recomputed by raw_evidence_assembler_v2 from direct terminal P defect, "
...
def _runtime_authority_schema(
    ...
    artifact_bindings = {
        ...
        "freeze_packet": {
            ...
            "sha256": None,
            "preparation_note": (
                "the independent v2 freeze review must bind the final packet bytes; "
    ...
    proposed_authority = {
        "schema_id": "R13_MECHANISM_RUNTIME_EXECUTION_AUTHORITY_v2",
        "executor_id": executor_v2.EXECUTOR_ID,
    ...
    return {
        "fixed_review_anchor_path": executor_custody_v2.REVIEW_ANCHOR_RELATIVE_PATH,
        "required_review_verdict": executor_custody_v2.EXPECTED_REVIEW_VERDICT,
        "required_review_field": executor_custody_v2.REVIEW_AUTHORITY_FIELD,
...
def build_packet(
    ...
    ) or not mutation_audit["all_passed"] or not source_attestation["all_passed"]:
        raise ValueError("v2 semantic/evidence/classifier/diagnostic self-validation failed")
    decisions = [
    ...
    return {
        ...
        "predecessor_correction_scope": {
            ...
            "corrected_blocker_count": 3,
            "corrected_classes": [
                "frozen runtime source closure and runtime-loaded byte identity",
                "source-independent scientific input plus complete execution identity",
                "exact field-specific first diagnostics for all 20 identity mutations",
            ],
        },
        "exact_run_matrix": {
        ...
        "run_lookup_and_preflight_contract": {
            "public_execution_entrypoint": (
                f"{EXECUTOR_RELATIVE_PATH}:execute_frozen_matrix_once_v2"
            ),
        ...
        "raw_evidence_assembler_contract": {
            "assembler_id": evidence_v2.ASSEMBLER_ID,
        ...
        "classifier_freeze": {
            "classifier_id": classifier_v2.CLASSIFIER_ID,
            ...
            "precedence": list(classifier_v2.CLASSIFIER_PRECEDENCE),
        ...
        "authority_boundary": {
            "numerical_freeze_v2_prepared": True,
            "numerical_freeze_v2_independently_accepted": False,
        ...
        "claim_ceiling": classifier_v2.CLAIM_CEILING,
        "nonclaims": [
...
def build_manifest(
    ...
    return {
        "schema_id": (
            "DIRAC_MAXWELL_FULL_ZERO_MODE_DESCENDANT_NECESSITY_AND_ROBUSTNESS_"
            "INSTRUMENTED_R13_MECHANISM_EXPERIMENT_NUMERICAL_FREEZE_MANIFEST_v2"
        ),
        "captured_at_utc": CAPTURED_AT_UTC,
...
def build_report(
    ...
    return {
        "schema_id": (
            "DIRAC_MAXWELL_FULL_ZERO_MODE_DESCENDANT_NECESSITY_AND_ROBUSTNESS_"
            "INSTRUMENTED_R13_MECHANISM_EXPERIMENT_NUMERICAL_FREEZE_PACKET_20260716_v2"
        ),
        "captured_at_utc": CAPTURED_AT_UTC,
        "target": TARGET,
        "verdict": "PREPARED_PENDING_INDEPENDENT_REVIEW",
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Prepare corrected R13 mechanism numerical-freeze v2."
    )
    ...
    if args.write:
        ...
        if stale:
            print(f"stale or missing numerical-freeze-v2 artifacts: {stale}", file=sys.stderr)
            return 1
    else:
