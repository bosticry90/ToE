...
SCHEMA_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_DOCUMENTATION_PACKET_20260515_v0"
PACKET_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_DOCUMENTATION_PACKET_v0"
OUTCOME_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_DOCUMENTATION_PACKET_PREPARED_"
...
DEFAULT_OUT = (
    ...
    / "docs"
    / "release"
    / "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_DOCUMENTATION_PACKET_20260515_v0.json"
)
DEFAULT_DOCUMENTATION_OUT = (
    ...
    / "docs"
    / "paper"
    / "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_DOCUMENTATION_v0.md"
)

NEXT_TARGET = "review_v01_alpha_dependency_remediation_tranche_005_documentation_packet_result"
...
def build_documentation_markdown(result_review: dict[str, Any]) -> str:
    ...
    return (
        ...
        "clear, or otherwise move tranche 005.\n\n"
        ...
        f"- Tranche 006 dependency: `{tranche_006.get('dependency')}`\n"
    )
...
def build_packet(
    *,
    ...
    acceptance_criteria = {
        ...
        "policy_question_preserved": result_review.get("policy_question") == POLICY_QUESTION,
        ...
        "documentation_markdown_records_required_scope": all(
            ...
            for token in [
                ...
                "project_axioms_used = []",
                "does not clear",
                "does not register blocker movement for tranche 005",
                TRANCHE_001_STATUS,
                TRANCHE_002_STATUS,
                TRANCHE_003_STATUS,
                TRANCHE_004_STATUS,
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_DOCUMENTATION_PACKET_BLOCKED",
        ...
        "documentation_purpose": (
            "Record the standard Lean axiom posture for tranche 005 after policy adjudication "
            "accepted it with a documentation requirement."
        ),
        "documentation_scope": (
            "Selected finding V01-ALPHA-DEP-REM-005 and dependency "
            "supplied_interface_alignment_semantics_construct_bridge_package_v0 only."
        ),
        ...
        "documentation_sections": [
            ...
            "tranche 006 tracked unresolved carry-forward",
        ],
        "what_this_documentation_does_not_prove": [
            "It does not prove the selected dependency.",
            "It does not discharge Lean theorem debt or proof debt.",
            "It does not discharge retained assumptions.",
            "It does not clear or downgrade tranche 005 by itself.",
            "It does not register blocker movement for tranche 005.",
            "It does not move tranche 004 or discharge the retained source-map blocker.",
        ...
        "blocker_movement_boundary": (
            "Tranche 005 remains blocking until documentation result review, later status "
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_DOCUMENTATION_PACKET",
        ...
        "candidate_next_targets": [
            {
                ...
                "decision": "selected",
                "reason": (
                    "The prepared tranche 005 documentation packet must be reviewed before "
            ...
            },
            {
                ...
                "decision": "deferred",
                "reason": "Status adjudication remains deferred until tranche 005 documentation is reviewed.",
            },
            {
        ...
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 005 documentation packet prepares a "
            "documentation surface for the policy-accepted standard Lean axiom posture only. It "
            "does not clear or move tranche 005, move retained tranche 004, discharge Lean theorem "
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate the v0.1-alpha dependency remediation tranche 005 documentation packet."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_005_documentation_packet_report: "
