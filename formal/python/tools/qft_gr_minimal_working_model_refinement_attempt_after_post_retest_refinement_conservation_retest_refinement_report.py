...
OUTCOME_ID = (
    "QFT_GR_MINIMAL_WORKING_MODEL_REFINEMENT_ATTEMPT_AFTER_POST_RETEST_"
    "REFINEMENT_CONSERVATION_RETEST_REFINEMENT_EXECUTED_WITH_NO_SOURCE_"
    "ADMISSIBILITY_OR_CONSERVATION_PROOF"
)
RESULT_CLASSIFICATION = (
    "qft_gr_minimal_working_model_refinement_attempt_after_post_retest_"
    "refinement_conservation_retest_refinement_executed_with_refined_"
    "candidate_pending_result_review"
)
...
REFINEMENT_SCOPE = (
    "post_retest_refinement_conservation_retest_refinement_v3_repeated_"
    "inconclusive_weak_pairing_domain_regular_context_test_function_class_"
...
def _refined_components() -> list[dict[str, Any]]:
    return [
        {
            "component_id": "toy_weak_pairing_domain_v4_candidate",
            "component_scope": "weak_pairing_domain",
            "source_dimension_id": "v3_repeat_retest_weak_pairing_domain",
            "obstruction_class": OBSTRUCTION_CLASS,
            "refinement_action": (
                "record the v4 candidate weak-pairing domain with explicit "
                "admitted and blocked toy test-vector pairings"
            ),
            "status_after_attempt": (
                "v4_candidate_pairing_domain_refined_not_source_admissibility"
            ),
            "source_admissibility_claimed": False,
            "conservation_claimed": False,
        },
        {
            "component_id": "toy_regular_context_v4_candidate",
            "component_scope": "regularity_assumptions",
            "source_dimension_id": "v3_repeat_retest_regular_context",
            "obstruction_class": OBSTRUCTION_CLASS,
            "refinement_action": (
                "separate derivative exchange, regularization, boundary-term, "
                "and limit/interchange assumptions into explicit v4 candidate "
                "clauses"
            ),
            "status_after_attempt": (
                "v4_regular_context_refined_as_assumption_not_theorem_discharge"
            ),
        ...
        {
            "component_id": "toy_conservation_test_function_class_v3_candidate",
            "component_scope": "test_function_class",
            "source_dimension_id": "v3_repeat_retest_test_function_class",
            "obstruction_class": OBSTRUCTION_CLASS,
            "refinement_action": (
                "refine the toy compact-support or admissible test-vector class "
                "as a v3 candidate for later weak-divergence discrimination"
            ),
            "status_after_attempt": "v3_test_class_refined_not_conservation_test",
            "source_admissibility_claimed": False,
            "conservation_claimed": False,
        },
        {
            "component_id": "toy_source_candidate_definition_v4_candidate",
            "component_scope": "candidate_source_definition",
            "source_dimension_id": "v3_repeat_retest_candidate_source_definition",
            "obstruction_class": OBSTRUCTION_CLASS,
            "refinement_action": (
                "name the v4 candidate-source definition and separate candidate "
                "data from admissibility witnesses"
            ),
            "status_after_attempt": (
                "v4_candidate_definition_refined_not_admitted_source"
            ),
            "source_admissibility_claimed": False,
            "conservation_claimed": False,
        },
        {
            "component_id": "bounded_toy_weak_pairing_scope_v4",
            "component_scope": "scope_restriction",
            "source_dimension_id": "v3_repeat_retest_scope_restriction",
            "obstruction_class": OBSTRUCTION_CLASS,
            "refinement_action": (
                "restrict interpretation to the bounded toy weak-pairing scope "
                "unless a reviewed packet later authorizes broader semantics"
            ),
            "status_after_attempt": "v4_scope_restricted_no_qft_gr_closure",
            "source_admissibility_claimed": False,
            "conservation_claimed": False,
        },
        {
            "component_id": "repeated_inconclusive_obstruction_account_v3",
            "component_scope": "obstruction_accounting",
            "source_dimension_id": "v3_repeat_retest_obstruction_accounting",
            "obstruction_class": OBSTRUCTION_CLASS,
            "refinement_action": (
        ...
        {
            "component_id": "bounded_validation_boundary_v3",
            "component_scope": "validation_boundary",
            "source_dimension_id": "v3_repeat_retest_validation_boundary",
            "obstruction_class": OBSTRUCTION_CLASS,
            "refinement_action": (
...
def build_qft_gr_minimal_working_model_refinement_attempt_after_post_retest_refinement_conservation_retest_refinement(
    *,
    ...
    acceptance_criteria = {
        ...
        "authorized_revision_ids_match_review": (
            review.get("proposed_weak_pairing_domain_revision")
            == "toy_weak_pairing_domain_v4_candidate"
            and review.get("proposed_regular_context_revision")
            == "toy_regular_context_v4_candidate"
            and review.get("proposed_test_function_class_revision")
            == "toy_conservation_test_function_class_v3_candidate"
            and review.get("proposed_candidate_source_definition_revision")
    ...
    return {
        ...
        if executed
            ...
            "RETEST_REFINEMENT_CONSERVATION_RETEST_REFINEMENT_REQUIRES_"
            "REMEDIATION"
        ),
        ...
        "refined_candidate_status": (
            "post_retest_refinement_conservation_retest_refinement_v4_refined_"
            "toy_candidate_pending_result_review"
        )
        if executed
        ...
        "current_weak_pairing_domain_id": review.get("current_weak_pairing_domain_id"),
        "weak_pairing_domain_id": "toy_weak_pairing_domain_v4_candidate",
        "current_regular_context_id": review.get("current_regular_context_id"),
        "regularity_structure_id": "toy_regular_context_v4_candidate",
        "current_test_function_class_id": review.get("current_test_function_class_id"),
        "test_function_class_id": "toy_conservation_test_function_class_v3_candidate",
        "current_candidate_source_definition_id": review.get(
            "current_candidate_source_definition_id"
        ),
        "candidate_source_definition_id": "toy_source_candidate_definition_v4_candidate",
        "scope_restriction_id": "bounded_toy_weak_pairing_scope_v4",
        "obstruction_accounting_id": "repeated_inconclusive_obstruction_account_v3",
        ...
        "next_action_scope": (
            ...
            "CONSERVATION_RERUN_COUNTERMODEL_PACKET_SOURCE_ADMISSIBILITY_"
...
def write_qft_gr_minimal_working_model_refinement_attempt_after_post_retest_refinement_conservation_retest_refinement(
    *,
    packet_result_review_path: Path = DEFAULT_PACKET_RESULT_REVIEW_PATH,
    out: Path = DEFAULT_OUT,
    captured_at_utc: str = DEFAULT_CAPTURED_AT_UTC,
) -> dict[str, Any]:
    payload = build_qft_gr_minimal_working_model_refinement_attempt_after_post_retest_refinement_conservation_retest_refinement(
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = write_qft_gr_minimal_working_model_refinement_attempt_after_post_retest_refinement_conservation_retest_refinement(
