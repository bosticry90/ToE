...
SCHEMA_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_BLOCKER_MOVEMENT_REGISTRATION_"
...
OUTCOME_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_BLOCKER_MOVEMENT_REGISTRATION_"
    "RESULT_REVIEW_ACCEPTS_DOCUMENTED_NONBLOCKING_MOVEMENT_AND_AUTHORIZES_"
...
RESULT_REVIEW_CLASSIFICATION = (
    "documented_nonblocking_movement_accepted_dependency_remediation_summary_pending"
)
NEXT_TARGET = "prepare_v01_alpha_dependency_remediation_summary_after_tranche_006_movement"
...
def build_result_review(
    *,
    ...
    acceptance_criteria = {
        ...
        "tranche_005_documented_nonblocking_preserved": registration.get(
            "tranche_005_status"
        )
        == TRANCHE_005_STATUS
        and registration.get("tranche_005_dependency") == TRANCHE_005_DEPENDENCY
        and registered_movement.get("tranche_005_status") == TRANCHE_005_STATUS,
        "tranche_006_registered_documented_nonblocking": registration.get(
            "tranche_006_status"
        )
        == CANDIDATE_BLOCKER_STATUS
        and tranche_006.get("dependency_finding_id") == SELECTED_FINDING_ID
        and tranche_006.get("dependency") == SELECTED_DEPENDENCY
        and registered_movement.get("tranche_006_effect")
        == "registered_documented_nonblocking_pending_result_review",
        ...
        "registered_movement_tranche_006_only": registered_movement.get(
            "selected_remediation_finding_id"
        )
        == SELECTED_FINDING_ID
        and registered_movement.get("selected_dependency") == SELECTED_DEPENDENCY
        and registered_movement.get("movement_scope") == "tranche_006_only",
        ...
        is True
        and registration.get("tranche_006_formal_movement_accepted") is False,
        "tranche_006_accepted_as_documented_nonblocking": CANDIDATE_BLOCKER_STATUS
        == "documented_dependency_nonblocking",
        "remaining_tranche_004_obligation_carried_forward": _remaining_obligations_carried_forward(
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_BLOCKER_MOVEMENT_REGISTRATION_RESULT_REVIEW_BLOCKED",
        ...
        "tranche_005_release_blocker_status": TRANCHE_005_STATUS,
        "tranche_005_dependency": TRANCHE_005_DEPENDENCY,
        "tranche_006_status": CANDIDATE_BLOCKER_STATUS,
        ...
        "registered_movement": {
            ...
            "tranche_005_status": registered_movement.get("tranche_005_status"),
            "tranche_006_status": registered_movement.get("tranche_006_status"),
            "global_release_readiness_effect": (
                "none_retained_tranche_004_still_blocks"
            ),
            "theorem_or_proof_debt_effect": "none",
            "retained_tranche_004_effect": "none",
            "tranche_006_effect": "documented_nonblocking_movement_accepted",
        },
        ...
        "tranche_006_formal_movement_accepted": accepted,
        "tranche_006_release_blocker_status": CANDIDATE_BLOCKER_STATUS,
        "tranche_006_dependency_policy_remediation_satisfied": accepted,
        ...
        "tranche_006_selected_yet": True,
        "dependency_remediation_queue_exhausted": True,
        "dependency_remediation_summary_preparation_authorized": accepted,
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_BLOCKER_MOVEMENT_REGISTRATION_RESULT_REVIEW",
        "selected_next_target_kind": "dependency_remediation_summary_preparation_only",
        ...
        "candidate_next_targets": [
            {
                ...
                "decision": "selected",
                "reason": (
                    "Tranche 006 movement is accepted and the dependency-remediation queue "
                    "is exhausted, so prepare a summary while carrying retained tranche 004."
                ),
            },
            {
                ...
                "decision": "deferred",
                "reason": (
                    "Release assembly remains deferred because retained tranche 004 still "
            ...
            },
            {
                ...
                "decision": "deferred",
                "reason": (
                    "Release-readiness pause/adjudication remains deferred to the summary path; "
                    "release readiness is still blocked by tranche 004."
                ),
            },
        ],
        "acceptance_criteria": acceptance_criteria,
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 006 blocker movement registration "
            "result review accepts the documented/nonblocking movement for V01-ALPHA-DEP-REM-006 "
            "and authorizes only dependency-remediation summary preparation after tranche 006 movement. "
            "It does not move or discharge retained tranche 004, "
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Generate the v0.1-alpha dependency remediation tranche 006 blocker movement "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_006_blocker_movement_registration_result_review_report: "
