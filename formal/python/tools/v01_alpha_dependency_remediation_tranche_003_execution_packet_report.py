...
SCHEMA_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_EXECUTION_PACKET_20260515_v0"
PACKET_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_EXECUTION_PACKET_v0"
OUTCOME_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_EXECUTION_PACKET_PREPARED_FOR_"
    "FINITE_TRANSPORT_THEOREMS_CONSTRUCT_RESIDUAL_PACKAGE_WITH_NO_REMEDIATION_EXECUTION_OR_RELEASE_PROMOTION"
)
...
DEFAULT_OUT = (
    ...
    / "docs"
    / "release"
    / "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_EXECUTION_PACKET_20260515_v0.json"
)

EXPECTED_SELECTION_RESULT_REVIEW_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_NEXT_TRANCHE_SELECTION_PACKET_AFTER_TRANCHE_002_"
    "MOVEMENT_RESULT_REVIEW_v0"
)
EXPECTED_SELECTION_RESULT_REVIEW_OUTCOME = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_NEXT_TRANCHE_SELECTION_AFTER_TRANCHE_002_"
    "MOVEMENT_RESULT_REVIEW_ACCEPTS_TRANCHE_003_SELECTION_AND_AUTHORIZES_TRANCHE_003_"
...
LEAN_AUDIT_COMMAND = (
    "#print axioms ToeFormal.Bridges.QMSTATTransportResidualPackage."
    "finite_transport_theorems_construct_residual_package_v0"
)
NEXT_TARGET = "review_v01_alpha_dependency_remediation_tranche_003_execution_packet_result"
...
def build_packet(
    *,
    ...
    documentation_requirement = {
        ...
        "condition": (
            "Required if the captured bridge dependency posture is policy-acceptable but "
            "needs release-facing documentation, or if project-local axioms or bridge "
    ...
    policy_adjudication_requirement = {
        ...
        "reason": (
            "Bridge theorem dependencies usually need release-policy adjudication after "
            "exact Lean dependency evidence is captured."
        ),
    ...
    expert_re_review_requirement = {
        "required": "conditional_after_audit_result_review",
        "trigger": (
            "Triggered by project-local axioms, unexpected nonstandard axioms, bridge "
            "target mismatch, or ambiguity in the captured dependency evidence."
        ),
        "executed_by_this_packet": False,
    }
    success_criteria = [
        "execution_consumes_this_packet_and_targets_only_finite_transport_theorems_construct_residual_package_v0",
        "raw_lean_axiom_output_is_recorded_for_the_pinned_bridge_audit_command",
    ...
    failure_criteria = [
        "execution_targets_a_dependency_other_than_finite_transport_theorems_construct_residual_package_v0",
    ...
    acceptance_criteria = {
        ...
        == TRANCHE_002_STATUS,
        "tranche_003_selected_only": result_review.get("selection_count") == 1
        ...
        "four_release_blockers_carried_forward": _obligations_are_unmodified(
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_EXECUTION_PACKET_BLOCKED",
        ...
        "tranche_003_status": "selected_for_execution_packet_preparation",
        ...
        "tranche_003_execution_packet_prepared": accepted,
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_EXECUTION_PACKET",
        "selected_next_target_kind": "tranche_003_execution_packet_result_review_only",
        "selection_count": 1 if accepted else 0,
        "next_action_scope": (
            "REVIEW_TRANCHE_003_EXECUTION_PACKET_RESULT_ONLY_NO_REMEDIATION_EXECUTION_OR_RELEASE_PROMOTION"
        ),
        "candidate_next_targets": [
            {
                "target": NEXT_TARGET,
                "decision": "selected",
                "reason": "The tranche 003 execution packet must be reviewed before remediation execution can be authorized.",
            },
            {
                "target": "execute_v01_alpha_dependency_remediation_tranche_003_audit",
                "decision": "deferred",
                "reason": "Actual tranche 003 audit execution is deferred until this packet is reviewed and accepted.",
            },
            {
                "target": "prepare_v01_alpha_release_readiness_adjudication_packet",
                "decision": "deferred",
                "reason": "Release-readiness adjudication remains blocked by the four tracked release-blocking obligations.",
            },
        ],
        "acceptance_criteria": acceptance_criteria,
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 003 execution packet prepares only "
            "a bounded Lean dependency-audit execution scope for V01-ALPHA-DEP-REM-003 / "
            "finite_transport_theorems_construct_residual_package_v0. It does not execute "
            "remediation, run the Lean audit, capture dependency evidence, prepare documentation, "
            "execute expert re-review, register blocker movement, assemble the release packet, "
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate the v0.1-alpha dependency remediation tranche 003 execution packet."
    )
    parser.add_argument(
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_003_execution_packet_report: "
