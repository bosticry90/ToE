...
SCHEMA_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_RELEASE_POLICY_ADJUDICATION_"
...
NEXT_TARGET = "prepare_v01_alpha_dependency_remediation_tranche_006_documentation_packet"
...
def _tranche_006(adjudication: dict[str, Any]) -> dict[str, Any]:
    return dict(adjudication.get("selected_release_blocking_obligation", {}))
...
def _other_blockers_tracked(rows: list[dict[str, Any]]) -> bool:
    return (
        ...
        == [TRANCHE_004_FINDING_ID]
        and all(
            row.get("modified_by_tranche_006_policy_adjudication") is False for row in rows
        )
    )
...
def build_result_review(
    *,
    ...
    acceptance_criteria = {
        ...
        == TRANCHE_004_RETAINED_REASON,
        "tranche_005_documented_nonblocking_preserved": adjudication.get("tranche_005_status")
        == TRANCHE_005_STATUS
        and adjudication.get("tranche_005_dependency") == TRANCHE_005_DEPENDENCY,
        "tranche_006_policy_status_pending_documentation": adjudication.get(
        ...
        "tranche_006_pending_documentation": adjudication.get(
            "tranche_006_release_blocker_status"
        )
        == "pending_result_review_policy_acceptable_with_documentation_requirement",
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_RELEASE_POLICY_ADJUDICATION_RESULT_REVIEW_BLOCKED",
        ...
        "tranche_006_status": "policy_acceptable_with_documentation_requirement",
        ...
        "tranche_006_policy_status": "policy_acceptable_documentation_required",
        "tranche_006_release_blocker_status": (
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_RELEASE_POLICY_ADJUDICATION_RESULT_REVIEW",
        ...
        "candidate_next_targets": [
            {
                ...
                "decision": "selected",
                "reason": (
                    "The tranche 006 policy adjudication accepted the standard Lean axioms "
            ...
            },
            {
                ...
                "decision": "deferred",
                "reason": (
                    "Status adjudication remains deferred until tranche 006 documentation is "
        ...
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 006 release-policy adjudication result "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_006_release_policy_adjudication_result_review_report: "
