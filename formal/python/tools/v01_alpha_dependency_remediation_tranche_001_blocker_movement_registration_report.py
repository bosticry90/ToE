...
EXECUTION_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_BLOCKER_MOVEMENT_REGISTRATION_v0"
OUTCOME_ID = (
...
NEXT_TARGET = "review_v01_alpha_dependency_remediation_tranche_001_blocker_movement_registration_result"
...
def build_registration(
    *,
    ...
    acceptance_criteria = {
        ...
        "registers_only_tranche_001": registered_movement[
            "selected_remediation_finding_id"
        ]
        == SELECTED_REMEDIATION_FINDING_ID
        and registered_movement["selected_dependency"] == SELECTED_DEPENDENCY
        and registered_movement["movement_scope"] == "tranche_001_only",
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_BLOCKER_MOVEMENT_REGISTRATION_BLOCKED",
        ...
        "tranche_001_formal_movement_accepted": False,
        ...
        "remaining_release_blocking_obligation_count_excluding_tranche_001_candidate": (
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_BLOCKER_MOVEMENT_REGISTRATION",
        ...
        "candidate_next_targets": [
            {
                "target": NEXT_TARGET,
                "decision": "selected",
                "reason": "The movement registration execution must be reviewed before tranche 001 movement is formally accepted.",
            },
            {
                "target": "execute_v01_alpha_dependency_remediation_tranche_002",
                "decision": "deferred",
                "reason": "The next remediation tranche remains deferred until tranche 001 movement registration is result-reviewed.",
            },
            {
                "target": "prepare_v01_alpha_release_readiness_adjudication_packet",
                "decision": "deferred",
                "reason": "Release-readiness adjudication remains blocked by five carried-forward blockers and pending movement result review.",
            },
        ],
        "acceptance_criteria": acceptance_criteria,
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 001 blocker movement registration "
            "execution registers only V01-ALPHA-DEP-REM-001 as documented/nonblocking pending "
            "result review. It does not clear tranche 001 for global release readiness, assemble "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_001_blocker_movement_registration_report: "
