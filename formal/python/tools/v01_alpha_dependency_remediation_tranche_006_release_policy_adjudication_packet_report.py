...
from formal.python.tools.v01_alpha_dependency_remediation_tranche_006_audit_result_review_report import (
    ...
    TRANCHE_005_STATUS,
    TRANCHE_CLASSIFICATION as EXPECTED_TRANCHE_CLASSIFICATION,
)


REPO_ROOT = find_repo_root(Path(__file__))
SCHEMA_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_RELEASE_POLICY_ADJUDICATION_PACKET_20260515_v0"
)
PACKET_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_RELEASE_POLICY_ADJUDICATION_PACKET_v0"
OUTCOME_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_RELEASE_POLICY_ADJUDICATION_PACKET_"
    ...
    return [
        {
            ...
            "modified_by_tranche_006_release_policy_packet": False,
        },
        {
...
def _other_blockers(*, retained_tranche_004: dict[str, Any]) -> list[dict[str, Any]]:
    return [
        {
            "dependency_finding_id": TRANCHE_004_FINDING_ID,
            "dependency": retained_tranche_004.get("dependency", TRANCHE_004_DEPENDENCY),
...
def _release_policy_acceptance_criteria() -> list[str]:
    return [
        "The later adjudication cites the exact accepted Lean dependency evidence for supplied_alignment_constructs_sr_cosmo_regime_transport_package_v0.",
        ...
        "Any blocker downgrade is limited to tranche 006 and does not affect tranches 001, 002, 003, 005, or retained tranche 004.",
...
def _release_policy_failure_criteria() -> list[str]:
    return [
        ...
        "The later adjudication clears or moves tranche 006 without a recorded v0.1-alpha policy decision.",
        "The later adjudication modifies tranches 001, 002, 003, 005, or retained tranche 004.",
...
def build_packet(
    *,
    ...
    other_blockers = _other_blockers(retained_tranche_004=retained_tranche_004)
    ...
    acceptance_criteria = {
        ...
        == LEAN_TARGET
        and result_review.get("lean_audit_target", {}).get("lean_source") == LEAN_SOURCE
        ...
        and other_blockers[0].get("modified_by_tranche_006_release_policy_packet")
        is False,
        ...
        is False
        and forbidden_effect_status["release_policy_adjudication_executed"] is False
        and forbidden_effect_status["release_policy_decision_made"] is False,
        "tranche_006_remains_blocking_pending_adjudication": True,
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_RELEASE_POLICY_ADJUDICATION_PACKET_BLOCKED",
        ...
        "packet_scope": (
            "PREPARE_TRANCHE_006_RELEASE_POLICY_ADJUDICATION_PACKET_ONLY_"
        ...
        "lean_audit_target": {
            ...
            "lean_source": result_review.get("lean_audit_target", {}).get("lean_source"),
        ...
        "expert_re_review_requirement": (
            ...
            "or waived for the standard Lean axiom posture of tranche 006."
        ),
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_POLICY_PACKET",
        ...
        "candidate_next_targets": [
            ...
            },
            {
                ...
                "decision": "deferred",
                "reason": "Release readiness remains blocked by retained tranche 004.",
            },
        ],
        ...
        "non_claim_boundary": (
            ...
            "nonblocking. It does not make the policy decision, close remediation, move blockers, "
            "assemble the release packet, mark v0.1-alpha readiness, discharge theorem/proof "
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Generate the v0.1-alpha dependency remediation tranche 006 release-policy "
            "adjudication packet."
        )
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_006_release_policy_adjudication_packet_report: "
