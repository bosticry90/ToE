...
from formal.python.tools.v01_alpha_dependency_remediation_tranche_005_documentation_packet_result_review_report import (
    ...
    PROJECT_AXIOMS_USED,
    RESULT_REVIEW_CLASSIFICATION as DOCUMENTATION_RESULT_REVIEW_CLASSIFICATION,
...
SCHEMA_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_STATUS_ADJUDICATION_PACKET_20260515_v0"
PACKET_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_STATUS_ADJUDICATION_PACKET_v0"
OUTCOME_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_STATUS_ADJUDICATION_PACKET_PREPARED_"
...
NEXT_TARGET = "review_v01_alpha_dependency_remediation_tranche_005_status_adjudication_packet_result"
...
def build_packet(
    *,
    ...
    acceptance_criteria = {
        ...
        "tranche_005_not_cleared": result_review.get("remediation_fully_satisfied") is False
        and result_review.get("blocker_movement_authorized") is False
        and result_review.get("blocker_movement_registered") is False
        and result_review.get("tranche_005_release_blocker_status")
        == "still_blocking_pending_status_adjudication_packet",
        "tranche_004_not_moved": result_review.get(
            "tranche_004_moved_to_documented_dependency_nonblocking"
        )
        is False
        ...
        "does_not_clear_or_move_tranche_005": forbidden_effect_status[
            "blocker_fully_remediated"
        ]
        is False
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_STATUS_ADJUDICATION_PACKET_BLOCKED",
        ...
        "status_adjudication_question": (
            ...
            "release-policy posture, and accepted documentation, can tranche 005 move "
        ...
        "status_adjudication_acceptance_criteria": [
            ...
            "Tranches 001, 002, and 003 remain documented_dependency_nonblocking.",
            "Tranche 004 remains retained_release_blocking_source_map_blocker.",
            "Tranche 006 remains tracked_unresolved.",
        ...
        "status_adjudication_failure_criteria": [
            ...
            "The status adjudication modifies tranche 004, tranche 006, or any blocker outside tranche 005.",
        ],
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_STATUS_ADJUDICATION_PACKET",
        ...
        "candidate_next_targets": [
            {
                ...
                "decision": "selected",
                "reason": (
                    "The tranche 005 status adjudication packet must be reviewed before the "
                    "status question can be executed."
                ),
            },
            {
                "target": "execute_v01_alpha_dependency_remediation_tranche_005_status_adjudication",
                "decision": "deferred",
        ...
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 005 status adjudication packet "
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Generate the v0.1-alpha dependency remediation tranche 005 status adjudication packet."
        )
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_005_status_adjudication_packet_report: "
