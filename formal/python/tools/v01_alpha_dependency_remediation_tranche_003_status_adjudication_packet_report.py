...
SCHEMA_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_STATUS_ADJUDICATION_PACKET_20260515_v0"
PACKET_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_STATUS_ADJUDICATION_PACKET_v0"
OUTCOME_ID = (
...
NEXT_TARGET = "review_v01_alpha_dependency_remediation_tranche_003_status_adjudication_packet_result"
...
def build_packet(
    *,
    ...
    acceptance_criteria = {
        ...
        "tranche_003_not_cleared": result_review.get("remediation_fully_satisfied") is False
        and result_review.get("blocker_movement_authorized") is False
        and result_review.get("blocker_movement_registered") is False
        and result_review.get("tranche_003_release_blocker_status")
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_STATUS_ADJUDICATION_PACKET_BLOCKED",
        ...
        "status_adjudication_question": (
            ...
            "release-policy posture, and accepted documentation, can tranche 003 move "
        ...
        "status_adjudication_failure_criteria": [
            ...
            "The status adjudication modifies any remaining blocker outside tranche 003.",
        ],
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_STATUS_ADJUDICATION_PACKET",
        ...
        "candidate_next_targets": [
            {
                "target": NEXT_TARGET,
                "decision": "selected",
                "reason": "The tranche 003 status adjudication packet must be reviewed before the status question can be executed.",
            },
            {
        ...
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 003 status adjudication packet "
            "prepares the narrow status question only. It does not execute status adjudication, "
            "clear or move tranche 003, assemble the release packet, mark v0.1-alpha readiness, "
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Generate the v0.1-alpha dependency remediation tranche 003 status adjudication packet."
        )
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_003_status_adjudication_packet_report: "
