...
REVIEW_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_STATUS_ADJUDICATION_RESULT_REVIEW_v0"
OUTCOME_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_STATUS_ADJUDICATION_RESULT_REVIEW_"
...
DEFAULT_ADJUDICATION_PATH = (
    ...
    / "docs"
    / "release"
    / "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_STATUS_ADJUDICATION_20260522_v0.json"
)
DEFAULT_OUT = (
    REPO_ROOT
    / "formal"
...
EXPECTED_ADJUDICATION_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_STATUS_ADJUDICATION_v0"
...
def build_result_review(
    *,
    ...
    acceptance_criteria = {
        ...
        "tranche_006_policy_status_preserved": adjudication.get("tranche_006_status")
        == POLICY_CLASSIFICATION
        and tranche_006.get("dependency") == SELECTED_DEPENDENCY
        and tranche_006.get("dependency_finding_id") == SELECTED_FINDING_ID,
        "status_candidate_exact": adjudication.get("tranche_006_status_candidate")
        == STATUS_DECISION
        ...
        "status_decision_was_bounded": decision.get("selected_tranche_id")
        == SELECTED_TRANCHE_ID
        and decision.get("selected_remediation_finding_id") == SELECTED_FINDING_ID
        ...
        and decision.get("does_not_move_retained_tranche_004") is True,
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_STATUS_ADJUDICATION_RESULT_REVIEW_BLOCKED",
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_STATUS_ADJUDICATION_RESULT_REVIEW",
        ...
        "candidate_next_targets": [
            {
                ...
                "decision": "selected",
                "reason": (
                    "The documented nonblocking status candidate is accepted, so prepare a "
                    "registration packet before any formal tranche 006 blocker movement."
                ),
            },
            {
                "target": "execute_v01_alpha_dependency_remediation_tranche_006_blocker_movement_registration",
                "decision": "deferred",
                "reason": "Movement execution requires packet preparation and result review first.",
            },
            {
                "target": "pause_v01_alpha_release_readiness_due_to_retained_tranche_004_blocker",
                "decision": "deferred",
                "reason": (
                    "Release readiness remains blocked by retained tranche 004 and tranche "
                    "006 movement registration still pending."
                ),
            },
        ],
        "acceptance_criteria": acceptance_criteria,
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 006 status adjudication result review "
            ...
            "clear tranche 006, move retained tranche 004, assemble the release packet, mark "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_006_status_adjudication_result_review_report: "
