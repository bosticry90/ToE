...
REVIEW_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_STATUS_ADJUDICATION_RESULT_REVIEW_v0"
OUTCOME_ID = (
...
EXPECTED_ADJUDICATION_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_STATUS_ADJUDICATION_v0"
...
def build_result_review(
    *,
    ...
    acceptance_criteria = {
        ...
        == TRANCHE_002_STATUS,
        "status_candidate_exact": adjudication.get("tranche_003_status_candidate")
        == STATUS_DECISION
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_STATUS_ADJUDICATION_RESULT_REVIEW_BLOCKED",
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_STATUS_ADJUDICATION_RESULT_REVIEW",
        ...
        "candidate_next_targets": [
            ...
            },
            {
                ...
                "decision": "deferred",
                "reason": "The next remediation tranche remains deferred until tranche 003 blocker movement registration is prepared and reviewed.",
            },
            {
        ...
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 003 status adjudication result review "
            ...
            "clear tranche 003, assemble the release packet, mark v0.1-alpha readiness, discharge "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_003_status_adjudication_result_review_report: "
