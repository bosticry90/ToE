    ...
    return [
        {
            ...
            "decision": "selected",
            "reason": (
                "The renormalized-expectation domain-link packet must be "
                "reviewed before any bounded reduction attempt, source "
                "admissibility question, conservation proof object, or seam "
                "closure action."
            ),
        },
        {
            ...
            "decision": "deferred",
            "reason": (
                "A bounded OD-ASSUMP-004 attempt requires this packet's result "
                "review first."
            ),
        },
        {
            ...
            "reason": (
                "Preparing renormalized-expectation domain linkage does not "
...
def build_qft_gr_renormalized_expectation_domain_link_assumption_reduction_packet(
    *,
    ...
    if selected_row:
        selected_row_payload = {
            ...
            "claim_ceiling": (
                "renormalized_expectation_domain_link_packet_only_no_source_"
    ...
    acceptance_criteria = {
        ...
        and result_review.get("completed_operator_domain_row") == PRIOR_ACCEPTED_ROW003,
        "prior_state_expectation_domain_link_contract_accepted": result_review.get(
        ...
        "selects_only_renormalized_expectation_domain_link_row": selected_row
        is not None
        ...
        "renormalized_expectation_object_recorded": bool(
            selected_row_payload.get("renormalized_expectation_object")
        ),
    ...
    return {
        ...
        if prepared
            ...
            "QFT_GR_RENORMALIZED_EXPECTATION_DOMAIN_LINK_ASSUMPTION_"
            "REDUCTION_PACKET_BLOCKED"
        ),
        "packet_classification": PACKET_CLASSIFICATION,
        "packet_classification_count": 1 if prepared else 0,
        "consumes_qft_gr_state_expectation_domain_link_assumption_reduction_attempt_result_review": EXPECTED_RESULT_REVIEW_ID,
        "consumes_qft_gr_state_expectation_domain_link_assumption_reduction_attempt_result_review_pointer": _ptr(
            result_review_path
        ),
        ...
        "renormalized_expectation_domain_link_assumption_reduction_analysis_prepared": prepared,
        "renormalized_expectation_domain_link_assumption": selected_row_payload,
        "renormalized_expectation_object": RENORMALIZED_EXPECTATION_OBJECT,
        "operator_domain_link_condition": OPERATOR_DOMAIN_LINK_CONDITION,
        ...
        "non_claim_boundary": (
            "This packet prepares only OD-ASSUMP-004 renormalized-expectation "
...
def write_qft_gr_renormalized_expectation_domain_link_assumption_reduction_packet(
    *,
    result_review_path: Path = DEFAULT_RESULT_REVIEW_PATH,
    operator_domain_packet_path: Path = DEFAULT_OPERATOR_DOMAIN_PACKET_PATH,
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = write_qft_gr_renormalized_expectation_domain_link_assumption_reduction_packet(
        result_review_path=result_review_path,
        operator_domain_packet_path=operator_domain_packet_path,
        out=out,
    ...
    print(
        "qft_gr_renormalized_expectation_domain_link_assumption_reduction_packet_report: "
