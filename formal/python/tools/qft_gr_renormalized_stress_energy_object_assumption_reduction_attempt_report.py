    ...
    return [
        {
            ...
            "decision": "selected",
            "reason": (
                "The bounded RN-ASSUMP-001 attempt must be result-reviewed "
                "before any downstream renormalization row, conservation proof, "
                "source admissibility, Bianchi compatibility, or seam-closure "
                "action."
            ),
        },
        {
        ...
        },
        {
            ...
            "reason": (
                ...
                "selected object-row attempt result review."
            ),
        },
        {
            ...
            "reason": (
                "Reducing the candidate object assumption does not construct a "
        ...
        },
        {
            ...
            "decision": "not_authorized",
            "reason": (
                "The candidate object contract is not a source-admissibility "
                "claim."
            ),
        },
        {
            ...
            "decision": "not_authorized",
            "reason": (
                "The candidate object contract is not a Bianchi compatibility "
                "claim."
            ),
        },
        {
...
def build_qft_gr_renormalized_stress_energy_object_assumption_reduction_attempt(
    *,
    ...
    classification_rows = [
        {
            ...
            "selected": True,
            "meaning": (
                "The RN-ASSUMP-001 candidate object assumption has been reduced "
                "to a bounded candidate-object contract pending result review, "
                "without defining the object as final or proving conservation."
            ),
        },
        {
            ...
            "meaning": (
                ...
                "the candidate object assumption could be reduced."
            ),
        },
        {
    ...
    object_contract = {
        "contract_id": RENORMALIZED_STRESS_ENERGY_OBJECT_CONTRACT_ID,
        ...
        "definition_status": BOUNDED_OBJECT_CONTRACT_STATUS,
        "source_packet_definition_status": (
            RENORMALIZED_STRESS_ENERGY_OBJECT_DEFINITION_STATUS
        ),
        ...
        "claim_ceiling": (
            "renormalized_stress_energy_object_candidate_contract_pending_"
            "result_review_only_no_final_definition_no_assumption_discharge_"
            "no_conservation_proof_no_conservation_witness_no_source_"
            "admissibility_no_bianchi_compatibility_no_qft_gr_seam_closure"
        ),
    }
    execution_findings = [
        "The attempt consumes the RN-ASSUMP-001 packet result review and keeps the renormalized stress-energy object as the only executed row.",
        "The candidate object is pinned as a bounded contract pending result review, not as a final definition or assumption discharge.",
        "The bounded object contract preserves the operator-domain-family closeout as prior context without deriving conservation.",
    ...
    acceptance_criteria = {
        ...
        "candidate_object_preserved": review.get("candidate_stress_energy_object")
        == CANDIDATE_STRESS_ENERGY_OBJECT
        and review.get("renormalized_stress_energy_object")
        == CANDIDATE_STRESS_ENERGY_OBJECT,
        "definition_status_not_final": review.get(
            "renormalized_stress_energy_object_definition_status"
        )
        == RENORMALIZED_STRESS_ENERGY_OBJECT_DEFINITION_STATUS,
        ...
        == 1,
        "reduction_distinguished_from_final_definition_or_discharge": True,
        "no_final_object_definition_claimed": review.get(
            "renormalized_stress_energy_object_final_definition_claimed"
        )
        is False
        and review.get("renormalized_stress_energy_object_defined_as_final")
        is False,
        "no_assumption_discharge_claimed": review.get(
            "renormalized_stress_energy_object_assumption_discharged"
        )
        is False
        and review.get("renormalization_assumptions_discharged_by_review") is False,
    ...
    return {
        ...
        "consumes_qft_gr_renormalized_stress_energy_object_assumption_reduction_packet_result_review_pointer": _ptr(
            review_path
        ),
        ...
        "required_future_proof_object": REQUIRED_FUTURE_PROOF_OBJECT,
        "attempt_scope": (
            "EXECUTE_BOUNDED_QFT_GR_RENORMALIZED_STRESS_ENERGY_OBJECT_"
        ...
        "renormalized_stress_energy_object_reduction_contract": object_contract,
        ...
        "renormalized_stress_energy_object_assumption_obstruction_identified": False,
        "renormalized_stress_energy_object_assumption_inconclusive": False,
        "renormalized_stress_energy_object_assumption_reduced_by_attempt": executed,
        ...
        "renormalized_stress_energy_object_final_definition_or_discharge_claimed_by_implication": False,
        "renormalized_stress_energy_object_claimed_as_conservation_proof": False,
        "renormalized_stress_energy_object_claimed_as_conservation_source": False,
        "renormalized_stress_energy_object_claimed_as_source_admissibility": False,
        "renormalized_stress_energy_object_claimed_as_bianchi_compatibility": False,
        ...
        "next_action_scope": (
            ...
            "REDUCTION_ATTEMPT_RESULT_ONLY_NO_FINAL_OBJECT_DEFINITION_"
            "CONSERVATION_WITNESS_OR_QFT_GR_SEAM_CLOSURE"
        ),
        "acceptance_criteria": acceptance_criteria,
        "non_claim_boundary": (
            "This execution reduces only RN-ASSUMP-001 to a bounded candidate "
            "renormalized stress-energy object contract pending result review. "
            "It does not define or discharge the renormalized stress-energy "
            "object as final, construct a conservation proof object or "
...
def write_qft_gr_renormalized_stress_energy_object_assumption_reduction_attempt(
    *,
    review_path: Path = DEFAULT_REVIEW_PATH,
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Generate the QFT-GR RN-ASSUMP-001 renormalized stress-energy "
            "object assumption-reduction attempt."
        )
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = write_qft_gr_renormalized_stress_energy_object_assumption_reduction_attempt(
        review_path=review_path,
        out=out,
        captured_at_utc=str(ns.captured_at_utc),
    )
    print(
        "qft_gr_renormalized_stress_energy_object_assumption_reduction_attempt_report: "
