...
SCHEMA_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_STATUS_ADJUDICATION_20260515_v0"
EXECUTION_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_STATUS_ADJUDICATION_v0"
OUTCOME_ID = (
...
EXPECTED_RESULT_REVIEW_OUTCOME = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_STATUS_ADJUDICATION_PACKET_RESULT_REVIEW_"
    "ACCEPTS_STATUS_QUESTION_PREPARATION_AND_AUTHORIZES_STATUS_ADJUDICATION_EXECUTION_ONLY"
)
EXPECTED_SELECTED_TARGET = "execute_v01_alpha_dependency_remediation_tranche_002_status_adjudication"
...
NEXT_TARGET = "review_v01_alpha_dependency_remediation_tranche_002_status_adjudication_result"
...
def build_adjudication(
    *,
    ...
    status_decision = {
        ...
        "meaning": (
            "Tranche 002 has enough dependency-policy evidence to be treated as a documented "
    ...
    acceptance_criteria = {
        ...
        == TRANCHE_001_STATUS,
        "adjudicates_only_tranche_002": status_decision["selected_tranche_id"]
        == SELECTED_TRANCHE_ID
        and status_decision["selected_remediation_finding_id"]
        == SELECTED_REMEDIATION_FINDING_ID
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_STATUS_ADJUDICATION_BLOCKED",
        ...
        "tranche_002_status_candidate": STATUS_DECISION,
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_STATUS_ADJUDICATION",
        ...
        "candidate_next_targets": [
            {
                "target": NEXT_TARGET,
                "decision": "selected",
                "reason": "The status adjudication execution must be reviewed before any blocker movement is recognized.",
            },
            {
                "target": "prepare_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_packet",
                "decision": "deferred",
                "reason": "Blocker movement registration requires acceptance of the tranche 002 status adjudication result.",
            },
            {
                "target": "prepare_v01_alpha_release_readiness_adjudication_packet",
                "decision": "deferred",
                "reason": "Release-readiness adjudication remains blocked by status result review and tracked blockers.",
            },
        ],
        "acceptance_criteria": acceptance_criteria,
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 002 status adjudication decides only "
            ...
            "itself, register blocker movement, assemble the release packet, mark v0.1-alpha "
            "readiness, discharge Lean theorem debt, reduce axiom/spec-backed proof debt, "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_002_status_adjudication_report: "
