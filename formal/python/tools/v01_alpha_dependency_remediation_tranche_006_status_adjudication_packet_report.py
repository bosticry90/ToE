...
SCHEMA_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_STATUS_ADJUDICATION_PACKET_20260522_v0"
PACKET_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_STATUS_ADJUDICATION_PACKET_v0"
OUTCOME_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_STATUS_ADJUDICATION_PACKET_PREPARED_"
...
NEXT_TARGET = "review_v01_alpha_dependency_remediation_tranche_006_status_adjudication_packet_result"
...
def build_packet(
    *,
    ...
    acceptance_criteria = {
        ...
        "tranche_006_not_cleared": result_review.get("remediation_fully_satisfied") is False
        and result_review.get("blocker_movement_authorized") is False
        and result_review.get("blocker_movement_registered") is False
        and result_review.get("tranche_006_moved_or_cleared") is False
        and result_review.get("tranche_006_release_blocker_status")
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_STATUS_ADJUDICATION_PACKET_BLOCKED",
        ...
        "status_adjudication_question": (
            ...
            "release-policy posture, and accepted documentation, can tranche 006 move "
        ...
        "status_adjudication_acceptance_criteria": [
            ...
            "Tranche 005 remains documented_dependency_nonblocking.",
            "Tranche 006 remains uncleared until status adjudication executes and is reviewed.",
        ...
        "status_adjudication_failure_criteria": [
            ...
            "The status adjudication modifies tranche 004, tranche 006, or any blocker outside tranche 006.",
        ],
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_STATUS_ADJUDICATION_PACKET",
        ...
        "candidate_next_targets": [
            {
                ...
                "decision": "selected",
                "reason": (
                    "The tranche 006 status adjudication packet must be reviewed before the "
        ...
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 006 status adjudication packet "
            "prepares the narrow status question only. It does not execute status adjudication, "
            "clear or move tranche 006, move retained tranche 004, assemble the release packet, "
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Generate the v0.1-alpha dependency remediation tranche 006 status adjudication packet."
        )
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_006_status_adjudication_packet_report: "
