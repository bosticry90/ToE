...
EXPECTED_PACKET_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_STATUS_ADJUDICATION_PACKET_v0"
...
NEXT_TARGET = "execute_v01_alpha_dependency_remediation_tranche_002_status_adjudication"
...
def build_result_review(
    *,
    ...
    acceptance_criteria = {
        ...
        "tranche_002_not_cleared_or_moved": packet.get("remediation_fully_satisfied")
        is False
        ...
        == "execute_v01_alpha_dependency_remediation_tranche_002_status_adjudication",
    }
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_STATUS_ADJUDICATION_PACKET_RESULT_REVIEW_BLOCKED",
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_STATUS_ADJUDICATION_PACKET_RESULT_REVIEW",
        ...
        "candidate_next_targets": [
            {
                "target": NEXT_TARGET,
                "decision": "selected",
                "reason": "The status question preparation is accepted, so the narrow tranche 002 status adjudication execution can proceed.",
            },
            {
            ...
            },
            {
                ...
                "decision": "deferred",
                "reason": "Release-readiness adjudication remains blocked by tranche 002 status execution and tracked blockers.",
            },
        ],
        "acceptance_criteria": acceptance_criteria,
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 002 status adjudication packet result "
            ...
            "tranche 002, assemble the release packet, mark v0.1-alpha readiness, discharge Lean "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_002_status_adjudication_packet_result_review_report: "
