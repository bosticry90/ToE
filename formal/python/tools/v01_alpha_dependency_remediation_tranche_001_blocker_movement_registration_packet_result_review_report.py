...
NEXT_TARGET = "execute_v01_alpha_dependency_remediation_tranche_001_blocker_movement_registration"
...
def build_result_review(
    *,
    ...
    acceptance_criteria = {
        ...
        "movement_scope_tranche_001_only": movement_proposal.get("movement_scope")
        == "tranche_001_only"
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_BLOCKER_MOVEMENT_REGISTRATION_PACKET_RESULT_REVIEW_BLOCKED",
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_BLOCKER_MOVEMENT_REGISTRATION_PACKET_RESULT_REVIEW",
        ...
        "candidate_next_targets": [
            ...
            },
            {
                ...
                "decision": "deferred",
                "reason": "The next remediation tranche remains deferred until tranche 001 movement registration is executed and reviewed.",
            },
            {
                "target": "prepare_v01_alpha_release_readiness_adjudication_packet",
                "decision": "deferred",
                "reason": "Release-readiness adjudication remains blocked by unexecuted tranche 001 registration and five other blockers.",
            },
        ],
        ...
        "non_claim_boundary": (
            ...
            "registration execution. It does not register blocker movement, clear tranche 001, "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_001_blocker_movement_registration_packet_result_review_report: "
