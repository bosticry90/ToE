...
REVIEW_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_STATUS_ADJUDICATION_RESULT_REVIEW_v0"
OUTCOME_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_STATUS_ADJUDICATION_RESULT_REVIEW_"
...
EXPECTED_ADJUDICATION_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_STATUS_ADJUDICATION_v0"
...
def build_result_review(
    *,
    ...
    acceptance_criteria = {
        ...
        "status_candidate_exact": adjudication.get("tranche_005_status_candidate")
        == STATUS_DECISION
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_STATUS_ADJUDICATION_RESULT_REVIEW_BLOCKED",
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_STATUS_ADJUDICATION_RESULT_REVIEW",
        ...
        "candidate_next_targets": [
            {
                ...
                "reason": (
                    ...
                    "registration packet before any formal tranche 005 blocker movement."
                ),
            },
            {
                "target": "execute_v01_alpha_dependency_remediation_tranche_005_blocker_movement_registration",
                "decision": "deferred",
            ...
            },
            {
                ...
                "decision": "deferred",
                "reason": (
                    "Release readiness remains blocked by retained tranche 004 and tracked "
                    "tranche 006."
                ),
            },
        ],
        ...
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 005 status adjudication result review "
            ...
            "clear tranche 005, move retained tranche 004, assemble the release packet, mark "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_005_status_adjudication_result_review_report: "
