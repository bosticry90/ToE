...
SCHEMA_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_AUDIT_20260515_v0"
AUDIT_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_AUDIT_v0"
OUTCOME_ID = (
...
EXPECTED_RESULT_REVIEW_OUTCOME = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_EXECUTION_PACKET_RESULT_REVIEW_"
    "ACCEPTS_AUDIT_TARGET_AND_AUTHORIZES_TRANCHE_003_AUDIT_EXECUTION_ONLY"
)
...
LEAN_IMPORT_MODULE = "ToeFormal.Bridges.QM_STAT_TransportResidualPackage"
LEAN_AUDIT_COMMAND = (
...
NEXT_TARGET = "review_v01_alpha_dependency_remediation_tranche_003_audit_result"
    ...
    return [
        {
            ...
            "status_carry_forward": "tracked_unmodified_not_audited_in_tranche_003",
            "remediation_execution_status": row.get("remediation_execution_status"),
            "modified_by_tranche_003": False,
        }
        for row in rows
        if row.get("dependency_finding_id") != SELECTED_FINDING_ID
    ]
...
def build_audit(
    *,
    ...
    acceptance_criteria = {
        ...
        == TRANCHE_002_STATUS,
        "audit_is_only_for_tranche_003": result_review.get("selected_tranche_id")
        == SELECTED_TRANCHE_ID
        ...
        "lean_audit_was_authorized": result_review.get(
            "tranche_003_audit_execution_authorized"
        )
        is True
        ...
        "remaining_release_blockers_carried_forward": len(release_blockers) == 4
        and len(other_obligations) == 3
        and all(row["modified_by_tranche_003"] is False for row in other_obligations),
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_AUDIT_BLOCKED",
        "consumes_tranche_003_execution_packet_result_review": EXPECTED_RESULT_REVIEW_ID,
        "consumes_tranche_003_execution_packet_result_review_pointer": _ptr(
            result_review_path
        ),
        ...
        "tranche_002_global_release_readiness_still_not_marked": True,
        ...
        "evidence_surfaces_produced_or_updated": [
            {
                "surface": "formal/docs/release/V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_AUDIT_20260515_v0.json",
                "kind": "tranche_003_audit_result_packet",
                "status": "produced",
            },
            {
        ...
        "tranche_003_audit_result_classification": (
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_AUDIT",
        "selected_next_target_kind": "tranche_003_audit_result_review_only",
        ...
        "candidate_next_targets": [
            {
                ...
                "decision": "selected",
                "reason": (
                    "The tranche 003 audit produced exact Lean dependency evidence that must "
                    "be result-reviewed before policy or blocker movement."
                ),
            },
            {
                "target": (
                    "prepare_v01_alpha_dependency_remediation_tranche_003_release_policy_"
                    "adjudication_packet"
                ),
                "decision": "deferred",
        ...
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 003 audit captures exact Lean "
            "dependency evidence for finite_transport_theorems_construct_residual_package_v0 "
            "only. It separates standard Lean/mathlib axioms from project-local axioms and "
            "records that no project-local axioms were used. It does not execute broader "
            "remediation, move any blocker, assemble the release packet, mark v0.1-alpha "
            "readiness, discharge theorem/proof debt, discharge retained assumptions, "
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate the v0.1-alpha dependency remediation tranche 003 audit."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_003_audit_report: "
