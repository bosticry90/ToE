...
SCHEMA_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_STATUS_ADJUDICATION_PACKET_20260515_v0"
PACKET_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_STATUS_ADJUDICATION_PACKET_v0"
OUTCOME_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_STATUS_ADJUDICATION_PACKET_PREPARED_"
...
NEXT_TARGET = "review_v01_alpha_dependency_remediation_tranche_001_status_adjudication_packet_result"
...
def build_packet(
    *,
    ...
    acceptance_criteria = {
        ...
        "tranche_001_not_cleared": result_review.get("remediation_fully_satisfied") is False
        and result_review.get("blocker_movement_authorized") is False
        and result_review.get("tranche_001_release_blocker_status")
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_STATUS_ADJUDICATION_PACKET_BLOCKED",
        ...
        "status_adjudication_question": (
            "Given accepted Lean dependency evidence, zero project axioms, accepted "
            "release-policy posture, and accepted documentation, can tranche 001 move "
            "from release-blocking to a narrower nonblocking/documented dependency status?"
        ),
        ...
        "status_adjudication_failure_criteria": [
            ...
            "The status adjudication modifies any of the other five blockers.",
        ],
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_STATUS_ADJUDICATION_PACKET",
        ...
        "candidate_next_targets": [
            {
                "target": NEXT_TARGET,
                "decision": "selected",
                "reason": "The status adjudication packet must be reviewed before the status question can be executed.",
            },
            {
                "target": "execute_v01_alpha_dependency_remediation_tranche_001_status_adjudication",
                "decision": "deferred",
        ...
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 001 status adjudication packet "
            "prepares the narrow status question only. It does not execute status adjudication, "
            "clear or move tranche 001, assemble the release packet, mark v0.1-alpha readiness, "
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Generate the v0.1-alpha dependency remediation tranche 001 status adjudication packet."
        )
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_001_status_adjudication_packet_report: "
