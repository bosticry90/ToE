...
SCHEMA_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_STATUS_ADJUDICATION_20260515_v0"
EXECUTION_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_STATUS_ADJUDICATION_v0"
OUTCOME_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_STATUS_ADJUDICATED_PENDING_RESULT_REVIEW_"
...
DEFAULT_OUT = (
    ...
    / "docs"
    / "release"
    / "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_STATUS_ADJUDICATION_20260515_v0.json"
)
...
EXPECTED_SELECTED_TARGET = "execute_v01_alpha_dependency_remediation_tranche_003_status_adjudication"
...
NEXT_TARGET = "review_v01_alpha_dependency_remediation_tranche_003_status_adjudication_result"
...
def build_adjudication(
    *,
    ...
    status_decision = {
        ...
        "meaning": (
            "Tranche 003 has enough dependency-policy evidence to be treated as a documented "
    ...
    acceptance_criteria = {
        ...
        == TRANCHE_002_STATUS,
        "adjudicates_only_tranche_003": status_decision["selected_tranche_id"]
        == SELECTED_TRANCHE_ID
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_STATUS_ADJUDICATION_BLOCKED",
        ...
        "tranche_003_status_candidate": STATUS_DECISION,
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_STATUS_ADJUDICATION",
        ...
        "candidate_next_targets": [
            ...
            },
            {
                ...
                "decision": "deferred",
                "reason": "Blocker movement registration requires acceptance of the tranche 003 status adjudication result.",
            },
            {
        ...
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 003 status adjudication decides only "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_003_status_adjudication_report: "
