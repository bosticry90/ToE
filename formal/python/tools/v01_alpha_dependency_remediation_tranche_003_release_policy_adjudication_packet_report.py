...
SCHEMA_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_RELEASE_POLICY_ADJUDICATION_PACKET_20260515_v0"
)
PACKET_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_RELEASE_POLICY_ADJUDICATION_PACKET_v0"
OUTCOME_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_RELEASE_POLICY_ADJUDICATION_PACKET_"
...
def _release_policy_acceptance_criteria() -> list[str]:
    return [
        "The later adjudication cites the exact accepted Lean dependency evidence for finite_transport_theorems_construct_residual_package_v0.",
        ...
        "Any blocker downgrade is limited to tranche 003 and does not affect tranches 001 or 002 or the three non-selected release-blocking obligations.",
...
def _release_policy_failure_criteria() -> list[str]:
    return [
        ...
        "The later adjudication clears or moves tranche 003 without a recorded v0.1-alpha policy decision.",
        "The later adjudication modifies tranches 001 or 002 or any of the three non-selected release-blocking obligations.",
...
def build_packet(
    *,
    ...
    acceptance_criteria = {
        ...
        "tranche_003_remains_blocking_pending_adjudication": True,
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_RELEASE_POLICY_ADJUDICATION_PACKET_BLOCKED",
        ...
        "packet_scope": (
            "PREPARE_TRANCHE_003_RELEASE_POLICY_ADJUDICATION_PACKET_ONLY_"
        ...
        "expert_re_review_requirement": (
            ...
            "or waived for the standard Lean axiom posture of tranche 003."
        ),
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_POLICY_PACKET",
        ...
        "candidate_next_targets": [
            ...
            },
            {
                ...
                "decision": "deferred",
                "reason": "Release-readiness adjudication remains blocked by tranche 003 policy adjudication and the remaining tracked blockers.",
            },
        ],
        ...
        "non_claim_boundary": (
            ...
            "evidence and empty project-local axiom evidence, but does not make the policy "
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Generate the v0.1-alpha dependency remediation tranche 003 release-policy "
            "adjudication packet."
        )
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_packet_report: "
