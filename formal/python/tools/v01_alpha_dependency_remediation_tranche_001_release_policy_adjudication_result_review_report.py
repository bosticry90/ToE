...
EXPECTED_ADJUDICATION_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_RELEASE_POLICY_ADJUDICATION_v0"
...
NEXT_TARGET = "prepare_v01_alpha_dependency_remediation_tranche_001_documentation_packet"
...
def build_result_review(
    *,
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_RELEASE_POLICY_ADJUDICATION_RESULT_REVIEW_BLOCKED",
        ...
        "review_scope": (
            "REVIEW_TRANCHE_001_RELEASE_POLICY_ADJUDICATION_RESULT_ONLY_"
        ...
        "tranche_001_policy_status": "policy_acceptable_documentation_required",
        "tranche_001_release_blocker_status": "still_blocking_pending_documentation_packet",
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_RELEASE_POLICY_ADJUDICATION_RESULT_REVIEW",
        ...
        "candidate_next_targets": [
            {
                "target": NEXT_TARGET,
                "decision": "selected",
                "reason": "The policy adjudication is acceptable with documentation required, so prepare the documentation packet next.",
            },
            {
                "target": "execute_v01_alpha_dependency_remediation_tranche_002",
                "decision": "deferred",
                "reason": "The next remediation tranche remains deferred until tranche 001 documentation is prepared and reviewed.",
            },
            {
                "target": "prepare_v01_alpha_release_readiness_adjudication_packet",
                "decision": "deferred",
                "reason": "Release-readiness adjudication remains blocked by tranche 001 documentation and five other blockers.",
            },
        ],
        "acceptance_criteria": acceptance_criteria,
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 001 release-policy adjudication result "
            "review accepts policy_acceptable_with_documentation_requirement and authorizes only "
            "documentation packet preparation. It does not prepare documentation itself, clear the "
            "blocker, assemble the release packet, mark v0.1-alpha readiness, discharge Lean theorem "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_001_release_policy_adjudication_result_review_report: "
