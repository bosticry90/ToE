...
REVIEW_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_STATUS_ADJUDICATION_RESULT_REVIEW_v0"
OUTCOME_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_STATUS_ADJUDICATION_RESULT_REVIEW_"
...
DEFAULT_ADJUDICATION_PATH = (
    ...
    / "docs"
    / "release"
    / "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_STATUS_ADJUDICATION_20260515_v0.json"
)
DEFAULT_OUT = (
    REPO_ROOT
    / "formal"
...
EXPECTED_ADJUDICATION_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_STATUS_ADJUDICATION_v0"
EXPECTED_ADJUDICATION_OUTCOME = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_STATUS_ADJUDICATED_PENDING_RESULT_REVIEW_"
...
def build_result_review(
    *,
    ...
    acceptance_criteria = {
        ...
        == TRANCHE_001_STATUS,
        "status_candidate_exact": adjudication.get("tranche_002_status_candidate")
        == STATUS_DECISION
        ...
        == SELECTED_TRANCHE_ID
        and decision.get("selected_remediation_finding_id") == SELECTED_REMEDIATION_FINDING_ID
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_STATUS_ADJUDICATION_RESULT_REVIEW_BLOCKED",
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_STATUS_ADJUDICATION_RESULT_REVIEW",
        ...
        "candidate_next_targets": [
            ...
            },
            {
                ...
                "decision": "deferred",
                "reason": "The next remediation tranche remains deferred until tranche 002 blocker movement registration is prepared and reviewed.",
            },
            {
                "target": "prepare_v01_alpha_release_readiness_adjudication_packet",
                "decision": "deferred",
                "reason": "Release-readiness adjudication remains blocked by unregistered tranche 002 movement and tracked blockers.",
            },
        ],
        "acceptance_criteria": acceptance_criteria,
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 002 status adjudication result review "
            ...
            "clear tranche 002, assemble the release packet, mark v0.1-alpha readiness, discharge "
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Generate the v0.1-alpha dependency remediation tranche 002 status adjudication "
            "result review."
        )
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_002_status_adjudication_result_review_report: "
