...
SCHEMA_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_RELEASE_POLICY_ADJUDICATION_PACKET_RESULT_REVIEW_20260515_v0"
)
REVIEW_ID = (
...
def build_result_review(
    *,
    ...
    acceptance_criteria = {
        ...
        == TRANCHE_002_STATUS,
        "tranche_003_remains_pending_adjudication": packet.get(
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_RELEASE_POLICY_ADJUDICATION_PACKET_RESULT_REVIEW_BLOCKED",
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_POLICY_PACKET_RESULT_REVIEW",
        ...
        "candidate_next_targets": [
            {
                "target": NEXT_TARGET,
                "decision": "selected",
                "reason": "The policy question packet is complete, so the narrow tranche 003 policy adjudication execution can be authorized.",
            },
            {
                "target": "prepare_v01_alpha_release_readiness_adjudication_packet",
                "decision": "deferred",
                "reason": "Release-readiness adjudication remains blocked by the pending tranche 003 policy decision and tracked blockers.",
            },
            {
                "target": "prepare_v01_alpha_dependency_remediation_next_tranche_selection_packet",
                "decision": "deferred",
                "reason": "Next-tranche selection is deferred until tranche 003 policy meaning is adjudicated and reviewed.",
            },
        ],
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_packet_result_review_report: "
