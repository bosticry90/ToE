...
def build_result_review(
    *,
    ...
    acceptance_criteria = {
        ...
        "registered_movement_tranche_002_only": registered_movement.get(
            "selected_remediation_finding_id"
        )
        == SELECTED_REMEDIATION_FINDING_ID
        and registered_movement.get("selected_dependency") == SELECTED_DEPENDENCY
        and registered_movement.get("movement_scope") == "tranche_002_only",
        ...
        is True
        and registration.get("tranche_002_formal_movement_accepted") is False,
        "tranche_002_accepted_as_documented_nonblocking": REGISTERED_BLOCKER_STATUS
        == "documented_dependency_nonblocking",
        "remaining_four_obligations_carried_forward": _remaining_obligations_carried_forward(
            registration
        ),
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_BLOCKER_MOVEMENT_REGISTRATION_RESULT_REVIEW_BLOCKED",
        ...
        "tranche_002_formal_movement_accepted": accepted,
        "tranche_002_release_blocker_status": REGISTERED_BLOCKER_STATUS,
        "tranche_002_dependency_policy_remediation_satisfied": accepted,
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_BLOCKER_MOVEMENT_REGISTRATION_RESULT_REVIEW",
        ...
        "candidate_next_targets": [
            {
                ...
                "decision": "selected",
                "reason": (
                    "Tranche 002 movement is accepted, so select the next remediation "
                    "tranche using the remaining four blockers."
                ),
            },
            {
                ...
                "decision": "deferred",
                "reason": (
                    "Direct tranche 003 preparation is deferred until a selection packet "
                    "chooses the next tranche."
                ),
            },
            {
                ...
                "decision": "deferred",
                "reason": (
                    "Release-readiness adjudication remains blocked by four release-blocking "
                    "obligations."
                ),
            },
        ],
        ...
        "non_claim_boundary": (
            ...
            "result review accepts the documented/nonblocking movement for V01-ALPHA-DEP-REM-002 "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_result_review_report: "
