...
SCHEMA_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_RELEASE_POLICY_ADJUDICATION_20260522_v0"
EXECUTION_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_RELEASE_POLICY_ADJUDICATION_v0"
OUTCOME_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_RELEASE_POLICY_ADJUDICATED_WITH_NO_RELEASE_PROMOTION"
DEFAULT_CAPTURED_AT_UTC = "2026-05-22T00:00:00Z"
...
EXPECTED_RESULT_REVIEW_OUTCOME = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_RELEASE_POLICY_ADJUDICATION_PACKET_RESULT_REVIEW_"
    "ACCEPTS_POLICY_QUESTION_PREPARATION_AND_AUTHORIZES_POLICY_ADJUDICATION_EXECUTION_ONLY"
)
EXPECTED_SELECTED_TARGET = "execute_v01_alpha_dependency_remediation_tranche_006_release_policy_adjudication"
...
TRANCHE_004_DEPENDENCY = "qft_gr_source_map_eligibility_ladder_summary_source_map_not_authorized_v0"
TRANCHE_004_CURRENT_BLOCKER = "full_source_map_semantic_closure_not_authorized"
TRANCHE_004_RETAINED_REASON = "obligation_ladder_constructed_witness_chain_absent_source_map_closure_not_authorized"
...
SELECTED_TRANCHE_ID = "V01-ALPHA-DEP-REM-TRANCHE-006"
SELECTED_FINDING_ID = "V01-ALPHA-DEP-REM-006"
SELECTED_DEPENDENCY = "supplied_alignment_constructs_sr_cosmo_regime_transport_package_v0"
...
NEXT_TARGET = "review_v01_alpha_dependency_remediation_tranche_006_release_policy_adjudication_result"
    ...
    return [
        {
            ...
            "modified_by_tranche_006_policy_adjudication": False,
        },
        {
...
def build_adjudication(
    *,
    ...
    other_blockers = [release_blockers[0]]
    ...
    policy_decision = {
        ...
        "decision": (
            ...
            "supplied_alignment_constructs_sr_cosmo_regime_transport_package_v0 when no "
            "project-local axioms are used, provided the release materials document this "
            "standard-axiom posture."
        ),
        "decision_basis": [
            "Tranche 006 packet result review accepted the policy-question preparation.",
            "The selected dependency is supplied_alignment_constructs_sr_cosmo_regime_transport_package_v0.",
            ...
            "The decision is specific to V01-ALPHA-DEP-REM-006 and is not inferred by analogy alone.",
        ],
        "documentation_requirement": (
            "A later documentation packet and result review must record that tranche 006 depends "
    ...
    acceptance_criteria = {
        ...
        == POLICY_QUESTION,
        "adjudicates_only_tranche_006": policy_decision["classification"]
        ...
        and other_blockers[0].get("modified_by_tranche_006_policy_adjudication") is False,
        ...
        "does_not_move_tranche_004_or_006": forbidden_effect_status[
            "tranche_004_moved_to_documented_dependency_nonblocking"
        ]
        is False
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_RELEASE_POLICY_ADJUDICATION_BLOCKED",
        ...
        "execution_scope": "EXECUTE_TRANCHE_006_RELEASE_POLICY_ADJUDICATION_ONLY_NO_RELEASE_PROMOTION",
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_RELEASE_POLICY_ADJUDICATION",
        "selected_next_target_kind": "release_policy_adjudication_result_review_only",
        "selection_count": 1 if accepted else 0,
        "next_action_scope": "REVIEW_TRANCHE_006_RELEASE_POLICY_ADJUDICATION_RESULT_ONLY_NO_RELEASE_PROMOTION",
        "candidate_next_targets": [
            ...
            {
                "target": "prepare_v01_alpha_dependency_remediation_tranche_006_documentation_packet",
                "decision": "deferred",
        ...
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 006 release-policy adjudication "
            "decides only that the standard Lean axioms [propext, Classical.choice, Quot.sound] "
            "are acceptable for supplied_alignment_constructs_sr_cosmo_regime_transport_package_v0 "
            "with a documentation requirement and no project-local axioms. It carries tranche 004 "
            "as retained/release-blocking and preserves tranche 005 as documented/nonblocking. It "
            "does not close remediation, move blockers, assemble the release packet, mark "
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate the v0.1-alpha dependency remediation tranche 006 release-policy adjudication."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_006_release_policy_adjudication_report: "
