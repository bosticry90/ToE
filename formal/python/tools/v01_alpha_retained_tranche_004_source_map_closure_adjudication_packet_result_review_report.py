...
from formal.python.tools.v01_alpha_retained_tranche_004_source_map_closure_adjudication_packet_report import (
    DEFAULT_OUT as DEFAULT_CLOSURE_ADJUDICATION_PACKET_PATH,
...
OUTCOME_ID = (
    "V01_ALPHA_RETAINED_TRANCHE_004_SOURCE_MAP_CLOSURE_ADJUDICATION_PACKET_"
    "RESULT_REVIEW_ACCEPTS_PACKET_AND_AUTHORIZES_BOUNDED_CLOSURE_ADJUDICATION_"
    "EXECUTION_ONLY"
)
RESULT_REVIEW_CLASSIFICATION = (
    "source_map_closure_adjudication_packet_accepted_bounded_closure_"
    "adjudication_execution_authorized_only"
)
CONSUMED_TARGET = (
    "review_v01_alpha_retained_tranche_004_source_map_closure_adjudication_"
    "packet_result"
)
NEXT_TARGET = SOURCE_MAP_CLOSURE_ADJUDICATION_EXECUTION_TARGET
...
FORBIDDEN_EFFECTS = [
    ...
    "source_map_closure_result_review_authorized",
    ...
    return [
        {
            ...
            "decision": "selected",
            "reason": (
                "The closure adjudication packet is accepted for bounded closure "
                "adjudication execution only; execution still cannot move tranche "
                "004 or promote release by this review."
            ),
        },
        {
            ...
            "decision": "deferred",
            "reason": (
                "Blocker movement remains unavailable unless later closure "
        ...
        },
        {
            ...
            "decision": "deferred",
            "reason": "Refinement remains available if closure adjudication execution cannot proceed.",
        },
        {
...
def build_source_map_closure_adjudication_packet_result_review(
    *,
    packet_path: Path = DEFAULT_CLOSURE_ADJUDICATION_PACKET_PATH,
    captured_at_utc: str = DEFAULT_CAPTURED_AT_UTC,
) -> dict[str, Any]:
    packet = _read_json(packet_path)
    closure_requirements = list(packet.get("closure_adjudication_requirements", []))
    reviewed_requirements = list(packet.get("reviewed_authorization_requirements", []))
    ...
    success_criteria = list(packet.get("closure_adjudication_success_criteria", []))
    failure_criteria = list(packet.get("closure_adjudication_failure_criteria", []))
    execution_boundary = list(packet.get("closure_adjudication_execution_boundary", []))
    candidate_next_targets = _candidate_next_targets()
    forbidden_effect_status = {effect: False for effect in FORBIDDEN_EFFECTS}

    acceptance_criteria = {
        "consumes_expected_closure_adjudication_packet": packet.get("packet_id")
        == PACKET_ID,
        "closure_adjudication_packet_schema_expected": packet.get("schema_id")
        == EXPECTED_PACKET_SCHEMA_ID,
        "closure_adjudication_packet_outcome_expected": packet.get("outcome_id")
        == EXPECTED_PACKET_OUTCOME,
        "closure_adjudication_packet_selected_this_review": packet.get(
            "selected_next_target"
        )
        == CONSUMED_TARGET,
        "packet_prepared_adjudication_only": packet.get("accepted") is True
        and packet.get("prepared") is True
        and packet.get("source_map_closure_adjudication_packet_prepared") is True
        and packet.get("source_map_closure_adjudication_packet_preparation_only")
        is True
        and packet.get("packet_classification") == PACKET_CLASSIFICATION,
        "packet_did_not_answer_or_execute_closure_adjudication": packet.get(
            "source_map_closure_adjudication_question_answered"
        )
        is False
        and packet.get("source_map_closure_adjudication_execution_authorized_by_packet")
        is False
        and packet.get("source_map_closure_adjudication_execution_authorized") is False
        and packet.get("source_map_closure_adjudication_executed") is False,
        "accepted_authorization_requirements_carried": len(closure_requirements) == 7
        and len(reviewed_requirements) == 7
        ...
        "proof_evidence_and_boundaries_carried": len(reviewed_components) == 7
        ...
        and packet.get("closure_adjudication_success_criteria_count") == 4
        and len(failure_criteria) == 4
        and packet.get("closure_adjudication_failure_criteria_count") == 4
        and len(execution_boundary) == 5
        and packet.get("closure_adjudication_execution_boundary_count") == 5,
        ...
        "bounded_closure_adjudication_execution_selected_only": sum(
    ...
    return {
        ...
        "consumes_source_map_closure_adjudication_packet": PACKET_ID,
        "consumes_source_map_closure_adjudication_packet_pointer": _ptr(packet_path),
        "consumed_source_map_closure_adjudication_packet_schema_id": packet.get(
            "schema_id"
        ),
        "consumed_source_map_closure_adjudication_packet_outcome_id": packet.get(
            "outcome_id"
        ),
        ...
        "source_map_closure_adjudication_packet_result_reviewed": accepted,
        "source_map_closure_adjudication_packet_result_accepted": accepted,
        "source_map_closure_adjudication_packet_accepted_for_bounded_execution_only": accepted,
        "source_map_closure_adjudication_packet_accepted_as_closure_evidence": False,
        "result_review_classification": RESULT_REVIEW_CLASSIFICATION,
        "result_classification_count": 1 if accepted else 0,
        "source_map_closure_adjudication_packet_prepared": packet.get(
            "source_map_closure_adjudication_packet_prepared"
        )
        is True,
        "source_map_closure_adjudication_packet_preparation_only": packet.get(
            "source_map_closure_adjudication_packet_preparation_only"
        )
        is True,
        "source_map_closure_adjudication_question_prepared": packet.get(
            "source_map_closure_adjudication_question_prepared"
        )
        is True,
        "closure_adjudication_question": packet.get("closure_adjudication_question"),
        ...
        "bounded_source_map_closure_adjudication_execution_authorized": accepted,
        "source_map_closure_adjudication_execution_authorized_by_review": accepted,
        "source_map_closure_adjudication_execution_authorized": accepted,
        "source_map_closure_adjudication_executed": False,
        "source_map_closure_adjudication_execution_target": NEXT_TARGET,
        ...
        "source_map_authorization_adjudication_result_reviewed": packet.get(
            "source_map_authorization_adjudication_result_reviewed"
        )
        is True,
        ...
        is True,
        "source_map_authorization_requirements_satisfied_accepted_by_review": packet.get(
        ...
        "source_map_closure_authorization_requirements_decision_recorded": packet.get(
        ...
        "next_action_scope": (
            ...
            "NO_SOURCE_MAP_CLOSURE_BLOCKER_MOVEMENT_OR_RELEASE_PROMOTION"
        ),
        "acceptance_criteria": acceptance_criteria,
        "non_claim_boundary": (
            "The retained tranche 004 source-map closure adjudication packet result "
            "review accepts the prepared packet and authorizes only bounded closure "
            "adjudication execution as the next target. It does not execute closure "
            "adjudication, answer the closure question, claim or register source-map "
            ...
            "authorize Phase 2, authorize empirical validation, authorize publication, "
...
def write_source_map_closure_adjudication_packet_result_review(
    *,
    packet_path: Path = DEFAULT_CLOSURE_ADJUDICATION_PACKET_PATH,
    out: Path = DEFAULT_OUT,
    captured_at_utc: str = DEFAULT_CAPTURED_AT_UTC,
) -> dict[str, Any]:
    payload = build_source_map_closure_adjudication_packet_result_review(
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--packet",
        type=Path,
        default=DEFAULT_CLOSURE_ADJUDICATION_PACKET_PATH,
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = write_source_map_closure_adjudication_packet_result_review(
        packet_path=packet_path,
        out=out,
        captured_at_utc=str(ns.captured_at_utc),
    )
    print(
        "v01_alpha_retained_tranche_004_source_map_closure_adjudication_packet_result_review_report: "
