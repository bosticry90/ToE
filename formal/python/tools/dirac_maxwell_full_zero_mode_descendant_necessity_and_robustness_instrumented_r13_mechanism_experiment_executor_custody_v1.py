...
"""Static names and domains for the R13 mechanism executor-v1 custody layer.

This module deliberately contains no self-authorizing SHA-256 values for the
v1 freeze artifacts or implementation.  Those values must be supplied by the
...
CUSTODY_LOCK_ID = (
    ...
    "INSTRUMENTED_R13_MECHANISM_EXPERIMENT_EXECUTOR_CUSTODY_v1"
)
...
REVIEW_ANCHOR_RELATIVE_PATH = (
    ...
    "PACKET_REVIEW_20260715_v1.json"
)
...
EXECUTOR_MODULE = (
    "formal.python.tools.dirac_maxwell_full_zero_mode_descendant_necessity_and_"
    "robustness_instrumented_r13_mechanism_experiment_executor_v1"
)
CUSTODY_MODULE = (
    "formal.python.tools.dirac_maxwell_full_zero_mode_descendant_necessity_and_"
    "robustness_instrumented_r13_mechanism_experiment_executor_custody_v1"
)
...
MODULE_PATH_BY_NAME = {
    EXECUTOR_MODULE: (
        ...
        "and_robustness_instrumented_r13_mechanism_experiment_executor_v1.py"
    ),
    CUSTODY_MODULE: (
        "formal/python/tools/dirac_maxwell_full_zero_mode_descendant_necessity_"
    ...
    CLASSIFIER_MODULE: (
        "formal/python/tools/dirac_maxwell_full_zero_mode_descendant_necessity_"
        "and_robustness_instrumented_r13_mechanism_experiment_classifier_v1.py"
    ),
}
