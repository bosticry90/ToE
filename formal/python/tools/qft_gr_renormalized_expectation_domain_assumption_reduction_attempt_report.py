...
from formal.python.tools.qft_gr_renormalized_expectation_domain_assumption_reduction_packet_result_review_report import (
...
DEFAULT_OUT = (
    ...
    / "docs"
    / "release"
    / "QFT_GR_RENORMALIZED_EXPECTATION_DOMAIN_ASSUMPTION_REDUCTION_ATTEMPT_20260606_v0.json"
)
    ...
    return [
        {
            ...
            "decision": "selected",
            "reason": (
                "The bounded RN-ASSUMP-003 renormalized-expectation-domain "
                "attempt must be result-reviewed before finiteness, conservation, "
                "source admissibility, Bianchi compatibility, or seam-closure work."
            ),
        },
        {
            "target": (
            ...
            "decision": "deferred",
            "reason": (
                "Finiteness and regularity remain downstream of the RN-ASSUMP-003 "
        ...
        },
        {
            ...
            "reason": (
                "Reducing the bounded domain row pending review does not discharge "
                "the renormalized-expectation-domain assumption."
            ),
        },
        {
            ...
            "decision": "not_authorized",
            "reason": (
                "Reducing the bounded domain row does not construct a conservation "
                "proof object."
            ),
        },
        {
        ...
        },
        {
            ...
            "decision": "not_authorized",
            "reason": "The bounded domain contract is not a source-admissibility claim.",
        },
        {
            "target": "claim_qft_gr_bianchi_compatibility",
            "decision": "not_authorized",
            "reason": "The bounded domain contract is not a Bianchi compatibility claim.",
        },
        {
...
def build_qft_gr_renormalized_expectation_domain_assumption_reduction_attempt(
    *,
    ...
    classification_rows = [
        {
            ...
            "selected": True,
            "meaning": (
                "The RN-ASSUMP-003 renormalized-expectation-domain assumption "
                "has been reduced to a bounded repo-local domain contract pending "
                "result review, without discharging the domain assumption or "
        ...
        },
        {
            ...
            "meaning": (
                ...
                "the renormalized expectation domain could be reduced."
            ),
        },
        {
    ...
    reduction_contract = {
        "contract_id": RENORMALIZED_EXPECTATION_DOMAIN_CONTRACT_ID,
        ...
        "contract_status": BOUNDED_DOMAIN_CONTRACT_STATUS,
        ...
        "available_repo_evidence": review.get(
            "renormalized_expectation_domain_status_tokens", []
        ),
        "claim_ceiling": (
            "renormalized_expectation_domain_contract_pending_result_review_only_"
            "no_domain_discharge_no_conservation_proof_no_conservation_witness_"
            "no_source_admissibility_no_bianchi_compatibility_no_qft_gr_seam_closure"
        ),
    }
    execution_findings = [
        "The attempt consumes the RN-ASSUMP-003 packet result review and keeps renormalized_expectation_domain as the only executed row.",
        "The bounded repo-local domain admits the renormalized expectation value to the selected operator-domain structure without finiteness, source-admissibility, Bianchi, or conservation claims.",
        "The bounded domain contract preserves RN-ASSUMP-001 and RN-ASSUMP-002 as accepted prior rows and operator-domain closeout as prior family context.",
    ...
    acceptance_criteria = {
        ...
        is True,
        "prior_rn_assump_001_002_accepted": review.get(
        ...
        "domain_object_preserved": review.get("renormalized_expectation_domain")
        == RENORMALIZED_EXPECTATION_DOMAIN
        and review.get("renormalized_expectation_domain_object")
        == RENORMALIZED_EXPECTATION_DOMAIN,
        "domain_status_not_discharged": review.get(
            "renormalized_expectation_domain_status"
        )
        == RENORMALIZED_EXPECTATION_DOMAIN_STATUS,
        "domain_boundary_preserved": review.get("domain_boundary") == DOMAIN_BOUNDARY,
        ...
        == 1,
        "does_not_discharge_domain_by_implication": True,
        "no_domain_discharge": review.get(
    ...
    return {
        ...
        if executed
        else "QFT_GR_RENORMALIZED_EXPECTATION_DOMAIN_ASSUMPTION_REDUCTION_ATTEMPT_BLOCKED",
        "consumes_qft_gr_renormalized_expectation_domain_assumption_reduction_packet_result_review": (
            EXPECTED_REVIEW_ID
        ),
        "consumes_qft_gr_renormalized_expectation_domain_assumption_reduction_packet_result_review_pointer": _ptr(
            review_path
        ),
        ...
        "required_future_proof_object": REQUIRED_FUTURE_PROOF_OBJECT,
        "attempt_scope": (
            "EXECUTE_BOUNDED_QFT_GR_RENORMALIZED_EXPECTATION_DOMAIN_ASSUMPTION_"
        ...
        "renormalized_expectation_domain_reduction_contract": reduction_contract,
        "execution_findings": execution_findings,
        "renormalized_expectation_domain_assumption_reduction_attempt_executed": executed,
        "renormalized_expectation_domain_assumption_reduced_pending_result_review": (
            executed
        ),
        "renormalized_expectation_domain_assumption_obstruction_identified": False,
        "renormalized_expectation_domain_assumption_inconclusive": False,
        "renormalized_expectation_domain_assumption_reduced_by_attempt": executed,
        ...
        if executed
        else "REMEDIATE_QFT_GR_RENORMALIZED_EXPECTATION_DOMAIN_ASSUMPTION_REDUCTION_ATTEMPT",
        "selected_next_target_kind": (
            "qft_gr_renormalized_expectation_domain_assumption_reduction_attempt_result_review"
        ),
        "selected_route": (
            "qft_gr_renormalized_expectation_domain_assumption_reduction_attempt_"
        ...
        "next_action_scope": (
            ...
            "ATTEMPT_RESULT_ONLY_NO_DOMAIN_DISCHARGE_CONSERVATION_WITNESS_OR_"
            "QFT_GR_SEAM_CLOSURE"
        ),
        "acceptance_criteria": acceptance_criteria,
        "non_claim_boundary": (
            "This execution reduces only RN-ASSUMP-003 to a bounded repo-local "
            "renormalized-expectation-domain contract pending result review. It "
            "does not discharge the domain assumption, construct a conservation "
...
def write_qft_gr_renormalized_expectation_domain_assumption_reduction_attempt(
    *,
    review_path: Path = DEFAULT_REVIEW_PATH,
    out: Path = DEFAULT_OUT,
    captured_at_utc: str = DEFAULT_CAPTURED_AT_UTC,
) -> dict[str, Any]:
    payload = build_qft_gr_renormalized_expectation_domain_assumption_reduction_attempt(
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = write_qft_gr_renormalized_expectation_domain_assumption_reduction_attempt(
        review_path=review_path,
        out=out,
        captured_at_utc=str(ns.captured_at_utc),
    )
    print(
        "qft_gr_renormalized_expectation_domain_assumption_reduction_attempt_report: "
