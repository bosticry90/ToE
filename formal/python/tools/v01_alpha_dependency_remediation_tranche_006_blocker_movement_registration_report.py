...
OUTCOME_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_BLOCKER_MOVEMENT_REGISTERED_AS_"
...
def _registered_movement() -> dict[str, Any]:
    return {
        ...
        "tranche_006_effect": "registered_documented_nonblocking_pending_result_review",
    }
...
def build_registration(
    *,
    ...
    acceptance_criteria = {
        ...
        "registers_only_tranche_006": registered_movement[
            "selected_remediation_finding_id"
        ]
        == SELECTED_FINDING_ID
        and registered_movement["selected_dependency"] == SELECTED_DEPENDENCY
        and registered_movement["movement_scope"] == "tranche_006_only",
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_BLOCKER_MOVEMENT_REGISTRATION_BLOCKED",
        ...
        "tranche_006_formal_movement_accepted": False,
        ...
        "remaining_release_blocking_obligation_count_excluding_tranche_006_candidate": (
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_BLOCKER_MOVEMENT_REGISTRATION",
        ...
        "candidate_next_targets": [
            {
                ...
                "decision": "selected",
                "reason": (
                    "The movement registration execution must be reviewed before tranche 006 "
                    "movement is formally accepted."
                ),
            },
            {
                "target": "prepare_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_006_movement",
                "decision": "deferred",
                "reason": (
                    "Next-tranche selection remains deferred until tranche 006 movement "
        ...
        "non_claim_boundary": (
            ...
            "execution registers only V01-ALPHA-DEP-REM-006 as documented/nonblocking pending "
            "result review. It does not clear tranche 006 for global release readiness, move "
            "or discharge retained tranche 004, assemble the release packet, "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_006_blocker_movement_registration_report: "
