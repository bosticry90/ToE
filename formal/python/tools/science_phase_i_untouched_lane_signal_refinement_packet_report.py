...
SCHEMA_ID = "SCIENCE_PHASE_I_UNTOUCHED_LANE_SIGNAL_REFINEMENT_PACKET_REPORT_20260412_v0"
...
DEFAULT_DECLARATION_PATH = (
    ...
    / "docs"
    / "release"
    / "SCIENCE_PHASE_I_UNTOUCHED_LANE_SIGNAL_REFINEMENT_PACKET_20260412_v0.json"
)
...
def build_report(*, declaration_path: Path, captured_at_utc: str | None) -> dict[str, Any]:
    ...
    required_phase_h_decision_outcome = str(packet_policy.get("required_phase_h_decision_outcome", "")).strip()
    ...
    signal_refinement_valid_without_movement = bool(
        packet_policy.get("signal_refinement_valid_without_movement", False)
    )
    ...
    if not preconditions_ok or not one_execution_only or not one_immediate_ruling_only:
        ...
        next_action = "STOP_AND_REPAIR_PHASE_I_CONTRACT_BEFORE_ANY_RETRY"
    elif undeclared_structure_detected:
        terminal_outcome = "UNTOUCHED_LANE_REFINEMENT_REQUIRES_UNDECLARED_STRUCTURE"
    ...
    elif signal_refinement_valid_without_movement:
    ...
    return {
        ...
        "criteria": {
            ...
            == "EXACTLY_ONE_ALLOWED_SCIENCE_PHASE_I_UNTOUCHED_LANE_SIGNAL_REFINEMENT_PACKET_OUTCOME",
            "no_loop_rule_declared": str(packet_contract.get("no_loop_rule", "")).strip()
            == "ONE_SCIENCE_PHASE_I_UNTOUCHED_LANE_SIGNAL_REFINEMENT_PACKET_LAYER_ONLY",
        },
        "objective_quality": {
            "criteria": {
            ...
            "inputs": {
                ...
                "signal_refinement_valid_without_movement": signal_refinement_valid_without_movement,
        ...
        "non_claim_boundary": "Repository-local untouched-lane signal-refinement packet report only; no scientific adequacy claim.",
    }


def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate Phase I untouched-lane signal-refinement packet report."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "science_phase_i_untouched_lane_signal_refinement_packet_report: "
