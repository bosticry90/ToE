...
REVIEW_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_EXECUTION_PACKET_RESULT_REVIEW_v0"
OUTCOME_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_EXECUTION_PACKET_RESULT_REVIEW_"
...
EXPECTED_PACKET_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_EXECUTION_PACKET_v0"
...
NEXT_TARGET = "execute_v01_alpha_dependency_remediation_tranche_003_audit"
...
def build_result_review(
    *,
    ...
    acceptance_criteria = {
        ...
        == TRANCHE_002_STATUS,
        "tranche_003_only_selected_target": packet.get("selection_count") == 1
        ...
        "no_documentation_prepared": packet.get("documentation_prepared") is False
        and forbidden_effect_status["documentation_prepared"] is False,
        "all_four_release_blockers_carried_forward": _release_blockers_are_carried_forward(
            release_blockers
        ),
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_EXECUTION_PACKET_RESULT_REVIEW_BLOCKED",
        "consumes_tranche_003_execution_packet": EXPECTED_PACKET_ID,
        "consumes_tranche_003_execution_packet_pointer": _ptr(packet_path),
        "consumed_packet_schema_id": packet.get("schema_id"),
        "review_scope": (
            "REVIEW_TRANCHE_003_EXECUTION_PACKET_ONLY_ACCEPT_AUDIT_TARGET_NO_AUDIT_EXECUTION_OR_RELEASE_PROMOTION"
        ),
        "tranche_001_status": TRANCHE_001_STATUS,
        "tranche_002_status": TRANCHE_002_STATUS,
        "tranche_003_status": "audit_target_accepted_pending_audit_execution",
        ...
        "tranche_003_execution_packet_accepted": accepted,
        "tranche_003_audit_target_accepted": accepted,
        "tranche_003_audit_execution_authorized": accepted,
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_EXECUTION_PACKET_RESULT_REVIEW",
        "selected_next_target_kind": "tranche_003_audit_execution_only",
        ...
        "candidate_next_targets": [
            {
                ...
                "decision": "selected",
                "reason": (
                    "The execution packet result review accepts the pinned Lean audit target "
                    "and authorizes only audit evidence capture."
                ),
            },
            {
                ...
                "decision": "deferred",
                "reason": (
                    "Full tranche 003 remediation execution remains too broad for the "
        ...
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 003 execution packet result review "
            "accepts the pinned audit target for V01-ALPHA-DEP-REM-003 / "
            "finite_transport_theorems_construct_residual_package_v0 and authorizes only the "
            "bounded tranche 003 Lean audit execution. It does not run the audit during review, "
            "execute remediation, capture evidence, prepare documentation, execute expert "
            "re-review, register blocker movement, assemble the release packet, mark v0.1-alpha "
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Generate the v0.1-alpha dependency remediation tranche 003 execution packet "
            "result review."
        )
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_003_execution_packet_result_review_report: "
