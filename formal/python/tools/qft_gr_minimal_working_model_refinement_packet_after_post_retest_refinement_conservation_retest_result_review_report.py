...
SCHEMA_ID = (
    ...
    "REFINEMENT_CONSERVATION_RETEST_RESULT_REVIEW_20260613_v0"
)
REVIEW_ID = (
    "QFT_GR_MINIMAL_WORKING_MODEL_REFINEMENT_PACKET_AFTER_POST_RETEST_"
...
OUTCOME_ID = (
    "QFT_GR_MINIMAL_WORKING_MODEL_REFINEMENT_PACKET_AFTER_POST_RETEST_"
    "REFINEMENT_CONSERVATION_RETEST_RESULT_REVIEW_ACCEPTS_PACKET_AND_"
    "AUTHORIZES_BOUNDED_REFINEMENT_ATTEMPT_ONLY"
)
...
NEXT_TARGET = (
    ...
    "refinement_conservation_retest"
)
NEXT_TARGET_KIND = (
    "qft_gr_minimal_working_model_refinement_attempt_after_post_retest_"
    "refinement_conservation_retest_execution_only"
)
DEFAULT_OUT = (
    REPO_ROOT
    / "formal"
    ...
    / (
        "QFT_GR_MINIMAL_WORKING_MODEL_REFINEMENT_PACKET_AFTER_POST_RETEST_"
        "REFINEMENT_CONSERVATION_RETEST_RESULT_REVIEW_20260613_v0.json"
    )
)
    ...
    return [
        {
            ...
            "decision": "selected",
            "reason": (
                "The repeated-inconclusive refinement packet is accepted as a "
                "preparation artifact, so the next bounded action may execute "
                "only the scoped refinement attempt."
            ),
        },
        {
        ...
        },
        {
            ...
            "reason": "The review authorizes refinement attempt execution, not a retest.",
        },
        {
            "target": (
            ...
            "reason": (
                "The packet records repeated inconclusive retests, not an "
                "explicit failed-retest countermodel obstruction."
            ),
        },
        {
...
def build_qft_gr_minimal_working_model_refinement_packet_after_post_retest_refinement_conservation_retest_result_review(
    *,
    ...
    acceptance_criteria = {
        ...
        "repeated_inconclusive_signal_confirmed": packet.get(
        ...
        "refinement_dimensions_confirmed": refinement_scopes
        >= {
            "weak_pairing_domain",
    ...
    selected_next_target = (
        ...
        if accepted
            ...
            "POST_RETEST_REFINEMENT_CONSERVATION_RETEST_RESULT_REVIEW"
        )
    )
    ...
    return {
        ...
        if accepted
            ...
            "QFT_GR_MINIMAL_WORKING_MODEL_REFINEMENT_PACKET_AFTER_POST_RETEST_"
            "REFINEMENT_CONSERVATION_RETEST_RESULT_REVIEW_REQUIRES_REMEDIATION"
        ),
        ...
        "consumes_qft_gr_minimal_working_model_refinement_packet": (
            EXPECTED_PACKET_ID
        ),
        "consumes_qft_gr_minimal_working_model_refinement_packet_pointer": (
            _ptr(packet_path)
        ),
        ...
        "repeated_inconclusive_signal_confirmed": accepted,
        ...
        "next_action_scope": (
            ...
            "POST_RETEST_REFINEMENT_CONSERVATION_RETEST_ONLY_NO_REFINEMENT_"
            "EXECUTION_BY_REVIEW_CONSERVATION_RERUN_COUNTERMODEL_PACKET_SOURCE_"
        ...
        "non_claim_boundary": (
            "This result review accepts only the prepared repeated-inconclusive "
...
def write_qft_gr_minimal_working_model_refinement_packet_after_post_retest_refinement_conservation_retest_result_review(
    *,
    packet_path: Path = DEFAULT_PACKET_PATH,
    out: Path = DEFAULT_OUT,
    captured_at_utc: str = DEFAULT_CAPTURED_AT_UTC,
) -> dict[str, Any]:
    payload = build_qft_gr_minimal_working_model_refinement_packet_after_post_retest_refinement_conservation_retest_result_review(
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = write_qft_gr_minimal_working_model_refinement_packet_after_post_retest_refinement_conservation_retest_result_review(
        packet_path=packet_path,
        out=out,
    ...
    print(
        "qft_gr_minimal_working_model_refinement_packet_after_post_retest_"
        "refinement_conservation_retest_result_review_report: "
