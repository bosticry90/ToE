...
from formal.python.tools.v01_alpha_dependency_remediation_tranche_006_status_adjudication_result_review_report import (
    ...
    SELECTED_FINDING_ID,
    SELECTED_TRANCHE_ID,
    STATUS_DECISION as STATUS_CANDIDATE,
    TRANCHE_001_STATUS,
    TRANCHE_002_STATUS,
    TRANCHE_003_STATUS,
...
SCHEMA_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_BLOCKER_MOVEMENT_REGISTRATION_PACKET_"
    "20260522_v0"
)
PACKET_ID = (
...
def build_packet(
    *,
    ...
    acceptance_criteria = {
        ...
        "movement_proposal_is_tranche_006_only": movement_proposal["selected_tranche_id"]
        == SELECTED_TRANCHE_ID
        and movement_proposal["selected_remediation_finding_id"] == SELECTED_FINDING_ID
        and movement_proposal["selected_dependency"] == SELECTED_DEPENDENCY
        and movement_proposal["movement_scope"] == "tranche_006_only",
        ...
        "does_not_move_or_clear_tranche_006": forbidden_effect_status[
            "tranche_006_moved_or_cleared"
        ]
        is False,
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_BLOCKER_MOVEMENT_REGISTRATION_PACKET_BLOCKED",
        ...
        "movement_registration_inputs": [
            ...
            "tranche 006 status candidate = documented_dependency_nonblocking_pending_result_review",
            "status candidate accepted pending blocker-movement registration",
        ],
        "movement_registration_acceptance_criteria": [
            "The proposed movement is only for V01-ALPHA-DEP-REM-006.",
            ...
            "Tranches 001, 002, 003, and 005 remain documented_dependency_nonblocking.",
            "Tranche 004 remains retained_release_blocking_source_map_blocker.",
            "Tranche 006 movement is not registered until packet result review and execution.",
            "No release readiness or global theorem/proof debt discharge is inferred.",
        ],
        "movement_registration_failure_criteria": [
            "The proposal touches any dependency other than supplied_alignment_constructs_sr_cosmo_regime_transport_package_v0.",
            ...
            "The proposal moves retained tranche 004 or registers tranche 006 movement.",
        ],
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_BLOCKER_MOVEMENT_REGISTRATION_PACKET",
        ...
        "candidate_next_targets": [
            {
                ...
                "decision": "selected",
                "reason": (
                    "The proposed blocker movement must be result-reviewed before any "
                    "movement registration execution is authorized."
                ),
            },
            {
                "target": "execute_v01_alpha_dependency_remediation_tranche_006_blocker_movement_registration",
                "decision": "deferred",
        ...
        "non_claim_boundary": (
            ...
            "dependency status for V01-ALPHA-DEP-REM-006 only. It does not register blocker "
            "movement, clear tranche 006, move retained tranche 004, assemble the release packet, "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_006_blocker_movement_registration_packet_report: "
