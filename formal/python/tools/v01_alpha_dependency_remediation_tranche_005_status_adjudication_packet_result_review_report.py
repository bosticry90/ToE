...
SCHEMA_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_STATUS_ADJUDICATION_PACKET_"
...
OUTCOME_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_STATUS_ADJUDICATION_PACKET_RESULT_REVIEW_"
...
NEXT_TARGET = "execute_v01_alpha_dependency_remediation_tranche_005_status_adjudication"
...
def build_result_review(
    *,
    ...
    acceptance_criteria = {
        ...
        == expected_candidate_status_outcomes,
        "tranche_005_not_cleared_or_moved": packet.get("remediation_fully_satisfied")
        is False
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_STATUS_ADJUDICATION_PACKET_RESULT_REVIEW_BLOCKED",
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_STATUS_ADJUDICATION_PACKET_RESULT_REVIEW",
        ...
        "candidate_next_targets": [
            {
                ...
                "decision": "selected",
                "reason": (
                    "The status question preparation is accepted, so the narrow tranche 005 "
        ...
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 005 status adjudication packet result "
            ...
            "tranche 005, move retained tranche 004, assemble the release packet, mark v0.1-alpha "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_005_status_adjudication_packet_result_review_report: "
