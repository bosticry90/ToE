...
NEXT_TARGET = "prepare_v01_alpha_dependency_remediation_tranche_003_execution_packet"
...
def build_result_review(
    *,
    ...
    acceptance_criteria = {
        ...
        == TRANCHE_002_STATUS
        and packet.get("tranche_002_formal_movement_accepted") is True,
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_NEXT_TRANCHE_SELECTION_PACKET_AFTER_TRANCHE_002_MOVEMENT_RESULT_REVIEW_BLOCKED",
        ...
        "review_scope": (
            "REVIEW_NEXT_TRANCHE_SELECTION_PACKET_AFTER_TRANCHE_002_MOVEMENT_ONLY_ACCEPT_TRANCHE_003_SELECTION_NO_REMEDIATION_EXECUTION_OR_RELEASE_PROMOTION"
        ),
        ...
        "tranche_003_selection_accepted": accepted,
        "tranche_003_execution_packet_preparation_authorized": accepted,
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_NEXT_TRANCHE_SELECTION_PACKET_AFTER_TRANCHE_002_MOVEMENT_RESULT_REVIEW",
        "selected_next_target_kind": "tranche_003_execution_packet_preparation_only",
        "next_action_scope": (
        ...
        "candidate_next_targets": [
            {
                ...
                "decision": "selected",
                "reason": (
                    "Selection review accepts tranche 003 and authorizes only "
            ...
            },
            {
                ...
                "decision": "deferred",
                "reason": (
                    "Actual tranche 003 remediation execution is not authorized until "
            ...
            },
            {
                ...
                "decision": "deferred",
                "reason": (
                    "Release-readiness adjudication remains blocked by the four remaining "
        ...
        "non_claim_boundary": (
            ...
            "review after tranche 002 movement accepts only the tranche 003 selection for "
            "V01-ALPHA-DEP-REM-003 / finite_transport_theorems_construct_residual_package_v0 "
            "and authorizes only tranche 003 execution-packet preparation. It does not "
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "result review after tranche 002 movement."
        )
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_002_movement_result_review_report: "
