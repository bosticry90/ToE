...
from formal.python.tools.qft_gr_minimal_working_model_refinement_attempt_after_post_retest_refinement_conservation_retest_refinement_result_review_report import (
...
PACKET_CLASSIFICATION = (
    ...
    "refinement_conservation_retest_refinement_refinement_prepared_pending_"
    "result_review"
)
...
NEXT_TARGET_KIND = (
    "qft_gr_minimal_working_model_conservation_retest_packet_after_post_retest_"
    "refinement_conservation_retest_refinement_refinement_result_review"
)
RETEST_CONDITION_ID = (
    ...
    return [
        {
            ...
            "decision": "selected",
            "reason": (
                "The v4 post-retest-refinement conservation-retest-refinement "
                "packet must "
        ...
        },
        {
            ...
            "reason": "The v4 toy source remains candidate-only.",
        },
        {
...
def _newest_refinement_delta(review: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "delta_id": (
            "post_retest_refinement_conservation_retest_refinement_refined_"
            "toy_candidate_delta_v4"
        ),
        ...
        "changed_after_repeated_inconclusive_retests": [
            {
                ...
                "effect_on_retest": (
                    ...
                    "by the v4 candidate weak-pairing domain."
                ),
            ...
            },
            {
                ...
                "effect_on_retest": (
                    ...
                    "and limit/interchange clauses only where the v4 regularity "
                    "context admits them."
                ),
            ...
            },
            {
                ...
                "effect_on_retest": (
                    "Use the v3 toy compact-support or admissible test-vector "
            ...
            },
            {
                ...
                "effect_on_retest": (
                    "Retest the v4 candidate source definition only, without "
            ...
            },
            {
                ...
                "effect_on_retest": (
                    "Restrict interpretation to the bounded v4 toy "
                    "weak-pairing scope."
                ),
...
def _retest_condition(review: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "condition_being_retested": (
            "Weak distributional covariant conservation of the v4 "
            "post-retest-refinement conservation-retest-refinement toy "
            "stress-energy-like candidate under the v4 weak pairing domain, "
            "v4 regularity context, and v3 "
            "test-function class."
        ),
        "statement_template": (
            "For every retest-admitted compactly supported test vector field X, "
            "with pairings admitted by toy_weak_pairing_domain_v4_candidate "
            "and derivative, regularization, boundary-term, or limit operations "
            "admitted by toy_regular_context_v4_candidate, the weak pairing "
            "<div_g(T_post_retest_refinement_conservation_retest_refinement_refined_v4), X> "
            "must vanish; otherwise record the first explicit obstruction."
        ),
        "refined_artifact_status": review.get("refined_candidate_status"),
        "weak_pairing_domain_id": "toy_weak_pairing_domain_v4_candidate",
        "regularity_structure_id": "toy_regular_context_v4_candidate",
        "test_function_class_id": "toy_conservation_test_function_class_v3_candidate",
        "candidate_source_definition_id": "toy_source_candidate_definition_v4_candidate",
    ...
    return {
        "pass": [
            ...
            (
                ...
                "admitted by toy_regular_context_v4_candidate"
            ),
            (
                "every compact-support or admissible test-vector pairing in "
                "toy_conservation_test_function_class_v3_candidate evaluates "
                "the weak divergence to zero without adding an unrecorded "
                "assumption"
            ),
            "no v4 post-refinement retest obstruction row is triggered",
        ],
        "fail": [
            (
                "a v4 admitted weak divergence pairing is explicitly nonzero "
...
def _pass_boundary() -> list[str]:
    return [
        (
            "A future pass would establish only that the v4 toy candidate "
...
def build_qft_gr_minimal_working_model_conservation_retest_packet_after_post_retest_refinement_conservation_retest_refinement_refinement(
    *,
    ...
    return {
        ...
        "post_retest_refinement_conservation_retest_refinement_refinement_retest_packet_prepared": (
            prepared
        ),
        "conservation_retest_packet_after_post_retest_refinement_conservation_retest_refinement_refinement_prepared": (
            prepared
        ),
        ...
        if prepared
            ...
            "POST_RETEST_REFINEMENT_CONSERVATION_RETEST_REFINEMENT_"
            "REFINEMENT_REQUIRES_REMEDIATION"
        ),
        ...
        "consumes_qft_gr_minimal_working_model_refinement_attempt_after_post_retest_refinement_conservation_retest_refinement_result_review": (
            EXPECTED_RESULT_REVIEW_ID
        ),
        "consumes_qft_gr_minimal_working_model_refinement_attempt_after_post_retest_refinement_conservation_retest_refinement_result_review_pointer": _ptr(
            result_review_path
        ),
        ...
        "next_action_scope": (
            ...
            "REFINEMENT_RESULT_ONLY_NO_RETEST_EXECUTION_SOURCE_ADMISSIBILITY_"
        ...
        "non_claim_boundary": (
            ...
            "for the v4 post-retest-refinement conservation-retest-refinement "
            "toy source candidate. It "
...
def write_qft_gr_minimal_working_model_conservation_retest_packet_after_post_retest_refinement_conservation_retest_refinement_refinement(
    *,
    result_review_path: Path = DEFAULT_RESULT_REVIEW_PATH,
    out: Path = DEFAULT_OUT,
    captured_at_utc: str = DEFAULT_CAPTURED_AT_UTC,
) -> dict[str, Any]:
    payload = build_qft_gr_minimal_working_model_conservation_retest_packet_after_post_retest_refinement_conservation_retest_refinement_refinement(
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = write_qft_gr_minimal_working_model_conservation_retest_packet_after_post_retest_refinement_conservation_retest_refinement_refinement(
        result_review_path=result_review_path,
        out=out,
    ...
    print(
        "qft_gr_minimal_working_model_conservation_retest_packet_after_"
        "post_retest_refinement_conservation_retest_refinement_refinement_report: "
