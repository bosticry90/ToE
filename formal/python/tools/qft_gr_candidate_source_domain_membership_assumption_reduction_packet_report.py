...
from formal.python.tools.qft_gr_selected_operator_action_assumption_reduction_attempt_result_review_report import (
...
PACKET_ID = "QFT_GR_CANDIDATE_SOURCE_DOMAIN_MEMBERSHIP_ASSUMPTION_REDUCTION_PACKET_v0"
OUTCOME_ID = (
    "QFT_GR_CANDIDATE_SOURCE_DOMAIN_MEMBERSHIP_ASSUMPTION_REDUCTION_PACKET_"
...
PRIOR_ACCEPTED_ROW = "OD-ASSUMP-001-selected_operator_action"
...
CANDIDATE_SOURCE_OBJECT = "candidate_stress_energy_source"
...
DEFAULT_OUT = (
    ...
    / "docs"
    / "release"
    / "QFT_GR_CANDIDATE_SOURCE_DOMAIN_MEMBERSHIP_ASSUMPTION_REDUCTION_PACKET_20260527_v0.json"
)
    ...
    return [
        {
            ...
            "decision": "selected",
            "reason": (
                "The candidate source-domain membership packet must be reviewed "
                "before any reduction attempt or downstream row selection."
            ),
        },
        {
            "target": (
            ...
            "reason": (
                ...
                "downstream of this packet review."
            ),
        },
        {
            "target": (
        ...
        },
        {
            ...
            "reason": (
                "Preparing source-domain membership analysis does not authorize "
        ...
        },
        {
            ...
            "decision": "not_authorized",
            "reason": "Candidate source-domain membership does not close QFT-GR.",
        },
        {
...
def build_qft_gr_candidate_source_domain_membership_assumption_reduction_packet(
    *,
    ...
    if selected_row:
        selected_row_payload = {
            ...
            "claim_ceiling": (
                "candidate_source_domain_membership_packet_only_no_source_"
                "admissibility_no_conservation_witness"
            ),
    ...
    acceptance_criteria = {
        ...
        and result_review.get("completed_operator_domain_row") == PRIOR_ACCEPTED_ROW,
        "prior_selected_operator_action_contract_accepted": result_review.get(
        ...
        "selects_only_candidate_source_domain_membership_row": selected_row is not None
        ...
        "candidate_source_object_recorded": bool(
            selected_row_payload.get("candidate_source_object")
        ),
        "operator_domain_membership_condition_recorded": bool(
            selected_row_payload.get("operator_domain_membership_condition")
        ),
    ...
    return {
        ...
        if prepared
        else "QFT_GR_CANDIDATE_SOURCE_DOMAIN_MEMBERSHIP_ASSUMPTION_REDUCTION_PACKET_BLOCKED",
        "packet_classification": PACKET_CLASSIFICATION,
        "packet_classification_count": 1 if prepared else 0,
        "consumes_qft_gr_selected_operator_action_assumption_reduction_attempt_result_review": EXPECTED_RESULT_REVIEW_ID,
        "consumes_qft_gr_selected_operator_action_assumption_reduction_attempt_result_review_pointer": _ptr(
            result_review_path
        ),
        ...
        "candidate_source_domain_membership_assumption_reduction_analysis_prepared": prepared,
        "candidate_source_domain_membership_assumption": selected_row_payload,
        "candidate_source_object": CANDIDATE_SOURCE_OBJECT,
        "operator_domain_membership_condition": OPERATOR_DOMAIN_MEMBERSHIP_CONDITION,
        ...
        "claim_ceiling": (
            "candidate_source_domain_membership_assumption_reduction_packet_only_"
        ...
        "next_action_scope": (
            ...
            "REDUCTION_PACKET_RESULT_ONLY_NO_SOURCE_ADMISSIBILITY_OR_QFT_GR_SEAM_CLOSURE"
        ),
        "acceptance_criteria": acceptance_criteria,
        "non_claim_boundary": (
            "This packet prepares only OD-ASSUMP-002 candidate source-domain "
            "membership reduction analysis. It does not claim source "
...
def write_qft_gr_candidate_source_domain_membership_assumption_reduction_packet(
    *,
    result_review_path: Path = DEFAULT_RESULT_REVIEW_PATH,
    operator_domain_packet_path: Path = DEFAULT_OPERATOR_DOMAIN_PACKET_PATH,
    ...
    payload = (
        build_qft_gr_candidate_source_domain_membership_assumption_reduction_packet(
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = write_qft_gr_candidate_source_domain_membership_assumption_reduction_packet(
        result_review_path=result_review_path,
        operator_domain_packet_path=operator_domain_packet_path,
        out=out,
    ...
    print(
        "qft_gr_candidate_source_domain_membership_assumption_reduction_packet_report: "
