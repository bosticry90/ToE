"""CLI wrapper for OV-SEL-SND-04 density dependence audit lock."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    rec = ovsel_snd04_density_dependence_audit_record(status_date=str(args.status_date))

    if not args.no_write:
        out = write_ovsel_snd04_lock(
