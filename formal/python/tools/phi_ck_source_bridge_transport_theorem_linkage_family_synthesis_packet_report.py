...
STAGE_KEY = "triad_packet"
SCHEMA_ID = STAGES[STAGE_KEY].schema_id
PACKET_ID = STAGES[STAGE_KEY].packet_id
OUTCOME_ID = STAGES[STAGE_KEY].outcome_id
STRICT_PACKET_RESULT = STAGES[STAGE_KEY].strict_outcome_id
DEFAULT_OUT = release_path(STAGES[STAGE_KEY])


def build_phi_ck_source_bridge_transport_theorem_linkage_family_synthesis_packet():
