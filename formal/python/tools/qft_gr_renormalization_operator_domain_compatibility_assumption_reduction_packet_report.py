...
from formal.python.tools.qft_gr_renormalized_expectation_finiteness_assumption_reduction_attempt_result_review_report import (
    ...
    NEXT_ROW_ID as EXPECTED_SELECTED_OPERATOR_DOMAIN_COMPATIBILITY_ROW,
...
from formal.python.tools.qft_gr_renormalized_expectation_finiteness_assumption_reduction_packet_report import (
    SELECTED_ROW_ID as ACCEPTED_PRIOR_FINITENESS_ROW,
)
...
SELECTED_ROW_ID = EXPECTED_SELECTED_OPERATOR_DOMAIN_COMPATIBILITY_ROW
ACCEPTED_PRIOR_ROWS = [
    ACCEPTED_PRIOR_OBJECT_ROW,
    ACCEPTED_PRIOR_SCOPE_ROW,
    ACCEPTED_PRIOR_DOMAIN_ROW,
    ACCEPTED_PRIOR_FINITENESS_ROW,
]
NEXT_TARGET = (
...
OPERATOR_DOMAIN_COMPATIBILITY_BOUNDARIES = [
    "repo_local_operator_domain_compatibility_only",
    "accepted_operator_domain_rows_OD_ASSUMP_001_through_006_only",
    "accepted_renormalization_rows_RN_ASSUMP_001_through_004_only",
    "no_operator_domain_compatibility_discharge",
...
CANDIDATE_REDUCTION_ROUTE = (
    "check compatibility with the selected operator-domain structure while "
    "preserving no Bianchi, conservation, or source-admissibility claim"
)
...
DEFAULT_OUT = (
    ...
    / "docs"
    / "release"
    / "QFT_GR_RENORMALIZATION_OPERATOR_DOMAIN_COMPATIBILITY_ASSUMPTION_REDUCTION_PACKET_20260606_v0.json"
)
    ...
    return [
        {
            ...
            "decision": "selected",
            "reason": (
                "The prepared RN-ASSUMP-005 operator-domain compatibility "
        ...
        },
        {
            ...
            "reason": "Packet preparation does not discharge operator-domain compatibility.",
        },
        {
        ...
        },
        {
            ...
            "decision": "not_authorized",
            "reason": "The operator-domain compatibility packet does not claim source admissibility.",
        },
        {
...
def build_qft_gr_renormalization_operator_domain_compatibility_assumption_reduction_packet(
    *,
    ...
    if selected_row:
        selected_row_payload = {
            ...
            "claim_ceiling": (
                "renormalization_operator_domain_compatibility_packet_only_no_"
    ...
    acceptance_criteria = {
        "consumes_expected_rn_assump_004_result_review": result_review.get(
            "review_id"
        )
        ...
        == ACCEPTED_PRIOR_ROWS,
        "selects_only_operator_domain_compatibility_row": selected_row is not None
        ...
        "operator_domain_compatibility_condition_recorded": bool(
            OPERATOR_DOMAIN_COMPATIBILITY
        ),
        "scope_boundaries_recorded": len(OPERATOR_DOMAIN_COMPATIBILITY_BOUNDARIES)
        == 8,
        "prepares_reduction_analysis_only": bool(selected_row_payload),
        "does_not_discharge_operator_domain_compatibility": True,
    ...
    return {
        ...
        if prepared
        else "QFT_GR_RENORMALIZATION_OPERATOR_DOMAIN_COMPATIBILITY_ASSUMPTION_REDUCTION_PACKET_BLOCKED",
        ...
        "consumes_qft_gr_renormalized_expectation_finiteness_assumption_reduction_attempt_result_review_pointer": _ptr(
        ...
        "operator_domain_compatibility_status": OPERATOR_DOMAIN_COMPATIBILITY_STATUS,
        "scope_boundaries": OPERATOR_DOMAIN_COMPATIBILITY_BOUNDARIES,
        "renormalization_operator_domain_compatibility_assumption": (
            selected_row_payload
        ),
        ...
        "claim_ceiling": (
            ...
            "packet_preparation_only_no_assumption_discharge_no_conservation_"
        ...
        "operator_domain_compatibility_reduced_or_discharged_by_preparation": False,
        ...
        if prepared
        else "REMEDIATE_QFT_GR_RENORMALIZATION_OPERATOR_DOMAIN_COMPATIBILITY_ASSUMPTION_REDUCTION_PACKET",
        ...
        "non_claim_boundary": (
            "This packet prepares only RN-ASSUMP-005 operator-domain "
            "compatibility reduction analysis. It does not discharge "
            "operator-domain compatibility or renormalization assumptions, "
...
def write_qft_gr_renormalization_operator_domain_compatibility_assumption_reduction_packet(
    *,
    attempt_result_review_path: Path = DEFAULT_ATTEMPT_RESULT_REVIEW_PATH,
    renormalization_packet_path: Path = DEFAULT_RENORMALIZATION_PACKET_PATH,
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = write_qft_gr_renormalization_operator_domain_compatibility_assumption_reduction_packet(
        attempt_result_review_path=attempt_result_review_path,
        renormalization_packet_path=renormalization_packet_path,
        out=out,
    ...
    print(
        "qft_gr_renormalization_operator_domain_compatibility_assumption_reduction_packet_report: "
