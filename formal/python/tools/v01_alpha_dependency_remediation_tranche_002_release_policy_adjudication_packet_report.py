...
SCHEMA_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_RELEASE_POLICY_ADJUDICATION_PACKET_20260515_v0"
)
PACKET_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_RELEASE_POLICY_ADJUDICATION_PACKET_v0"
OUTCOME_ID = (
...
def _release_policy_acceptance_criteria() -> list[str]:
    return [
        "The later adjudication cites the exact accepted Lean dependency evidence for stationary_implies_operator_zero.",
        ...
        "Any blocker downgrade is limited to tranche 002 and does not affect tranche 001 or the four non-selected release-blocking obligations.",
...
def _release_policy_failure_criteria() -> list[str]:
    return [
        ...
        "The later adjudication clears or moves tranche 002 without a recorded v0.1-alpha policy decision.",
        "The later adjudication modifies tranche 001 or any of the four non-selected release-blocking obligations.",
...
def build_packet(
    *,
    ...
    acceptance_criteria = {
        ...
        "tranche_002_remains_blocking_pending_adjudication": True,
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_RELEASE_POLICY_ADJUDICATION_PACKET_BLOCKED",
        ...
        "expert_re_review_requirement": (
            ...
            "or waived for the standard Lean axiom posture of tranche 002."
        ),
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_POLICY_PACKET",
        ...
        "candidate_next_targets": [
            ...
            },
            {
                ...
                "decision": "deferred",
                "reason": "Release-readiness adjudication remains blocked by tranche 002 policy adjudication and the remaining tracked blockers.",
            },
        ],
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_002_release_policy_adjudication_packet_report: "
