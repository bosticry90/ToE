...
def build_runtime_baseline(
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "source_commands": {
            "governance_suite": "pwsh -NoProfile -ExecutionPolicy Bypass -File ./governance_suite.ps1",
            "branch_health_full_pytest": "./py.ps1 -m pytest formal/python/tests -q",
            "checkpoint_ladder": "pwsh -NoProfile -ExecutionPolicy Bypass -File ./checkpoint_ladder.ps1",
        },
