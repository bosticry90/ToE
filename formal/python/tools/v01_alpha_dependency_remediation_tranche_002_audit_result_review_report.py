...
SCHEMA_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_AUDIT_RESULT_REVIEW_20260515_v0"
REVIEW_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_AUDIT_RESULT_REVIEW_v0"
OUTCOME_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_AUDIT_RESULT_REVIEW_ACCEPTS_EXACT_"
...
EXPECTED_AUDIT_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_AUDIT_v0"
...
def build_result_review(
    *,
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_AUDIT_RESULT_REVIEW_BLOCKED",
        ...
        "source_execution_packet_result_review": audit.get(
            "consumes_tranche_002_execution_packet_result_review"
        ),
        "review_scope": (
        ...
        "tranche_002_audit_result_classification": TRANCHE_CLASSIFICATION,
        ...
        "classification_reason": (
            "Exact Lean dependency evidence was captured for stationary_implies_operator_zero "
            "and no project-local axioms were found. The evidence is accepted, but standard Lean "
            "axiom acceptability must be prepared for v0.1-alpha release-policy adjudication "
            "before any blocker movement or remediation closure."
        ),
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_AUDIT_RESULT_REVIEW",
        "selected_next_target_kind": "tranche_002_release_policy_adjudication_packet_preparation_only",
        ...
        "candidate_next_targets": [
            {
                "target": NEXT_TARGET,
                "decision": "selected",
                "reason": "Accepted standard Lean axiom evidence requires a prepared v0.1-alpha release-policy adjudication packet before blocker movement can be considered.",
            },
            {
                "target": "execute_v01_alpha_dependency_remediation_tranche_002_release_policy_adjudication",
                "decision": "deferred",
            ...
            },
            {
                ...
                "decision": "deferred",
                "reason": "Release-readiness adjudication remains blocked by tranche 002 policy work and the remaining tracked obligations.",
            },
        ],
        "acceptance_criteria": acceptance_criteria,
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 002 audit result review accepts exact "
            "Lean dependency evidence for stationary_implies_operator_zero and authorizes only "
            "release-policy adjudication packet preparation. It does not decide release policy, "
            "close remediation, move blockers, assemble the release packet, mark v0.1-alpha "
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate the v0.1-alpha dependency remediation tranche 002 audit result review."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_002_audit_result_review_report: "
