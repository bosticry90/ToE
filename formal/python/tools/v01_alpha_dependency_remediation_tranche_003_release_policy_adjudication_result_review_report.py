...
SCHEMA_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_RELEASE_POLICY_ADJUDICATION_RESULT_REVIEW_20260515_v0"
)
REVIEW_ID = (
...
EXPECTED_ADJUDICATION_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_RELEASE_POLICY_ADJUDICATION_v0"
...
NEXT_TARGET = "prepare_v01_alpha_dependency_remediation_tranche_003_documentation_packet"
...
def build_result_review(
    *,
    ...
    acceptance_criteria = {
        ...
        "tranche_003_pending_documentation": adjudication.get(
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_RELEASE_POLICY_ADJUDICATION_RESULT_REVIEW_BLOCKED",
        ...
        "tranche_003_policy_status": "policy_acceptable_documentation_required",
        "tranche_003_release_blocker_status": "still_blocking_pending_documentation_packet",
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_RELEASE_POLICY_ADJUDICATION_RESULT_REVIEW",
        ...
        "candidate_next_targets": [
            {
                "target": NEXT_TARGET,
                "decision": "selected",
                "reason": "The policy adjudication is acceptable with documentation required, so prepare the tranche 003 documentation packet next.",
            },
            {
                "target": "prepare_v01_alpha_dependency_remediation_tranche_003_status_adjudication_packet",
                "decision": "deferred",
                "reason": "Status adjudication remains deferred until tranche 003 documentation is prepared and reviewed.",
            },
            {
                "target": "prepare_v01_alpha_release_readiness_adjudication_packet",
                "decision": "deferred",
                "reason": "Release-readiness adjudication remains blocked by tranche 003 documentation and the remaining tracked blockers.",
            },
        ],
        "acceptance_criteria": acceptance_criteria,
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 003 release-policy adjudication result "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_result_review_report: "
