...
REVIEW_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_EXECUTION_PACKET_RESULT_REVIEW_v0"
OUTCOME_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_EXECUTION_PACKET_RESULT_REVIEW_"
...
EXPECTED_PACKET_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_EXECUTION_PACKET_v0"
...
NEXT_TARGET = "execute_v01_alpha_dependency_remediation_tranche_005_audit"
...
def build_result_review(
    *,
    ...
    acceptance_criteria = {
        ...
        "tranche_005_only_selected_target": packet.get("selection_count") == 1
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_EXECUTION_PACKET_RESULT_REVIEW_BLOCKED",
        "consumes_tranche_005_execution_packet": EXPECTED_PACKET_ID,
        "consumes_tranche_005_execution_packet_pointer": _ptr(packet_path),
        "consumed_packet_schema_id": packet.get("schema_id"),
        "review_scope": (
            "REVIEW_TRANCHE_005_EXECUTION_PACKET_ONLY_ACCEPT_LEAN_DEPENDENCY_AUDIT_SCOPE_NO_AUDIT_EXECUTION_OR_RELEASE_PROMOTION"
        ),
        ...
        "tranche_005_status": "lean_dependency_audit_scope_accepted_pending_execution",
        ...
        "tranche_005_execution_packet_accepted": accepted,
        "tranche_005_lean_dependency_audit_scope_accepted": accepted,
        "tranche_005_audit_execution_authorized": accepted,
        ...
        "audit_execution_authorized_scope": {
            ...
            "carries_tranche_006_unresolved": True,
        },
        ...
        "selected_next_target": NEXT_TARGET
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_EXECUTION_PACKET_RESULT_REVIEW",
        "selected_next_target_kind": "tranche_005_audit_execution_only",
        ...
        "candidate_next_targets": [
            {
                ...
                "reason": (
                    ...
                    "audit scope and authorizes only audit evidence capture."
                ),
            },
            {
                "target": "execute_v01_alpha_dependency_remediation_tranche_005",
                "decision": "deferred",
                "reason": (
                    "Full tranche 005 remediation execution remains too broad for the "
            ...
            },
            {
                ...
                "decision": "deferred",
                "reason": "Release readiness remains blocked by retained tranche 004 and unresolved obligations.",
            },
        ],
        "acceptance_criteria": acceptance_criteria,
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 005 execution packet result review "
            "accepts the pinned Lean audit target for V01-ALPHA-DEP-REM-005 / "
            "supplied_interface_alignment_semantics_construct_bridge_package_v0 and authorizes "
            "only the bounded tranche 005 Lean audit execution. It carries tranche 004 as "
            "retained/release-blocking and keeps tranche 006 unresolved. It does not run the "
            "audit during review, execute remediation, capture evidence, prepare documentation, "
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Generate the v0.1-alpha dependency remediation tranche 005 execution packet "
            "result review."
        )
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_005_execution_packet_result_review_report: "
