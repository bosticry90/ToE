...
PROFILE_FILES = {
    ...
    "historical_debt": PROFILE_ROOT / "HISTORICAL_DEBT_PROFILE_20260725_v1.json",
}
REGISTRY_PATH = PROFILE_ROOT / "RECOVERY_OBLIGATION_REGISTRY_20260725_v1.json"
RECONCILIATION_PATH = (
    PROFILE_ROOT / "VALIDATION_PROFILE_RECONCILIATION_20260725_v1.json"
)
