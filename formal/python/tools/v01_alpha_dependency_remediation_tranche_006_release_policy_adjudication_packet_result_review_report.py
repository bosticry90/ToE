...
SCHEMA_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_RELEASE_POLICY_ADJUDICATION_PACKET_RESULT_REVIEW_20260522_v0"
)
REVIEW_ID = (
    ...
    return [
        {
            ...
            "modified_by_tranche_006_release_policy_packet_result_review": False,
        },
        {
...
def build_result_review(
    *,
    ...
    acceptance_criteria = {
        ...
        "tranche_006_remains_pending_execution": packet.get(
        ...
        and other_blockers[0].get(
            "modified_by_tranche_006_release_policy_packet_result_review"
        )
        is False,
        ...
        "no_tranche_004_or_006_movement": forbidden_effect_status[
            "tranche_004_moved_to_documented_dependency_nonblocking"
        ]
        is False
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_RELEASE_POLICY_ADJUDICATION_PACKET_RESULT_REVIEW_BLOCKED",
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_POLICY_PACKET_RESULT_REVIEW",
        ...
        "candidate_next_targets": [
            {
                "target": NEXT_TARGET,
                "decision": "selected",
                "reason": "The policy question packet is complete, so the narrow tranche 006 policy adjudication execution can be authorized.",
            },
            {
            ...
            {
                "target": "prepare_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_006",
                "decision": "deferred",
                "reason": "Next-tranche selection is deferred until tranche 006 policy meaning is adjudicated and reviewed.",
            },
        ],
        ...
        "non_claim_boundary": (
            ...
            "and preserves tranche 005 as documented/nonblocking. It does not decide the policy "
            "question, close remediation, move blockers, assemble the release packet, mark "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_006_release_policy_adjudication_packet_result_review_report: "
