...
NEXT_TARGET_KIND = (
    "qft_gr_state_admissibility_boundary_assumption_reduction_attempt_execution"
)
AUTHORIZED_ATTEMPT_RESULT_CLASSIFICATIONS = [
    "qft_gr_state_admissibility_boundary_assumption_reduced_pending_result_review",
    (
        "qft_gr_state_admissibility_boundary_assumption_obstruction_"
        "identified_requires_refinement"
    ),
    (
        "qft_gr_state_admissibility_boundary_assumption_inconclusive_"
    ...
    return [
        {
            ...
            "decision": "selected",
            "reason": (
                "The SD-ASSUMP-002 packet has been accepted; the next bounded "
                "step may attempt to reduce exactly the state-admissibility "
                "boundary assumption."
            ),
        },
        {
            ...
            "reason": (
                ...
                "SD-ASSUMP-002 bounded reduction attempt."
            ),
        },
        {
        ...
        },
        {
            ...
            "decision": "not_authorized",
            "reason": (
                "A state-admissibility boundary review does not claim "
...
def build_qft_gr_state_admissibility_boundary_assumption_reduction_packet_result_review(
    *,
    ...
    selected_status = packet.get("state_admissibility_boundary_status_tokens", [])

    acceptance_criteria = {
        "consumes_expected_sd_assump_002_packet": packet.get("packet_id")
        == EXPECTED_PACKET_ID,
        ...
        "confirms_sd001_remains_accepted": packet.get(
            "accepted_prior_state_domain_assumption_row"
        )
        == ACCEPTED_PRIOR_ROW_ID
        and packet.get("accepted_state_domain_assumption_rows")
        == [ACCEPTED_PRIOR_ROW_ID]
        and packet.get("accepted_state_domain_assumption_row_count") == 1,
        ...
        "state_admissibility_boundary_recorded": packet.get(
            "state_admissibility_boundary_condition"
        )
        == STATE_ADMISSIBILITY_BOUNDARY_CONDITION
        and packet.get("state_admissibility_boundary")
        == STATE_ADMISSIBILITY_BOUNDARY_CONDITION,
        ...
        "no_state_admissibility_reduced_by_review": packet.get(
            "state_admissibility_claimed"
        )
        is False
        and packet.get("state_admissibility_discharged") is False
        and packet.get("state_admissibility_boundary_satisfied") is False
        and packet.get("state_admissibility_boundary_discharged") is False,
    ...
    return {
        ...
        "consumes_qft_gr_state_admissibility_boundary_assumption_reduction_packet_pointer": _ptr(
            packet_path
        ),
        ...
        "state_admissibility_boundary_assumption_reduction_analysis_accepted": (
            accepted
        ),
        "state_admissibility_boundary_assumption_reduced_by_review": False,
        ...
        "authorized_attempt_scope": (
            "state_admissibility_boundary_assumption_reduction_attempt_only_no_"
            "state_admissibility_claim_no_source_admissibility_no_conservation_"
        ...
        "next_action_scope": (
            "EXECUTE_QFT_GR_STATE_ADMISSIBILITY_BOUNDARY_ASSUMPTION_REDUCTION_"
            "ATTEMPT_ONLY_NO_STATE_ADMISSIBILITY_CLAIM_SOURCE_ADMISSIBILITY_"
            "CONSERVATION_WITNESS_OR_QFT_GR_SEAM_CLOSURE"
        ),
        "acceptance_criteria": acceptance_criteria,
        "non_claim_boundary": (
            "This result review accepts only the SD-ASSUMP-002 packet and "
            "authorizes one bounded reduction attempt. It does not reduce or "
            "discharge the state-admissibility boundary assumption by review "
...
def write_qft_gr_state_admissibility_boundary_assumption_reduction_packet_result_review(
    *,
    packet_path: Path = DEFAULT_PACKET_PATH,
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = (
        write_qft_gr_state_admissibility_boundary_assumption_reduction_packet_result_review(
            packet_path=packet_path,
            out=out,
    ...
    print(
        "qft_gr_state_admissibility_boundary_assumption_reduction_packet_result_review_report: "
