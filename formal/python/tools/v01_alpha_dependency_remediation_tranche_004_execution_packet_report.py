...
SCHEMA_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_004_EXECUTION_PACKET_20260515_v0"
PACKET_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_004_EXECUTION_PACKET_v0"
OUTCOME_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_004_EXECUTION_PACKET_PREPARED_FOR_"
    "QFT_GR_SOURCE_MAP_ELIGIBILITY_LADDER_WITH_NO_REMEDIATION_EXECUTION_OR_RELEASE_PROMOTION"
)
...
DEFAULT_OUT = (
    ...
    / "docs"
    / "release"
    / "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_004_EXECUTION_PACKET_20260515_v0.json"
)
...
NEXT_TARGET = "review_v01_alpha_dependency_remediation_tranche_004_execution_packet_result"
...
def build_packet(
    *,
    ...
    execution_scope = {
        "scope_kind": "QFT_GR_SOURCE_MAP_AUTHORIZATION_AND_DEPENDENCY_AUDIT_PREPARATION_ONLY",
        ...
        "allowed_execution_actions": [
            "run_the_pinned_lean_axiom_audit_command_for_the_selected_source_map_authorization_target",
            "record_raw_lean_axiom_output_for_the_selected_target",
            "inspect_the_qft_gr_source_map_authorization_readout_surface",
            "record_whether_the_target_is_an_authorization_absence_marker_or_a_positive_source_map_authorization",
        ...
        "forbidden_execution_actions": [
            ...
            "reinterpret_the_negative_authorization_marker_as_source_map_closure",
    ...
    required_evidence_surface = {
        "surface_kind": "source_map_authorization_and_lean_axiom_audit_readout",
        "lean_target": LEAN_TARGET,
        "lean_source": LEAN_SOURCE,
        "audit_command": LEAN_AUDIT_COMMAND,
        "ledger_surface": LEDGER_SURFACE,
        "source_map_authorization_surface": (
            "qftGRSourceMapEligibilityLadderSummaryStatusReadoutV0.full_source_map_semantic_closure_authorized"
        ),
        "negative_authorization_marker_expected": True,
        "raw_output_required": True,
        "parsed_axioms_required": True,
        "project_axioms_used_required": True,
        "authorization_status_readout_required": True,
        "execution_status": "prepared_not_executed_v0",
    }
    audit_requirements = {
        "lean_audit_required": True,
        "authorization_surface_audit_required": True,
    ...
    documentation_requirement = {
        ...
        "condition": (
            "Required if tranche 004 remains a negative source-map authorization marker, "
            "if dependency posture is policy-acceptable but release-facing explanation is needed, "
            "or if project-local axioms or retained assumptions require documentation."
        ),
    ...
    policy_adjudication_requirement = {
        ...
        "reason": (
            "This row is a blocked bridge authorization dependency; after audit evidence is captured, "
            "release policy must adjudicate whether the negative source-map authorization marker can be "
            "documented/nonblocking or requires a different remediation path."
        ),
    ...
    expert_re_review_requirement = {
        "required": "conditional_after_audit_result_review",
        "trigger": (
            "Triggered by a positive source-map closure claim, project-local axioms, unexpected "
            "nonstandard axioms, source-map authorization ambiguity, or any attempted blocker downgrade."
        ),
        "executed_by_this_packet": False,
    }
    success_criteria = [
        "execution_consumes_this_packet_and_targets_only_qft_gr_source_map_eligibility_ladder_summary_source_map_not_authorized_v0",
        "raw_lean_axiom_output_is_recorded_for_the_pinned_qft_gr_source_map_audit_command",
        "parsed_axioms_and_project_axioms_used_are_recorded",
        "authorization_status_readout_is_preserved_as_negative_unless_separately_adjudicated",
    ...
    failure_criteria = [
        "execution_targets_a_dependency_other_than_qft_gr_source_map_eligibility_ladder_summary_source_map_not_authorized_v0",
        "lean_audit_output_is_missing_or_not_parseable",
        "source_map_authorization_status_is_missing_or_reinterpreted_without_adjudication",
    ...
    acceptance_criteria = {
        ...
        == TRANCHE_003_STATUS,
        "tranche_004_selected_only": result_review.get("selection_count") == 1
        ...
        "three_release_blockers_carried_forward": _obligations_are_unmodified(
        ...
        "audit_targets_defined": required_evidence_surface["lean_target"] == LEAN_TARGET
        ...
        and audit_requirements["authorization_surface_audit_required"] is True,
        ...
        and forbidden_effect_status["authorization_evidence_captured"] is False,
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_004_EXECUTION_PACKET_BLOCKED",
        ...
        "tranche_004_status": "selected_for_execution_packet_preparation",
        "tranche_004_cleared_for_global_release_readiness": False,
        ...
        "tranche_004_execution_packet_prepared": accepted,
        ...
        "source_map_authorization_audit_target": {
            "authorization_readout": required_evidence_surface[
                "source_map_authorization_surface"
            ],
            "negative_authorization_marker_expected": True,
            "executed_by_this_packet": False,
        ...
        "post_execution_adjudication_target": (
            "review_v01_alpha_dependency_remediation_tranche_004_audit_result"
        ),
        "remediation_execution_authorized": False,
        "remediation_executed": False,
        "lean_dependency_audit_executed": False,
        "source_map_authorization_audit_executed": False,
        "lean_dependency_evidence_captured": False,
        "authorization_evidence_captured": False,
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_004_EXECUTION_PACKET",
        "selected_next_target_kind": "tranche_004_execution_packet_result_review_only",
        "selection_count": 1 if accepted else 0,
        "next_action_scope": (
            "REVIEW_TRANCHE_004_EXECUTION_PACKET_RESULT_ONLY_NO_REMEDIATION_EXECUTION_OR_RELEASE_PROMOTION"
        ),
        "candidate_next_targets": [
            {
                "target": NEXT_TARGET,
                "decision": "selected",
                "reason": "The tranche 004 execution packet must be reviewed before remediation execution can be authorized.",
            },
            {
                "target": "execute_v01_alpha_dependency_remediation_tranche_004_audit",
                "decision": "deferred",
                "reason": "Actual tranche 004 audit execution is deferred until this packet is reviewed and accepted.",
            },
            {
                "target": "prepare_v01_alpha_release_readiness_adjudication_packet",
                "decision": "deferred",
                "reason": "Release-readiness adjudication remains blocked by the three tracked release-blocking obligations.",
            },
        ],
        "acceptance_criteria": acceptance_criteria,
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 004 execution packet prepares only "
            "a bounded source-map authorization and Lean dependency-audit scope for "
            "V01-ALPHA-DEP-REM-004 / qft_gr_source_map_eligibility_ladder_summary_source_map_not_authorized_v0. "
            "It does not execute remediation, run the Lean audit, capture authorization evidence, "
            "prepare documentation, execute policy adjudication or expert re-review, register blocker "
            "movement, assemble the release packet, mark v0.1-alpha readiness, discharge Lean theorem "
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate the v0.1-alpha dependency remediation tranche 004 execution packet."
    )
    parser.add_argument(
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_004_execution_packet_report: "
