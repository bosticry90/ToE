...
SCHEMA_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_DOCUMENTATION_PACKET_RESULT_REVIEW_"
    "20260515_v0"
)
REVIEW_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_DOCUMENTATION_PACKET_RESULT_REVIEW_v0"
OUTCOME_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_DOCUMENTATION_PACKET_RESULT_REVIEW_"
...
RESULT_REVIEW_CLASSIFICATION = "documentation_accepted_pending_tranche_005_status_adjudication"
NEXT_TARGET = "prepare_v01_alpha_dependency_remediation_tranche_005_status_adjudication_packet"
...
def build_result_review(
    *,
    ...
    acceptance_criteria = {
        ...
        "tranche_005_not_cleared": packet.get("remediation_fully_satisfied") is False
        and packet.get("blocker_movement_authorized") is False
        and packet.get("blocker_movement_registered") is False
        and packet.get("tranche_005_release_blocker_status")
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_DOCUMENTATION_PACKET_RESULT_REVIEW_BLOCKED",
        ...
        "tranche_005_release_blocker_status": "still_blocking_pending_status_adjudication_packet",
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_DOCUMENTATION_PACKET_RESULT_REVIEW",
        ...
        "candidate_next_targets": [
            {
                ...
                "decision": "selected",
                "reason": (
                    "The tranche 005 documentation packet is accepted as documentation, so "
        ...
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 005 documentation packet result review "
            "accepts the documentation surface and authorizes only remediation status adjudication "
            "packet preparation. It does not clear tranche 005, move tranche 005, move retained "
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Generate the v0.1-alpha dependency remediation tranche 005 documentation packet "
            "result review."
        )
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_005_documentation_packet_result_review_report: "
