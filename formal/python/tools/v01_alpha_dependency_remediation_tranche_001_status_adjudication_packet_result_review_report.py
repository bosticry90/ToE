...
OUTCOME_ID = (
    "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_STATUS_ADJUDICATION_PACKET_RESULT_REVIEW_"
...
EXPECTED_PACKET_ID = "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_STATUS_ADJUDICATION_PACKET_v0"
...
NEXT_TARGET = "execute_v01_alpha_dependency_remediation_tranche_001_status_adjudication"
...
def build_result_review(
    *,
    ...
    return {
        ...
        if accepted
        else "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_STATUS_ADJUDICATION_PACKET_RESULT_REVIEW_BLOCKED",
        ...
        if accepted
        else "REMEDIATE_V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_STATUS_ADJUDICATION_PACKET_RESULT_REVIEW",
        ...
        "candidate_next_targets": [
            {
                "target": NEXT_TARGET,
                "decision": "selected",
                "reason": "The status question preparation is accepted, so the narrow status adjudication execution can proceed.",
            },
            {
            ...
            },
            {
                ...
                "decision": "deferred",
                "reason": "Release-readiness adjudication remains blocked by tranche 001 status execution and five other blockers.",
            },
        ],
        "acceptance_criteria": acceptance_criteria,
        "non_claim_boundary": (
            "The v0.1-alpha dependency remediation tranche 001 status adjudication packet result "
            ...
            "tranche 001, assemble the release packet, mark v0.1-alpha readiness, discharge Lean "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "v01_alpha_dependency_remediation_tranche_001_status_adjudication_packet_result_review_report: "
