...
def test_rl13_lock_markdown_matches_record() -> None:
    repo_root = Path(__file__).resolve().parents[3]
    lock_path = repo_root / "formal" / "markdown" / "locks" / "observables" / "OV-RL-13_velocity_addition_group_law_v0.md"

    rec = rl13_velocity_addition_group_law_v0_record(date="2026-02-09", tolerance_profile="pinned")
    expected = render_rl13_lock_markdown(rec)
