...
def test_ct09_lock_markdown_matches_record() -> None:
    repo_root = Path(__file__).resolve().parents[3]
    lock_path = repo_root / "formal" / "markdown" / "locks" / "observables" / "CT-09_independent_external_anchor_sound_speed_v0.md"

    rec = ct09_independent_external_anchor_sound_speed_v0_record(date="2026-02-11", tolerance_profile="pinned")
    expected = render_ct09_lock_markdown(rec)
