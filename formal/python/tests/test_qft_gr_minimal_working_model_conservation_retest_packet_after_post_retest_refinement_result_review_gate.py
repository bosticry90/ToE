...
from formal.python.tools.qft_gr_minimal_working_model_conservation_retest_packet_after_post_retest_refinement_result_review_report import (
    ...
    REVIEW_ID,
    SCHEMA_ID,
    build_qft_gr_minimal_working_model_conservation_retest_packet_after_post_retest_refinement_result_review,
)
...
TOOL_PATH = (
    ...
    / (
        ...
        "retest_refinement_result_review_report.py"
    )
)
LEAN_REVIEW_PATH = (
    REPO_ROOT
...
def test_post_retest_refinement_conservation_retest_packet_result_review_accepts_protocol() -> None:
    review = _json(DEFAULT_OUT)
    ...
    delta = review["post_retest_refinement_delta"]
...
def test_post_retest_refinement_conservation_retest_packet_result_review_updates_live_target() -> None:
    ...
    assert (
        review_workstream["bounded_conservation_retest_attempt_authorized"]
        == "yes"
    )
    assert (
    ...
    assert (
        active_workstream[
            "post_retest_refinement_conservation_retest_packet_result_review_consumed"
        ]
        == "yes"
    )
...
def test_post_retest_refinement_conservation_retest_packet_result_review_deterministic() -> None:
    review = _json(DEFAULT_OUT)
    generated = build_qft_gr_minimal_working_model_conservation_retest_packet_after_post_retest_refinement_result_review(
...
def test_post_retest_refinement_conservation_retest_packet_result_review_not_manifest_enrolled() -> None:
    assert_focused_gate_not_manifest_enrolled(
        "test_qft_gr_minimal_working_model_conservation_retest_packet_after_post_retest_refinement_result_review_gate.py"
    )
