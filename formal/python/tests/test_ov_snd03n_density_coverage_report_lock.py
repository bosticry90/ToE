...
def test_ov_snd03n_density_coverage_report_lock_matches_computed_record() -> None:
    rec = ovsnd03n_density_coverage_report_record(date="2026-01-24")
    ...
    lock_path = (
        ...
        / "locks"
        / "observables"
        / "OV-SND-03N_density_coverage_report.md"
    )
    ...
    assert locked["observable_id"] == "OV-SND-03N-COV"
    assert locked["decision"]["n_density_conditions_supported"] >= 1
