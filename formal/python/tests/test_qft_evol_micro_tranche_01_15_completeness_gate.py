...
TRANCHE_GATE_PATH = "formal/python/tests/test_qft_evol_micro_tranche_01_15_completeness_gate.py"
LEGACY_TRANCHE_GATE_PATH = "formal/python/tests/test_qft_evol_micro_tranche_01_14_completeness_gate.py"
...
def test_qft_evol_umbrella_contains_micro_tranche_01_15_in_order() -> None:
