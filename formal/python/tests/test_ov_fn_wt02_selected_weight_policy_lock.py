...
def test_ov_fn_wt02_selected_weight_policy_lock_exists_and_blocked_by_default() -> None:
    lock_path = (
        REPO_ROOT
        / "formal"
        / "markdown"
    ...
    assert locked["schema"] == "OV-FN-WT-02_selected_weight_policy/v1"
    assert locked["observable_id"] == "OV-FN-WT-02"
