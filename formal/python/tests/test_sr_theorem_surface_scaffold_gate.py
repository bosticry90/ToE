...
def test_sr_theorem_surface_tokens_are_synced_in_state_and_results() -> None:
    ...
    results_tokens = [
        "TOE-SR-THM-01",
        "`T-PROVED`",
        "cycles 14-48 remain synchronized, cycles 49-60 phase-execution locks are pinned, cycles 61-67 closure-gap execution locks are pinned, and cycles 68-74 discharge-closure and promotion-transition locks are pinned",
        ...
        "No external truth claim beyond bounded theorem scope.",
    ]
...
def test_sr_roadmap_active_row_includes_theorem_surface_target() -> None:
    ...
    required_tokens = [
        "| `PILLAR-SR` | `CLOSED` | `TARGET-SR-COV-PLAN;TARGET-SR-COV-THEOREM-SURFACE-PLAN;TARGET-SR-DERIV-COMPLETENESS-GATE-PLAN;TARGET-SR-FULL-DERIVATION-ENFORCEMENT-ROADMAP-PLAN`",
