...
TRANCHE_GATE_PATH = "formal/python/tests/test_qft_evol_micro_tranche_01_05_completeness_gate.py"
...
def test_qft_evol_umbrella_contains_micro_tranche_01_05_in_order() -> None:
