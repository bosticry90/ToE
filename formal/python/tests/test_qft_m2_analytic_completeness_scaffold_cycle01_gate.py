...
def test_qft_m2_analytic_completeness_scaffold_cycle01_gate() -> None:
    ...
    assert _extract_token(qft_text, "QFT_M2_ANALYTIC_COMPLETENESS_STATUS_v0") == "SCAFFOLD_PINNED_NONCLAIM"
    assert _extract_token(state_text, "QFT_M2_ANALYTIC_COMPLETENESS_STATUS_v0") == "SCAFFOLD_PINNED_NONCLAIM"
    assert _extract_token(roadmap_text, "QFT_M2_ANALYTIC_COMPLETENESS_STATUS_v0") == "SCAFFOLD_PINNED_NONCLAIM"
