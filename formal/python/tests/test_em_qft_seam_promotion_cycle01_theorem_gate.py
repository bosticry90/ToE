...
TARGET_PATH = REPO_ROOT / "formal" / "docs" / "paper" / "DERIVATION_TARGET_EM_QFT_CLASS_B_SEAM_PROMOTION_CYCLE01_v0.md"
...
THEOREM_POINTER_SYMBOL = "em_qft_seam_cycle01_theorem_pointer"
...
def test_em_qft_cycle01_theorem_pointer_is_cross_surface_pinned() -> None:
    ...
    assert "EM_QFT_CLASS_B_PROMOTION_CYCLE01_THEOREM_STATUS_v0: THEOREM_POINTER_PINNED_v0_NONCLAIM" in target_text
