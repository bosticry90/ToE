...
from formal.python.tools.psi_A_gauge_sector_exchange_theorem_linkage_attempt_from_sourced_maxwell_route_execution_result_review_report import (
    ...
    build_psi_A_gauge_sector_exchange_theorem_linkage_attempt_from_sourced_maxwell_route_execution_result_review,
)
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "psi_A_gauge_sector_exchange_theorem_linkage_attempt_from_sourced_maxwell_route_execution_result_review_report.py"
)
...
def test_psi_A_gauge_exchange_attempt_execution_result_review_files_exist() -> None:
    for path in [
        EXECUTION_PATH,
        DEFAULT_OUT,
        TOOL_PATH,
...
def test_psi_A_gauge_exchange_attempt_execution_result_review_accepts_route() -> None:
...
def test_psi_A_gauge_exchange_attempt_execution_result_review_records_scope() -> None:
    review = _json(DEFAULT_OUT)
...
def test_psi_A_gauge_exchange_attempt_execution_result_review_records_lean_status() -> None:
    review = _json(DEFAULT_OUT)
...
def test_psi_A_gauge_exchange_attempt_execution_result_review_rotates_to_closeout() -> None:
...
def test_psi_A_gauge_exchange_attempt_execution_result_review_mirrors() -> None:
    ...
    for token in [
        ...
        STRICT_REVIEW_RESULT,
        PACKET_CLASSIFICATION,
        "PsiAGaugeSectorExchangeTheoremLinkageAttemptFromSourcedMaxwellRouteExecutionResultReview",
        CONSUMED_TARGET,
        NEXT_TARGET,
        NEXT_TARGET_KIND,
        CLOSEOUT_OUTCOME,
        ...
        ROUTE_STATEMENT,
        LEAN_STATUS_WORDING_FOR_REVIEW,
        "PSI_A_GAUGE_SECTOR_EXCHANGE_THEOREM_LINKAGE_ATTEMPT_FROM_"
        "SOURCED_MAXWELL_ROUTE_EXECUTION_RESULT_REVIEW_OUTCOME_v0",
        "PSI_A_GAUGE_SECTOR_EXCHANGE_THEOREM_LINKAGE_ATTEMPT_FROM_"
        "SOURCED_MAXWELL_ROUTE_EXECUTION_RESULT_REVIEW_NONCLAIM_BOUNDARY_v0",
...
def test_psi_A_gauge_exchange_attempt_execution_result_review_not_manifest_enrolled() -> None:
    assert_focused_gate_not_manifest_enrolled(
        "test_psi_A_gauge_sector_exchange_theorem_linkage_attempt_from_sourced_maxwell_route_execution_result_review_gate.py"
    )
