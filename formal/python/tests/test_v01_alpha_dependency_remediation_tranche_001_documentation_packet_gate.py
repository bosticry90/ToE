...
from formal.python.tools.v01_alpha_dependency_remediation_tranche_001_documentation_packet_report import (
...
RESULT_REVIEW_PATH = (
    RELEASE_DIR
    / "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_RELEASE_POLICY_ADJUDICATION_RESULT_REVIEW_20260515_v0.json"
)
PACKET_PATH = (
    RELEASE_DIR
    / "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_DOCUMENTATION_PACKET_20260515_v0.json"
)
DOCUMENTATION_PATH = (
    PAPER_DIR / "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_DOCUMENTATION_v0.md"
)
TOOL_PATH = (
    REPO_ROOT
    / "formal"
    / "python"
    / "tools"
    / "v01_alpha_dependency_remediation_tranche_001_documentation_packet_report.py"
)
...
LEAN_PACKET_PATH = (
    ...
    / "ToeFormal"
    / "Release"
    / "V01DependencyRemediationTranche001DocumentationPacket.lean"
)
...
def test_v01_alpha_dependency_remediation_tranche_001_documentation_packet_files_exist() -> None:
...
def test_v01_alpha_dependency_remediation_tranche_001_documentation_packet_consumes_result_review() -> None:
    packet = _json(PACKET_PATH)
    assert packet["schema_id"] == (
        "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_DOCUMENTATION_PACKET_20260515_v0"
    )
    ...
    assert packet["consumes_result_review_pointer"] == (
        "formal/docs/release/V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_RELEASE_POLICY_ADJUDICATION_RESULT_REVIEW_20260515_v0.json"
    )


def test_v01_alpha_dependency_remediation_tranche_001_documentation_packet_preserves_selected_dependency() -> None:
    packet = _json(PACKET_PATH)
    assert packet["packet_scope"] == (
        "PREPARE_TRANCHE_001_DOCUMENTATION_PACKET_ONLY_NO_BLOCKER_CLEARANCE_OR_RELEASE_PROMOTION"
    )
...
def test_v01_alpha_dependency_remediation_tranche_001_documentation_packet_preserves_evidence() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_001_documentation_packet_documentation_surface() -> None:
    packet = _json(PACKET_PATH)
    ...
    assert packet["documentation_surface"] == {
        "surface": "formal/docs/paper/V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_DOCUMENTATION_v0.md",
    ...
    assert "does not discharge Lean theorem debt or proof debt" in documentation


def test_v01_alpha_dependency_remediation_tranche_001_documentation_packet_prepares_only() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_001_documentation_packet_other_five_unmodified() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_001_documentation_packet_forbidden_effects_false() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_001_documentation_packet_next_target() -> None:
    packet = _json(PACKET_PATH)
    ...
    assert packet["next_action_scope"] == (
        "REVIEW_TRANCHE_001_DOCUMENTATION_PACKET_RESULT_ONLY_NO_BLOCKER_MOVEMENT_OR_RELEASE_PROMOTION"
    )
    assert {row["target"]: row["decision"] for row in packet["candidate_next_targets"]} == {
        "review_v01_alpha_dependency_remediation_tranche_001_documentation_packet_result": "selected",
...
def test_v01_alpha_dependency_remediation_tranche_001_documentation_packet_acceptance_and_determinism() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_001_documentation_packet_is_pinned() -> None:
    ...
    refs = [
        ...
        "formal/python/tools/v01_alpha_dependency_remediation_tranche_001_documentation_packet_report.py",
        "formal/python/tests/test_v01_alpha_dependency_remediation_tranche_001_documentation_packet_gate.py",
        OUTCOME_ID,
        NEXT_TARGET,
    ]
    for ref in refs:
    ...
    assert "V01DependencyRemediationTranche001DocumentationPacket" in index_text
    assert "v01_dependency_remediation_tranche_001_documentation_packet_does_not_clear_blocker" in index_text
