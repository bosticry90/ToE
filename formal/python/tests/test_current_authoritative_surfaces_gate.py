...
def test_current_authoritative_surfaces_index_records_live_authority_chain() -> None:
    ...
    for token in {
        ...
        "CURRENT_LIVE_NEXT_TARGET_v0: review_calc_scalar_stress_energy_covariant_divergence_identity_multi_background_robustness_v0_result",
        "PREVIOUS_LIVE_NEXT_TARGET_v0: execute_calc_scalar_stress_energy_covariant_divergence_identity_multi_background_robustness_v0",
        "ACTIVE_LANE_v0: review_calc_scalar_stress_energy_covariant_divergence_identity_multi_background_robustness_v0_result",
        "CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/toe_formal/ToeFormal/Derivation/ScalarStressEnergyCovariantDivergenceIdentityMultiBackgroundRobustnessCalculationExecution.lean",
        "CURRENT_LIVE_TARGET_REPORT_v0: formal/docs/release/SCALAR_STRESS_ENERGY_COVARIANT_DIVERGENCE_IDENTITY_MULTI_BACKGROUND_ROBUSTNESS_CALCULATION_EXECUTION_20260710_v0.json",
        "CURRENT_LIVE_TARGET_OUTCOME_v0: CALC_SCALAR_STRESS_ENERGY_COVARIANT_DIVERGENCE_IDENTITY_MULTI_BACKGROUND_ROBUSTNESS_EXECUTED_CLOSED_FOUR_BACKGROUND_FAMILY_CANDIDATE_E_REPRO_PENDING_INDEPENDENT_REVIEW",
        "CURRENT_LIVE_TARGET_STRICT_OUTCOME_v0: CALC_SCALAR_STRESS_ENERGY_COVARIANT_DIVERGENCE_IDENTITY_MULTI_BACKGROUND_ROBUSTNESS_EXECUTED_LEVEL3_CLOSED_ENUMERATED_FIXED_BACKGROUND_FAMILY_ONLY_NO_THEOREM_STATISTICAL_OR_ARBITRARY_BACKGROUND_GENERALIZATION",
        "CURRENT_LIVE_TARGET_KIND_v0: scalar_stress_energy_covariant_divergence_identity_multi_background_robustness_calculation_result_review",
