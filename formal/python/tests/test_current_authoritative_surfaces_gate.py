...
def test_current_authoritative_surfaces_index_records_live_authority_chain() -> None:
    ...
    for token in {
        ...
        "CURRENT_LIVE_TARGET_REPORT_v0: formal/docs/release/QFT_GR_RENORMALIZED_EXPECTATION_FINITENESS_ASSUMPTION_REDUCTION_ATTEMPT_RESULT_REVIEW_20260606_v0.json",
        "CURRENT_LIVE_TARGET_OUTCOME_v0: QFT_GR_RENORMALIZED_EXPECTATION_FINITENESS_ASSUMPTION_REDUCTION_ATTEMPT_RESULT_REVIEW_ACCEPTS_REDUCED_FINITE_REGULAR_BOUNDARY_AND_AUTHORIZES_NEXT_RENORMALIZATION_ROW_SELECTION_ONLY",
