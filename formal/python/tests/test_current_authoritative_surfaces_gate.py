...
def test_current_authoritative_surfaces_index_records_live_authority_chain() -> None:
    ...
    for token in {
        ...
        "CURRENT_LIVE_NEXT_TARGET_v0: review_pillar_seam_unit_mapping_ledger_blocker_response_route_selection_packet_v1_result",
        "PREVIOUS_LIVE_NEXT_TARGET_v0: prepare_pillar_seam_unit_mapping_ledger_blocker_response_route_selection_packet_v1",
        "ACTIVE_LANE_v0: review_pillar_seam_unit_mapping_ledger_blocker_response_route_selection_packet_v1_result",
        "CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/toe_formal/ToeFormal/Derivation/PillarSeamUnitMappingLedgerBlockerResponseRouteSelectionPacketV1.lean",
        "CURRENT_LIVE_TARGET_REPORT_v0: formal/docs/release/PILLAR_SEAM_UNIT_MAPPING_LEDGER_BLOCKER_RESPONSE_ROUTE_SELECTION_PACKET_20260712_v1.json",
        "CURRENT_LIVE_TARGET_OUTCOME_v0: TWELVE_UNIT_BLOCKERS_RECOMPUTED_AND_ROUTED_ONCE_FROM_EXACT_SOURCE_ATTRIBUTION_WITHOUT_UNIT_ASSIGNMENT_OR_DIMENSIONAL_RESOLUTION_PENDING_INDEPENDENT_REVIEW",
        "CURRENT_LIVE_TARGET_STRICT_OUTCOME_v0: SOURCE_ATTRIBUTION_CORRECTION_AND_ROUTE_SELECTION_ONLY_NO_DIMENSIONAL_CLOSURE_NO_PILLAR_COMPLETION_NO_SEAM_ADMISSIBILITY_NO_LEVEL4_OR5_NO_PHYSICAL_CALIBRATION_NO_CROSS_SECTOR_COUPLING_VALIDATION_NO_CK_ACTION_EMBEDDING_NO_CCFT_NO_MASTER_ACTION_PROMOTION",
        "CURRENT_LIVE_TARGET_KIND_v0: pillar_seam_unit_mapping_ledger_blocker_response_route_selection_packet_v1_result_review",
