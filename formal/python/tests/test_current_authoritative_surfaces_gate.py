...
def test_current_authoritative_surfaces_index_records_live_authority_chain() -> None:
    ...
    for token in {
        ...
        "CURRENT_LIVE_NEXT_TARGET_v0: prepare_selected_ccft_empirical_discriminator_baseline_component_equation_source_applicability_gap_resolution_open_system_decoherence_superconducting_circuit_qed_platform_requirement_refinement_packet",
        "PREVIOUS_LIVE_NEXT_TARGET_v0: review_selected_ccft_empirical_discriminator_baseline_component_equation_source_applicability_gap_resolution_open_system_decoherence_platform_narrowing_candidate_selection_packet_result",
        "ACTIVE_LANE_v0: prepare_selected_ccft_empirical_discriminator_baseline_component_equation_source_applicability_gap_resolution_open_system_decoherence_superconducting_circuit_qed_platform_requirement_refinement_packet",
        "CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/toe_formal/ToeFormal/Derivation/SelectedCCFTOpenSystemDecoherencePlatformNarrowingCandidateSelectionPacketResultReview.lean",
        "CURRENT_LIVE_TARGET_REPORT_v0: formal/docs/release/SELECTED_CCFT_OPEN_SYSTEM_DECOHERENCE_PLATFORM_NARROWING_CANDIDATE_SELECTION_PACKET_RESULT_REVIEW_20260708_v0.json",
        ...
        "CURRENT_LIVE_TARGET_STRICT_OUTCOME_v0: SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_SOURCE_PLATFORM_NARROWING_CANDIDATE_SELECTION_PACKET_RESULT_REVIEW_ACCEPTS_CANDIDATE_SELECTION_ONLY_NO_SOURCE_VALIDATION_NO_LINDBLAD_IMPORT_NO_TAU_BASELINE_COMPUTATION_NO_MASTER_ACTION_PROMOTION",
