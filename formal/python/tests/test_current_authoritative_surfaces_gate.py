...
def test_current_authoritative_surfaces_index_records_live_authority_chain() -> None:
    ...
    for token in {
        ...
        "CURRENT_LIVE_NEXT_TARGET_v0: execute_calc_scalar_stress_energy_divergence_identity_minkowski_v0",
        "PREVIOUS_LIVE_NEXT_TARGET_v0: prepare_scalar_qft_gr_source_contract_flat_limit_pretest_guardrail_packet",
        "ACTIVE_LANE_v0: execute_calc_scalar_stress_energy_divergence_identity_minkowski_v0",
        "CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/toe_formal/ToeFormal/Derivation/ScalarQFTGRSourceContractFlatLimitPretestGuardrailPacket.lean",
        "CURRENT_LIVE_TARGET_REPORT_v0: formal/docs/release/SCALAR_QFT_GR_SOURCE_CONTRACT_FLAT_LIMIT_PRETEST_GUARDRAIL_PACKET_20260709_v0.json",
        "CURRENT_LIVE_TARGET_OUTCOME_v0: SCALAR_QFT_GR_SOURCE_CONTRACT_FLAT_LIMIT_PRETEST_GUARDRAIL_PACKET_PREPARED_AUTHORIZES_MINKOWSKI_STRESS_ENERGY_DIVERGENCE_IDENTITY_CALCULATION_ONLY",
        "CURRENT_LIVE_TARGET_STRICT_OUTCOME_v0: SCALAR_QFT_GR_SOURCE_CONTRACT_FLAT_LIMIT_PRETEST_GUARDRAIL_PACKET_PREPARED_LEVEL_3_PRETEST_ONLY_NO_GRAVITY_DYNAMICS_NO_SOURCE_ADMISSIBILITY_NO_SEAM_ADMISSIBILITY_OR_MASTER_ACTION_PROMOTION",
