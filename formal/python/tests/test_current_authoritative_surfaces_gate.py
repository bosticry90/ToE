...
def test_current_authoritative_surfaces_index_records_live_authority_chain() -> None:
    ...
    for token in {
        ...
        "CURRENT_LIVE_NEXT_TARGET_v0: prepare_pillar_seam_unit_mapping_ledger_blocker_response_route_selection_packet",
        "PREVIOUS_LIVE_NEXT_TARGET_v0: execute_pillar_seam_unit_mapping_ledger_v0",
        "ACTIVE_LANE_v0: prepare_pillar_seam_unit_mapping_ledger_blocker_response_route_selection_packet",
        "CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/toe_formal/ToeFormal/Derivation/PillarSeamUnitMappingLedgerResultReview.lean",
        "CURRENT_LIVE_TARGET_REPORT_v0: formal/docs/release/PILLAR_SEAM_UNIT_MAPPING_LEDGER_RESULT_REVIEW_20260712_v0.json",
        "CURRENT_LIVE_TARGET_OUTCOME_v0: PILLAR_SEAM_UNIT_MAPPING_LEDGER_RESULT_REVIEW_ACCEPTS_REPRODUCIBLE_TWELVE_ROW_BLOCKER_PRESERVING_AUDIT_AND_AUTHORIZES_BLOCKER_RESPONSE_ROUTE_SELECTION_PACKET_PREPARATION_ONLY",
        "CURRENT_LIVE_TARGET_STRICT_OUTCOME_v0: PILLAR_SEAM_UNIT_MAPPING_LEDGER_RESULT_REVIEW_ACCEPTS_AUDIT_ONLY_NO_UNIT_CLOSURE_NO_PILLAR_COMPLETION_NO_SEAM_ADMISSIBILITY_NO_LEVEL4OR5_NO_CK_ACTION_EMBEDDING_NO_CCFT_NO_MASTER_ACTION_PROMOTION",
        "CURRENT_LIVE_TARGET_KIND_v0: pillar_seam_unit_mapping_ledger_blocker_response_route_selection_packet",
