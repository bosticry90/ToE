...
def test_current_authoritative_surfaces_index_records_live_authority_chain() -> None:
    ...
    for token in {
        ...
        "CURRENT_LIVE_NEXT_TARGET_v0: execute_pillar_seam_unit_mapping_ledger_v0",
        "PREVIOUS_LIVE_NEXT_TARGET_v0: prepare_pillar_seam_unit_mapping_ledger_guardrail_packet",
        "ACTIVE_LANE_v0: execute_pillar_seam_unit_mapping_ledger_v0",
        "CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/toe_formal/ToeFormal/Derivation/PillarSeamUnitMappingLedgerGuardrailPacket.lean",
        "CURRENT_LIVE_TARGET_REPORT_v0: formal/docs/release/PILLAR_SEAM_UNIT_MAPPING_LEDGER_GUARDRAIL_PACKET_20260710_v0.json",
        "CURRENT_LIVE_TARGET_OUTCOME_v0: PILLAR_SEAM_UNIT_MAPPING_LEDGER_GUARDRAIL_PACKET_PREPARED_AUTHORIZES_BOUNDED_TWELVE_ROW_UNIT_MAPPING_LEDGER_CONSTRUCTION_ONLY",
        "CURRENT_LIVE_TARGET_STRICT_OUTCOME_v0: PILLAR_SEAM_UNIT_MAPPING_LEDGER_GUARDRAIL_PACKET_PREPARED_AUDIT_ONLY_NO_UNIT_CLOSURE_NO_PILLAR_OR_SEAM_ADMISSIBILITY_NO_LEVEL4_OR5_NO_CK_ACTION_EMBEDDING_NO_MASTER_ACTION_PROMOTION",
        "CURRENT_LIVE_TARGET_KIND_v0: pillar_seam_unit_mapping_ledger_execution",
