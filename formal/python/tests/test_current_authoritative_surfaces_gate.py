...
def test_current_authoritative_surfaces_index_records_live_authority_chain() -> None:
    ...
    for token in {
        ...
        "CURRENT_LIVE_NEXT_TARGET_v0: review_selected_ccft_empirical_discriminator_baseline_component_equation_source_applicability_gap_resolution_open_system_decoherence_superconducting_circuit_qed_platform_source_candidate_rescreening_packet_result",
        "PREVIOUS_LIVE_NEXT_TARGET_v0: prepare_selected_ccft_empirical_discriminator_baseline_component_equation_source_applicability_gap_resolution_open_system_decoherence_superconducting_circuit_qed_platform_source_candidate_rescreening_packet",
        "ACTIVE_LANE_v0: review_selected_ccft_empirical_discriminator_baseline_component_equation_source_applicability_gap_resolution_open_system_decoherence_superconducting_circuit_qed_platform_source_candidate_rescreening_packet_result",
        "CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/toe_formal/ToeFormal/Derivation/SelectedCCFTOpenSystemDecoherenceSuperconductingCircuitQEDPlatformSourceCandidateRescreeningPacket.lean",
        "CURRENT_LIVE_TARGET_REPORT_v0: formal/docs/release/SELECTED_CCFT_OPEN_SYSTEM_DECOHERENCE_SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_SOURCE_CANDIDATE_RESCREENING_PACKET_20260709_v0.json",
        ...
        "CURRENT_LIVE_TARGET_STRICT_OUTCOME_v0: SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_SOURCE_SUPERCONDUCTING_CIRCUIT_QED_SOURCE_CANDIDATE_RESCREENING_PACKET_PREPARED_RESCREENING_ONLY_NO_LINDBLAD_IMPORT_NO_TAU_BASELINE_COMPUTATION_NO_MASTER_ACTION_PROMOTION",
