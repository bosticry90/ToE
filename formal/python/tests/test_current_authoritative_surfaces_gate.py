...
def test_current_authoritative_surfaces_index_records_live_authority_chain() -> None:
    ...
    for token in {
        ...
        "CURRENT_LIVE_NEXT_TARGET_v0: execute_calc_scalar_stress_energy_covariant_divergence_identity_conformal_background_v0",
        "PREVIOUS_LIVE_NEXT_TARGET_v0: prepare_bounded_curved_space_scalar_qft_gr_source_contract_retest_guardrail_packet",
        "ACTIVE_LANE_v0: execute_calc_scalar_stress_energy_covariant_divergence_identity_conformal_background_v0",
        "CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/toe_formal/ToeFormal/Derivation/BoundedCurvedSpaceScalarQFTGRSourceContractRetestGuardrailPacket.lean",
        "CURRENT_LIVE_TARGET_REPORT_v0: formal/docs/release/BOUNDED_CURVED_SPACE_SCALAR_QFT_GR_SOURCE_CONTRACT_RETEST_GUARDRAIL_PACKET_20260709_v0.json",
        "CURRENT_LIVE_TARGET_OUTCOME_v0: BOUNDED_CURVED_SPACE_SCALAR_QFT_GR_SOURCE_CONTRACT_RETEST_GUARDRAIL_PACKET_PREPARED_AUTHORIZES_FIXED_CONFORMAL_BACKGROUND_COVARIANT_DIVERGENCE_IDENTITY_CALCULATION_ONLY",
        "CURRENT_LIVE_TARGET_STRICT_OUTCOME_v0: BOUNDED_CURVED_SPACE_SCALAR_QFT_GR_SOURCE_CONTRACT_RETEST_GUARDRAIL_PACKET_PREPARED_LEVEL_3_FIXED_BACKGROUND_PRETEST_ONLY_NO_GRAVITY_EVOLUTION_NO_SOURCE_ADMISSIBILITY_NO_BIANCHI_OR_SEAM_ADMISSIBILITY_NO_MASTER_ACTION_PROMOTION",
