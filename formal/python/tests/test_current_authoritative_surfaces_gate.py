...
def test_current_authoritative_surfaces_index_records_live_authority_chain() -> None:
    ...
    for token in {
        ...
        "CURRENT_LIVE_NEXT_TARGET_v0: execute_calc_scalar_stress_energy_covariant_divergence_identity_multi_background_robustness_v0",
        "PREVIOUS_LIVE_NEXT_TARGET_v0: prepare_scalar_stress_energy_covariant_divergence_identity_multi_background_robustness_guardrail_packet",
        "ACTIVE_LANE_v0: execute_calc_scalar_stress_energy_covariant_divergence_identity_multi_background_robustness_v0",
        "CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/toe_formal/ToeFormal/Derivation/ScalarStressEnergyCovariantDivergenceIdentityMultiBackgroundRobustnessGuardrailPacket.lean",
        "CURRENT_LIVE_TARGET_REPORT_v0: formal/docs/release/SCALAR_STRESS_ENERGY_COVARIANT_DIVERGENCE_IDENTITY_MULTI_BACKGROUND_ROBUSTNESS_GUARDRAIL_PACKET_20260710_v0.json",
        "CURRENT_LIVE_TARGET_OUTCOME_v0: SCALAR_STRESS_ENERGY_COVARIANT_DIVERGENCE_IDENTITY_MULTI_BACKGROUND_ROBUSTNESS_GUARDRAIL_PACKET_PREPARED_AUTHORIZES_BOUNDED_FOUR_BACKGROUND_EVIDENCE_SYNTHESIS_ONLY",
        "CURRENT_LIVE_TARGET_STRICT_OUTCOME_v0: SCALAR_STRESS_ENERGY_COVARIANT_DIVERGENCE_IDENTITY_MULTI_BACKGROUND_ROBUSTNESS_GUARDRAIL_PACKET_PREPARED_LEVEL3_CLOSED_FAMILY_FIXED_BACKGROUND_SYNTHESIS_ONLY_NO_NEW_PDE_SOLVE_NO_GENERAL_THEOREM_NO_PILLAR_SOURCE_BIANCHI_SEAM_OR_MASTER_ACTION_PROMOTION",
        "CURRENT_LIVE_TARGET_KIND_v0: scalar_stress_energy_covariant_divergence_identity_multi_background_robustness_calculation_execution",
