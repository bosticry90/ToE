...
def test_current_authoritative_surfaces_index_records_live_authority_chain() -> None:
    ...
    for token in {
        ...
        "CURRENT_LIVE_NEXT_TARGET_v0: prepare_scalar_qft_gr_source_contract_flat_limit_pretest_guardrail_packet",
        "PREVIOUS_LIVE_NEXT_TARGET_v0: review_science_first_pillar_seam_dependency_rebase_packet_result",
        "ACTIVE_LANE_v0: prepare_scalar_qft_gr_source_contract_flat_limit_pretest_guardrail_packet",
        "CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/toe_formal/ToeFormal/Derivation/ScienceFirstPillarSeamDependencyRebasePacketResultReview.lean",
        "CURRENT_LIVE_TARGET_REPORT_v0: formal/docs/release/SCIENCE_FIRST_PILLAR_SEAM_DEPENDENCY_REBASE_PACKET_RESULT_REVIEW_20260709_v0.json",
        "CURRENT_LIVE_TARGET_OUTCOME_v0: SCIENCE_FIRST_PILLAR_SEAM_DEPENDENCY_REBASE_PACKET_RESULT_REVIEW_ACCEPTS_COMPACT_SCIENCE_SPRINT_READINESS_AUTHORITY_AND_SELECTS_FLAT_LIMIT_PRETEST_ONLY",
        "CURRENT_LIVE_TARGET_STRICT_OUTCOME_v0: SCIENCE_FIRST_PILLAR_SEAM_DEPENDENCY_REBASE_PACKET_RESULT_REVIEW_ACCEPTS_READINESS_CLASSIFICATION_ONLY_NO_QFT_GR_SEAM_ADMISSIBILITY_NO_MASTER_ACTION_PROMOTION",
