...
def test_current_authoritative_surfaces_index_records_live_authority_chain() -> None:
    ...
    for token in {
        ...
        "CURRENT_LIVE_NEXT_TARGET_v0: review_science_first_pillar_seam_dependency_rebase_packet_result",
        "PREVIOUS_LIVE_NEXT_TARGET_v0: prepare_science_first_pillar_seam_dependency_rebase_packet",
        "ACTIVE_LANE_v0: review_science_first_pillar_seam_dependency_rebase_packet_result",
        "CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/toe_formal/ToeFormal/Derivation/ScienceFirstPillarSeamDependencyRebasePacket.lean",
        "CURRENT_LIVE_TARGET_REPORT_v0: formal/docs/release/SCIENCE_FIRST_PILLAR_SEAM_DEPENDENCY_REBASE_PACKET_20260709_v0.json",
        "CURRENT_LIVE_TARGET_OUTCOME_v0: SCIENCE_FIRST_PILLAR_SEAM_DEPENDENCY_REBASE_PACKET_PREPARED_COMPACT_READINESS_AUTHORITY_PENDING_REVIEW_NO_PILLAR_OR_SEAM_CLOSURE",
        "CURRENT_LIVE_TARGET_STRICT_OUTCOME_v0: SCIENCE_FIRST_PILLAR_SEAM_DEPENDENCY_REBASE_PACKET_PREPARED_ENTRY_MATURITY_AND_SEAM_GATES_ONLY_NO_MASTER_ACTION_PROMOTION_OR_CCFT_RESUMPTION",
