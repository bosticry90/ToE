...
def test_current_authoritative_surfaces_index_records_live_authority_chain() -> None:
    ...
    for token in {
        ...
        "CURRENT_LIVE_NEXT_TARGET_v0: prepare_science_first_pillar_seam_dependency_rebase_packet",
        "PREVIOUS_LIVE_NEXT_TARGET_v0: review_calc_ccft_scqed_literature_applicability_matrix_v0_result",
        "ACTIVE_LANE_v0: prepare_science_first_pillar_seam_dependency_rebase_packet",
        "CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/toe_formal/ToeFormal/Derivation/CCFTSCQEDLiteratureApplicabilityMatrixCalculationResultReview.lean",
        "CURRENT_LIVE_TARGET_REPORT_v0: formal/docs/release/CCFT_SCQED_LITERATURE_APPLICABILITY_MATRIX_CALCULATION_RESULT_REVIEW_20260709_v0.json",
        "CURRENT_LIVE_TARGET_OUTCOME_v0: CALC_CCFT_SCQED_LITERATURE_APPLICABILITY_MATRIX_RESULT_REVIEW_ACCEPTS_REPRODUCIBLE_MATRIX_COUNTS_ONLY_NO_SOURCE_VALIDATION_OR_TAU_BASELINE_COMPUTATION",
        "CURRENT_LIVE_TARGET_STRICT_OUTCOME_v0: CALC_CCFT_SCQED_LITERATURE_APPLICABILITY_MATRIX_RESULT_REVIEW_ACCEPTS_SCOPED_E_REPRO_FOR_COUNTS_ONLY_NO_EQUATION_ADOPTION_NO_CCFT_VALIDATION_NO_MASTER_ACTION_PROMOTION",
