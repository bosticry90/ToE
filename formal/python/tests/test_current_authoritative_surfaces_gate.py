...
def test_current_authoritative_surfaces_index_records_live_authority_chain() -> None:
    ...
    for token in {
        ...
        "CURRENT_LIVE_NEXT_TARGET_v0: execute_qft_gr_limit_interchange_regularization_boundary_assumption_reduction_attempt",
        "PREVIOUS_LIVE_NEXT_TARGET_v0: review_qft_gr_limit_interchange_regularization_boundary_assumption_reduction_packet_result",
        "ACTIVE_LANE_v0: review_qft_gr_limit_interchange_regularization_boundary_assumption_reduction_packet_result",
        "CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/toe_formal/ToeFormal/Bridges/QFT_GR_LimitInterchangeRegularizationBoundaryAssumptionReductionPacketResultReview.lean",
        "CURRENT_LIVE_TARGET_REPORT_v0: formal/docs/release/QFT_GR_LIMIT_INTERCHANGE_REGULARIZATION_BOUNDARY_ASSUMPTION_REDUCTION_PACKET_RESULT_REVIEW_20260609_v0.json",
        "CURRENT_LIVE_TARGET_OUTCOME_v0: QFT_GR_LIMIT_INTERCHANGE_REGULARIZATION_BOUNDARY_ASSUMPTION_REDUCTION_PACKET_RESULT_REVIEW_ACCEPTS_PACKET_AND_AUTHORIZES_BOUNDED_MR_ASSUMP_004_ATTEMPT_ONLY",
