...
def test_current_authoritative_surfaces_index_records_live_authority_chain() -> None:
    ...
    for token in {
        ...
        "CURRENT_LIVE_NEXT_TARGET_v0: await_fresh_response_selector_after_v2_nonenrollment_v0",
        "PREVIOUS_LIVE_NEXT_TARGET_v0: prepare_pillar_seam_unit_mapping_ledger_blocker_response_route_selection_packet_v2",
        "ACTIVE_LANE_v0: await_fresh_response_selector_after_v2_nonenrollment_v0",
        "CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/docs/release/V2_ENROLLMENT_DECISION_20260725_v0.json",
        "CURRENT_LIVE_TARGET_REPORT_v0: formal/docs/release/V2_ENROLLMENT_DECISION_20260725_v0.json",
        "CURRENT_LIVE_TARGET_OUTCOME_v0: V2_REPRODUCIBLE_BUT_NOT_ENROLLED_PREPARATION_TARGET_CLOSED_WITHOUT_ACCEPTANCE",
        "CURRENT_LIVE_TARGET_STRICT_OUTCOME_v0: B_BLOCKED_NO_V2_ENROLLMENT_NO_EXECUTABLE_SCIENTIFIC_TARGET_FRESH_RESPONSE_SELECTOR_REQUIRED_NO_SCIENTIFIC_EXECUTION",
        "CURRENT_LIVE_TARGET_KIND_v0: nonexecuting_scientific_target_selection_boundary",
