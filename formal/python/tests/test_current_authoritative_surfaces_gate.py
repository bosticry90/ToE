...
def test_current_authoritative_surfaces_index_records_live_authority_chain() -> None:
    ...
    for token in {
        ...
        "CURRENT_LIVE_NEXT_TARGET_v0: prepare_scalar_stress_energy_covariant_divergence_identity_nonzero_curvature_background_guardrail_packet",
        "PREVIOUS_LIVE_NEXT_TARGET_v0: review_calc_scalar_stress_energy_covariant_divergence_identity_conformal_background_v0_result",
        "ACTIVE_LANE_v0: prepare_scalar_stress_energy_covariant_divergence_identity_nonzero_curvature_background_guardrail_packet",
        "CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/toe_formal/ToeFormal/Derivation/ScalarStressEnergyCovariantDivergenceIdentityConformalBackgroundCalculationResultReview.lean",
        "CURRENT_LIVE_TARGET_REPORT_v0: formal/docs/release/SCALAR_STRESS_ENERGY_COVARIANT_DIVERGENCE_IDENTITY_CONFORMAL_BACKGROUND_CALCULATION_RESULT_REVIEW_20260709_v0.json",
        "CURRENT_LIVE_TARGET_OUTCOME_v0: CALC_SCALAR_STRESS_ENERGY_COVARIANT_DIVERGENCE_IDENTITY_CONFORMAL_BACKGROUND_RESULT_REVIEW_ACCEPTS_REPRODUCIBLE_LOCALLY_FLAT_NONTRIVIAL_CONNECTION_TEST_ONLY_NO_CURVATURE_OR_SOURCE_ADMISSIBILITY_CLAIM",
        "CURRENT_LIVE_TARGET_STRICT_OUTCOME_v0: CALC_SCALAR_STRESS_ENERGY_COVARIANT_DIVERGENCE_IDENTITY_CONFORMAL_BACKGROUND_RESULT_REVIEW_ACCEPTS_SCOPED_E_REPRO_FOR_COVARIANT_CONNECTION_IDENTITY_ONLY_NO_BIANCHI_COMPATIBILITY_NO_QFT_GR_SEAM_ADMISSIBILITY_NO_MASTER_ACTION_PROMOTION",
