...
def test_current_authoritative_surfaces_index_records_live_authority_chain() -> None:
    ...
    for token in {
        ...
        "CURRENT_LIVE_NEXT_TARGET_v0: prepare_bounded_curved_space_scalar_qft_gr_source_contract_retest_guardrail_packet",
        "PREVIOUS_LIVE_NEXT_TARGET_v0: review_calc_scalar_stress_energy_divergence_identity_minkowski_v0_result",
        "ACTIVE_LANE_v0: prepare_bounded_curved_space_scalar_qft_gr_source_contract_retest_guardrail_packet",
        "CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/toe_formal/ToeFormal/Derivation/ScalarStressEnergyDivergenceIdentityMinkowskiCalculationResultReview.lean",
        "CURRENT_LIVE_TARGET_REPORT_v0: formal/docs/release/SCALAR_STRESS_ENERGY_DIVERGENCE_IDENTITY_MINKOWSKI_CALCULATION_RESULT_REVIEW_20260709_v0.json",
        "CURRENT_LIVE_TARGET_OUTCOME_v0: SCALAR_STRESS_ENERGY_DIVERGENCE_IDENTITY_MINKOWSKI_CALCULATION_RESULT_REVIEW_ACCEPTS_LEVEL_3_REPRODUCIBLE_DIVERGENCE_IDENTITY_PRETEST_ONLY",
        "CURRENT_LIVE_TARGET_STRICT_OUTCOME_v0: SCALAR_STRESS_ENERGY_DIVERGENCE_IDENTITY_MINKOWSKI_CALCULATION_RESULT_REVIEW_ACCEPTS_SCOPED_E_REPRO_NO_GRAVITY_DYNAMICS_NO_SOURCE_ADMISSIBILITY_NO_QFT_GR_SEAM_ADMISSIBILITY_OR_MASTER_ACTION_PROMOTION",
