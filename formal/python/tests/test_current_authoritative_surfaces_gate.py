...
def test_current_authoritative_surfaces_index_records_live_authority_chain() -> None:
    ...
    for token in {
        ...
        "CURRENT_LIVE_NEXT_TARGET_v0: review_v01_alpha_retained_tranche_004_bounded_source_map_witness_chain_research_attempt_result",
        "PREVIOUS_LIVE_NEXT_TARGET_v0: execute_v01_alpha_retained_tranche_004_bounded_source_map_witness_chain_research_attempt",
        "ACTIVE_LANE_v0: v01_alpha_retained_tranche_004_bounded_source_map_witness_chain_research_attempt",
        "CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/toe_formal/ToeFormal/Release/V01RetainedTranche004BoundedSourceMapWitnessChainResearchAttempt.lean",
