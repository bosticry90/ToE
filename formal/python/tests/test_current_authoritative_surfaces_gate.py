...
def test_current_authoritative_surfaces_index_records_live_authority_chain() -> None:
    ...
    for token in {
        ...
        "CURRENT_LIVE_NEXT_TARGET_v0: review_calc_scalar_stress_energy_covariant_divergence_identity_conformal_background_v0_result",
        "PREVIOUS_LIVE_NEXT_TARGET_v0: execute_calc_scalar_stress_energy_covariant_divergence_identity_conformal_background_v0",
        "ACTIVE_LANE_v0: review_calc_scalar_stress_energy_covariant_divergence_identity_conformal_background_v0_result",
        "CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/toe_formal/ToeFormal/Derivation/ScalarStressEnergyCovariantDivergenceIdentityConformalBackgroundCalculationExecution.lean",
        "CURRENT_LIVE_TARGET_REPORT_v0: formal/docs/release/SCALAR_STRESS_ENERGY_COVARIANT_DIVERGENCE_IDENTITY_CONFORMAL_BACKGROUND_CALCULATION_EXECUTION_20260709_v0.json",
        "CURRENT_LIVE_TARGET_OUTCOME_v0: SCALAR_STRESS_ENERGY_COVARIANT_DIVERGENCE_IDENTITY_CONFORMAL_BACKGROUND_CALCULATION_EXECUTED_PASSES_LEVEL_3_CONNECTION_COVARIANCE_CONTROLS_PENDING_RESULT_REVIEW",
        "CURRENT_LIVE_TARGET_STRICT_OUTCOME_v0: SCALAR_STRESS_ENERGY_COVARIANT_DIVERGENCE_IDENTITY_CONFORMAL_BACKGROUND_CALCULATION_EXECUTED_SCOPED_E_REPRO_PENDING_REVIEW_LOCALLY_FLAT_BACKGROUND_ONLY_NO_CURVATURE_TEST_NO_SOURCE_ADMISSIBILITY_NO_BIANCHI_OR_SEAM_ADMISSIBILITY_NO_MASTER_ACTION_PROMOTION",
