...
def test_current_authoritative_surfaces_index_records_live_authority_chain() -> None:
    ...
    for token in {
        ...
        "CURRENT_LIVE_NEXT_TARGET_v0: execute_calc_scalar_stress_energy_covariant_divergence_identity_higher_dimensional_curved_background_v0",
        "PREVIOUS_LIVE_NEXT_TARGET_v0: prepare_scalar_stress_energy_covariant_divergence_identity_higher_dimensional_curved_background_guardrail_packet",
        "ACTIVE_LANE_v0: execute_calc_scalar_stress_energy_covariant_divergence_identity_higher_dimensional_curved_background_v0",
        "CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/toe_formal/ToeFormal/Derivation/ScalarStressEnergyCovariantDivergenceIdentityHigherDimensionalCurvedBackgroundGuardrailPacket.lean",
        "CURRENT_LIVE_TARGET_REPORT_v0: formal/docs/release/SCALAR_STRESS_ENERGY_COVARIANT_DIVERGENCE_IDENTITY_HIGHER_DIMENSIONAL_CURVED_BACKGROUND_GUARDRAIL_PACKET_20260709_v1.json",
        "CURRENT_LIVE_TARGET_OUTCOME_v0: SCALAR_STRESS_ENERGY_COVARIANT_DIVERGENCE_IDENTITY_HIGHER_DIMENSIONAL_CURVED_BACKGROUND_GUARDRAIL_PACKET_PREPARED_AUTHORIZES_FIXED_2PLUS1_SPATIALLY_VARYING_WARPED_GEOMETRY_MATTER_IDENTITY_CALCULATION_ONLY",
        "CURRENT_LIVE_TARGET_STRICT_OUTCOME_v0: SCALAR_STRESS_ENERGY_COVARIANT_DIVERGENCE_IDENTITY_HIGHER_DIMENSIONAL_CURVED_BACKGROUND_GUARDRAIL_PACKET_PREPARED_LEVEL_3_FIXED_BACKGROUND_SCOPED_E_REPRO_SPRINT_ONLY_NO_GRAVITY_EVOLUTION_NO_EINSTEIN_SOURCE_NO_BIANCHI_COMPATIBILITY_NO_QFT_GR_SEAM_ADMISSIBILITY_OR_PROMOTION",
        "CURRENT_LIVE_TARGET_KIND_v0: scalar_stress_energy_covariant_divergence_identity_higher_dimensional_curved_background_calculation_execution",
