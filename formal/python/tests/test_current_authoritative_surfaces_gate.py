...
def test_current_authoritative_surfaces_index_records_live_authority_chain() -> None:
    ...
    for token in {
        ...
        "CURRENT_LIVE_NEXT_TARGET_v0: prepare_pillar_seam_unit_mapping_ledger_guardrail_packet",
        "PREVIOUS_LIVE_NEXT_TARGET_v0: review_calc_scalar_stress_energy_covariant_divergence_identity_multi_background_robustness_v0_result",
        "ACTIVE_LANE_v0: prepare_pillar_seam_unit_mapping_ledger_guardrail_packet",
        "CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/toe_formal/ToeFormal/Derivation/ScalarStressEnergyCovariantDivergenceIdentityMultiBackgroundRobustnessCalculationResultReview.lean",
        "CURRENT_LIVE_TARGET_REPORT_v0: formal/docs/release/SCALAR_STRESS_ENERGY_COVARIANT_DIVERGENCE_IDENTITY_MULTI_BACKGROUND_ROBUSTNESS_CALCULATION_RESULT_REVIEW_20260710_v0.json",
        "CURRENT_LIVE_TARGET_OUTCOME_v0: SCALAR_STRESS_ENERGY_COVARIANT_DIVERGENCE_IDENTITY_MULTI_BACKGROUND_ROBUSTNESS_RESULT_REVIEW_ACCEPTS_REPRODUCIBLE_ROBUSTNESS_ACROSS_THE_EXACT_FOUR_ENUMERATED_FIXED_BACKGROUND_EVIDENCE_CHAINS",
        "CURRENT_LIVE_TARGET_STRICT_OUTCOME_v0: SCALAR_STRESS_ENERGY_COVARIANT_DIVERGENCE_IDENTITY_MULTI_BACKGROUND_ROBUSTNESS_RESULT_REVIEW_ACCEPTS_LEVEL3_CLOSED_ENUMERATED_FIXED_BACKGROUND_FIXED_COORDINATE_SHARED_LINEAGE_E_REPRO_ONLY_NO_THEOREM_NO_STATISTICAL_OR_ARBITRARY_BACKGROUND_GENERALIZATION_NO_LEVEL4_OR5",
        "CURRENT_LIVE_TARGET_KIND_v0: pillar_seam_unit_mapping_ledger_guardrail_packet",
