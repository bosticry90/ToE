...
from formal.python.tools.v01_alpha_dependency_remediation_tranche_001_status_adjudication_packet_report import (
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "v01_alpha_dependency_remediation_tranche_001_status_adjudication_packet_report.py"
)
...
LEAN_PACKET_PATH = (
    ...
    / "ToeFormal"
    / "Release"
    / "V01DependencyRemediationTranche001StatusAdjudicationPacket.lean"
)
...
def test_v01_alpha_dependency_remediation_tranche_001_status_adjudication_packet_files_exist() -> None:
...
def test_v01_alpha_dependency_remediation_tranche_001_status_adjudication_packet_consumes_result_review() -> None:
    packet = _json(PACKET_PATH)
    assert packet["schema_id"] == (
        "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_STATUS_ADJUDICATION_PACKET_20260515_v0"
    )
...
def test_v01_alpha_dependency_remediation_tranche_001_status_adjudication_packet_preserves_selected_dependency() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_001_status_adjudication_packet_preserves_evidence_policy_and_documentation() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_001_status_adjudication_packet_defines_question_only() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_001_status_adjudication_packet_keeps_blocker_unmoved() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_001_status_adjudication_packet_other_five_unmodified() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_001_status_adjudication_packet_forbidden_effects_false() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_001_status_adjudication_packet_next_target() -> None:
    packet = _json(PACKET_PATH)
    ...
    assert packet["next_action_scope"] == (
        "REVIEW_TRANCHE_001_STATUS_ADJUDICATION_PACKET_RESULT_ONLY_NO_STATUS_DECISION_OR_BLOCKER_MOVEMENT"
    )
    assert {row["target"]: row["decision"] for row in packet["candidate_next_targets"]} == {
        "review_v01_alpha_dependency_remediation_tranche_001_status_adjudication_packet_result": "selected",
        "execute_v01_alpha_dependency_remediation_tranche_001_status_adjudication": "deferred",
        "prepare_v01_alpha_release_readiness_adjudication_packet": "deferred",
    }


def test_v01_alpha_dependency_remediation_tranche_001_status_adjudication_packet_acceptance_and_determinism() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_001_status_adjudication_packet_is_pinned() -> None:
    ...
    refs = [
        ...
        "formal/python/tools/v01_alpha_dependency_remediation_tranche_001_status_adjudication_packet_report.py",
        "formal/python/tests/test_v01_alpha_dependency_remediation_tranche_001_status_adjudication_packet_gate.py",
        OUTCOME_ID,
        NEXT_TARGET,
    ]
    for ref in refs:
    ...
    assert "V01DependencyRemediationTranche001StatusAdjudicationPacket" in index_text
    assert (
        "v01_dependency_remediation_tranche_001_status_adjudication_packet_does_not_move_blocker"
        in index_text
    )
