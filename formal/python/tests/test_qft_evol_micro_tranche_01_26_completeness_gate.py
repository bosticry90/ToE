...
TRANCHE_GATE_PATH = "formal/python/tests/test_qft_evol_micro_tranche_01_26_completeness_gate.py"
LEGACY_TRANCHE_GATE_PATH = "formal/python/tests/test_qft_evol_micro_tranche_01_25_completeness_gate.py"
...
def test_qft_evol_umbrella_contains_micro_tranche_01_26_in_order() -> None:
