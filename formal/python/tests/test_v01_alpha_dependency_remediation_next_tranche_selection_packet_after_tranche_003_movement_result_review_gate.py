...
from formal.python.tools.v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_result_review_report import (
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_result_review_report.py"
)
...
LEAN_RESULT_REVIEW_PATH = (
    ...
    / "ToeFormal"
    / "Release"
    / "V01DependencyRemediationNextTrancheSelectionPacketAfterTranche003MovementResultReview.lean"
)
...
def test_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_result_review_files_exist() -> None:
...
def test_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_result_review_consumes_packet() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert review["schema_id"] == (
        "V01_ALPHA_DEPENDENCY_REMEDIATION_NEXT_TRANCHE_SELECTION_PACKET_AFTER_TRANCHE_003_MOVEMENT_RESULT_REVIEW_20260515_v0"
    )
...
def test_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_result_review_preserves_tranche_statuses() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_result_review_tracks_remaining_three() -> None:
    review = _json(RESULT_REVIEW_PATH)
    rows = review["remaining_release_blocking_obligations"]
    assert review["remaining_release_blocking_obligation_count"] == 3
...
def test_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_result_review_accepts_exact_tranche_004_selection() -> None:
    review = _json(RESULT_REVIEW_PATH)
    ...
    assert review["tranche_004_selection_accepted"] is True


def test_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_result_review_authorizes_preparation_only() -> None:
    review = _json(RESULT_REVIEW_PATH)
    selected = review["selected_next_remediation_tranche"]
    assert review["selection_result_review_classification"] == (
        "tranche_004_selection_accepted_execution_packet_preparation_pending"
    )
    assert review["tranche_004_execution_packet_preparation_authorized"] is True
...
def test_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_result_review_forbidden_effects_false() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_result_review_next_target() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert review["selected_next_target"] == NEXT_TARGET
    assert review["selected_next_target_kind"] == (
        "tranche_004_execution_packet_preparation_only"
    )
    ...
    assert {row["target"]: row["decision"] for row in review["candidate_next_targets"]} == {
        "prepare_v01_alpha_dependency_remediation_tranche_004_execution_packet": "selected",
...
def test_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_result_review_acceptance_and_determinism() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_result_review_is_pinned() -> None:
    roadmap_text = _read(PHYSICS_ROADMAP_PATH)
    refs = [
        REVIEW_ID,
        "formal/docs/release/V01_ALPHA_DEPENDENCY_REMEDIATION_NEXT_TRANCHE_SELECTION_PACKET_AFTER_TRANCHE_003_MOVEMENT_RESULT_REVIEW_20260515_v0.json",
        "formal/python/tools/v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_result_review_report.py",
        "formal/python/tests/test_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_result_review_gate.py",
        OUTCOME_ID,
        NEXT_TARGET,
    ]
    for ref in refs:
    ...
    assert (
        "V01DependencyRemediationNextTrancheSelectionPacketAfterTranche003MovementResultReview"
        in index_text
    )
    assert (
        "v01_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_result_review_does_not_execute_remediation"
        in index_text
    )
