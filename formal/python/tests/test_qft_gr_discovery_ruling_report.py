...
from formal.python.tools.qft_gr_discovery_ruling_report import build_report


def test_qft_gr_discovery_ruling_report_enforces_single_terminal_outcome() -> None:
    ...
    assert payload["schema_id"] == "QFT_GR_DISCOVERY_RULING_REPORT_20260411_v0"
