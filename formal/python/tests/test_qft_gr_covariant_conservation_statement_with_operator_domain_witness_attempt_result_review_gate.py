...
from formal.python.tools.qft_gr_covariant_conservation_statement_with_operator_domain_witness_attempt_result_review_report import (
    ...
    REVIEW_ID,
    SCHEMA_ID,
    build_qft_gr_covariant_conservation_statement_with_operator_domain_witness_attempt_result_review,
)
...
LEAN_REVIEW_PATH = (
    ...
    / "ToeFormal"
    / "Bridges"
    / "QFT_GR_CovariantConservationStatementWithOperatorDomainWitnessAttemptResultReview.lean"
)
TOOL_PATH = (
    REPO_ROOT
    / "formal"
    / "python"
    / "tools"
    / "qft_gr_covariant_conservation_statement_with_operator_domain_witness_attempt_result_review_report.py"
)
...
def test_qft_gr_covariant_conservation_statement_with_operator_domain_witness_attempt_result_review_files_exist() -> None:
...
def test_qft_gr_covariant_conservation_statement_with_operator_domain_witness_attempt_result_review_consumes_attempt() -> None:
...
def test_qft_gr_covariant_conservation_statement_with_operator_domain_witness_attempt_result_review_accepts_obstruction_only() -> None:
    review = _json(DEFAULT_OUT)
    assert review["obstruction_result_accepted"] is True
    assert review["refined_obstruction_class"] == REFINED_OBSTRUCTION_CLASS
...
def test_qft_gr_covariant_conservation_statement_with_operator_domain_witness_attempt_result_review_preserves_nonclaims() -> None:
    review = _json(DEFAULT_OUT)
...
def test_qft_gr_covariant_conservation_statement_with_operator_domain_witness_attempt_result_review_selects_one_refinement_packet_target() -> None:
    review = _json(DEFAULT_OUT)
...
def test_qft_gr_covariant_conservation_statement_with_operator_domain_witness_attempt_result_review_deterministic_and_pinned() -> None:
    review = _json(DEFAULT_OUT)
    generated = build_qft_gr_covariant_conservation_statement_with_operator_domain_witness_attempt_result_review(
