...
def test_gr_m2_canonical_equivalence_scaffold_cycle01_gate() -> None:
    ...
    assert _extract_token(gr_text, "GR_M2_CANONICAL_EQUIVALENCE_STATUS_v0") == "RUN_BOUNDED_v0_NONCLAIM"
    assert _extract_token(state_text, "GR_M2_CANONICAL_EQUIVALENCE_STATUS_v0") == "RUN_BOUNDED_v0_NONCLAIM"
    assert _extract_token(roadmap_text, "GR_M2_CANONICAL_EQUIVALENCE_STATUS_v0") == "RUN_BOUNDED_v0_NONCLAIM"
