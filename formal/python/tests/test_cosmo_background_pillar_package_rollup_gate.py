...
def test_cosmo_package_contains_required_freeze_and_reopen_tokens() -> None:
    ...
    required_tokens = [
        ...
        "DERIVATION_TARGET_COSMOLOGY_BACKGROUND_MICRO_12_DRYRUN_CLOSURE_PACKET_v0.md",
        "DERIVATION_TARGET_COSMOLOGY_BACKGROUND_MICRO_20_DRYRUN_CUSTODY_CONFIRMATION_ATTESTATION_CONFIRMATION_ATTESTATION_CONFIRMATION_ATTESTATION_CONFIRMATION_PACKET_v0.md",
        "DERIVATION_TARGET_COSMOLOGY_BACKGROUND_MICRO_27_DRYRUN_CUSTODY_CONFIRMATION_ATTESTATION_CONFIRMATION_ATTESTATION_CONFIRMATION_ATTESTATION_CONFIRMATION_ATTESTATION_CONFIRMATION_ATTESTATION_CONFIRMATION_ATTESTATION_CONFIRMATION_ATTESTATION_PACKET_v0.md",
        "DERIVATION_TARGET_COSMOLOGY_BACKGROUND_EXTERNAL_HYDROGEN_INTENSITY_REFERENCE_SURFACE_v0.md",
        "EXTERNAL_IMPLICATIONS_INTEGRATION_PLAN_v0.md",
        ...
        "cosmo_bg_micro06_state_checkpoint_boundary_cycle01_v0.json",
        "cosmo_bg_micro12_dryrun_closure_packet_cycle01_v0.json",
        "cosmo_bg_micro20_dryrun_custody_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_packet_cycle01_v0.json",
        "cosmo_bg_micro27_dryrun_custody_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_packet_cycle01_v0.json",
    ]
    missing = [token for token in required_tokens if token not in text]
