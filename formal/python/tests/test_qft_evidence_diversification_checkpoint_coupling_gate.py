...
def test_qft_evidence_diversification_checkpoint_coupling_gate() -> None:
    ...
    state_artifact_token = _extract_token_from_compact_state_or_inventory(state_text, inventory_text, "QFT_EVIDENCE_DIVERSIFICATION_CHECKPOINT_ARTIFACT_v0")
    ...
    state_sha_token = _extract_token_from_compact_state_or_inventory(state_text, inventory_text, "QFT_EVIDENCE_DIVERSIFICATION_CHECKPOINT_SHA256_v0")
    ...
    state_gate_token = _extract_token_from_compact_state_or_inventory(state_text, inventory_text, "QFT_EVIDENCE_DIVERSIFICATION_CHECKPOINT_GATE_v0")
