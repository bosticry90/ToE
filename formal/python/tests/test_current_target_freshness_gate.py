...
def test_single_live_target_is_machine_pinned_after_samplerep32_audit_selector() -> None:
    ...
    assert current_active_workstream["selected_route"] == (
        "qft_gr_covariant_conservation_proof_object_packet_preparation_after_operator_domain_obstruction_refinement_result_review"
    )
    ...
    assert current_active_workstream["track2_started"] == (
        "covariant_conservation_proof_object_packet_preparation_authorized"
    )
