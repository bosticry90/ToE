...
LIVE_TARGET = "prepare_qft_gr_mathematical_regularity_assumption_reduction_packet"
...
def test_single_live_target_is_machine_pinned_after_samplerep32_audit_selector() -> None:
    ...
    assert current_active_workstream["selected_route"] == (
        "qft_gr_mathematical_regularity_assumption_reduction_packet_preparation_"
        "after_state_domain_family_closeout_review"
    )
    ...
    assert current_active_workstream["track2_remains_deferred"] == (
        "pending_mathematical_regularity_assumption_reduction_packet_preparation"
    )
    ...
    assert current_active_workstream["track2_selected_after_result_review"] == (
        "mathematical_regularity_assumption_reduction_packet_preparation"
    )
