...
ACTIVE_LANE = (
    "qft_gr_state_admissibility_boundary_assumption_reduction_attempt_result_review"
)
ATTEMPT_TARGET = (
...
def test_single_live_target_is_machine_pinned_after_samplerep32_audit_selector() -> None:
    ...
    assert current_active_workstream["selected_route"] == (
        "qft_gr_state_expectation_compatibility_assumption_reduction_packet_preparation_"
        "after_sd_assump_002_result_review"
    )
    ...
    assert current_active_workstream["track2_selected_after_result_review"] == (
        "state_expectation_compatibility_assumption_reduction_packet_preparation_"
        "authorized"
    )
