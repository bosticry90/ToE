...
ACTIVE_LANE = (
    "qft_gr_renormalization_operator_domain_compatibility_assumption_reduction_attempt_result_review"
)
ATTEMPT_TARGET = (
...
def test_single_live_target_is_machine_pinned_after_samplerep32_audit_selector() -> None:
    ...
    assert current_active_workstream["track2_started"] == (
        "renormalization_operator_domain_compatibility_attempt_result_review_"
        "accepted_pending_closeout_packet"
    )
