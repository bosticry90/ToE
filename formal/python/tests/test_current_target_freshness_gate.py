...
ACTIVE_LANE = (
    "qft_gr_stress_energy_conservation_obstruction_refinement_packet"
)
PREVIOUS_TARGET = (
...
def test_single_live_target_is_machine_pinned_after_samplerep32_audit_selector() -> None:
    ...
    assert current_active_workstream["output_token"] == (
        "QFT_GR_STRESS_ENERGY_CONSERVATION_OBSTRUCTION_REFINEMENT_PACKET_"
    ...
    assert current_active_workstream["selected_route"] == (
        "qft_gr_covariant_conservation_statement_witness_packet_after_obstruction_refinement"
    )
    ...
    assert current_active_workstream["track2_started"] == (
        "conservation_obstruction_refined_covariant_statement_packet_pending"
    )
