...
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_SPECIFIC_LITERATURE_APPLICABILITY_CROSSWALK_TARGET = (
...
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_SPECIFIC_LITERATURE_APPLICABILITY_CROSSWALK_REVIEW_TARGET = (
...
BASELINE_COMPONENT_EQUATION_SOURCE_CANDIDATE_REGISTRY_PACKET_TARGET = (
...
CCFT_EMPIRICAL_DISCRIMINATOR_CANDIDATE_PRIORITY_SELECTION_PACKET_TARGET = (
...
CCFT_INDEX_REVIEW_TARGET = (
    "review_ccft_ck_admissibility_obligation_index_packet_result"
)
CCFT_FULL_VARIATIONAL_ACTION_PROGRAM_PACKET_TARGET = (
...
BASELINE_COMPONENT_EQUATION_SOURCE_CLASSIFICATION_PACKET_EVIDENCE_PATH = (
    REPO_ROOT
    / "formal"
    / "toe_formal"
    / "ToeFormal"
...
BASELINE_COMPONENT_EQUATION_SOURCE_CLASSIFICATION_REVIEW_EVIDENCE_PATH = (
    REPO_ROOT
    / "formal"
    / "toe_formal"
    / "ToeFormal"
...
BASELINE_COMPONENT_EQUATION_SOURCE_VALIDATION_CRITERIA_PACKET_EVIDENCE_PATH = (
    REPO_ROOT
    / "formal"
    / "toe_formal"
    / "ToeFormal"
...
BASELINE_COMPONENT_EQUATION_SOURCE_VALIDATION_CRITERIA_REVIEW_EVIDENCE_PATH = (
    REPO_ROOT
    / "formal"
    / "toe_formal"
    / "ToeFormal"
...
BASELINE_COMPONENT_EQUATION_SOURCE_CANDIDATE_REGISTRY_PACKET_EVIDENCE_PATH = (
    REPO_ROOT
    / "formal"
    / "toe_formal"
    / "ToeFormal"
...
BASELINE_COMPONENT_EQUATION_SOURCE_CANDIDATE_REGISTRY_REVIEW_EVIDENCE_PATH = (
    REPO_ROOT
    / "formal"
    / "toe_formal"
    / "ToeFormal"
...
LIVE_TARGET_EVIDENCE_PATH = (
    ...
    / "ToeFormal"
    / "Derivation"
    / "QFTGRQuadraticComponentExpandedGenericBackgroundLinearizationResultReviewV0.lean"
)
LIVE_TARGET_REPORT = (
    "formal/docs/release/QFT_GR_QUADRATIC_COMPONENT_EXPANDED_GENERIC_"
    "BACKGROUND_LINEARIZATION_RESULT_REVIEW_20260728_v0.json"
)
...
BASELINE_CONSTRUCTION_OBLIGATION_REVIEW_REPORT = (
    "formal/docs/release/"
...
BASELINE_COMPONENT_EQUATION_SOURCE_CLASSIFICATION_REVIEW_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_CLASSIFICATION_PACKET_RESULT_REVIEW_ACCEPTS_EQUATION_SLOT_SOURCE_"
    "STATUS_CLASSIFICATION_ONLY_NO_EQUATION_DERIVATION_OR_TAU_BASELINE_COMPUTATION"
)
...
BASELINE_COMPONENT_EQUATION_SOURCE_VALIDATION_CRITERIA_REVIEW_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_VALIDATION_CRITERIA_PACKET_RESULT_REVIEW_ACCEPTS_SOURCE_ACCEPTANCE_"
    "CRITERIA_ONLY_NO_SOURCE_VALIDATION_OR_TAU_BASELINE_COMPUTATION"
)
...
BASELINE_COMPONENT_EQUATION_SOURCE_CANDIDATE_REGISTRY_REVIEW_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_CANDIDATE_REGISTRY_PACKET_RESULT_REVIEW_ACCEPTS_CANDIDATE_"
    "SOURCES_ONLY_NO_SOURCE_VALIDATION_OR_EQUATION_ADOPTION"
)
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_REQUIREMENT_REFINEMENT_PACKET_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
...
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_SOURCE_CANDIDATE_RESCREENING_PACKET_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_APPLICABILITY_GAP_RESOLUTION_OPEN_SYSTEM_DECOHERENCE_SUPERCONDUCTING_"
    "CIRCUIT_QED_PLATFORM_SOURCE_CANDIDATE_RESCREENING_PACKET_PREPARED_RESCREENS_"
    "RETAINED_SOURCE_CANDIDATES_AGAINST_PLATFORM_SPECIFIC_REQUIREMENTS_ONLY_NO_"
    "SOURCE_VALIDATION_OR_EQUATION_ADOPTION"
)
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_SOURCE_CANDIDATE_RESCREENING_REVIEW_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_APPLICABILITY_GAP_RESOLUTION_OPEN_SYSTEM_DECOHERENCE_SUPERCONDUCTING_"
    "CIRCUIT_QED_PLATFORM_SOURCE_CANDIDATE_RESCREENING_PACKET_RESULT_REVIEW_"
    "ACCEPTS_168_ROW_PLATFORM_RESCREENING_MAP_ONLY_NO_SOURCE_VALIDATION_OR_"
    "EQUATION_ADOPTION"
)
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_RELEVANT_CANDIDATE_TRIAGE_PACKET_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_APPLICABILITY_GAP_RESOLUTION_OPEN_SYSTEM_DECOHERENCE_SUPERCONDUCTING_"
    "CIRCUIT_QED_PLATFORM_RELEVANT_CANDIDATE_TRIAGE_PACKET_PREPARED_TRIAGES_"
...
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_RELEVANT_CANDIDATE_FOLLOWON_ROUTE_SELECTION_REVIEW_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_APPLICABILITY_GAP_RESOLUTION_OPEN_SYSTEM_DECOHERENCE_SUPERCONDUCTING_"
    "CIRCUIT_QED_PLATFORM_RELEVANT_CANDIDATE_FOLLOWON_ROUTE_SELECTION_PACKET_"
...
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_RELEVANT_CANDIDATE_PLATFORM_SPECIFIC_LITERATURE_REVIEW_PACKET_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_APPLICABILITY_GAP_RESOLUTION_OPEN_SYSTEM_DECOHERENCE_SUPERCONDUCTING_"
    "CIRCUIT_QED_PLATFORM_RELEVANT_CANDIDATE_PLATFORM_SPECIFIC_LITERATURE_"
    "REVIEW_PACKET_PREPARED_REVIEWS_PLATFORM_SPECIFIC_LITERATURE_FOR_RELEVANT_"
    "UNVALIDATED_ROWS_ONLY_NO_SOURCE_VALIDATION_OR_EQUATION_ADOPTION"
)
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_RELEVANT_CANDIDATE_PLATFORM_SPECIFIC_LITERATURE_REVIEW_REVIEW_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_APPLICABILITY_GAP_RESOLUTION_OPEN_SYSTEM_DECOHERENCE_SUPERCONDUCTING_"
    "CIRCUIT_QED_PLATFORM_RELEVANT_CANDIDATE_PLATFORM_SPECIFIC_LITERATURE_"
    "REVIEW_PACKET_RESULT_REVIEW_ACCEPTS_PLATFORM_SPECIFIC_LITERATURE_"
    "LOCATORS_ONLY_NO_SOURCE_VALIDATION_OR_EQUATION_ADOPTION"
)
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_SPECIFIC_LITERATURE_APPLICABILITY_CROSSWALK_PACKET_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_APPLICABILITY_GAP_RESOLUTION_OPEN_SYSTEM_DECOHERENCE_SUPERCONDUCTING_"
    "CIRCUIT_QED_PLATFORM_SPECIFIC_LITERATURE_APPLICABILITY_CROSSWALK_PACKET_"
    "PREPARED_48_ROW_CALCULATION_READY_APPLICABILITY_CROSSWALK_ONLY_NO_SOURCE_"
    "VALIDATION_OR_EQUATION_ADOPTION"
)
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_SPECIFIC_LITERATURE_APPLICABILITY_CROSSWALK_REVIEW_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_APPLICABILITY_GAP_RESOLUTION_OPEN_SYSTEM_DECOHERENCE_"
    "SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_SPECIFIC_LITERATURE_"
    "APPLICABILITY_CROSSWALK_PACKET_RESULT_REVIEW_ACCEPTS_48_ROW_"
    "APPLICABILITY_CROSSWALK_AS_CALCULATION_INPUT_ONLY_NO_SOURCE_"
    "VALIDATION_OR_EQUATION_ADOPTION"
)
LIVE_TARGET_OUTCOME = (
    "QFT_GR_QUADRATIC_COMPONENT_EXPANDED_GENERIC_BACKGROUND_"
    "LINEARIZATION_RESULT_ACCEPTED"
)
...
BASELINE_CONSTRUCTION_OBLIGATION_PACKET_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_CONSTRUCTION_OBLIGATION_"
...
BASELINE_COMPONENT_INTERACTION_RISK_PACKET_OUTCOME = (
...
BASELINE_COMPONENT_EQUATION_SOURCE_CLASSIFICATION_REVIEW_STRICT_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_CLASSIFICATION_PACKET_RESULT_REVIEW_ACCEPTS_SOURCE_CLASSIFICATION_"
    "ONLY_NO_EQUATION_IMPORT_NO_EMPIRICAL_FIT_NO_COMPLETED_BASELINE_MODEL_NO_"
...
BASELINE_COMPONENT_EQUATION_SOURCE_VALIDATION_CRITERIA_PACKET_STRICT_OUTCOME = (
    ...
    "NO_SOURCE_VALIDATION_NO_EQUATION_IMPORT_NO_EMPIRICAL_FIT_NO_MASTER_ACTION_"
    "PROMOTION"
)
BASELINE_COMPONENT_EQUATION_SOURCE_VALIDATION_CRITERIA_REVIEW_STRICT_OUTCOME = (
    ...
    "CRITERIA_ONLY_NO_EQUATION_IMPORT_NO_EMPIRICAL_FIT_NO_COMPLETED_BASELINE_"
    "MODEL_NO_MASTER_ACTION_PROMOTION"
)
BASELINE_COMPONENT_EQUATION_SOURCE_CANDIDATE_REGISTRY_PACKET_STRICT_OUTCOME = (
    ...
    "ONLY_NO_EQUATION_IMPORT_NO_EMPIRICAL_FIT_NO_TAU_BASELINE_COMPUTATION_NO_"
    "MASTER_ACTION_PROMOTION"
)
BASELINE_COMPONENT_EQUATION_SOURCE_CANDIDATE_REGISTRY_REVIEW_STRICT_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_CANDIDATE_REGISTRY_PACKET_RESULT_REVIEW_ACCEPTS_SOURCE_CANDIDATE_"
    "REGISTRY_ONLY_NO_EQUATION_IMPORT_NO_EMPIRICAL_FIT_NO_TAU_BASELINE_"
    "COMPUTATION_NO_MASTER_ACTION_PROMOTION"
)
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_REQUIREMENT_REFINEMENT_PACKET_STRICT_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
...
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_SOURCE_CANDIDATE_RESCREENING_PACKET_STRICT_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_SUPERCONDUCTING_CIRCUIT_QED_SOURCE_CANDIDATE_RESCREENING_PACKET_"
    "PREPARED_RESCREENING_ONLY_NO_LINDBLAD_IMPORT_NO_TAU_BASELINE_COMPUTATION_"
    "NO_MASTER_ACTION_PROMOTION"
)
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_SOURCE_CANDIDATE_RESCREENING_REVIEW_STRICT_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_SUPERCONDUCTING_CIRCUIT_QED_SOURCE_CANDIDATE_RESCREENING_PACKET_"
    "RESULT_REVIEW_ACCEPTS_RESCREENING_ONLY_NO_LINDBLAD_IMPORT_NO_TAU_BASELINE_"
    "COMPUTATION_NO_MASTER_ACTION_PROMOTION"
)
...
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_RELEVANT_CANDIDATE_FOLLOWON_ROUTE_SELECTION_REVIEW_STRICT_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_SUPERCONDUCTING_CIRCUIT_QED_RELEVANT_CANDIDATE_FOLLOWON_ROUTE_"
...
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_RELEVANT_CANDIDATE_PLATFORM_SPECIFIC_LITERATURE_REVIEW_PACKET_STRICT_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_SPECIFIC_LITERATURE_REVIEW_"
    "PACKET_PREPARED_LITERATURE_REVIEW_ONLY_NO_LINDBLAD_IMPORT_NO_TAU_BASELINE_"
    "COMPUTATION_NO_MASTER_ACTION_PROMOTION"
)
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_RELEVANT_CANDIDATE_PLATFORM_SPECIFIC_LITERATURE_REVIEW_REVIEW_STRICT_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_SPECIFIC_LITERATURE_REVIEW_"
    "PACKET_RESULT_REVIEW_ACCEPTS_LITERATURE_REVIEW_ONLY_NO_LINDBLAD_IMPORT_"
    "NO_TAU_BASELINE_COMPUTATION_NO_MASTER_ACTION_PROMOTION"
)
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_SPECIFIC_LITERATURE_APPLICABILITY_CROSSWALK_PACKET_STRICT_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_SPECIFIC_LITERATURE_"
    "APPLICABILITY_CROSSWALK_PACKET_PREPARED_CROSSWALK_INPUT_ONLY_NO_E_REPRO_"
    "NO_LINDBLAD_IMPORT_NO_TAU_BASELINE_COMPUTATION_NO_MASTER_ACTION_PROMOTION"
)
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_SPECIFIC_LITERATURE_APPLICABILITY_CROSSWALK_REVIEW_STRICT_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_SUPERCONDUCTING_CIRCUIT_QED_LITERATURE_APPLICABILITY_CROSSWALK_"
    "PACKET_RESULT_REVIEW_ACCEPTS_CROSSWALK_ONLY_NO_LINDBLAD_IMPORT_NO_TAU_"
    "BASELINE_COMPUTATION_NO_MASTER_ACTION_PROMOTION"
)
LIVE_TARGET_STRICT_OUTCOME = (
    "GENERIC_COMPONENT_LINEARIZATION_BLOCKED_BY_GAUGE_C3_TRACEFREE_"
    "TANGENT_AND_ON_SHELL_JET_CONTRACT_MINKOWSKI_CONTROL_PRESERVED_NO_"
    "SPECTRAL_VARIABLE_OR_NONLINEAR_ESTIMATE"
)
...
BASELINE_CONSTRUCTION_OBLIGATION_REVIEW_STRICT_OUTCOME = (
    ...
    "COMPUTATION_NO_MEASUREMENT_PROTOCOL_NO_STATISTICAL_"
    "VALIDATION_NO_MASTER_ACTION_PROMOTION"
)
BASELINE_CONSTRUCTION_OBLIGATION_PACKET_STRICT_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_CONSTRUCTION_OBLIGATION_"
...
BASELINE_COMPONENT_INTERACTION_RISK_PACKET_STRICT_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_INTERACTION_"
    "RISK_PACKET_PREPARED_INTERACTION_RISK_TRACEABILITY_ONLY_NO_TAU_"
...
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_RELEVANT_CANDIDATE_TRIAGE_KIND = (
    "selected_ccft_empirical_discriminator_baseline_component_equation_"
...
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_RELEVANT_CANDIDATE_PLATFORM_SPECIFIC_LITERATURE_REVIEW_KIND = (
    "selected_ccft_empirical_discriminator_baseline_component_equation_"
...
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_RELEVANT_CANDIDATE_PLATFORM_SPECIFIC_LITERATURE_REVIEW_REVIEW_KIND = (
    "selected_ccft_empirical_discriminator_baseline_component_equation_"
    "source_applicability_gap_resolution_open_system_decoherence_superconducting_circuit_qed_platform_relevant_candidate_platform_specific_literature_review_packet_result_review"
)
CCFT_SCQED_LITERATURE_APPLICABILITY_MATRIX_CALCULATION_SPRINT_GUARDRAIL_KIND = (
    "ccft_scqed_literature_applicability_matrix_calculation_sprint_guardrail_packet"
)
CCFT_SCQED_LITERATURE_APPLICABILITY_MATRIX_CALCULATION_EXECUTION_KIND = (
...
LIVE_TARGET_KIND = (
    "qft_gr_quadratic_generic_background_linearization_gauge_and_jet_"
...
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_SPECIFIC_LITERATURE_APPLICABILITY_CROSSWALK_REVIEW_KIND = (
    "selected_ccft_empirical_discriminator_baseline_component_equation_"
...
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_SOURCE_CANDIDATE_RESCREENING_REVIEW_KIND = (
    "selected_ccft_empirical_discriminator_baseline_component_equation_"
...
SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_REQUIREMENT_REFINEMENT_REVIEW_KIND = (
    "selected_ccft_empirical_discriminator_baseline_component_equation_"
...
BASELINE_COMPONENT_INTERACTION_RISK_PACKET_KIND = (
    "selected_ccft_empirical_discriminator_baseline_component_interaction_"
    "risk_packet"
)
...
def test_single_live_target_is_machine_pinned_after_samplerep32_audit_selector() -> None:
    ...
    psi_A_gauge_exchange_closeout_result_review_outcome = (
    ...
    psi_A_gauge_exchange_closeout_result_review_strict_outcome = (
        "PSI_A_GAUGE_SECTOR_EXCHANGE_THEOREM_LINKAGE_OBLIGATION_CLOSEOUT_RESULT_"
        "REVIEW_ACCEPTS_LOCAL_GAUGE_EXCHANGE_LINKAGE_NO_ACTION_VARIATION_OR_"
        "MASTER_ACTION_PROMOTION"
    )
    psi_A_interaction_exchange_chain_synthesis_outcome = (
    ...
    psi_A_interaction_exchange_chain_synthesis_strict_outcome = (
    ...
    psi_A_interaction_exchange_chain_synthesis_result_review_outcome = (
    ...
    psi_A_interaction_exchange_chain_synthesis_result_review_strict_outcome = (
        "PSI_A_INTERACTION_EXCHANGE_THEOREM_LINKAGE_CHAIN_SYNTHESIS_RESULT_REVIEW_"
        "ACCEPTS_CEXCHANGE_TOTAL_MATTER_AND_GAUGE_LINKAGE_CHAIN_NO_ACTION_VARIATION_OR_"
        "MASTER_ACTION_PROMOTION"
    )
    psi_A_interaction_exchange_chain_synthesis_result_review_target = (
    ...
    psi_A_interaction_exchange_chain_closeout_outcome = (
    ...
    psi_A_interaction_exchange_chain_closeout_target = (
    ...
    psi_A_exchange_chain_selector_review_outcome = (
        "CK_FAMILY_THEOREM_LINKAGE_OBLIGATION_SELECTION_AFTER_PSI_A_EXCHANGE_CHAIN_"
    ...
    A_source_attempt_strict_outcome = (
        "A_SOURCE_THEOREM_LINKAGE_ATTEMPT_FROM_STANDALONE_A_ROUTE_PREPARED_"
        "STANDALONE_A_STRESS_CONSERVATION_ROUTE_NO_SOURCED_MAXWELL_"
        "SUBSTITUTION_OR_MASTER_ACTION_PROMOTION"
    )
    A_source_attempt_result_review_report = (
        "formal/docs/release/"
        "A_SOURCE_THEOREM_LINKAGE_ATTEMPT_FROM_STANDALONE_A_ROUTE_EXECUTION_"
        "RESULT_REVIEW_20260628_v0.json"
    )
    A_source_attempt_result_review_outcome = (
        "A_SOURCE_THEOREM_LINKAGE_ATTEMPT_FROM_STANDALONE_A_ROUTE_RESULT_REVIEW_"
        "ACCEPTS_C_SOURCE_A_LINKAGE_CONSTRUCTED_NO_CK_RULE_PROMOTION_OR_MASTER_"
        "ACTION_PROMOTION"
    )
    A_source_attempt_result_review_strict_outcome = (
        "A_SOURCE_THEOREM_LINKAGE_ATTEMPT_FROM_STANDALONE_A_ROUTE_RESULT_REVIEW_"
        "ACCEPTS_C_SOURCE_A_ZERO_FROM_STANDALONE_STRESS_CONSERVATION_NO_SOURCED_"
        "MAXWELL_SUBSTITUTION_OR_SEAM_CLOSURE"
    )
    A_source_suggested_execution_outcome = (
    ...
    A_source_strict_suggested_execution_outcome = (
        "A_SOURCE_THEOREM_LINKAGE_ATTEMPT_FROM_STANDALONE_A_ROUTE_EXECUTED_"
        "C_SOURCE_A_ZERO_FROM_STANDALONE_STRESS_CONSERVATION_NO_SOURCED_MAXWELL_"
        "SUBSTITUTION_OR_SEAM_CLOSURE"
    )
    A_source_attempt_residual_definition = (
    ...
    phi_bridge_selector_report = (
        "formal/docs/release/"
        "CK_FAMILY_THEOREM_LINKAGE_OBLIGATION_SELECTION_AFTER_PHI_BRIDGE_CLOSEOUT_20260630_v0.json"
    )
    phi_bridge_selector_outcome = (
    ...
    phi_bridge_strict_selector_outcome = (
        "CK_FAMILY_THEOREM_LINKAGE_OBLIGATION_SELECTION_AFTER_PHI_BRIDGE_CLOSEOUT_"
        "SELECTS_PHI_TRANSPORT_LINKAGE_OBLIGATION_NO_GAP_DISCHARGE_OR_CK_RULE_PROMOTION"
    )
    phi_transport_selected_obligation = "C_transport^phi theorem-linkage obligation"
    phi_transport_follow_on_target = (
        "prepare_phi_transport_theorem_linkage_obligation_packet"
    )
    phi_bridge_selector_result_review_report = (
        "formal/docs/release/"
        "CK_FAMILY_THEOREM_LINKAGE_OBLIGATION_SELECTION_AFTER_PHI_BRIDGE_CLOSEOUT_RESULT_REVIEW_20260630_v0.json"
    )
    phi_bridge_selector_result_review_outcome = (
        "CK_FAMILY_THEOREM_LINKAGE_OBLIGATION_SELECTION_AFTER_PHI_BRIDGE_CLOSEOUT_"
        "RESULT_REVIEW_ACCEPTS_C_TRANSPORT_PHI_THEOREM_LINKAGE_GAP_SELECTION_NO_PROOF_"
        "EXECUTION_OR_MASTER_ACTION_PROMOTION"
    )
    phi_bridge_strict_selector_result_review_outcome = (
        "CK_FAMILY_THEOREM_LINKAGE_OBLIGATION_SELECTION_AFTER_PHI_BRIDGE_CLOSEOUT_"
        "RESULT_REVIEW_ACCEPTS_PHI_TRANSPORT_LINKAGE_SELECTION_ONLY_NO_GAP_DISCHARGE_"
        "OR_CK_RULE_PROMOTION"
    )
    phi_transport_packet_outcome = (
    ...
    phi_transport_strict_packet_outcome = (
    ...
    phi_transport_next_packet_scope = (
        ...
        "boundary/domain assumptions from the prior standalone phi transport-consistency "
        "registry."
    )
    phi_transport_watch_item = (
    ...
    phi_transport_attempt_preparation_target_kind = (
    ...
    phi_transport_attempt_evidence = (
        "formal/toe_formal/ToeFormal/Derivation/"
    ...
    phi_transport_strict_suggested_execution_review_outcome = (
        "PHI_TRANSPORT_THEOREM_LINKAGE_ATTEMPT_FROM_STANDALONE_PHI_TRANSPORT_ROUTE_"
        "EXECUTION_RESULT_REVIEW_ACCEPTS_LOCAL_PHI_TRANSPORT_THEOREM_LINKAGE_ONLY_NO_"
        "PHI_SECTOR_OR_SEAM_CLOSURE"
    )
    phi_transport_execution_result_review_report = (
        "formal/docs/release/"
        "PHI_TRANSPORT_THEOREM_LINKAGE_ATTEMPT_FROM_STANDALONE_PHI_TRANSPORT_ROUTE_"
        "EXECUTION_RESULT_REVIEW_20260701_v0.json"
    )
    phi_transport_execution_result_review_evidence = (
        "formal/toe_formal/ToeFormal/Derivation/"
        "PhiTransportTheoremLinkageAttemptFromStandalonePhiTransportRouteExecutionResultReview.lean"
    )
    phi_transport_obligation_closeout_target = (
        "prepare_phi_transport_theorem_linkage_obligation_closeout"
    )
    phi_transport_obligation_closeout_target_kind = (
    ...
    phi_transport_closeout_report = (
        "formal/docs/release/"
        "PHI_TRANSPORT_THEOREM_LINKAGE_OBLIGATION_CLOSEOUT_20260701_v0.json"
    )
    phi_transport_closeout_evidence = (
        "formal/toe_formal/ToeFormal/Derivation/"
        "PhiTransportTheoremLinkageObligationCloseout.lean"
    )
    phi_transport_closeout_result_review_target = (
        "review_phi_transport_theorem_linkage_obligation_closeout_result"
    )
    phi_transport_closeout_result_review_target_kind = (
    ...
    phi_transport_closeout_result_review_evidence = (
        "formal/toe_formal/ToeFormal/Derivation/"
    ...
    phi_transport_constraint_equation = "C_transport^phi = 0"
    ...
    consumed_phi_transport_packet = _workstream(payload, phi_transport_follow_on_target)
    assert consumed_phi_transport_packet["status"] == "paused"
    assert consumed_phi_transport_packet["authorization_evidence"] == (
        "formal/toe_formal/ToeFormal/Derivation/"
        "PhiTransportTheoremLinkageObligationPacket.lean"
    )
    assert consumed_phi_transport_packet["report"] == phi_transport_packet_report
    assert consumed_phi_transport_packet["packet_result"] == (
        phi_transport_packet_outcome
    )
    assert consumed_phi_transport_packet["strict_packet_result"] == (
        phi_transport_strict_packet_outcome
    )
    assert consumed_phi_transport_packet["selected_next_target"] == (
        phi_transport_packet_review_target
    )
    assert consumed_phi_transport_packet["selected_next_target_kind"] == (
        "phi_transport_theorem_linkage_obligation_packet_result_review"
    )
    assert consumed_phi_transport_packet["selected_obligation"] == (
        phi_transport_selected_obligation
    )
    assert consumed_phi_transport_packet["transport_constraint_form"] == (
        phi_transport_constraint_form
    )
    assert consumed_phi_transport_packet["transport_constraint_equation"] == (
        phi_transport_constraint_equation
    )
    assert consumed_phi_transport_packet["transport_admissibility_constraint_form"] == (
        phi_transport_constraint_equation
    )
    assert consumed_phi_transport_packet["new_transport_formula_invented"] == "no"
    assert consumed_phi_transport_packet["proof_attempt_executed"] == "no"
    assert consumed_phi_transport_packet["theorem_discharged"] == "no"
    assert consumed_phi_transport_packet["C_transport_phi_discharged"] == "no"
    assert consumed_phi_transport_packet["rule_promoted"] == "no"
    assert consumed_phi_transport_packet["master_action_promoted"] == "no"

    consumed_phi_transport_packet_review = _workstream(
    ...
    assert consumed_phi_transport_packet_review["prepared_packet_result"] == (
        phi_transport_packet_outcome
    )
    assert consumed_phi_transport_packet_review["prepared_packet_strict_result"] == (
        phi_transport_strict_packet_outcome
    )
    assert consumed_phi_transport_packet_review["review_result"] == (
        phi_transport_packet_result_review_outcome
    )
    assert consumed_phi_transport_packet_review["strict_review_result"] == (
        phi_transport_strict_packet_result_review_outcome
    )
    assert consumed_phi_transport_packet_review["selected_next_target"] == (
        phi_transport_attempt_preparation_target
    )
    assert consumed_phi_transport_packet_review["selected_next_target_kind"] == (
        phi_transport_attempt_preparation_target_kind
    )
    assert consumed_phi_transport_packet_review["transport_constraint_form"] == (
        phi_transport_constraint_form
    )
    assert consumed_phi_transport_packet_review["transport_constraint_equation"] == (
        phi_transport_constraint_equation
    )
    assert consumed_phi_transport_packet_review["exact_five_component_transport_tuple_preserved"] == (
        "yes"
    )
    assert consumed_phi_transport_packet_review["new_transport_formula_invented"] == "no"
    assert consumed_phi_transport_packet_review["proof_attempt_executed"] == "no"
    assert consumed_phi_transport_packet_review["theorem_discharged"] == "no"
    assert consumed_phi_transport_packet_review["C_transport_phi_discharged"] == "no"
    ...
    assert consumed_phi_transport_attempt["authorization_evidence"] == (
        phi_transport_attempt_evidence
    )
    ...
    consumed_phi_transport_attempt_review = _workstream(
        payload, phi_transport_attempt_result_review_target
    )
    assert consumed_phi_transport_attempt_review["status"] == "paused"
    assert consumed_phi_transport_attempt_review["authorization_evidence"] == (
        phi_transport_attempt_result_review_evidence
    )
    assert consumed_phi_transport_attempt_review["report"] == (
        phi_transport_attempt_result_review_report
    )
    assert consumed_phi_transport_attempt_review["consumed_target"] == (
        phi_transport_attempt_result_review_target
    )
    assert consumed_phi_transport_attempt_review["attempt_preparation_result"] == (
        phi_transport_attempt_result
    )
    assert consumed_phi_transport_attempt_review["strict_attempt_preparation_result"] == (
        phi_transport_strict_attempt_result
    )
    assert consumed_phi_transport_attempt_review["review_result"] == (
        phi_transport_suggested_attempt_review_outcome
    )
    assert consumed_phi_transport_attempt_review["strict_review_result"] == (
        phi_transport_strict_suggested_attempt_review_outcome
    )
    assert consumed_phi_transport_attempt_review["selected_next_target"] == (
        phi_transport_execution_target
    )
    assert consumed_phi_transport_attempt_review["selected_next_target_kind"] == (
        phi_transport_execution_target_kind
    )
    assert consumed_phi_transport_attempt_review["suggested_execution_outcome"] == (
        phi_transport_suggested_execution_outcome
    )
    assert consumed_phi_transport_attempt_review[
        "strict_suggested_execution_outcome"
    ] == phi_transport_strict_suggested_execution_outcome
    assert consumed_phi_transport_attempt_review["componentwise_zero_route"] == (
        phi_transport_likely_attempt_shape
    )
    assert consumed_phi_transport_attempt_review["C_transport_phi_discharged"] == "no"
    assert consumed_phi_transport_attempt_review["theorem_discharged"] == "no"
    assert consumed_phi_transport_attempt_review["rule_promoted"] == "no"
    assert consumed_phi_transport_attempt_review["master_action_promoted"] == "no"

    consumed_phi_transport_execution = _workstream(
        payload, phi_transport_execution_target
    )
    assert consumed_phi_transport_execution["status"] == "paused"
    assert consumed_phi_transport_execution["authorization_evidence"] == (
        phi_transport_execution_evidence
    )
    assert consumed_phi_transport_execution["report"] == (
        phi_transport_execution_report
    )
    assert consumed_phi_transport_execution["consumed_target"] == (
        phi_transport_execution_target
    )
    assert consumed_phi_transport_execution["review_result"] == (
        phi_transport_suggested_attempt_review_outcome
    )
    assert consumed_phi_transport_execution["strict_review_result"] == (
        phi_transport_strict_suggested_attempt_review_outcome
    )
    assert consumed_phi_transport_execution["execution_result"] == (
        phi_transport_suggested_execution_outcome
    )
    assert consumed_phi_transport_execution["strict_execution_result"] == (
        phi_transport_strict_suggested_execution_outcome
    )
    assert consumed_phi_transport_execution["selected_next_target"] == (
        phi_transport_execution_result_review_target
    )
    assert consumed_phi_transport_execution["selected_next_target_kind"] == (
        phi_transport_execution_result_review_target_kind
    )
    assert consumed_phi_transport_execution["suggested_review_outcome"] == (
        phi_transport_suggested_execution_review_outcome
    )
    assert consumed_phi_transport_execution["strict_suggested_review_outcome"] == (
        phi_transport_strict_suggested_execution_review_outcome
    )
    assert consumed_phi_transport_execution["executed_componentwise_route"] == (
        phi_transport_likely_attempt_shape
    )
    assert consumed_phi_transport_execution["C_transport_phi_zero_derived"] == "yes"
    assert consumed_phi_transport_execution["C_transport_phi_discharged"] == "yes"
    assert consumed_phi_transport_execution["theorem_discharged"] == "yes"
    assert consumed_phi_transport_execution["theorem_linkage_obligation_discharged"] == (
        "yes"
    )
    assert consumed_phi_transport_execution["proof_attempt_executed"] == "yes"
    assert consumed_phi_transport_execution["rule_promoted"] == "no"
    assert consumed_phi_transport_execution["master_action_promoted"] == "no"

    consumed_phi_transport_execution_review = _workstream(
        payload, phi_transport_execution_result_review_target
    )
    assert consumed_phi_transport_execution_review["status"] == "paused"
    assert consumed_phi_transport_execution_review["authorization_evidence"] == (
        phi_transport_execution_result_review_evidence
    )
    assert consumed_phi_transport_execution_review["report"] == (
        phi_transport_execution_result_review_report
    )
    assert consumed_phi_transport_execution_review["consumed_target"] == (
        phi_transport_execution_result_review_target
    )
    assert consumed_phi_transport_execution_review["execution_result"] == (
        phi_transport_suggested_execution_outcome
    )
    assert consumed_phi_transport_execution_review["strict_execution_result"] == (
        phi_transport_strict_suggested_execution_outcome
    )
    assert consumed_phi_transport_execution_review["review_result"] == (
        phi_transport_suggested_execution_review_outcome
    )
    assert consumed_phi_transport_execution_review["strict_review_result"] == (
        phi_transport_strict_suggested_execution_review_outcome
    )
    assert consumed_phi_transport_execution_review["selected_next_target"] == (
        phi_transport_obligation_closeout_target
    )
    assert consumed_phi_transport_execution_review["selected_next_target_kind"] == (
        phi_transport_obligation_closeout_target_kind
    )
    assert consumed_phi_transport_execution_review["closeout_outcome_suggested"] == (
        phi_transport_closeout_outcome
    )
    assert consumed_phi_transport_execution_review[
        "strict_closeout_outcome_suggested"
    ] == phi_transport_strict_closeout_outcome
    assert consumed_phi_transport_execution_review["C_transport_phi_zero_derived"] == (
        "yes"
    )
    assert consumed_phi_transport_execution_review["C_transport_phi_discharged"] == (
        "yes"
    )
    assert consumed_phi_transport_execution_review["theorem_discharged"] == "yes"
    assert consumed_phi_transport_execution_review["proof_attempt_executed"] == "yes"
    assert consumed_phi_transport_execution_review["rule_promoted"] == "no"
    assert consumed_phi_transport_execution_review["master_action_promoted"] == "no"

    consumed_phi_transport_closeout = _workstream(
        payload, phi_transport_obligation_closeout_target
    )
    assert consumed_phi_transport_closeout["status"] == "paused"
    assert consumed_phi_transport_closeout["authorization_evidence"] == (
        phi_transport_closeout_evidence
    )
    assert consumed_phi_transport_closeout["report"] == phi_transport_closeout_report
    assert consumed_phi_transport_closeout["consumed_target"] == (
        phi_transport_obligation_closeout_target
    )
    assert consumed_phi_transport_closeout["execution_result"] == (
        phi_transport_suggested_execution_outcome
    )
    assert consumed_phi_transport_closeout["strict_execution_result"] == (
        phi_transport_strict_suggested_execution_outcome
    )
    assert consumed_phi_transport_closeout["review_result"] == (
        phi_transport_suggested_execution_review_outcome
    )
    assert consumed_phi_transport_closeout["strict_review_result"] == (
        phi_transport_strict_suggested_execution_review_outcome
    )
    assert consumed_phi_transport_closeout["closeout_result"] == (
        phi_transport_closeout_outcome
    )
    assert consumed_phi_transport_closeout["strict_closeout_result"] == (
        phi_transport_strict_closeout_outcome
    )
    assert consumed_phi_transport_closeout["selected_next_target"] == (
        phi_transport_closeout_result_review_target
    )
    assert consumed_phi_transport_closeout["selected_next_target_kind"] == (
        phi_transport_closeout_result_review_target_kind
    )
    assert consumed_phi_transport_closeout["suggested_review_outcome"] == (
        phi_transport_closeout_review_outcome
    )
    assert consumed_phi_transport_closeout["strict_suggested_review_outcome"] == (
        phi_transport_strict_closeout_review_outcome
    )
    assert consumed_phi_transport_closeout[
        "phi_transport_theorem_linkage_obligation_locally_closed"
    ] == "yes"
    assert consumed_phi_transport_closeout[
        "five_component_C_transport_phi_tuple_preserved"
    ] == "yes"
    assert consumed_phi_transport_closeout["componentwise_zero_route_reviewed"] == "yes"
    assert consumed_phi_transport_closeout["C_transport_phi_zero_derived"] == "yes"
    assert consumed_phi_transport_closeout["C_transport_phi_discharged"] == "yes"
    assert consumed_phi_transport_closeout["proof_attempt_executed"] == "yes"
    assert consumed_phi_transport_closeout["theorem_discharged"] == "yes"
    assert consumed_phi_transport_closeout["theorem_linkage_obligation_discharged"] == (
        "yes"
    )
    assert consumed_phi_transport_closeout["rule_promoted"] == "no"
    assert consumed_phi_transport_closeout["master_action_promoted"] == "no"

    consumed_phi_transport_closeout_review = _workstream(
        payload, phi_transport_closeout_result_review_target
    )
    assert consumed_phi_transport_closeout_review["status"] == "paused"
    assert consumed_phi_transport_closeout_review["authorization_evidence"] == (
        phi_transport_closeout_result_review_evidence
    )
    assert consumed_phi_transport_closeout_review["report"] == (
        phi_transport_closeout_result_review_report
    )
    assert consumed_phi_transport_closeout_review["consumed_target"] == (
        phi_transport_closeout_result_review_target
    )
    assert consumed_phi_transport_closeout_review["review_result"] == (
        phi_transport_closeout_review_outcome
    )
    assert consumed_phi_transport_closeout_review["strict_review_result"] == (
        phi_transport_strict_closeout_review_outcome
    )
    assert consumed_phi_transport_closeout_review["closeout_result"] == (
        phi_transport_closeout_outcome
    )
    assert consumed_phi_transport_closeout_review["strict_closeout_result"] == (
        phi_transport_strict_closeout_outcome
    )
    assert consumed_phi_transport_closeout_review["selected_next_target"] == (
        phi_transport_after_closeout_selector_target
    )
    assert consumed_phi_transport_closeout_review["selected_next_target_kind"] == (
        phi_transport_after_closeout_selector_target_kind
    )
    assert consumed_phi_transport_closeout_review["selector_authorized"] == "yes"
    assert consumed_phi_transport_closeout_review["selector_executed"] == "no"
    assert consumed_phi_transport_closeout_review[
    ...
    assert consumed_phi_transport_closeout_review[
        "C_transport_phi_zero_locally_linked"
    ] == "yes"
    assert consumed_phi_transport_closeout_review["C_transport_phi_zero_derived"] == (
        "yes"
    )
    ...
    ccft_priority_packet_outcome = (
        "CCFT_EMPIRICAL_DISCRIMINATOR_CANDIDATE_PRIORITY_SELECTION_PACKET_"
        "PREPARED_RANKS_MEASURABLE_SYSTEM_AND_FALSIFIER_ROWS_NO_EMPIRICAL_"
        "VALIDATION_OR_CCFT_VALIDATION"
    )
    ccft_priority_packet_strict_outcome = (
        "CCFT_EMPIRICAL_DISCRIMINATOR_CANDIDATE_PRIORITY_SELECTION_PACKET_"
        "PREPARED_SELECTS_TOP_DISCRIMINATOR_CANDIDATE_FOR_PACKET_ONLY_NO_"
        "EXECUTION_OR_MASTER_ACTION_PROMOTION"
    )
    ccft_priority_review_outcome = (
        "CCFT_EMPIRICAL_DISCRIMINATOR_CANDIDATE_PRIORITY_SELECTION_PACKET_"
        "RESULT_REVIEW_ACCEPTS_TOP_DISCRIMINATOR_PRIORITY_FOR_FUTURE_PACKET_"
        "ONLY_NO_EMPIRICAL_VALIDATION_OR_CCFT_VALIDATION"
    )
    ccft_priority_review_strict_outcome = (
        "CCFT_EMPIRICAL_DISCRIMINATOR_CANDIDATE_PRIORITY_SELECTION_PACKET_"
        "RESULT_REVIEW_ACCEPTS_PRIORITY_SELECTION_AS_PLANNING_ONLY_NO_EXECUTION_"
        "OR_MASTER_ACTION_PROMOTION"
    )
    ...
    assert ccft_index_review_workstream["selected_next_target"] == (
        CCFT_FULL_VARIATIONAL_ACTION_PROGRAM_PACKET_TARGET
    )
    ...
    ccft_full_program_packet = _workstream(
        payload, CCFT_FULL_VARIATIONAL_ACTION_PROGRAM_PACKET_TARGET
    )
    assert ccft_full_program_packet["status"] == "paused"
    assert ccft_full_program_packet["authorization_evidence"] == (
        "formal/toe_formal/ToeFormal/Derivation/"
        "CCFTFullVariationalActionProgramPacket.lean"
    )
    assert ccft_full_program_packet["report"] == (
        "formal/docs/release/"
        "CCFT_FULL_VARIATIONAL_ACTION_PROGRAM_PACKET_20260702_v0.json"
    )
    assert ccft_full_program_packet["consumed_target"] == (
        CCFT_FULL_VARIATIONAL_ACTION_PROGRAM_PACKET_TARGET
    )
    assert ccft_full_program_packet["packet_result"] == ccft_full_program_outcome
    assert ccft_full_program_packet["strict_packet_result"] == (
        ccft_full_program_strict_outcome
    )
    assert ccft_full_program_packet["selected_next_target"] == (
        CCFT_FULL_VARIATIONAL_ACTION_PROGRAM_REVIEW_TARGET
    )
    assert ccft_full_program_packet["selected_next_target_kind"] == (
        "ccft_full_variational_action_program_packet_result_review"
    )
    assert ccft_full_program_packet[
        "ccft_full_variational_action_program_target_count"
    ] == 13
    assert "CCFT full Lagrangian candidate targets" in ccft_full_program_packet[
        "ccft_full_variational_action_program_targets"
    ]
    assert "CCFT full Hamiltonian candidate targets" in ccft_full_program_packet[
        "ccft_full_variational_action_program_targets"
    ]
    assert "required blockers before C_k variation" in ccft_full_program_packet[
        "ccft_full_variational_action_program_targets"
    ]
    assert ccft_full_program_packet["C_k_action_embedding_authorized"] == "no"
    assert ccft_full_program_packet["C_k_variation_authorized"] == "no"
    assert ccft_full_program_packet["empirical_discriminator_claims_authorized"] == (
        "no"
    )
    assert ccft_full_program_packet["proof_attempt_executed"] == "no"
    assert ccft_full_program_packet["theorem_discharged"] == "no"
    assert ccft_full_program_packet["CCFT_validated"] == "no"
    assert ccft_full_program_packet["seam_closure_claim"] == "no"
    assert ccft_full_program_packet["master_action_promoted"] == "no"

    ccft_full_program_review = _workstream(
        payload, CCFT_FULL_VARIATIONAL_ACTION_PROGRAM_REVIEW_TARGET
    )
    assert ccft_full_program_review["status"] == "paused"
    assert ccft_full_program_review["authorization_evidence"] == (
        "formal/toe_formal/ToeFormal/Derivation/"
        "CCFTFullVariationalActionProgramPacketResultReview.lean"
    )
    assert ccft_full_program_review["report"] == (
        "formal/docs/release/"
        "CCFT_FULL_VARIATIONAL_ACTION_PROGRAM_PACKET_RESULT_REVIEW_20260702_v0.json"
    )
    assert ccft_full_program_review["consumed_target"] == (
        CCFT_FULL_VARIATIONAL_ACTION_PROGRAM_REVIEW_TARGET
    )
    assert ccft_full_program_review["prepared_packet_result"] == (
        ccft_full_program_outcome
    )
    assert ccft_full_program_review["prepared_packet_strict_result"] == (
        ccft_full_program_strict_outcome
    )
    assert ccft_full_program_review["review_result"] == (
        ccft_full_program_review_outcome
    )
    ...
    assert ccft_full_program_review[
        "ccft_full_variational_action_program_review_acceptance_item_count"
    ] == 22
    assert "required blockers before C_k variation preserved" in (
        ccft_full_program_review[
            "ccft_full_variational_action_program_review_acceptance_items"
        ]
    )
    assert ccft_full_program_review["C_k_action_embedding_authorized"] == "no"
    assert ccft_full_program_review["C_k_variation_authorized"] == "no"
    assert ccft_full_program_review["empirical_discriminator_claims_authorized"] == (
        "no"
    )
    assert ccft_full_program_review["proof_attempt_executed"] == "no"
    assert ccft_full_program_review["theorem_discharged"] == "no"
    assert ccft_full_program_review["CCFT_validated"] == "no"
    ...
    assert ccft_empirical_packet["selected_next_target"] == (
        CCFT_EMPIRICAL_DISCRIMINATOR_CANDIDATE_MAP_REVIEW_TARGET
    )
    assert ccft_empirical_packet["selected_next_target_kind"] == (
        "ccft_empirical_discriminator_candidate_map_packet_result_review"
    )
    assert ccft_empirical_packet[
        "ccft_empirical_discriminator_candidate_map_target_count"
    ] == 11
    assert "candidate measurable systems" in ccft_empirical_packet[
        "ccft_empirical_discriminator_candidate_map_targets"
    ]
    assert "candidate falsifiers" in ccft_empirical_packet[
        "ccft_empirical_discriminator_candidate_map_targets"
    ]
    assert "required blockers before CCFT validation" in ccft_empirical_packet[
        "ccft_empirical_discriminator_candidate_map_targets"
    ]
    assert ccft_empirical_packet["CCFT_EMPIRICAL_DISCRIMINATOR_CANDIDATE_MAP_v0_prepared"] == "yes"
    assert ccft_empirical_packet["later_ccft_artifacts_fully_populated"] == "yes"
    assert ccft_empirical_packet["empirical_claim_authorized"] == "no"
    assert ccft_empirical_packet["pillar_closure_authorized"] == "no"
    assert ccft_empirical_packet["proof_attempt_executed"] == "no"
    assert ccft_empirical_packet["theorem_discharged"] == "no"
    assert ccft_empirical_packet["CCFT_validated"] == "no"
    assert ccft_empirical_packet["empirical_validation_claimed"] == "no"
    assert ccft_empirical_packet["seam_closure_claim"] == "no"
    assert ccft_empirical_packet["master_action_promoted"] == "no"

    ccft_empirical_review = _workstream(
        payload, CCFT_EMPIRICAL_DISCRIMINATOR_CANDIDATE_MAP_REVIEW_TARGET
    )
    assert ccft_empirical_review["status"] == "paused"
    assert ccft_empirical_review["authorization_evidence"] == (
        "formal/toe_formal/ToeFormal/Derivation/"
    ...
    assert ccft_empirical_review["consumed_target"] == (
        CCFT_EMPIRICAL_DISCRIMINATOR_CANDIDATE_MAP_REVIEW_TARGET
    )
    ...
    assert ccft_empirical_review["selected_next_target"] == (
        CCFT_EMPIRICAL_DISCRIMINATOR_CANDIDATE_PRIORITY_SELECTION_PACKET_TARGET
    )
    ...
    ccft_priority_packet = _workstream(
        payload, CCFT_EMPIRICAL_DISCRIMINATOR_CANDIDATE_PRIORITY_SELECTION_PACKET_TARGET
    )
    assert ccft_priority_packet["status"] == "paused"
    assert ccft_priority_packet["authorization_evidence"] == (
        "formal/toe_formal/ToeFormal/Derivation/"
        "CCFTEmpiricalDiscriminatorCandidatePrioritySelectionPacket.lean"
    )
    assert ccft_priority_packet["report"] == (
        "formal/docs/release/"
        "CCFT_EMPIRICAL_DISCRIMINATOR_CANDIDATE_PRIORITY_SELECTION_PACKET_"
        "20260702_v0.json"
    )
    assert ccft_priority_packet["consumed_target"] == (
        CCFT_EMPIRICAL_DISCRIMINATOR_CANDIDATE_PRIORITY_SELECTION_PACKET_TARGET
    )
    assert ccft_priority_packet["packet_result"] == ccft_priority_packet_outcome
    assert ccft_priority_packet["strict_packet_result"] == (
        ccft_priority_packet_strict_outcome
    )
    assert ccft_priority_packet["selected_next_target"] == (
        CCFT_EMPIRICAL_DISCRIMINATOR_CANDIDATE_PRIORITY_SELECTION_REVIEW_TARGET
    )
    assert ccft_priority_packet["selected_next_target_kind"] == (
        "ccft_empirical_discriminator_candidate_priority_selection_packet_result_review"
    )
    assert ccft_priority_packet[
    ...
    assert (
        ...
        in ccft_priority_packet["candidate_measurable_system_ranking"]
    )
    assert "risk of overclaim" in ccft_priority_packet[
        "ccft_empirical_discriminator_candidate_priority_selection_criteria"
    ]
    assert ccft_priority_packet["selected_top_candidate_for_future_packet_only"] == (
        "controlled_mesoscopic_coherence_platform_candidate"
    )
    assert ccft_priority_packet["future_packet_preparation_only"] == "yes"
    assert ccft_priority_packet["empirical_test_executed"] == "no"
    assert ccft_priority_packet["empirical_claim_authorized"] == "no"
    assert ccft_priority_packet["pillar_closure_authorized"] == "no"
    assert ccft_priority_packet["proof_attempt_executed"] == "no"
    assert ccft_priority_packet["theorem_discharged"] == "no"
    assert ccft_priority_packet["CCFT_validated"] == "no"
    assert ccft_priority_packet["empirical_validation_claimed"] == "no"
    assert ccft_priority_packet["seam_closure_claim"] == "no"
    assert ccft_priority_packet["master_action_promoted"] == "no"

    ccft_priority_review = _workstream(
        payload, CCFT_EMPIRICAL_DISCRIMINATOR_CANDIDATE_PRIORITY_SELECTION_REVIEW_TARGET
    )
    assert ccft_priority_review["status"] == "paused"
    assert ccft_priority_review["authorization_evidence"] == (
        "formal/toe_formal/ToeFormal/Derivation/"
        "CCFTEmpiricalDiscriminatorCandidatePrioritySelectionPacketResultReview.lean"
    )
    assert ccft_priority_review["report"] == (
        "formal/docs/release/"
        "CCFT_EMPIRICAL_DISCRIMINATOR_CANDIDATE_PRIORITY_SELECTION_PACKET_"
        "RESULT_REVIEW_20260702_v0.json"
    )
    assert ccft_priority_review["consumed_target"] == (
        CCFT_EMPIRICAL_DISCRIMINATOR_CANDIDATE_PRIORITY_SELECTION_REVIEW_TARGET
    )
    assert ccft_priority_review["prepared_packet_result"] == (
        ccft_priority_packet_outcome
    )
    assert ccft_priority_review["prepared_packet_strict_result"] == (
        ccft_priority_packet_strict_outcome
    )
    assert ccft_priority_review["review_result"] == ccft_priority_review_outcome
    assert ccft_priority_review["strict_review_result"] == (
        ccft_priority_review_strict_outcome
    )
    assert ccft_priority_review["selected_next_target"] == (
        SELECTED_CANDIDATE_PACKET_TARGET
    )
    assert ccft_priority_review["selected_next_target_kind"] == (
        "selected_ccft_empirical_discriminator_candidate_packet"
    )
    assert ccft_priority_review[
        "ccft_empirical_discriminator_candidate_priority_selection_review_acceptance_item_count"
    ] == 25
    assert "selected top discriminator remains packet-level priority candidate only" in (
        ccft_priority_review[
    ...
    assert ccft_priority_review["selected_candidate_packet_preparation_target"] == (
        SELECTED_CANDIDATE_PACKET_TARGET
    )
    assert ccft_priority_review["empirical_execution_authorized"] == "no"
    assert ccft_priority_review["empirical_test_executed"] == "no"
    assert ccft_priority_review["empirical_claim_authorized"] == "no"
    assert ccft_priority_review["pillar_closure_authorized"] == "no"
    assert ccft_priority_review["proof_attempt_executed"] == "no"
    assert ccft_priority_review["theorem_discharged"] == "no"
    assert ccft_priority_review["CCFT_validated"] == "no"
    assert ccft_priority_review["empirical_validation_claimed"] == "no"
    assert ccft_priority_review["seam_closure_claim"] == "no"
    assert ccft_priority_review["master_action_promoted"] == "no"

    selected_candidate_packet = _workstream(payload, SELECTED_CANDIDATE_PACKET_TARGET)
    assert selected_candidate_packet["status"] == "paused"
    assert selected_candidate_packet["authorization_evidence"] == (
        "formal/toe_formal/ToeFormal/Derivation/"
        "SelectedCCFTEmpiricalDiscriminatorCandidatePacket.lean"
    )
    assert selected_candidate_packet["report"] == (
        "formal/docs/release/"
        "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_CANDIDATE_PACKET_20260702_v0.json"
    )
    assert selected_candidate_packet["consumed_target"] == (
        SELECTED_CANDIDATE_PACKET_TARGET
    )
    assert selected_candidate_packet["packet_result"] == selected_candidate_packet_outcome
    ...
    assert selected_candidate_packet["empirical_claim_authorized"] == "no"
    assert selected_candidate_packet["pillar_closure_authorized"] == "no"
    assert selected_candidate_packet["proof_attempt_executed"] == "no"
    assert selected_candidate_packet["theorem_discharged"] == "no"
    assert selected_candidate_packet["CCFT_validated"] == "no"
    assert selected_candidate_packet["empirical_validation_claimed"] == "no"
    ...
    assert selected_candidate_review["review_result"] == (
        selected_candidate_review_outcome
    )
    ...
    tolerance_registry_review = _workstream(payload, TOLERANCE_REGISTRY_REVIEW_TARGET)
    assert tolerance_registry_review["status"] == "paused"
    assert tolerance_registry_review["authorization_evidence"] == (
        "formal/toe_formal/ToeFormal/Derivation/"
    ...
    assert tolerance_registry_review["consumed_target"] == TOLERANCE_REGISTRY_REVIEW_TARGET
    ...
    assert tolerance_registry_review["selected_next_target"] == (
        BASELINE_SEMANTICS_PACKET_TARGET
    )
    ...
    baseline_packet = _workstream(payload, BASELINE_SEMANTICS_PACKET_TARGET)
    assert baseline_packet["status"] == "paused"
    assert baseline_packet["authorization_evidence"] == str(
        (
            REPO_ROOT
            / "formal"
            / "toe_formal"
            / "ToeFormal"
            / "Derivation"
            / "SelectedCCFTEmpiricalDiscriminatorBaselineComparisonSemanticsPacket.lean"
    ...
    assert baseline_packet["consumed_target"] == BASELINE_SEMANTICS_PACKET_TARGET
    assert baseline_packet["packet_result"] == baseline_semantics_packet_outcome
    ...
    assert "BSEM-CCFT-MESO-COH-LIFETIME-v0" in baseline_packet[
    ...
    assert baseline_review["review_result"] == baseline_semantics_review_outcome
    ...
    assert residual_packet["selected_next_target"] == (
        RESIDUAL_FORMULA_SELECTION_REVIEW_TARGET
    )
    ...
    residual_review = _workstream(payload, RESIDUAL_FORMULA_SELECTION_REVIEW_TARGET)
    ...
    assert residual_review["consumed_target"] == RESIDUAL_FORMULA_SELECTION_REVIEW_TARGET
    ...
    measurement_packet = _workstream(
        payload, MEASUREMENT_FEEDBACK_BASELINE_PRESSURE_PACKET_TARGET
    )
    ...
    assert measurement_packet["consumed_target"] == (
        MEASUREMENT_FEEDBACK_BASELINE_PRESSURE_PACKET_TARGET
    )
    ...
    assert measurement_packet["measurement_feedback_baseline_pressure_row_count"] == 8
    assert (
    ...
    baseline_review = _workstream(payload, BASELINE_COMPONENT_REGISTRY_REVIEW_TARGET)
    assert baseline_review["status"] == "paused"
    assert baseline_review["authorization_evidence"] == str(
        (
            REPO_ROOT
    ...
    assert baseline_review["consumed_target"] == BASELINE_COMPONENT_REGISTRY_REVIEW_TARGET
    ...
    interaction_packet = _workstream(
        payload, BASELINE_COMPONENT_INTERACTION_RISK_PACKET_TARGET
    )
    assert interaction_packet["status"] == "paused"
    assert interaction_packet["active_lane"] == (
        BASELINE_COMPONENT_INTERACTION_RISK_PACKET_TARGET
    )
    assert interaction_packet["authorized_next_strict_target"] == (
        BASELINE_COMPONENT_INTERACTION_RISK_PACKET_TARGET
    )
    assert interaction_packet["authorized_target"] == (
        BASELINE_COMPONENT_INTERACTION_RISK_PACKET_TARGET
    )
    assert interaction_packet["authorization_evidence"] == (
        BASELINE_COMPONENT_INTERACTION_RISK_PACKET_EVIDENCE
    )
    assert interaction_packet["report"] == BASELINE_COMPONENT_INTERACTION_RISK_PACKET_REPORT
    ...
    assert interaction_packet["selected_next_target"] == (
        BASELINE_COMPONENT_INTERACTION_RISK_REVIEW_TARGET
    )
    ...
    interaction_review = _workstream(
        payload, BASELINE_COMPONENT_INTERACTION_RISK_REVIEW_TARGET
    )
    assert interaction_review["status"] == "paused"
    assert interaction_review["active_lane"] == (
        BASELINE_COMPONENT_INTERACTION_RISK_REVIEW_TARGET
    )
    assert interaction_review["authorized_next_strict_target"] == (
        BASELINE_COMPONENT_INTERACTION_RISK_REVIEW_TARGET
    )
    assert interaction_review["authorized_target"] == (
        BASELINE_COMPONENT_INTERACTION_RISK_REVIEW_TARGET
    )
    assert interaction_review["authorization_evidence"] == (
        BASELINE_COMPONENT_INTERACTION_RISK_REVIEW_EVIDENCE
    )
    assert interaction_review["report"] == BASELINE_COMPONENT_INTERACTION_RISK_REVIEW_REPORT
    ...
    assert (
        interaction_review["interaction_risk_map_accepted_as_traceability_only"]
        == "yes"
    )
    assert (
        interaction_review[
    ...
    construction_packet = _workstream(
        payload, BASELINE_CONSTRUCTION_OBLIGATION_PACKET_TARGET
    )
    ...
    assert construction_packet["authorized_next_strict_target"] == (
        BASELINE_CONSTRUCTION_OBLIGATION_PACKET_TARGET
    )
    assert construction_packet["authorized_target"] == (
        BASELINE_CONSTRUCTION_OBLIGATION_PACKET_TARGET
    )
    assert construction_packet["authorization_evidence"] == (
        "formal/toe_formal/ToeFormal/Derivation/"
        "SelectedCCFTEmpiricalDiscriminatorBaselineConstructionObligationPacket.lean"
    )
    assert construction_packet["report"] == (
        "formal/docs/release/"
        "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_CONSTRUCTION_"
    ...
    construction_review = _workstream(payload, BASELINE_CONSTRUCTION_OBLIGATION_REVIEW_TARGET)
    ...
    assert (
        construction_review["authorized_next_strict_target"]
        == BASELINE_CONSTRUCTION_OBLIGATION_REVIEW_TARGET
    )
    assert (
        construction_review["authorized_target"]
        == BASELINE_CONSTRUCTION_OBLIGATION_REVIEW_TARGET
    )
    assert construction_review[
        "authorization_evidence"
    ] == BASELINE_CONSTRUCTION_OBLIGATION_REVIEW_EVIDENCE
    assert construction_review["report"] == BASELINE_CONSTRUCTION_OBLIGATION_REVIEW_REPORT
    assert (
        construction_review["review_result"]
        == BASELINE_CONSTRUCTION_OBLIGATION_REVIEW_OUTCOME
    )
    assert (
        construction_review["strict_review_result"]
        == BASELINE_CONSTRUCTION_OBLIGATION_REVIEW_STRICT_OUTCOME
    )
    ...
    assert (
        scaffold_packet["selected_next_target"]
        == BASELINE_COMPONENT_EQUATION_SCAFFOLD_REVIEW_TARGET
    )
    ...
    scaffold_review = _workstream(payload, BASELINE_COMPONENT_EQUATION_SCAFFOLD_REVIEW_TARGET)
    assert scaffold_review["status"] == "paused"
    assert scaffold_review["active_lane"] == (
        BASELINE_COMPONENT_EQUATION_SCAFFOLD_REVIEW_TARGET
    )
    assert scaffold_review["authorized_next_strict_target"] == (
        BASELINE_COMPONENT_EQUATION_SCAFFOLD_REVIEW_TARGET
    )
    assert scaffold_review["authorized_target"] == (
        BASELINE_COMPONENT_EQUATION_SCAFFOLD_REVIEW_TARGET
    )
    assert (
        scaffold_review["authorization_evidence"]
        == BASELINE_COMPONENT_EQUATION_SCAFFOLD_REVIEW_EVIDENCE
    )
    assert scaffold_review["report"] == BASELINE_COMPONENT_EQUATION_SCAFFOLD_REVIEW_REPORT
    ...
    source_packet = _workstream(
        payload, BASELINE_COMPONENT_EQUATION_SOURCE_CLASSIFICATION_TARGET
    )
    assert source_packet["status"] == "paused"
    assert source_packet["active_lane"] == (
        BASELINE_COMPONENT_EQUATION_SOURCE_CLASSIFICATION_TARGET
    )
    assert source_packet["authorized_next_strict_target"] == (
        BASELINE_COMPONENT_EQUATION_SOURCE_CLASSIFICATION_TARGET
    )
    assert source_packet["authorized_target"] == (
        BASELINE_COMPONENT_EQUATION_SOURCE_CLASSIFICATION_TARGET
    )
    assert source_packet[
        "authorization_evidence"
    ] == str(
        BASELINE_COMPONENT_EQUATION_SOURCE_CLASSIFICATION_PACKET_EVIDENCE_PATH.relative_to(
            REPO_ROOT
        )
    ).replace("\\", "/")
    ...
    assert source_packet["baseline_component_equation_source_classification_only"] == (
        "yes"
    )
    assert source_packet["equation_slot_source_status_classified_only"] == "yes"
    assert (
        source_packet["baseline_component_equation_source_classification_row_count"]
        == 8
    )
    assert (
        source_packet["baseline_component_equation_source_classification_field_count"]
        == 8
    )
    assert (
        source_packet[
    ...
    source_review = _workstream(
        payload, BASELINE_COMPONENT_EQUATION_SOURCE_CLASSIFICATION_REVIEW_TARGET
    )
    assert source_review["status"] == "paused"
    assert source_review["active_lane"] == (
        BASELINE_COMPONENT_EQUATION_SOURCE_CLASSIFICATION_REVIEW_TARGET
    )
    assert source_review["authorized_next_strict_target"] == (
        BASELINE_COMPONENT_EQUATION_SOURCE_CLASSIFICATION_REVIEW_TARGET
    )
    assert source_review["authorized_target"] == (
        BASELINE_COMPONENT_EQUATION_SOURCE_CLASSIFICATION_REVIEW_TARGET
    )
    assert source_review[
        "authorization_evidence"
    ] == str(
        BASELINE_COMPONENT_EQUATION_SOURCE_CLASSIFICATION_REVIEW_EVIDENCE_PATH.relative_to(
            REPO_ROOT
        )
    ).replace("\\", "/")
    ...
    assert source_review["source_classification_rows_accepted_as_labels_only"] == (
        "yes"
    )
    ...
    assert criteria_packet["authorized_next_strict_target"] == (
        BASELINE_COMPONENT_EQUATION_SOURCE_VALIDATION_CRITERIA_PACKET_TARGET
    )
    assert criteria_packet["authorized_target"] == (
        BASELINE_COMPONENT_EQUATION_SOURCE_VALIDATION_CRITERIA_PACKET_TARGET
    )
    assert criteria_packet[
        "authorization_evidence"
    ] == str(
        BASELINE_COMPONENT_EQUATION_SOURCE_VALIDATION_CRITERIA_PACKET_EVIDENCE_PATH.relative_to(
            REPO_ROOT
        )
    ).replace("\\", "/")
    ...
    assert (
        criteria_packet[
            "standard_open_system_import_acceptance_criteria_defined"
        ]
        == "yes"
    )
    assert (
        criteria_packet[
            "literature_supplied_equation_acceptance_criteria_defined"
        ]
        == "yes"
    )
    assert (
        criteria_packet[
            "empirical_fit_needed_slot_acceptance_criteria_defined"
        ]
        == "yes"
    )
    assert (
    ...
    assert criteria_review["authorized_next_strict_target"] == (
        BASELINE_COMPONENT_EQUATION_SOURCE_VALIDATION_CRITERIA_REVIEW_TARGET
    )
    assert criteria_review["authorized_target"] == (
        BASELINE_COMPONENT_EQUATION_SOURCE_VALIDATION_CRITERIA_REVIEW_TARGET
    )
    assert criteria_review["authorization_evidence"] == str(
        BASELINE_COMPONENT_EQUATION_SOURCE_VALIDATION_CRITERIA_REVIEW_EVIDENCE_PATH.relative_to(
            REPO_ROOT
        )
    ).replace("\\", "/")
    ...
    assert candidate_packet["authorized_next_strict_target"] == (
        BASELINE_COMPONENT_EQUATION_SOURCE_CANDIDATE_REGISTRY_PACKET_TARGET
    )
    assert candidate_packet["authorized_target"] == (
        BASELINE_COMPONENT_EQUATION_SOURCE_CANDIDATE_REGISTRY_PACKET_TARGET
    )
    assert candidate_packet["authorization_evidence"] == str(
        BASELINE_COMPONENT_EQUATION_SOURCE_CANDIDATE_REGISTRY_PACKET_EVIDENCE_PATH.relative_to(
            REPO_ROOT
        )
    ).replace("\\", "/")
    ...
    assert candidate_review["authorized_next_strict_target"] == (
        BASELINE_COMPONENT_EQUATION_SOURCE_CANDIDATE_REGISTRY_REVIEW_TARGET
    )
    assert candidate_review["authorized_target"] == (
        BASELINE_COMPONENT_EQUATION_SOURCE_CANDIDATE_REGISTRY_REVIEW_TARGET
    )
    assert candidate_review["authorization_evidence"] == str(
        BASELINE_COMPONENT_EQUATION_SOURCE_CANDIDATE_REGISTRY_REVIEW_EVIDENCE_PATH.relative_to(
            REPO_ROOT
        )
    ).replace("\\", "/")
    assert (
    ...
    applicability_packet = _workstream(
        payload,
        BASELINE_COMPONENT_EQUATION_SOURCE_APPLICABILITY_REVIEW_PACKET_TARGET,
    )
    ...
    assert applicability_packet["candidate_source_applicability_review_executed"] == (
        "yes"
    )
    ...
    assert interaction_active_workstream["platform_narrowing_scope_defined"] == "yes"
    assert (
        interaction_active_workstream[
            "platform_narrowing_scope_packet_result_review_consumed"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream["platform_narrowing_scope_packet_accepted"]
        == "yes"
    )
    assert interaction_active_workstream["platform_narrowing_scope_accepted_only"] == "yes"
    assert (
        interaction_active_workstream[
            "platform_narrowing_scope_result_review_accepted"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_narrowing_scope_accepted_as_constraints_only"
        ]
        == "yes"
    )
    assert interaction_active_workstream["allowed_platform_class_count"] == 4
    assert interaction_active_workstream["excluded_platform_class_count"] == 6
    assert interaction_active_workstream["addressed_blocker_class_count"] == 8
    assert interaction_active_workstream["accepted_allowed_platform_class_count"] == 4
    assert interaction_active_workstream["accepted_excluded_platform_class_count"] == 6
    assert interaction_active_workstream["accepted_addressed_blocker_class_count"] == 8
    assert interaction_active_workstream["accepted_platform_narrowing_scope_row_count"] == 8
    assert (
        interaction_active_workstream[
            "platform_narrowing_candidate_selection_packet_selected"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_narrowing_candidate_selection_packet_selected_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_narrowing_candidate_selection_packet_prepared"
        ]
        == "yes"
    )
    assert (
    ...
    assert interaction_active_workstream["platform_candidate_selected"] == "yes"
    assert interaction_active_workstream["platform_candidate_selected_only"] == "yes"
    assert interaction_active_workstream["selected_platform_candidate_count"] == 1
    assert interaction_active_workstream["selected_narrowed_platform_candidate_count"] == 1
    assert interaction_active_workstream["selected_platform_class_count"] == 1
    assert interaction_active_workstream["selected_platform_candidate_id"] == (
        "superconducting_circuit_qed_transmon_resonator_coherence_lifetime_candidate"
    )
    assert interaction_active_workstream["selected_platform_candidate_plain_name"] == (
        "superconducting circuit-QED transmon/resonator coherence-lifetime platform"
    )
    assert interaction_active_workstream["included_platform_class"] == (
        "controlled_mesoscopic_superconducting_circuit_qed_coherence_lifetime_platform"
    )
    assert interaction_active_workstream["candidate_excluded_platform_class_count"] == 7
    assert interaction_active_workstream["candidate_regime_assumption_count"] == 8
    assert (
        interaction_active_workstream["candidate_measurement_control_assumption_count"]
        == 6
    )
    assert interaction_active_workstream["candidate_environment_noise_assumption_count"] == 5
    assert interaction_active_workstream["candidate_blocker_class_reduction_count"] == 8
    assert interaction_active_workstream["candidate_remaining_blocker_count"] == 10
    assert (
        interaction_active_workstream[
            "platform_narrowing_candidate_selection_packet_result_review_consumed"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_narrowing_candidate_selection_packet_accepted"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_narrowing_candidate_selection_accepted_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_narrowing_candidate_selection_result_review_accepted"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_narrowing_candidate_selection_accepted_as_candidate_only"
        ]
        == "yes"
    )
    assert interaction_active_workstream["accepted_platform_candidate_count"] == 1
    assert interaction_active_workstream["accepted_narrowed_platform_candidate_count"] == 1
    assert interaction_active_workstream["accepted_platform_class_count"] == 1
    assert interaction_active_workstream["accepted_platform_candidate_id"] == (
        "superconducting_circuit_qed_transmon_resonator_coherence_lifetime_candidate"
    )
    assert interaction_active_workstream["accepted_platform_candidate_plain_name"] == (
        "superconducting circuit-QED transmon/resonator coherence-lifetime platform"
    )
    assert interaction_active_workstream["accepted_platform_class"] == (
        "controlled_mesoscopic_superconducting_circuit_qed_coherence_lifetime_platform"
    )
    assert interaction_active_workstream["accepted_candidate_excluded_platform_class_count"] == 7
    assert interaction_active_workstream["accepted_candidate_regime_assumption_count"] == 8
    assert (
        interaction_active_workstream[
            "accepted_candidate_measurement_control_assumption_count"
        ]
        == 6
    )
    assert (
        interaction_active_workstream["accepted_candidate_environment_noise_assumption_count"]
        == 5
    )
    assert (
        interaction_active_workstream["accepted_candidate_blocker_class_reduction_count"]
        == 8
    )
    assert interaction_active_workstream["accepted_candidate_remaining_blocker_count"] == 10
    assert (
        interaction_active_workstream[
            "platform_specific_requirement_refinement_packet_selected"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_specific_requirement_refinement_packet_selected_only"
        ]
        == "yes"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "superconducting_circuit_qed_platform_requirement_refinement_packet_selected"
        ]
        == "yes"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "platform_requirement_refinement_packet_result_review_consumed"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream["platform_requirement_refinement_packet_accepted"]
        == "yes"
    )
    assert (
        interaction_active_workstream["platform_requirement_refinement_accepted_only"]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_requirement_refinement_accepted_as_requirements_only"
        ]
        == "yes"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "superconducting_circuit_qed_platform_requirement_refinement_packet_accepted"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "superconducting_circuit_qed_platform_requirement_refinement_accepted_only"
        ]
        == "yes"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "platform_specific_requirement_refinement_packet_accepted"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream["platform_specific_requirement_refinement_accepted_only"]
        == "yes"
    )
    assert interaction_active_workstream["requirements_accepted"] == "yes"
    assert (
        interaction_active_workstream["platform_specific_requirements_accepted_only"]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "superconducting_circuit_qed_platform_requirements_accepted_only"
        ]
        == "yes"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "platform_specific_source_candidate_rescreening_packet_selected"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_specific_source_candidate_rescreening_packet_selected_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_specific_source_candidate_rescreening_packet_prepared"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_specific_source_candidate_rescreening_performed"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream["platform_specific_source_candidates_rescreened"]
        == "yes"
    )
    assert (
        interaction_active_workstream["platform_specific_source_candidate_rescreening_only"]
        == "yes"
    )
    assert (
        interaction_active_workstream[
    ...
    assert (
        interaction_active_workstream[
            "superconducting_circuit_qed_platform_source_candidate_rescreening_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "superconducting_circuit_qed_platform_source_candidate_rescreening_performed"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "superconducting_circuit_qed_platform_source_candidates_rescreened"
        ]
        == "yes"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "superconducting_circuit_qed_platform_source_candidate_discovery_performed"
        ]
        == "no"
    )
    assert (
        interaction_active_workstream["source_candidate_rescreening_packet_selected"]
        == "yes"
    )
    assert (
        interaction_active_workstream["source_candidate_rescreening_packet_prepared"]
        == "yes"
    )
    assert interaction_active_workstream["source_candidate_rescreening_executed"] == "yes"
    assert (
        interaction_active_workstream[
            "source_candidate_rescreening_executed_as_screening_only"
        ]
        == "yes"
    )
    assert interaction_active_workstream["source_candidate_pool_scope_explicit"] == "yes"
    assert (
        interaction_active_workstream["source_candidate_pool_scope"]
        == "both_retained_candidate_sets"
    )
    assert (
        interaction_active_workstream[
            "source_candidate_pool_includes_original_replacement_candidates"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "source_candidate_pool_includes_targeted_literature_expansion_candidates"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "source_candidate_pool_original_replacement_candidate_count"
        ]
        == 6
    )
    assert (
        interaction_active_workstream[
            "source_candidate_pool_targeted_literature_expansion_candidate_count"
        ]
        == 8
    )
    assert interaction_active_workstream["source_candidate_pool_total_candidate_count"] == 14
    assert (
        interaction_active_workstream[
    ...
    assert (
        interaction_active_workstream[
            "superconducting_circuit_qed_platform_source_candidate_rescreening_row_count"
        ]
        == 168
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "source_candidate_rescreening_status_distribution_preserved"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "source_candidate_rescreening_platform_relevance_not_validation"
        ]
        == "yes"
    )
    assert interaction_active_workstream[
        "source_candidate_rescreening_status_distribution"
    ] == {
    ...
    assert interaction_active_workstream["source_candidate_rescreening_supported_row_count"] == 0
    assert interaction_active_workstream["source_candidate_rescreening_rejected_row_count"] == 0
    assert interaction_active_workstream["platform_relevant_unvalidated_row_count"] == 6
    assert interaction_active_workstream["platform_relevant_unvalidated_candidate_count"] == 3
    assert interaction_active_workstream["platform_relevant_unvalidated_requirement_count"] == 2
    assert (
        interaction_active_workstream["platform_relevant_candidate_triage_packet_selected"]
        == "yes"
    )
    assert (
        interaction_active_workstream["platform_relevant_candidate_triage_packet_prepared"]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_relevant_candidate_triage_packet_selected_only"
        ]
        == "yes"
    )
    assert interaction_active_workstream["platform_relevant_candidate_triage_executed"] == "yes"
    assert (
        interaction_active_workstream[
            "platform_relevant_candidate_triage_executed_as_triage_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_relevant_candidate_triage_rows_target_platform_relevant_unvalidated_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream["platform_relevant_candidate_triage_no_support_inferred"]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "superconducting_circuit_qed_platform_relevant_candidate_triage_packet_selected"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "superconducting_circuit_qed_platform_relevant_candidate_triage_packet_selected_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "superconducting_circuit_qed_platform_relevant_candidate_triage_packet_prepared"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "superconducting_circuit_qed_platform_relevant_candidate_triage_executed"
        ]
        == "yes"
    )
    assert (
    ...
    assert interaction_active_workstream["platform_relevant_candidate_triage_row_count"] == 6
    assert (
        interaction_active_workstream["platform_relevant_candidate_triage_candidate_count"]
        == 3
    )
    assert (
        interaction_active_workstream["platform_relevant_candidate_triage_requirement_count"]
        == 2
    )
    assert interaction_active_workstream["platform_relevant_candidate_triage_status_count"] == 2
    assert interaction_active_workstream["platform_relevant_candidate_triage_priority_count"] == 2
    assert (
        interaction_active_workstream[
            "platform_relevant_candidate_triage_recommended_next_action_count"
        ]
        == 2
    )
    assert (
        interaction_active_workstream["platform_relevant_candidate_triage_statuses_recorded"]
        == "yes"
    )
    assert interaction_active_workstream["platform_relevant_candidate_triage_status_counts"] == {
        "requires_measurement_control_review": 2,
        "requires_platform_specific_literature_review": 4,
    }
    assert interaction_active_workstream["platform_relevant_candidate_triage_priority_counts"] == {
        "high_priority_unvalidated": 2,
        "medium_priority_unvalidated": 4,
    }
    assert (
        interaction_active_workstream[
            "platform_relevant_candidate_triage_requires_platform_specific_literature_review_count"
        ]
        == 4
    )
    assert (
        interaction_active_workstream[
            "platform_relevant_candidate_triage_requires_measurement_control_review_count"
        ]
        == 2
    )
    assert (
        interaction_active_workstream[
            "platform_relevant_candidate_triage_high_priority_unvalidated_count"
        ]
        == 2
    )
    assert (
        interaction_active_workstream[
            "platform_relevant_candidate_triage_medium_priority_unvalidated_count"
        ]
        == 4
    )
    assert (
        interaction_active_workstream["platform_relevant_candidate_triage_supported_row_count"]
        == 0
    )
    assert (
        interaction_active_workstream["platform_relevant_candidate_triage_validated_source_count"]
        == 0
    )
    assert (
        interaction_active_workstream["platform_relevant_candidate_triage_adopted_source_count"]
        == 0
    )
    assert (
        interaction_active_workstream["platform_relevant_candidate_triage_replaced_source_count"]
        == 0
    )
    assert (
        interaction_active_workstream["platform_relevant_candidate_triage_equation_import_count"]
        == 0
    )
    assert (
        interaction_active_workstream["platform_relevant_candidate_triage_lindblad_import_count"]
        == 0
    )
    assert (
        interaction_active_workstream[
            "platform_relevant_candidate_triage_tau_baseline_computation_count"
        ]
        == 0
    )
    assert interaction_active_workstream["platform_relevant_candidate_triage_candidate_ids"] == [
    ...
    assert interaction_active_workstream["platform_relevant_candidate_triage_requirement_ids"] == [
    ...
    assert (
        interaction_active_workstream["platform_relevant_candidate_triage_packet_accepted"]
        == "yes"
    )
    assert (
        interaction_active_workstream["platform_relevant_candidate_triage_accepted_only"]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_relevant_candidate_triage_accepted_as_triage_only"
        ]
        == "yes"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "platform_relevant_candidate_triage_status_distribution_preserved"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_relevant_candidate_triage_status_distribution_inferred_support"
        ]
        == "no"
    )
    assert (
        interaction_active_workstream[
            "platform_relevant_candidate_triage_platform_relevance_not_validation"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream["accepted_platform_relevant_candidate_triage_row_count"]
        == 6
    )
    assert (
        interaction_active_workstream[
            "accepted_platform_relevant_candidate_triage_candidate_count"
        ]
        == 3
    )
    assert (
        interaction_active_workstream[
            "accepted_platform_relevant_candidate_triage_requirement_count"
        ]
        == 2
    )
    assert (
        interaction_active_workstream["accepted_platform_relevant_candidate_triage_status_count"]
        == 2
    )
    assert (
        interaction_active_workstream["accepted_platform_relevant_candidate_triage_priority_count"]
        == 2
    )
    assert interaction_active_workstream[
        "accepted_platform_relevant_candidate_triage_status_counts"
    ] == {
        "requires_measurement_control_review": 2,
        "requires_platform_specific_literature_review": 4,
    }
    assert interaction_active_workstream[
        "accepted_platform_relevant_candidate_triage_priority_counts"
    ] == {
        "high_priority_unvalidated": 2,
        "medium_priority_unvalidated": 4,
    }
    assert (
        interaction_active_workstream[
            "accepted_platform_relevant_candidate_triage_requires_platform_specific_literature_review_count"
        ]
        == 4
    )
    assert (
        interaction_active_workstream[
            "accepted_platform_relevant_candidate_triage_requires_measurement_control_review_count"
        ]
        == 2
    )
    assert (
        interaction_active_workstream[
            "accepted_platform_relevant_candidate_triage_high_priority_unvalidated_count"
        ]
        == 2
    )
    assert (
        interaction_active_workstream[
            "accepted_platform_relevant_candidate_triage_medium_priority_unvalidated_count"
        ]
        == 4
    )
    assert (
        interaction_active_workstream["accepted_platform_relevant_candidate_triage_supported_row_count"]
        == 0
    )
    assert (
        interaction_active_workstream[
            "accepted_platform_relevant_candidate_triage_validated_source_count"
        ]
        == 0
    )
    assert (
        interaction_active_workstream[
            "accepted_platform_relevant_candidate_triage_adopted_source_count"
        ]
        == 0
    )
    assert (
        interaction_active_workstream[
            "accepted_platform_relevant_candidate_triage_replaced_source_count"
        ]
        == 0
    )
    assert (
        interaction_active_workstream[
            "accepted_platform_relevant_candidate_triage_equation_import_count"
        ]
        == 0
    )
    assert (
        interaction_active_workstream[
            "accepted_platform_relevant_candidate_triage_lindblad_import_count"
        ]
        == 0
    )
    assert (
        interaction_active_workstream[
            "accepted_platform_relevant_candidate_triage_tau_baseline_computation_count"
        ]
        == 0
    )
    assert (
        interaction_active_workstream[
            "platform_relevant_candidate_followon_route_selection_packet_selected"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_relevant_candidate_followon_route_selection_packet_selected_only"
        ]
        == "yes"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "platform_relevant_candidate_followon_route_selection_options_recorded"
        ]
        == "yes"
    )
    assert interaction_active_workstream[
    ...
    assert (
        interaction_active_workstream["platform_relevant_candidate_followon_route_option_count"]
        == 2
    )
    assert (
        interaction_active_workstream["platform_specific_literature_review_followon_need_count"]
        == 4
    )
    assert (
        interaction_active_workstream["measurement_control_review_followon_need_count"]
        == 2
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "platform_specific_literature_review_executed_as_locator_review_only"
        ]
        == "yes"
    )
    assert interaction_active_workstream["literature_review_executed"] == "yes"
    assert (
        interaction_active_workstream[
            "literature_review_executed_as_platform_specific_locator_review_only"
        ]
        == "yes"
    )
    assert interaction_active_workstream["platform_specific_literature_review_row_count"] == 4
    assert (
        interaction_active_workstream[
            "platform_specific_literature_review_relevant_unvalidated_row_count"
        ]
        == 4
    )
    assert interaction_active_workstream["platform_specific_literature_review_candidate_count"] == 2
    assert interaction_active_workstream["platform_specific_literature_review_requirement_count"] == 2
    assert interaction_active_workstream["platform_specific_literature_review_locator_count"] == 4
    assert (
        interaction_active_workstream[
            "platform_specific_literature_review_supporting_locator_count"
        ]
        == 4
    )
    assert (
        interaction_active_workstream[
            "platform_specific_literature_review_not_validated_row_count"
        ]
        == 4
    )
    assert (
        interaction_active_workstream[
            "platform_specific_literature_review_not_adopted_row_count"
        ]
        == 4
    )
    assert (
        interaction_active_workstream[
            "platform_specific_literature_review_tau_baseline_not_computed_row_count"
        ]
        == 4
    )
    assert interaction_active_workstream[
        "platform_specific_literature_review_source_validation_statuses"
    ] == ["not_validated"]
    assert interaction_active_workstream[
        "platform_specific_literature_review_equation_adoption_statuses"
    ] == ["not_adopted"]
    assert interaction_active_workstream[
        "platform_specific_literature_review_tau_baseline_statuses"
    ] == ["not_computed"]
    assert interaction_active_workstream[
        "platform_specific_literature_review_source_validated_count"
    ] == 0
    assert interaction_active_workstream[
        "platform_specific_literature_review_equation_import_count"
    ] == 0
    assert interaction_active_workstream[
        "platform_specific_literature_review_tau_baseline_computation_count"
    ] == 0
    assert (
    ...
    assert (
        interaction_active_workstream[
            "selected_next_platform_specific_literature_review_result_review_target"
        ]
    ...
    assert (
        interaction_active_workstream[
            "selected_next_platform_specific_literature_review_result_review_kind"
        ]
        == SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_RELEVANT_CANDIDATE_PLATFORM_SPECIFIC_LITERATURE_REVIEW_REVIEW_KIND
    )
    assert (
        interaction_active_workstream[
            "platform_specific_literature_review_packet_result_review_consumed"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream["platform_specific_literature_review_packet_accepted"]
        == "yes"
    )
    assert (
        interaction_active_workstream["platform_specific_literature_review_accepted_only"]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_specific_literature_review_accepted_as_literature_locators_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_specific_literature_review_relevance_support_accepted_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "accepted_platform_specific_literature_review_row_count"
        ]
        == 4
    )
    assert (
        interaction_active_workstream[
            "accepted_platform_specific_literature_review_source_validation_status"
        ]
        == "not_validated"
    )
    assert (
        interaction_active_workstream[
            "accepted_platform_specific_literature_review_equation_adoption_status"
        ]
        == "not_adopted"
    )
    assert (
        interaction_active_workstream[
            "accepted_platform_specific_literature_review_tau_baseline_status"
        ]
        == "not_computed"
    )
    assert (
        interaction_active_workstream[
            "platform_specific_literature_applicability_crosswalk_packet_selected"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_specific_literature_applicability_crosswalk_packet_selected_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_specific_literature_applicability_crosswalk_executed"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_specific_literature_applicability_crosswalk_executed_as_input_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_specific_literature_applicability_crosswalk_packet_prepared"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_specific_literature_applicability_crosswalk_prepared_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "selected_next_platform_specific_literature_applicability_crosswalk_target"
        ]
        == SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_SPECIFIC_LITERATURE_APPLICABILITY_CROSSWALK_TARGET
    )
    assert (
        interaction_active_workstream[
            "selected_next_platform_specific_literature_applicability_crosswalk_kind"
        ]
        == SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_SPECIFIC_LITERATURE_APPLICABILITY_CROSSWALK_KIND
    )
    assert (
        interaction_active_workstream[
            "selected_next_platform_specific_literature_applicability_crosswalk_review_target"
        ]
        == SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_SPECIFIC_LITERATURE_APPLICABILITY_CROSSWALK_REVIEW_TARGET
    )
    assert (
        interaction_active_workstream[
            "selected_next_platform_specific_literature_applicability_crosswalk_review_kind"
        ]
        == SUPERCONDUCTING_CIRCUIT_QED_PLATFORM_SPECIFIC_LITERATURE_APPLICABILITY_CROSSWALK_REVIEW_KIND
    )
    assert (
        interaction_active_workstream[
            "platform_specific_literature_applicability_crosswalk_row_count"
        ]
        == 48
    )
    assert (
        interaction_active_workstream[
            "platform_specific_literature_applicability_crosswalk_literature_locator_count"
        ]
        == 4
    )
    assert (
        interaction_active_workstream[
            "platform_specific_literature_applicability_crosswalk_requirement_count"
        ]
        == 12
    )
    assert (
    ...
    assert (
        interaction_active_workstream["not_applicable_for_requirement_boundary"]
        == "applicability classification only, not source rejection"
    )
    assert interaction_active_workstream["calculation_readiness_metadata"] == {
    ...
    assert interaction_active_workstream["calculation_allowed"] == "no"
    assert interaction_active_workstream["calculation_executed"] == "yes"
    assert interaction_active_workstream["e_repro_evidence_claimed"] == "yes"
    assert (
        interaction_active_workstream[
            "platform_specific_literature_applicability_crosswalk_packet_accepted"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "platform_specific_literature_applicability_crosswalk_accepted_as_calculation_input_only"
        ]
        == "yes"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "platform_relevant_unvalidated_interpreted_as_validation"
        ]
        == "no"
    )
    assert (
        interaction_active_workstream[
            "partially_relevant_unvalidated_interpreted_as_adoption"
        ]
        == "no"
    )
    assert (
        interaction_active_workstream[
            "not_applicable_for_requirement_interpreted_as_source_rejection"
        ]
        == "no"
    )
    assert interaction_active_workstream["calculation_readiness_metadata_accepted"] == "yes"
    assert (
        interaction_active_workstream[
            "calculation_readiness_metadata_accepted_as_future_input_only"
        ]
        == "yes"
    )
    assert interaction_active_workstream["accepted_calculation_allowed"] == "no"
    assert interaction_active_workstream["accepted_calculation_executed"] == "no"
    assert interaction_active_workstream["accepted_e_repro_evidence_claimed"] == "no"
    assert interaction_active_workstream["calculation_sprint_guardrail_packet_selected"] == "yes"
    assert (
        interaction_active_workstream["calculation_sprint_guardrail_packet_prepared"]
        == "yes"
    )
    assert interaction_active_workstream["calculation_execution_authorized"] == "yes"
    assert (
        interaction_active_workstream[
            "calculation_execution_authorized_only_for_allowlist"
        ]
        == "yes"
    )
    assert interaction_active_workstream["safe_matrix_counts_calculation_executed"] == "yes"
    assert interaction_active_workstream["calculation_output_generated"] == "yes"
    assert interaction_active_workstream["calculation_manifest_generated"] == "yes"
    assert interaction_active_workstream["reproducibility_metadata_generated"] == "yes"
    assert interaction_active_workstream["e_repro_evidence_generated"] == "yes"
    assert interaction_active_workstream["e_repro_claim_label"] == "E-REPRO"
    assert interaction_active_workstream["e_repro_claim_status"] == (
        "accepted_scoped_matrix_counts_only"
    )
    assert interaction_active_workstream["calculation_result_review_pending"] == "no"
    assert interaction_active_workstream["calculation_result_review_completed"] == "yes"
    assert interaction_active_workstream["calculation_result_review_accepted"] == "yes"
    assert interaction_active_workstream["ccft_empirical_lane_status"] == (
        "paused_upstream_prerequisites"
    )
    assert (
        interaction_active_workstream["future_calculation_output"]
    ...
    assert (
        interaction_active_workstream[
            "residual_formula_changed_by_baseline_component_equation_source_applicability_gap_resolution_open_system_decoherence_superconducting_circuit_qed_platform_relevant_candidate_platform_specific_literature_review_packet"
        ]
        == "no"
    )
    assert (
        interaction_active_workstream[
            "residual_formula_changed_by_baseline_component_equation_source_applicability_gap_resolution_open_system_decoherence_superconducting_circuit_qed_platform_relevant_candidate_platform_specific_literature_review_review"
        ]
        == "no"
    )
    assert (
    ...
    assert (
        interaction_active_workstream["blocker_response_route_selection_packet_prepared"]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "blocker_response_route_selection_executed_as_selection_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "blocker_response_route_selection_result_review_accepted"
        ]
        == "yes"
    )
    assert (
    ...
    assert interaction_active_workstream["source_search_scope_packet_selected"] == (
        "yes"
    )
    assert (
        interaction_active_workstream[
    ...
    assert (
        interaction_active_workstream["source_search_scope_required_before_equation_import"]
        == "yes"
    )
    assert (
        interaction_active_workstream[
    ...
    assert (
        interaction_active_workstream[
            "source_search_candidate_discovery_packet_selected"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream["source_search_candidate_discovery_only_next"]
        == "yes"
    )
    assert (
        interaction_active_workstream[
    ...
    assert (
        interaction_active_workstream[
            "source_search_scope_defined_before_candidate_listing"
        ]
        == "yes"
    )
    assert (
    ...
    assert interaction_active_workstream["source_candidates_listed"] == "yes"
    assert interaction_active_workstream["source_candidates_discovered"] == "yes"
    assert interaction_active_workstream["source_discovery_executed"] == "yes"
    assert interaction_active_workstream["source_candidates_listed_count"] == 8
    assert interaction_active_workstream["source_search_execution_authorized"] == "yes"
    assert interaction_active_workstream["source_search_executed"] == "yes"
    assert interaction_active_workstream["replacement_source_search_executed"] == "no"
    assert interaction_active_workstream["source_candidates_listed_only"] == "yes"
    assert (
        interaction_active_workstream[
    ...
    assert interaction_active_workstream["targeted_literature_candidate_source_count"] == 8
    assert (
        interaction_active_workstream[
            "targeted_literature_candidate_blocker_class_count"
        ]
        == 8
    )
    assert (
    ...
    assert interaction_active_workstream["source_candidate_triage_packet_selected"] == "yes"
    assert (
        interaction_active_workstream[
            "targeted_literature_candidate_triage_packet_selected"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream["targeted_literature_candidate_triage_only_next"]
        == "yes"
    )
    assert (
        interaction_active_workstream["targeted_literature_candidate_triage_packet_prepared"]
        == "yes"
    )
    assert (
        interaction_active_workstream["targeted_literature_candidate_triage_only"]
        == "yes"
    )
    assert (
        interaction_active_workstream["targeted_literature_candidate_triage_executed"]
        == "yes"
    )
    assert interaction_active_workstream["source_candidate_triage_packet_prepared"] == "yes"
    assert interaction_active_workstream["source_candidate_triage_executed"] == "yes"
    assert (
        interaction_active_workstream[
            "source_candidate_triage_executed_as_role_classification_only"
        ]
        == "yes"
    )
    assert interaction_active_workstream["source_candidate_roles_classified"] == "yes"
    assert interaction_active_workstream["source_candidate_roles_classified_only"] == "yes"
    assert (
        interaction_active_workstream["source_candidate_likely_regimes_classified"]
        == "no"
    )
    assert (
        interaction_active_workstream["source_candidate_likely_usefulness_classified"]
        == "yes"
    )
    assert (
        interaction_active_workstream["source_candidate_triage_risks_classified"]
        == "yes"
    )
    assert (
        interaction_active_workstream["source_candidate_next_review_needs_recorded"]
        == "yes"
    )
    assert interaction_active_workstream["source_candidate_triage_review_selected"] == "yes"
    assert interaction_active_workstream["source_candidate_triage_packet_accepted"] == "yes"
    assert interaction_active_workstream["source_candidate_triage_accepted_only"] == "yes"
    assert (
        interaction_active_workstream["source_candidate_role_classification_accepted_only"]
        == "yes"
    )
    assert (
        interaction_active_workstream[
    ...
    assert (
        interaction_active_workstream[
            "targeted_literature_candidate_triage_status_count"
        ]
        == 6
    )
    assert (
    ...
    assert (
        interaction_active_workstream["source_candidate_requirement_crosswalk_packet_selected"]
        == "yes"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "targeted_literature_candidate_triage_review_accepts_triage_only"
        ]
        == "yes"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "targeted_literature_candidate_requirement_crosswalk_packet_selected"
        ]
        == "yes"
    )
    assert (
    ...
    assert interaction_active_workstream["crosswalk_blocker_synthesis_executed"] == "yes"
    assert (
        interaction_active_workstream[
    ...
    assert (
        interaction_active_workstream[
            "targeted_literature_candidate_requirement_crosswalk_blocker_synthesis_prior_crosswalk_row_count"
        ]
        == 48
    )
    assert (
    ...
    assert interaction_active_workstream["calculation_scaffold_started"] == "yes"
    assert interaction_active_workstream["calculation_matrix_executed"] == "yes"
    assert interaction_active_workstream["reproducible_calculation_executed"] == "yes"
    assert interaction_active_workstream["triage_scoring_executed"] == "no"
    assert (
        interaction_active_workstream[
    ...
    assert interaction_active_workstream["candidate_source_accepted"] == "no"
    assert interaction_active_workstream["candidate_source_validated"] == "no"
    assert interaction_active_workstream["candidate_source_adopted"] == "no"
    assert (
        interaction_active_workstream["candidate_source_applicability_validated"]
        == "no"
    )
    assert (
        interaction_active_workstream["candidate_source_applicability_accepted"]
        == "no"
    )
    assert interaction_active_workstream["candidate_equation_imported"] == "no"
    assert interaction_active_workstream["candidate_equation_adopted"] == "no"
    assert (
        interaction_active_workstream["source_replacement_execution_authorized"]
        == "no"
    )
    assert (
        interaction_active_workstream["source_candidate_replacement_performed"]
        == "no"
    )
    assert interaction_active_workstream["source_validated"] == "no"
    assert (
        interaction_active_workstream["standard_open_system_equations_imported"]
        == "no"
    )
    assert (
        interaction_active_workstream["open_system_decoherence_lindblad_form_imported"]
        == "no"
    )
    assert interaction_active_workstream["tau_baseline_value_computed"] == "no"
    assert interaction_active_workstream["baseline_model_completed"] == "no"
    ...
    assert (
        interaction_active_workstream[
            "baseline_component_equation_source_applicability_gap_resolution_strategy_packet_accepted"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "source_applicability_gap_resolution_strategy_packet_accepted"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "source_applicability_gap_resolution_strategy_accepted_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "source_applicability_gap_resolution_paths_accepted_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "source_applicability_gap_resolution_strategy_rows_accepted_as_future_paths_only"
        ]
        == "yes"
    )
    assert interaction_active_workstream["strategy_rows_accepted_as_not_executed"] == (
        "yes"
    )
    assert (
        interaction_active_workstream[
            "accepted_source_applicability_gap_resolution_strategy_field_count"
        ]
        == 9
    )
    assert (
        interaction_active_workstream[
            "accepted_source_applicability_gap_resolution_strategy_row_count"
        ]
        == 8
    )
    assert (
        interaction_active_workstream[
            "accepted_source_applicability_gap_resolution_strategy_path_count"
        ]
        == 8
    )
    assert (
        interaction_active_workstream["accepted_strategy_path_clarification_needed_count"]
        == 3
    )
    assert (
        interaction_active_workstream[
            "accepted_strategy_path_standard_theory_import_work_needed_count"
        ]
        == 3
    )
    assert (
        interaction_active_workstream[
            "accepted_strategy_path_literature_review_needed_count"
        ]
        == 3
    )
    assert (
        interaction_active_workstream[
            "accepted_strategy_path_source_replacement_if_needed_count"
        ]
        == 3
    )
    assert (
        interaction_active_workstream[
            "accepted_strategy_path_empirical_fit_design_needed_count"
        ]
        == 2
    )
    assert (
        interaction_active_workstream[
            "accepted_strategy_row_applicability_candidate_unclear_count"
        ]
        == 3
    )
    assert (
        interaction_active_workstream[
            "accepted_strategy_row_applicability_candidate_blocked_count"
        ]
        == 5
    )
    assert (
        interaction_active_workstream[
            "accepted_strategy_row_applicability_candidate_supported_count"
        ]
        == 0
    )
    assert (
        interaction_active_workstream[
            "accepted_strategy_row_applicability_candidate_rejected_for_slot_count"
        ]
        == 0
    )
    assert (
        interaction_active_workstream["gap_resolution_priority_selection_packet_selected"]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "gap_resolution_priority_selection_required_before_source_validation"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "gap_resolution_priority_selection_required_before_equation_import"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "gap_resolution_priority_selection_required_before_empirical_fit"
        ]
        == "yes"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "open_system_decoherence_clarification_packet_accepted"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream["open_system_decoherence_clarification_accepted_only"]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "open_system_decoherence_gap_clarification_accepted_only"
        ]
        == "yes"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "open_system_decoherence_clarification_resolved_rows_accepted"
        ]
        == "no"
    )
    assert (
        interaction_active_workstream["open_system_decoherence_gap_still_unresolved"]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "open_system_decoherence_source_path_still_unresolved"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "open_system_decoherence_equation_import_still_blocked"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "open_system_decoherence_tau_baseline_still_blocked"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "open_system_decoherence_requirement_refinement_packet_selected"
        ]
        == "yes"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "open_system_decoherence_source_requirement_refinement_packet_prepared"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "open_system_decoherence_source_requirement_refinement_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "open_system_decoherence_source_requirements_refined_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "open_system_decoherence_source_requirement_refinement_executed"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "open_system_decoherence_unresolved_clarification_rows_retained"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "open_system_decoherence_requirements_satisfied"
        ]
        == "no"
    )
    assert (
        interaction_active_workstream[
            "open_system_decoherence_source_validation_ready"
        ]
        == "no"
    )
    assert (
        interaction_active_workstream[
            "open_system_decoherence_tau_baseline_ready"
        ]
        == "no"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "open_system_decoherence_master_equation_form_imported"
        ]
        == "no"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "open_system_decoherence_physical_regime_requirement_refined"
        ]
        == "yes"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "open_system_decoherence_observable_mapping_requirement_refined"
        ]
        == "yes"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "open_system_decoherence_domain_limits_requirement_refined"
        ]
        == "yes"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "open_system_decoherence_source_provenance_requirement_refined"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "open_system_decoherence_uncertainty_boundary_requirement_refined"
        ]
        == "yes"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "open_system_decoherence_source_requirement_refinement_packet_accepted"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "open_system_decoherence_source_requirement_refinement_accepted_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "open_system_decoherence_refined_requirements_accepted_only"
        ]
        == "yes"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "open_system_decoherence_source_candidate_rescreening_packet_selected"
        ]
        == "yes"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "accepted_open_system_decoherence_requirement_refinement_field_count"
        ]
        == 11
    )
    assert (
        interaction_active_workstream[
            "accepted_open_system_decoherence_requirement_refinement_row_count"
        ]
        == 8
    )
    assert (
        interaction_active_workstream[
            "accepted_open_system_decoherence_requirement_refinement_requirement_count"
        ]
        == 8
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "accepted_open_system_decoherence_clarification_row_count"
        ]
        == 8
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "accepted_open_system_decoherence_clarification_resolved_row_count"
        ]
        == 0
    )
    assert (
    ...
    assert (
        interaction_active_workstream["source_validation_execution_authorized"]
        == "no"
    )
    assert (
        interaction_active_workstream[
    ...
    assert (
        interaction_active_workstream[
            "baseline_component_equation_source_applicability_gap_classification_packet_accepted"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "source_applicability_gap_classification_accepted_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "unclear_and_blocked_gap_classifications_accepted_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "accepted_gap_classified_applicability_candidate_unclear_count"
        ]
        == 3
    )
    assert (
        interaction_active_workstream[
            "accepted_gap_classified_applicability_candidate_blocked_count"
        ]
        == 5
    )
    assert (
        interaction_active_workstream[
            "accepted_gap_classified_applicability_candidate_supported_count"
        ]
        == 0
    )
    assert (
        interaction_active_workstream["source_applicability_gaps_remediated_count"]
        == 0
    )
    assert interaction_active_workstream["source_candidates_replaced_count"] == 0
    assert interaction_active_workstream["gap_resolution_strategy_packet_selected"] == (
        "yes"
    )
    assert (
        interaction_active_workstream[
            "gap_resolution_strategy_required_before_source_validation"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "source_applicability_gap_resolution_strategy_packet_prepared"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream["source_applicability_gap_resolution_strategy_only"]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "source_applicability_gap_resolution_paths_selected_only"
        ]
        == "yes"
    )
    assert (
    ...
    assert (
        interaction_active_workstream[
            "source_applicability_gap_resolution_strategy_path_count"
        ]
        == 8
    )
    assert interaction_active_workstream["strategy_path_clarification_needed_count"] == 3
    assert (
        interaction_active_workstream[
            "strategy_path_standard_theory_import_work_needed_count"
        ]
        == 3
    )
    assert interaction_active_workstream["strategy_path_literature_review_needed_count"] == 3
    assert (
        interaction_active_workstream[
            "strategy_path_source_replacement_if_needed_count"
        ]
        == 3
    )
    assert interaction_active_workstream["strategy_path_empirical_fit_design_needed_count"] == 2
    assert interaction_active_workstream["strategy_rows_executed_count"] == 0
    assert interaction_active_workstream["source_resolution_path_selected"] == "yes"
    assert interaction_active_workstream["source_remediation_strategy_selected"] == "yes"
    assert interaction_active_workstream["source_replacement_strategy_selected"] == "yes"
    assert interaction_active_workstream["literature_review_strategy_selected"] == "yes"
    assert interaction_active_workstream["standard_theory_import_work_selected"] == "yes"
    assert interaction_active_workstream["empirical_fit_design_selected"] == "yes"
    assert interaction_active_workstream["source_resolution_strategy_executed"] == "no"
    assert interaction_active_workstream["source_candidate_replacement_selected"] == "no"
    assert (
        interaction_active_workstream[
            "source_applicability_gap_classification_packet_prepared"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream["source_applicability_gap_classification_only"]
        == "yes"
    )
    assert (
        interaction_active_workstream["source_applicability_gaps_classified_only"]
        == "yes"
    )
    assert (
        interaction_active_workstream[
    ...
    assert (
        interaction_active_workstream["source_applicability_gap_remediation_performed"]
        == "no"
    )
    assert (
        interaction_active_workstream["source_candidate_replacement_performed"]
    ...
    assert interaction_active_workstream["source_candidate_registry_accepted_only"] == (
        "yes"
    )
    assert (
        interaction_active_workstream[
            "source_candidates_accepted_as_candidate_rows_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream["source_applicability_review_packet_selected"]
        == "yes"
    )
    assert (
        interaction_active_workstream["source_applicability_review_packet_prepared"]
        == "yes"
    )
    assert interaction_active_workstream["source_applicability_review_only"] == "yes"
    assert (
        interaction_active_workstream["candidate_source_applicability_map_prepared"]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "candidate_source_applicability_review_executed"
        ]
        == "yes"
    )
    assert interaction_active_workstream["candidate_source_applicability_checked"] == (
        "yes"
    )
    assert interaction_active_workstream["candidate_source_applicability_accepted"] == (
        "no"
    )
    assert interaction_active_workstream["source_candidate_applicability_determined"] == (
        "no"
    )
    assert (
        interaction_active_workstream["source_candidate_registry_packet_prepared"]
        == "yes"
    )
    assert interaction_active_workstream["source_candidate_registry_only"] == "yes"
    assert interaction_active_workstream["source_candidates_listed_only"] == "yes"
    assert (
        interaction_active_workstream["source_candidates_for_future_review_only"]
        == "yes"
    )
    assert interaction_active_workstream["source_candidate_registry_source_class_count"] == 3
    assert (
        interaction_active_workstream[
    ...
    assert interaction_active_workstream["literature_supplied_candidate_source_count"] == 3
    assert interaction_active_workstream["empirical_fit_needed_candidate_source_count"] == 2
    assert interaction_active_workstream["candidate_source_accepted"] == "no"
    assert interaction_active_workstream["candidate_source_validated"] == "no"
    assert interaction_active_workstream["candidate_source_adopted"] == "no"
    assert interaction_active_workstream["candidate_equation_adopted"] == "no"
    ...
    assert (
        interaction_active_workstream["source_validation_criteria_accepted_only"]
        == "yes"
    )
    assert (
        interaction_active_workstream["source_acceptance_criteria_accepted_only"]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "source_validation_criteria_rows_accepted_as_criteria_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream["source_candidate_registry_packet_selected"]
        == "yes"
    )
    assert (
        interaction_active_workstream[
    ...
    assert interaction_active_workstream["source_validation_criteria_only"] == "yes"
    assert (
        interaction_active_workstream["source_acceptance_criteria_defined_only"]
        == "yes"
    )
    assert interaction_active_workstream["source_validated"] == "no"
    assert interaction_active_workstream["source_validation_executed"] == "no"
    assert interaction_active_workstream["component_equations_derived"] == "no"
    assert interaction_active_workstream["component_equations_imported"] == "no"
    assert interaction_active_workstream["literature_equations_adopted"] == "no"
    assert interaction_active_workstream["empirical_fit_executed"] == "no"
    assert interaction_active_workstream["equation_source_validated"] == "no"
    assert (
        interaction_active_workstream[
            "measurement_feedback_baseline_pressure_packet_accepted_as_baseline_hardening_only"
        ]
    ...
    assert (
        interaction_active_workstream[
            "external_source_treated_as_baseline_pressure_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream["external_source_treated_as_toe_evidence"]
        == "no"
    )
    assert (
        interaction_active_workstream["external_source_treated_as_ccft_evidence"]
        == "no"
    )
    assert (
        interaction_active_workstream[
    ...
    assert (
        interaction_active_workstream["baseline_component_registry_result_review_consumed"]
        == "yes"
    )
    assert (
        interaction_active_workstream["baseline_component_interaction_risk_traceability_only"]
        == "yes"
    )
    assert (
        interaction_active_workstream["tau_baseline_component_interaction_risks_mapped"]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "interaction_risks_recorded_as_baseline_warnings_only"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream["baseline_component_interaction_risk_id_count"]
        == 8
    )
    assert (
        interaction_active_workstream["measurement_back_action_coupling_risk_recorded"]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "detector_efficiency_feedback_control_coupling_risk_recorded"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "feedback_delay_hamiltonian_control_coupling_risk_recorded"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream["control_field_decoherence_coupling_risk_recorded"]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "measurement_feedback_energy_accounting_coupling_risk_recorded"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream[
            "detector_efficiency_measurement_record_coupling_risk_recorded"
        ]
        == "yes"
    )
    assert (
        interaction_active_workstream["feedback_control_field_coupling_risk_recorded"]
        == "yes"
    )
    assert (
        interaction_active_workstream["delay_energy_accounting_coupling_risk_recorded"]
        == "yes"
    )
    assert (
    ...
    assert interaction_active_workstream["component_independence_claimed"] == "no"
    assert interaction_active_workstream["interaction_model_completed"] == "no"
    assert interaction_active_workstream["interaction_coupling_terms_computed"] == "no"
    assert (
        interaction_active_workstream[
            "residual_formula_changed_by_interaction_risk_packet"
        ]
        == "no"
    )
    assert interaction_active_workstream[
    ...
    assert interaction_active_workstream["priority_selection_result_review_consumed"] == (
        "yes"
    )
    assert interaction_active_workstream[
        "selected_candidate_instantiated_for_future_packet_only"
    ...
    assert interaction_active_workstream[
        "selected_observable_bound_as_planning_row"
    ] == "yes"
    assert interaction_active_workstream[
        "selected_baseline_bound_as_planning_row"
    ] == "yes"
    assert interaction_active_workstream[
        "selected_falsifier_bound_as_planning_row"
    ] == "yes"
    assert interaction_active_workstream[
        "selected_candidate_packet_accepted_as_future_packet_only"
    ] == "yes"
    ...
    assert interaction_active_workstream["tolerance_registry_result_review_consumed"] == (
        "yes"
    )
    assert interaction_active_workstream["tolerance_registry_review_result"] == (
        tolerance_registry_review_outcome
    )
    assert interaction_active_workstream["tolerance_registry_review_strict_result"] == (
        tolerance_registry_review_strict_outcome
    )
    ...
    assert interaction_active_workstream["baseline_not_accepted_as_complete"] == "yes"
    assert interaction_active_workstream["baseline_adequacy_accepted"] == "no"
    assert interaction_active_workstream["baseline_empirical_fit_quality_accepted"] == (
        "no"
    )
    assert interaction_active_workstream[
        "statistical_decision_rule_validity_accepted"
    ] == "no"
    assert interaction_active_workstream["observed_separation_accepted"] == "no"
    assert interaction_active_workstream["ccft_predicted_separation_accepted"] == "no"
    assert interaction_active_workstream[
    ...
    assert interaction_active_workstream["future_packet_preparation_only"] == "yes"
    assert interaction_active_workstream["empirical_test_executed"] == "no"
    assert interaction_active_workstream["C_k_action_embedding_authorized"] == "no"
    assert interaction_active_workstream["C_k_variation_authorized"] == "no"
    assert interaction_active_workstream[
        "empirical_discriminator_claims_authorized"
    ] == "no"
    ...
    assert interaction_active_workstream["gap_discharged"] == "no"
    ...
    assert consumed_A_source_packet["selected_next_target"] == (
        A_source_packet_review_target
    )
    assert consumed_A_source_packet["source_admissibility_condition"] == (
        A_source_packet_source_condition
    )
    assert consumed_A_source_packet["psi_A_sourced_route_substituted"] == "no"
    assert consumed_A_source_packet["C_source_A_discharged"] == "no"
    assert consumed_A_source_packet["proof_execution_authorized"] == "no"
    assert consumed_A_source_packet["theorem_discharged"] == "no"
    assert consumed_A_source_packet["rule_promoted"] == "no"
    assert consumed_A_source_packet["master_action_promoted"] == "no"

    consumed_A_source_review = _workstream(payload, A_source_packet_review_target)
    ...
    assert consumed_A_source_review["selected_next_target"] == A_source_attempt_target
    ...
    consumed_A_source_attempt = _workstream(payload, A_source_attempt_target)
    assert consumed_A_source_attempt["status"] == "paused"
    assert consumed_A_source_attempt["report"] == A_source_attempt_report
    assert consumed_A_source_attempt["attempt_preparation_result"] == (
        A_source_attempt_outcome
    )
    assert consumed_A_source_attempt["strict_attempt_preparation_result"] == (
        A_source_attempt_strict_outcome
    )
    assert consumed_A_source_attempt["selected_next_target"] == (
        A_source_attempt_result_review_target
    )
    assert consumed_A_source_attempt["C_source_A_residual_definition"] == (
        A_source_attempt_residual_definition
    )
    assert consumed_A_source_attempt["source_admissibility_condition"] == (
        A_source_packet_source_condition
    )
    assert consumed_A_source_attempt["target_conclusion"] == (
        A_source_attempt_target_conclusion
    )
    assert consumed_A_source_attempt["J_current_imported"] == "no"
    assert consumed_A_source_attempt["psi_A_sourced_route_substituted"] == "no"
    assert consumed_A_source_attempt["C_source_A_discharged"] == "no"
    assert consumed_A_source_attempt["theorem_discharged"] == "no"
    assert consumed_A_source_attempt["rule_promoted"] == "no"
    assert consumed_A_source_attempt["master_action_promoted"] == "no"

    consumed_A_source_attempt_review = _workstream(
        payload, A_source_attempt_result_review_target
    )
    assert consumed_A_source_attempt_review["status"] == "paused"
    assert (
        consumed_A_source_attempt_review["report"]
        == A_source_attempt_result_review_report
    )
    assert consumed_A_source_attempt_review["attempt_preparation_result"] == (
        A_source_attempt_outcome
    )
    assert consumed_A_source_attempt_review["strict_attempt_preparation_result"] == (
        A_source_attempt_strict_outcome
    )
    assert consumed_A_source_attempt_review["review_result"] == (
        A_source_attempt_result_review_outcome
    )
    assert consumed_A_source_attempt_review["strict_review_result"] == (
        A_source_attempt_result_review_strict_outcome
    )
    assert consumed_A_source_attempt_review["selected_next_target"] == (
        A_source_closeout_target
    )
    assert consumed_A_source_attempt_review["C_source_A_residual_definition"] == (
        A_source_attempt_residual_definition
    )
    assert consumed_A_source_attempt_review["source_admissibility_condition"] == (
        A_source_packet_source_condition
    )
    assert consumed_A_source_attempt_review["target_conclusion"] == (
        A_source_attempt_target_conclusion
    )
    assert consumed_A_source_attempt_review["J_current_imported"] == "no"
    assert consumed_A_source_attempt_review["psi_A_sourced_route_substituted"] == "no"
    assert consumed_A_source_attempt_review["C_source_A_discharged"] == "yes"
    assert consumed_A_source_attempt_review["theorem_discharged"] == "yes"
    assert consumed_A_source_attempt_review["rule_promoted"] == "no"
    assert consumed_A_source_attempt_review["master_action_promoted"] == "no"
    ...
    assert consumed_selector_review["review_result"] == (
        psi_A_exchange_chain_selector_review_outcome
    )
    ...
    assert consumed_selector_review["C_source_A_discharged"] == "no"
    assert consumed_selector_review["proof_execution_authorized"] == "no"
    assert consumed_selector_review["theorem_discharged"] == "no"
    assert consumed_selector_review["gap_discharged"] == "no"
    assert consumed_selector_review["rule_promoted"] == "no"
    assert consumed_selector_review["master_action_promoted"] == "no"

    consumed_selector = _workstream(payload, psi_A_exchange_chain_selector_target)
    ...
    assert consumed_selector["selected_next_target"] == (
        psi_A_exchange_chain_selector_review_target
    )
    ...
    assert consumed_closeout_result_review["review_result"] == (
        psi_A_interaction_exchange_chain_closeout_result_review_outcome
    )
    ...
    assert (
        consumed_closeout_result_review["selected_next_target"]
        == psi_A_exchange_chain_selector_target
    )
    ...
    assert consumed_closeout_result_review["gauge_sector_exchange_linkage_included"] == "yes"
    assert (
        consumed_closeout_result_review[
            "local_psi_A_interaction_exchange_support_chain_closed"
        ]
        == "yes"
    )
    assert consumed_closeout_result_review["new_proof_execution_in_review"] == "no"
    assert consumed_closeout_result_review["rule_promoted"] == "no"
    assert consumed_closeout_result_review["master_action_promoted"] == "no"

    consumed_closeout = _workstream(
        payload, psi_A_interaction_exchange_chain_closeout_target
    )
    assert consumed_closeout["status"] == "paused"
    assert consumed_closeout["closeout_result"] == (
        psi_A_interaction_exchange_chain_closeout_outcome
    )
    ...
    assert consumed_closeout["gauge_sector_exchange_linkage_locally_closed"] == "yes"
    assert (
        consumed_closeout["local_psi_A_interaction_exchange_support_chain_closed"]
        == "yes"
    )
    assert consumed_closeout["new_proof_execution_in_closeout"] == "no"
    assert consumed_closeout["rule_promoted"] == "no"
    assert consumed_closeout["master_action_promoted"] == "no"

    consumed_synthesis_result_review = _workstream(
        payload, psi_A_interaction_exchange_chain_synthesis_result_review_target
    )
    assert consumed_synthesis_result_review["status"] == "paused"
    assert consumed_synthesis_result_review["review_result"] == (
        psi_A_interaction_exchange_chain_synthesis_result_review_outcome
    )
    assert consumed_synthesis_result_review["strict_review_result"] == (
        psi_A_interaction_exchange_chain_synthesis_result_review_strict_outcome
    )
    assert (
        consumed_synthesis_result_review["selected_next_target"]
        == psi_A_interaction_exchange_chain_closeout_target
    )
    assert consumed_synthesis_result_review["C_exchange_linkage_included"] == "yes"
    assert consumed_synthesis_result_review["total_conservation_linkage_included"] == "yes"
    assert consumed_synthesis_result_review["matter_sector_exchange_linkage_included"] == "yes"
    assert consumed_synthesis_result_review["gauge_sector_exchange_linkage_included"] == "yes"
    assert consumed_synthesis_result_review["new_proof_execution_in_review"] == "no"
    assert consumed_synthesis_result_review["rule_promoted"] == "no"
    assert consumed_synthesis_result_review["master_action_promoted"] == "no"

    consumed_synthesis = _workstream(
        payload,
        "prepare_psi_A_interaction_exchange_theorem_linkage_chain_synthesis_after_cexchange_total_matter_and_gauge_closeouts",
    )
    assert consumed_synthesis["status"] == "paused"
    assert consumed_synthesis["packet_result"] == (
        psi_A_interaction_exchange_chain_synthesis_outcome
    )
    assert consumed_synthesis["strict_packet_result"] == (
        psi_A_interaction_exchange_chain_synthesis_strict_outcome
    )
    assert (
        consumed_synthesis["selected_next_target"]
        == psi_A_interaction_exchange_chain_synthesis_result_review_target
    )
    assert consumed_synthesis["synthesis_packet_prepared"] == "yes"
    assert consumed_synthesis["new_proof_execution_in_packet"] == "no"
    assert consumed_synthesis["theorem_discharged"] == "no"
    assert consumed_synthesis["rule_promoted"] == "no"
    assert consumed_synthesis["master_action_promoted"] == "no"

    consumed_gauge_closeout_review = _workstream(
        payload,
        "review_psi_A_gauge_sector_exchange_theorem_linkage_obligation_closeout_result",
    )
    assert consumed_gauge_closeout_review["status"] == "paused"
    assert consumed_gauge_closeout_review["review_result"] == (
        psi_A_gauge_exchange_closeout_result_review_outcome
    )
    assert consumed_gauge_closeout_review["strict_review_result"] == (
        psi_A_gauge_exchange_closeout_result_review_strict_outcome
    )
    assert consumed_gauge_closeout_review["closeout_result"] == (
        psi_A_gauge_exchange_closeout_outcome
    )
    assert consumed_gauge_closeout_review["selected_next_target"] == (
        "prepare_psi_A_interaction_exchange_theorem_linkage_chain_synthesis_after_"
        "cexchange_total_matter_and_gauge_closeouts"
    )
    assert consumed_gauge_closeout_review["synthesis_target_authorized"] == "yes"
    assert consumed_gauge_closeout_review["synthesis_packet_prepared"] == "no"
    assert consumed_gauge_closeout_review[
    ...
    compact_active_workstream = active_workstream(payload)
    assert compact_active_workstream["workstream_id"] == LIVE_TARGET
    assert compact_active_workstream["status"] == "active"
    assert compact_active_workstream["authorization_evidence"] == str(
        LIVE_TARGET_EVIDENCE_PATH.relative_to(REPO_ROOT)
    ).replace("\\", "/")
    active_targets = {
        state["live_next_target"],
        compact_active_workstream[
