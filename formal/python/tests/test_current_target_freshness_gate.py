...
LIVE_TARGET_REPORT = (
    ...
    "TARGETED_LITERATURE_REVIEW_EXPANSION_SCOPE_PACKET_RESULT_REVIEW_20260705_v0.json"
)
...
LIVE_TARGET_OUTCOME = (
    ...
    "LITERATURE_REVIEW_EXPANSION_SCOPE_PACKET_RESULT_REVIEW_ACCEPTS_"
    "LITERATURE_EXPANSION_SCOPE_ONLY_NO_SOURCE_SEARCH_EXECUTION_OR_EQUATION_"
    "ADOPTION"
)
...
LIVE_TARGET_STRICT_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_LITERATURE_EXPANSION_SCOPE_PACKET_RESULT_REVIEW_ACCEPTS_SCOPE_"
    "ONLY_NO_SOURCE_VALIDATION_NO_LINDBLAD_IMPORT_NO_TAU_BASELINE_"
    "COMPUTATION_NO_MASTER_ACTION_PROMOTION"
)
...
def test_single_live_target_is_machine_pinned_after_samplerep32_audit_selector() -> None:
    ...
    assert interaction_active_workstream["source_candidates_listed"] == "no"
    assert interaction_active_workstream["source_candidates_discovered"] == "no"
    assert interaction_active_workstream["source_discovery_executed"] == "no"
    ...
    assert interaction_active_workstream["source_search_executed"] == "no"
