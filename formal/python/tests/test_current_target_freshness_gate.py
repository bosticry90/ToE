...
LIVE_TARGET_REPORT = (
    ...
    "TARGETED_LITERATURE_REVIEW_EXPANSION_CANDIDATE_DISCOVERY_PACKET_20260705_v0.json"
)
...
LIVE_TARGET_OUTCOME = (
    ...
    "LITERATURE_REVIEW_EXPANSION_CANDIDATE_DISCOVERY_PACKET_PREPARED_LISTS_"
...
LIVE_TARGET_STRICT_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_LITERATURE_EXPANSION_CANDIDATE_DISCOVERY_PACKET_PREPARED_"
    "CANDIDATE_DISCOVERY_ONLY_NO_LINDBLAD_IMPORT_NO_TAU_BASELINE_"
    "COMPUTATION_NO_MASTER_ACTION_PROMOTION"
)
...
def test_single_live_target_is_machine_pinned_after_samplerep32_audit_selector() -> None:
    ...
    assert (
        interaction_active_workstream[
            "source_candidates_remain_unvalidated_after_triage"
        ]
        == "yes"
    )
