...
ACTIVE_LANE = (
    "qft_gr_conserved_renormalized_stress_energy_source_witness_obstruction_refinement_packet"
)
PREVIOUS_TARGET = (
...
def test_single_live_target_is_machine_pinned_after_samplerep32_audit_selector() -> None:
    ...
    assert current_active_workstream["selected_route"] == (
        "qft_gr_stress_energy_conservation_witness_packet_after_obstruction_refinement"
    )
    ...
    assert current_active_workstream["track2_started"] == (
        "obstruction_refinement_packet_prepared_conservation_witness_packet_pending"
    )
