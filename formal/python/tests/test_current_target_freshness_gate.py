...
def test_single_live_target_is_machine_pinned_after_samplerep32_audit_selector() -> None:
    ...
    assert interaction_active_workstream["route_step_count"] == 6
    ...
    assert interaction_active_workstream["review_criteria_count"] == 8
    assert interaction_active_workstream["blocked_claim_count"] == 12
    for key in [
