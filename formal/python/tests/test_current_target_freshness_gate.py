...
LIVE_TARGET_OUTCOME = (
    ...
    "LITERATURE_REVIEW_EXPANSION_CANDIDATE_DISCOVERY_PACKET_RESULT_REVIEW_"
    "ACCEPTS_TARGETED_LITERATURE_CANDIDATES_ONLY_NO_SOURCE_VALIDATION_OR_"
    "EQUATION_ADOPTION"
)
...
LIVE_TARGET_STRICT_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_LITERATURE_EXPANSION_CANDIDATE_DISCOVERY_PACKET_RESULT_REVIEW_"
    "ACCEPTS_CANDIDATE_DISCOVERY_ONLY_NO_LINDBLAD_IMPORT_NO_TAU_BASELINE_"
    "COMPUTATION_NO_MASTER_ACTION_PROMOTION"
)
...
def test_single_live_target_is_machine_pinned_after_samplerep32_audit_selector() -> None:
    ...
    assert interaction_active_workstream["source_candidate_triage_packet_prepared"] == "no"
    assert interaction_active_workstream["source_candidate_triage_executed"] == "no"
    assert (
        interaction_active_workstream[
    ...
    assert interaction_active_workstream["source_candidate_roles_classified"] == "no"
    assert interaction_active_workstream["source_candidate_roles_classified_only"] == "no"
    assert (
    ...
    assert interaction_active_workstream["source_candidate_triage_review_selected"] == "no"
