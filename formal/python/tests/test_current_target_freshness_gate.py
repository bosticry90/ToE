...
PREVIOUS_TARGET = OPERATOR_DOMAIN_ASSUMPTION_REDUCTION_CLOSEOUT_PACKET_RESULT_REVIEW_TARGET
LIVE_TARGET = RENORMALIZATION_ASSUMPTION_REDUCTION_PACKET_TARGET
...
def test_single_live_target_is_machine_pinned_after_samplerep32_audit_selector() -> None:
    ...
    assert current_active_workstream["track2_selected_after_result_review"] == (
        "renormalization_assumption_reduction_packet_preparation_selected"
    )
    ...
    assert current_active_workstream["track2_started"] == (
        "renormalization_assumption_reduction_packet_preparation_pending"
    )
    ...
    assert current_active_workstream["track2_selected_after_this_review"] == (
        "renormalization_assumption_family_packet_preparation_selected"
    )
    ...
    assert current_active_workstream["next_bounded_action"] == PREVIOUS_TARGET
    ...
    assert current_active_workstream["next_operator_domain_assumption_reduction_target"] == PREVIOUS_TARGET
