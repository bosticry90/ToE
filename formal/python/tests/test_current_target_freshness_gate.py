...
def test_single_live_target_is_machine_pinned_after_samplerep32_audit_selector() -> None:
    ...
    assert current_active_workstream["selected_route"] == (
        "qft_gr_stress_energy_conservation_obstruction_refinement_packet_after_attempt_result_review"
    )
    ...
    assert current_active_workstream["track2_started"] == (
        "conservation_witness_attempt_result_reviewed_refinement_packet_pending"
    )
    ...
    assert current_active_workstream["next_action_scope"] == (
        "PREPARE_QFT_GR_STRESS_ENERGY_CONSERVATION_OBSTRUCTION_REFINEMENT_PACKET_ONLY_"
