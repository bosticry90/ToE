...
ACTIVE_LANE = "qft_gr_state_admissibility_boundary_assumption_reduction_packet_result_review"
ATTEMPT_TARGET = (
...
def test_single_live_target_is_machine_pinned_after_samplerep32_audit_selector() -> None:
    ...
    assert (
        ...
        == "qft_gr_state_admissibility_boundary_assumption_reduction_packet_result_review_v0"
    )
