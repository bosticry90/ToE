...
ACTIVE_LANE = "review_ck_family_theorem_linkage_priority_selection_after_index_result"
ATTEMPT_TARGET = (
...
PREVIOUS_LIVE_TARGET = "prepare_ck_family_theorem_linkage_priority_selection_after_index"
...
LIVE_TARGET = "review_ck_family_theorem_linkage_priority_selection_after_index_result"
...
def test_single_live_target_is_machine_pinned_after_samplerep32_audit_selector() -> None:
    ...
    ck_family_theorem_linkage_priority_selection_after_index_result = (
        "CK_FAMILY_THEOREM_LINKAGE_PRIORITY_SELECTION_AFTER_INDEX_PREPARED_PRIORITY_"
        "RANKING_SELECTS_TOP_OBLIGATION_CANDIDATE_NO_THEOREM_DISCHARGE_OR_MASTER_"
        "ACTION_PROMOTION"
    )
