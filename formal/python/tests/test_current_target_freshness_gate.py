...
def test_single_live_target_is_machine_pinned_after_samplerep32_audit_selector() -> None:
    ...
    assert current_active_workstream["track2_selection_kind"] == (
        "qft_gr_selected_operator_action_assumption_reduction_attempt_result_review_only"
    )
    ...
    assert current_active_workstream["track2_started"] == (
        "selected_operator_action_assumption_reduction_attempt_executed_pending_result_review"
    )
    ...
    assert current_active_workstream["selected_operator_action_attempt_result_review_target"] == LIVE_TARGET
