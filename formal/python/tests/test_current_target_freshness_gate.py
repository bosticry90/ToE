...
ACTIVE_LANE = "prepare_psi_A_total_conservation_theorem_linkage_obligation_packet"
ATTEMPT_TARGET = (
...
LIVE_TARGET = "prepare_psi_A_total_conservation_theorem_linkage_obligation_packet"
...
def test_single_live_target_is_machine_pinned_after_samplerep32_audit_selector() -> None:
    ...
    assert interaction_active_workstream["selection_outcome"] == (
        ck_family_selection_after_cexchange_outcome
    )
    ...
    assert interaction_active_workstream["packet_scope"] == (
