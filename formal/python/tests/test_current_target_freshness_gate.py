...
ACTIVE_LANE = (
    "qft_gr_stress_energy_conservation_witness_packet"
)
PREVIOUS_TARGET = (
...
def test_single_live_target_is_machine_pinned_after_samplerep32_audit_selector() -> None:
    ...
    assert current_active_workstream["selected_route"] == (
        "qft_gr_stress_energy_conservation_witness_packet_result_review_after_packet_preparation"
    )
    ...
    assert current_active_workstream["track2_started"] == (
        "conservation_witness_packet_prepared_pending_result_review"
    )
