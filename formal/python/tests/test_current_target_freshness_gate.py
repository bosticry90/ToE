...
ACTIVE_LANE = "review_ck_family_theorem_linkage_obligation_selection_after_index_result"
ATTEMPT_TARGET = (
...
PREVIOUS_LIVE_TARGET = "select_next_ck_family_theorem_linkage_obligation_after_index"
...
LIVE_TARGET = "review_ck_family_theorem_linkage_obligation_selection_after_index_result"
...
def test_single_live_target_is_machine_pinned_after_samplerep32_audit_selector() -> None:
    ...
    ck_family_theorem_linkage_obligation_selection_after_index_result = (
        "CK_FAMILY_THEOREM_LINKAGE_OBLIGATION_SELECTION_AFTER_INDEX_SELECTS_"
        "PRIORITY_SELECTION_PACKET_NO_PROOF_EXECUTION_OR_MASTER_ACTION_PROMOTION"
    )
