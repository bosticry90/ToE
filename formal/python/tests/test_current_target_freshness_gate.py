...
LIVE_TARGET_OUTCOME = (
    ...
    "NARROWING_SCOPE_PACKET_RESULT_REVIEW_ACCEPTS_PLATFORM_NARROWING_SCOPE_"
    "ONLY_NO_PLATFORM_SELECTION_EXECUTION_OR_EQUATION_ADOPTION"
)
...
LIVE_TARGET_STRICT_OUTCOME = (
    "SELECTED_CCFT_EMPIRICAL_DISCRIMINATOR_BASELINE_COMPONENT_EQUATION_"
    "SOURCE_PLATFORM_NARROWING_SCOPE_PACKET_RESULT_REVIEW_ACCEPTS_SCOPE_ONLY_"
...
def test_single_live_target_is_machine_pinned_after_samplerep32_audit_selector() -> None:
    ...
    assert interaction_active_workstream["platform_candidate_selected"] == "no"
    assert interaction_active_workstream["selected_platform_candidate_count"] == 0
    assert (
        interaction_active_workstream[
