...
LIVE_TARGET_EVIDENCE_PATH = (
    ...
    / "ToeFormal"
    / "Derivation"
    / "ToeNativeCoherenceRepresentationV0ResultReview.lean"
)
LIVE_TARGET_REPORT = (
    "formal/docs/release/TOE_NATIVE_COHERENCE_REPRESENTATION_V0_"
...
LIVE_TARGET_STRICT_OUTCOME = (
    "NATIVE_SURROGATE_V0_BLOCKED_AT_STAGE_1_NO_REPAIR_STAGES_2_TO_5_"
    "PROHIBITED_NO_UNIQUE_TOE_DISCRIMINATOR_V0"
)
