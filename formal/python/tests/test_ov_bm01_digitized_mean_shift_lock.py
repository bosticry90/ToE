...
def test_ov_bm01_digitized_lock_matches_computed_record() -> None:
    rec = ovbm01_digitized_mean_shift_dataset_record(date="2026-01-23")
    ...
    assert locked["digitization_id"] == "OV-BM-01N"
