...
def test_cosmo_m2_literature_alignment_scaffold_cycle01_gate() -> None:
    ...
    assert _extract_token(cosmo_text, "COSMO_M2_LITERATURE_ALIGNMENT_STATUS_v0") == "SCAFFOLD_PINNED_NONCLAIM"
    assert _extract_token(state_text, "COSMO_M2_LITERATURE_ALIGNMENT_STATUS_v0") == "SCAFFOLD_PINNED_NONCLAIM"
    assert _extract_token(roadmap_text, "COSMO_M2_LITERATURE_ALIGNMENT_STATUS_v0") == "SCAFFOLD_PINNED_NONCLAIM"
