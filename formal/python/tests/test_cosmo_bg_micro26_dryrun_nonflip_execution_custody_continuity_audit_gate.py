...
register_cosmo_nonflip_gate_suite(
    ...
    CosmoNonflipGateSpec(
        micro_id="26",
        micro_doc_relative_path="formal/docs/paper/DERIVATION_TARGET_COSMOLOGY_BACKGROUND_MICRO_26_DRYRUN_NONFLIP_EXECUTION_CUSTODY_CONTINUITY_AUDIT_v0.md",
        artifact_relative_path="formal/output/cosmo_bg_micro26_dryrun_nonflip_execution_custody_continuity_audit_cycle01_v0.json",
        gate_relative_path="formal/python/tests/test_cosmo_bg_micro26_dryrun_nonflip_execution_custody_continuity_audit_gate.py",
        ...
        expected_artifact_id="cosmo_bg_micro26_dryrun_nonflip_execution_custody_continuity_audit_cycle01_v0",
        expected_cycle="CYCLE-026",
        expected_boundary_statement="DRYRUN_NONFLIP_LANE_ONLY_EXECUTION_CUSTODY_CONTINUITY_NO_ADJUDICATION_FLIP_NO_COMPARATOR_AUTHORIZATION",
        matrix_doc_key="dryrun_nonflip_execution_custody_continuity_audit_doc",
        matrix_gate_key="dryrun_nonflip_execution_custody_continuity_audit_gate",
        matrix_policy_key="dryrun_nonflip_execution_custody_continuity_audit_policy",
        matrix_policy_value="CYCLE08_09_10_11_12_13_14_15_16_17_18_19_20_21_22_23_24_25_DRYRUN_NONFLIP_EXECUTION_CUSTODY_CONTINUITY_LOCK_REQUIRED_NO_STATUS_FLIP_NO_COMPARATOR_AUTHORIZATION",
