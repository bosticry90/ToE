...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "qft_gr_covariant_conservation_statement_with_operator_domain_packet_result_review_report.py"
)
...
def test_qft_gr_covariant_conservation_statement_with_operator_domain_packet_result_review_files_exist() -> None:
...
def test_qft_gr_covariant_conservation_statement_with_operator_domain_packet_result_review_consumes_packet() -> None:
    ...
    assert review["statement_formulation_accepted"] is True
    assert review["statement_formulated_under_accepted_operator_domain"] is True


def test_qft_gr_covariant_conservation_statement_with_operator_domain_packet_result_review_preserves_nonclaims() -> None:
    review = _json(DEFAULT_OUT)
...
def test_qft_gr_covariant_conservation_statement_with_operator_domain_packet_result_review_selects_one_witness_attempt_target() -> None:
    review = _json(DEFAULT_OUT)
...
def test_qft_gr_covariant_conservation_statement_with_operator_domain_packet_result_review_deterministic_and_pinned() -> None:
    review = _json(DEFAULT_OUT)
    generated = (
        build_qft_gr_covariant_conservation_statement_with_operator_domain_packet_result_review(
