...
DESIGN_REPORT_PATH = (
    ...
    / "output"
    / "reports"
    / "post_recovery_stat_der01_sign_definiteness_witness_binding_design_20260424_v0.json"
)
GAP_REPORT_PATH = (
    REPO_ROOT
    / "formal"
    / "output"
    / "reports"
    / "post_recovery_stat_der01_theorem_body_discharge_gap_isolation_20260424_v0.json"
)
...
EXPECTED_ARTIFACT_ID = "stat_der01_entropy_production_sign_definiteness_witness_binding_v0"
EXPECTED_WITNESS_OBJECT_ID = "STAT_DER01_ENTROPY_PRODUCTION_SIGN_DEFINITENESS_WITNESS_BINDING_OBJECT_v0"
EXPECTED_GAP_ID = "STAT_DER01_ENTROPY_PRODUCTION_SIGN_DEFINITENESS_WITNESS_BINDING_v0"
EXPECTED_GATE_REL = "formal/python/tests/test_stat_der01_entropy_production_sign_definiteness_witness_binding_gate.py"
...
def test_stat_der01_entropy_production_sign_definiteness_witness_binding_gate() -> None:
    ...
    assert payload.get("results_row_id") == "TOE-STAT-DER-01"
    assert payload.get("results_row_expected_label") == "T-PROVED"
    assert payload.get("status") == "sign_definiteness_witness_binding_pinned_nonclaim"
    assert payload.get("sign_definiteness_witness_result") == "SIGN_DEFINITENESS_WITNESS_PINNED_NONCLAIM"
    ...
    for binding in payload["slot_bindings"].values():
        ...
        assert source_payload["results_row_id"] == "TOE-STAT-DER-01"
