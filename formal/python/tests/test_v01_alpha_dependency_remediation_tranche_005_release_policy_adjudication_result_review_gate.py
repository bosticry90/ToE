...
from formal.python.tools.v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_result_review_report import (
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_result_review_report.py"
)
...
LEAN_RESULT_REVIEW_PATH = (
    ...
    / "ToeFormal"
    / "Release"
    / "V01DependencyRemediationTranche005ReleasePolicyAdjudicationResultReview.lean"
)
...
def test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_result_review_files_exist() -> None:
...
def test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_result_review_consumes_adjudication() -> None:
    ...
    assert review["consumes_adjudication"] == (
        "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_RELEASE_POLICY_ADJUDICATION_v0"
    )
...
def test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_result_review_preserves_selected_dependency() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_result_review_preserves_policy_result_and_evidence() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_result_review_authorizes_documentation_packet_only() -> None:
    review = _json(RESULT_REVIEW_PATH)
    ...
    assert review["tranche_005_policy_status"] == "policy_acceptable_documentation_required"
...
def test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_result_review_carries_tranche_004_and_006() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_result_review_keeps_blockers_tracked() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_result_review_forbidden_effects_false() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_result_review_next_target() -> None:
    review = _json(RESULT_REVIEW_PATH)
    ...
    assert {row["target"]: row["decision"] for row in review["candidate_next_targets"]} == {
        "prepare_v01_alpha_dependency_remediation_tranche_005_documentation_packet": "selected",
...
def test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_result_review_acceptance_and_determinism() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_result_review_is_pinned() -> None:
    ...
    refs = [
        ...
        "formal/python/tools/v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_result_review_report.py",
        "formal/python/tests/test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_result_review_gate.py",
        OUTCOME_ID,
        NEXT_TARGET,
    ]
    for ref in refs:
    ...
    assert "V01DependencyRemediationTranche005ReleasePolicyAdjudicationResultReview" in index_text
    assert (
        "v01_dependency_remediation_tranche_005_release_policy_adjudication_result_review_does_not_promote_release"
        in index_text
    )
