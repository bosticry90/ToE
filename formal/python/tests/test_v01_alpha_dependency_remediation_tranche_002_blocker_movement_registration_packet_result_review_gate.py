...
from formal.python.tools.v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_packet_result_review_report import (
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_packet_result_review_report.py"
)
...
LEAN_RESULT_REVIEW_PATH = (
    ...
    / "ToeFormal"
    / "Release"
    / "V01DependencyRemediationTranche002BlockerMovementRegistrationPacketResultReview.lean"
)
...
def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_packet_result_review_files_exist() -> None:
...
def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_packet_result_review_consumes_packet() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert review["schema_id"] == (
        "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_BLOCKER_MOVEMENT_REGISTRATION_PACKET_RESULT_REVIEW_20260515_v0"
    )
...
def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_packet_result_review_preserves_selected_dependency() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_packet_result_review_accepts_exact_proposed_movement() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_packet_result_review_preserves_evidence_policy_and_documentation() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_packet_result_review_authorizes_execution_only() -> None:
    review = _json(RESULT_REVIEW_PATH)
    proposal = review["movement_proposal"]
    assert (
...
def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_packet_result_review_keeps_blocker_unmoved() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_packet_result_review_remaining_blockers_tracked() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_packet_result_review_forbidden_effects_false() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_packet_result_review_next_target() -> None:
    review = _json(RESULT_REVIEW_PATH)
    ...
    assert {row["target"]: row["decision"] for row in review["candidate_next_targets"]} == {
        "execute_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration": "selected",
...
def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_packet_result_review_acceptance_and_determinism() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_packet_result_review_is_pinned() -> None:
    roadmap_text = _read(PHYSICS_ROADMAP_PATH)
    refs = [
        REVIEW_ID,
        "formal/docs/release/V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_BLOCKER_MOVEMENT_REGISTRATION_PACKET_RESULT_REVIEW_20260515_v0.json",
        "formal/python/tools/v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_packet_result_review_report.py",
        "formal/python/tests/test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_packet_result_review_gate.py",
        OUTCOME_ID,
        NEXT_TARGET,
    ]
    for ref in refs:
    ...
    assert (
        "V01DependencyRemediationTranche002BlockerMovementRegistrationPacketResultReview"
        in index_text
    )
    assert (
        "v01_dependency_remediation_tranche_002_blocker_movement_registration_packet_result_review_does_not_register_movement"
        in index_text
    )
