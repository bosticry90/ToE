...
from formal.python.tools.v01_alpha_dependency_remediation_tranche_006_status_adjudication_result_review_report import (
...
ADJUDICATION_PATH = (
    RELEASE_DIR / "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_STATUS_ADJUDICATION_20260522_v0.json"
)
RESULT_REVIEW_PATH = (
    RELEASE_DIR
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "v01_alpha_dependency_remediation_tranche_006_status_adjudication_result_review_report.py"
)
...
LEAN_RESULT_REVIEW_PATH = (
    ...
    / "ToeFormal"
    / "Release"
    / "V01DependencyRemediationTranche006StatusAdjudicationResultReview.lean"
)
...
def test_v01_alpha_dependency_remediation_tranche_006_status_adjudication_result_review_files_exist() -> None:
...
def test_v01_alpha_dependency_remediation_tranche_006_status_adjudication_result_review_consumes_adjudication() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert review["schema_id"] == (
        "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_STATUS_ADJUDICATION_RESULT_REVIEW_20260522_v0"
    )
    ...
    assert review["consumes_adjudication_pointer"] == (
        "formal/docs/release/V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_STATUS_ADJUDICATION_20260522_v0.json"
    )


def test_v01_alpha_dependency_remediation_tranche_006_status_adjudication_result_review_preserves_selected_dependency() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert review["review_scope"] == (
        "REVIEW_TRANCHE_006_STATUS_ADJUDICATION_RESULT_ONLY_"
        "AUTHORIZE_BLOCKER_MOVEMENT_REGISTRATION_PACKET_PREPARATION_NO_DIRECT_MOVEMENT"
    )
...
def test_v01_alpha_dependency_remediation_tranche_006_status_adjudication_result_review_preserves_candidate() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_006_status_adjudication_result_review_preserves_evidence_policy_and_documentation() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_006_status_adjudication_result_review_authorizes_registration_preparation_only() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_006_status_adjudication_result_review_carries_posture() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_006_status_adjudication_result_review_remaining_blockers_tracked() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_006_status_adjudication_result_review_forbidden_effects_false() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_006_status_adjudication_result_review_next_target() -> None:
    review = _json(RESULT_REVIEW_PATH)
    ...
    assert review["next_action_scope"] == (
        "PREPARE_TRANCHE_006_BLOCKER_MOVEMENT_REGISTRATION_PACKET_ONLY_NO_DIRECT_BLOCKER_MOVEMENT_OR_RELEASE_PROMOTION"
    )
    assert {row["target"]: row["decision"] for row in review["candidate_next_targets"]} == {
        "prepare_v01_alpha_dependency_remediation_tranche_006_blocker_movement_registration_packet": "selected",
...
def test_v01_alpha_dependency_remediation_tranche_006_status_adjudication_result_review_acceptance_and_determinism() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_006_status_adjudication_result_review_is_pinned() -> None:
    roadmap_text = _read(PHYSICS_ROADMAP_PATH)
    refs = [
        REVIEW_ID,
        "formal/docs/release/V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_006_STATUS_ADJUDICATION_RESULT_REVIEW_20260522_v0.json",
        "formal/python/tools/v01_alpha_dependency_remediation_tranche_006_status_adjudication_result_review_report.py",
        "formal/python/tests/test_v01_alpha_dependency_remediation_tranche_006_status_adjudication_result_review_gate.py",
        OUTCOME_ID,
        NEXT_TARGET,
    ]
    for ref in refs:
    ...
    assert "V01DependencyRemediationTranche006StatusAdjudicationResultReview" in index_text
    assert (
        "v01_dependency_remediation_tranche_006_status_adjudication_result_review_does_not_register_movement"
        in index_text
    )
