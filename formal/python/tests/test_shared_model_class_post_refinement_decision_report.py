...
from formal.python.tools import shared_model_class_post_refinement_decision_report as tool
    ...
    _write_json(
        path,
        {
            "required_inputs": {
                ...
                "shared_model_class_binding_refinement_report": "formal/output/reports/shared_model_class_binding_refinement_20260412_v0.json",
            ...
            "decision_policy": {
                ...
                "required_refinement_outcome": "SHARED_MODEL_CLASS_BINDING_STILL_PARTIAL_HOLD",
                "required_refinement_next_action": "OPEN_NEXT_BOUNDED_REFINEMENT_OR_HOLD_DECISION_LAYER",
            ...
            "decision_contract": {
                ...
                "single_terminal_outcome_rule": "EXACTLY_ONE_ALLOWED_SHARED_MODEL_CLASS_POST_REFINEMENT_DECISION_OUTCOME",
                "no_loop_rule": "ONE_SHARED_MODEL_CLASS_POST_REFINEMENT_DECISION_LAYER_ONLY",
                "default_outcome": "HOLD_SHARED_MODEL_CLASS_AS_EXTERNALLY_COMPARABLE_BUT_NOT_PROBE_READY",
            },
        },
    )
...
def _seed_inputs(
    ...
    *,
    ...
    refinement_outcome: str = "SHARED_MODEL_CLASS_BINDING_STILL_PARTIAL_HOLD",
) -> None:
    _write_json(
        root / "formal" / "output" / "reports" / "shared_model_class_comparator_binding_execution_20260412_v0.json",
        {"summary": {"terminal_outcome": binding_outcome}},
    )
    _write_json(
        root / "formal" / "output" / "reports" / "shared_model_class_binding_refinement_20260412_v0.json",
        {
            "summary": {
...
def test_reports_hold_as_externally_comparable_not_probe_ready(tmp_path: Path, monkeypatch) -> None:
    ...
    declaration_path = tmp_path / "formal" / "docs" / "release" / "SHARED_MODEL_CLASS_POST_REFINEMENT_DECISION_20260412_v0.json"
...
def test_reports_path_falsified(tmp_path: Path, monkeypatch) -> None:
    ...
    report = tool.build_report(declaration_path=declaration_path, captured_at_utc=None)
    assert report["summary"]["terminal_outcome"] == "PATH_FALSIFIED"
