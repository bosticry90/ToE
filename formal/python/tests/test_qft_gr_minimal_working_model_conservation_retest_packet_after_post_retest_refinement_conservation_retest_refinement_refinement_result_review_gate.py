...
from formal.python.tools.qft_gr_minimal_working_model_conservation_retest_packet_after_post_retest_refinement_conservation_retest_refinement_refinement_result_review_report import (
    ...
    REVIEW_ID,
    SCHEMA_ID,
    build_qft_gr_minimal_working_model_conservation_retest_packet_after_post_retest_refinement_conservation_retest_refinement_refinement_result_review,
)
...
def test_post_retest_refinement_conservation_retest_refinement_refinement_packet_result_review_files_exist() -> None:
...
def test_post_retest_refinement_conservation_retest_refinement_refinement_packet_result_review_consumes_packet() -> None:
...
def test_post_retest_refinement_conservation_retest_refinement_refinement_packet_result_review_accepts_protocol() -> None:
    review = _json(DEFAULT_OUT)
    assert review["packet_result_review_accepted"] is True
    assert review["retest_packet_result_review_accepted"] is True
    assert (
        review[
            "post_retest_refinement_conservation_retest_refinement_refinement_packet_result_review_accepted"
        ]
        is True
    )
...
def test_post_retest_refinement_conservation_retest_refinement_refinement_packet_result_review_authorizes_attempt_only() -> None:
    review = _json(DEFAULT_OUT)
...
def test_post_retest_refinement_conservation_retest_refinement_refinement_packet_result_review_preserves_nonclaims() -> None:
    review = _json(DEFAULT_OUT)
    for key in [
...
def test_post_retest_refinement_conservation_retest_refinement_refinement_packet_result_review_validation_policy() -> None:
    review = _json(DEFAULT_OUT)
...
def test_post_retest_refinement_conservation_retest_refinement_refinement_packet_result_review_updates_live_target() -> None:
    ...
    assert state["live_next_target_report"] == (
        "formal/docs/release/"
        "QFT_GR_MINIMAL_WORKING_MODEL_CONSERVATION_RETEST_PACKET_AFTER_POST_"
        "RETEST_REFINEMENT_CONSERVATION_RETEST_REFINEMENT_REFINEMENT_RESULT_REVIEW_20260614_v0.json"
    )
    ...
    assert (
        active_workstream[
            "post_retest_refinement_conservation_retest_refinement_refinement_packet_result_review_consumed"
        ]
        == "yes"
    )
...
def test_post_retest_refinement_conservation_retest_refinement_refinement_packet_result_review_deterministic() -> None:
    review = _json(DEFAULT_OUT)
    generated = build_qft_gr_minimal_working_model_conservation_retest_packet_after_post_retest_refinement_conservation_retest_refinement_refinement_result_review(
...
def test_post_retest_refinement_conservation_retest_refinement_refinement_packet_result_review_not_manifest_enrolled() -> None:
    assert_focused_gate_not_manifest_enrolled(
        "test_qft_gr_minimal_working_model_conservation_retest_packet_after_post_retest_refinement_conservation_retest_refinement_refinement_result_review_gate.py"
    )
