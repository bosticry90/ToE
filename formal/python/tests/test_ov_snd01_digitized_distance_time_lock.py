...
def test_ov_snd01_digitized_lock_matches_computed_record() -> None:
    rec = ovsnd01_digitized_propagation_dataset_record(date="2026-01-24")
    ...
    assert locked["digitization_id"] == "OV-SND-01N"
