...
from formal.python.tools.v01_alpha_retained_tranche_004_source_map_closure_registration_report import (
    ...
    EXECUTION_ID as REGISTRATION_EXECUTION_ID,
    OUTCOME_ID as REGISTRATION_OUTCOME,
...
from formal.python.tools.v01_alpha_retained_tranche_004_source_map_closure_registration_result_review_report import (
    ...
    build_source_map_closure_registration_result_review,
)
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "v01_alpha_retained_tranche_004_source_map_closure_registration_result_review_report.py"
)
...
def test_v01_alpha_retained_tranche_004_source_map_closure_registration_result_review_files_exist() -> None:
    assert DEFAULT_REGISTRATION_PATH.exists()
...
def test_v01_alpha_retained_tranche_004_source_map_closure_registration_result_review_consumes_registration_execution() -> None:
    review = _json(DEFAULT_OUT)
    registration = _json(DEFAULT_REGISTRATION_PATH)
    ...
    assert (
        review["consumes_source_map_closure_registration_execution"]
        == REGISTRATION_EXECUTION_ID
    )
    assert review["consumes_source_map_closure_registration_execution_pointer"] == (
        "formal/docs/release/"
        "V01_ALPHA_RETAINED_TRANCHE_004_SOURCE_MAP_CLOSURE_REGISTRATION_20260523_v0.json"
    )
    assert registration["outcome_id"] == REGISTRATION_OUTCOME
    assert registration["selected_next_target"] == (
        "review_v01_alpha_retained_tranche_004_source_map_closure_registration_result"
    )
    assert (
        review["consumed_source_map_closure_registration_result_classification"]
        == REGISTRATION_RESULT_CLASSIFICATION
    )


def test_v01_alpha_retained_tranche_004_source_map_closure_registration_result_review_accepts_registered_source_map_closure() -> None:
    review = _json(DEFAULT_OUT)
    ...
    assert review["source_map_closure_registration_result_reviewed"] is True
    assert review["source_map_closure_registration_result_accepted_by_review"] is True
    ...
    assert review["source_map_closure_registration_finalized_by_review"] is True
    assert review["source_map_closure_registered"] is True
    assert review["source_map_closure_registered_as_final"] is True
...
def test_v01_alpha_retained_tranche_004_source_map_closure_registration_result_review_carries_execution_material() -> None:
    review = _json(DEFAULT_OUT)
    assert review["source_map_closure_registration_executed"] is True
    assert review["source_map_closure_registered_pending_result_review"] is False
    assert review["source_map_closure_registration_pending_result_review"] is False
    assert review["source_map_closure_registration_result_review_required"] is False
    assert review["source_map_closure_registration_result_review_authorized"] is False
    ...
    assert review["registration_execution_step_count"] == 5


def test_v01_alpha_retained_tranche_004_source_map_closure_registration_result_review_preserves_retained_blocker_before_movement_packet() -> None:
    review = _json(DEFAULT_OUT)
...
def test_v01_alpha_retained_tranche_004_source_map_closure_registration_result_review_authorizes_packet_preparation_only() -> None:
    review = _json(DEFAULT_OUT)
    assert review["blocker_movement_packet_preparation_authorized"] is True
    assert review["blocker_movement_registration_packet_preparation_authorized"] is True
    assert review["blocker_movement_registration_packet_preparation_only"] is True
...
def test_v01_alpha_retained_tranche_004_source_map_closure_registration_result_review_does_not_promote_downstream() -> None:
    review = _json(DEFAULT_OUT)
...
def test_v01_alpha_retained_tranche_004_source_map_closure_registration_result_review_forbidden_effects_false() -> None:
    review = _json(DEFAULT_OUT)
...
def test_v01_alpha_retained_tranche_004_source_map_closure_registration_result_review_selects_exactly_one_next_target() -> None:
    review = _json(DEFAULT_OUT)
...
def test_v01_alpha_retained_tranche_004_source_map_closure_registration_result_review_determinism() -> None:
    review = _json(DEFAULT_OUT)
    for key, value in review["acceptance_criteria"].items():
        assert value is True, f"Acceptance criterion failed: {key}"

    generated_1 = build_source_map_closure_registration_result_review(
        registration_path=DEFAULT_REGISTRATION_PATH,
        captured_at_utc=DEFAULT_CAPTURED_AT_UTC,
    )
    generated_2 = build_source_map_closure_registration_result_review(
        registration_path=DEFAULT_REGISTRATION_PATH,
        captured_at_utc=DEFAULT_CAPTURED_AT_UTC,
    )
...
def test_v01_alpha_retained_tranche_004_source_map_closure_registration_result_review_is_pinned() -> None:
    roadmap_text = _read(ROADMAP_PATH)
    refs = [
        REVIEW_ID,
        "formal/docs/release/V01_ALPHA_RETAINED_TRANCHE_004_SOURCE_MAP_CLOSURE_REGISTRATION_RESULT_REVIEW_20260523_v0.json",
        "formal/python/tools/v01_alpha_retained_tranche_004_source_map_closure_registration_result_review_report.py",
        "formal/python/tests/test_v01_alpha_retained_tranche_004_source_map_closure_registration_result_review_gate.py",
        OUTCOME_ID,
        RESULT_REVIEW_CLASSIFICATION,
        REGISTRATION_RESULT_CLASSIFICATION,
        NEXT_TARGET,
    ...
    assert "V01RetainedTranche004SourceMapClosureRegistrationResultReview" in index_text
    assert (
        "v01_alpha_retained_tranche_004_source_map_closure_registration_result_review_authorizes_blocker_movement_packet_preparation_only"
        in index_text
    )
