...
from formal.python.tools.qft_gr_discovery_discriminator_tranche_report import build_report


def test_qft_gr_discovery_discriminator_tranche_report_is_executable() -> None:
    ...
    payload = build_report(declaration_path=declaration, captured_at_utc="2026-04-11T23:59:58Z")

    assert payload["schema_id"] == "QFT_GR_DISCOVERY_DISCRIMINATOR_TRANCHE_REPORT_20260411_v0"
