...
def test_qft_gr_seam_packet11_bounded_execution_authority_parity_and_invariance() -> None:
    ...
    for ref in refs:
        assert ref in state_text, f"Missing packet11 execution pointer in State_of_the_Theory.md: {ref}"
        assert ref in roadmap_text, f"Missing packet11 execution pointer in PHYSICS_ROADMAP_v0.md: {ref}"

    state_packet11 = _extract_token(state_text, "TOE_QFT_GR_SEAM_PACKET11_STATUS_v0")
