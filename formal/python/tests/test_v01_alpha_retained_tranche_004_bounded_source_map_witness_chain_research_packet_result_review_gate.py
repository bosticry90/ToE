...
from formal.python.tools.v01_alpha_retained_tranche_004_bounded_source_map_witness_chain_research_packet_report import (
    ...
    OUTCOME_ID as PACKET_OUTCOME_ID,
    PACKET_ID,
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "v01_alpha_retained_tranche_004_bounded_source_map_witness_chain_research_packet_result_review_report.py"
)
...
def test_v01_alpha_retained_tranche_004_bounded_witness_chain_packet_result_review_files_exist() -> None:
...
def test_v01_alpha_retained_tranche_004_bounded_witness_chain_packet_result_review_consumes_packet() -> None:
    ...
    assert review["consumes_bounded_source_map_witness_chain_research_packet"] == PACKET_ID
    assert review["consumes_bounded_source_map_witness_chain_research_packet_pointer"] == (
        "formal/docs/release/"
    ...
    assert packet["outcome_id"] == PACKET_OUTCOME_ID
...
def test_v01_alpha_retained_tranche_004_bounded_witness_chain_packet_result_review_accepts_preparation_only() -> None:
    review = _json(DEFAULT_OUT)
    assert review["research_packet_reviewed"] is True
    assert review["research_packet_accepted"] is True
    assert review["research_packet_accepted_as_preparation_only"] is True
    assert review["packet_accepted_as_closure_evidence"] is False
    assert review["blocked_object"] == BLOCKED_OBJECT
    assert review["missing_object"] == RESEARCH_PACKET_MISSING_OBJECT
    assert review["candidate_witness_chain_component_count"] == 7
    assert review["required_lean_theory_surface_count"] == 6
    ...
    assert review["sandbox_research_mode_boundary_count"] == 4
    assert review["promotion_firewall_count"] == 8


def test_v01_alpha_retained_tranche_004_bounded_witness_chain_packet_result_review_preserves_hold() -> None:
    review = _json(DEFAULT_OUT)
...
def test_v01_alpha_retained_tranche_004_bounded_witness_chain_packet_result_review_preserves_queue() -> None:
    review = _json(DEFAULT_OUT)
...
def test_v01_alpha_retained_tranche_004_bounded_witness_chain_packet_result_review_keeps_tranche_004() -> None:
    review = _json(DEFAULT_OUT)
...
def test_v01_alpha_retained_tranche_004_bounded_witness_chain_packet_result_review_selects_execution_only() -> None:
    review = _json(DEFAULT_OUT)
    assert review["selected_next_target"] == NEXT_TARGET
    assert review["selected_next_target_kind"] == (
        "bounded_source_map_witness_chain_research_attempt_execution_only"
    )
    assert review["selection_count"] == 1
    assert review["bounded_source_map_witness_chain_research_attempt_authorized_for_execution"] is True
    assert review["source_map_witness_chain_research_execution_authorized"] is True
    assert review["bounded_source_map_witness_chain_research_attempt_executed"] is False
    assert review["research_executed"] is False
    assert {row["target"]: row["decision"] for row in review["candidate_next_targets"]} == {
        RESEARCH_EXECUTION_TARGET: "selected",
        "route_v01_alpha_tranche_004_to_research_mode_or_main_physics_target_selection": "deferred",
        "review_v01_alpha_retained_tranche_004_bounded_source_map_witness_chain_research_attempt_result": "deferred",
...
def test_v01_alpha_retained_tranche_004_bounded_witness_chain_packet_result_review_forbidden_effects() -> None:
    review = _json(DEFAULT_OUT)
...
def test_v01_alpha_retained_tranche_004_bounded_witness_chain_packet_result_review_determinism() -> None:
    review = _json(DEFAULT_OUT)
...
def test_v01_alpha_retained_tranche_004_bounded_witness_chain_packet_result_review_is_pinned() -> None:
    ...
    refs = [
        ...
        "formal/python/tools/v01_alpha_retained_tranche_004_bounded_source_map_witness_chain_research_packet_result_review_report.py",
        "formal/python/tests/test_v01_alpha_retained_tranche_004_bounded_source_map_witness_chain_research_packet_result_review_gate.py",
        OUTCOME_ID,
        NEXT_TARGET,
        BLOCKED_OBJECT,
        RESEARCH_PACKET_MISSING_OBJECT,
    ...
    assert "V01RetainedTranche004BoundedSourceMapWitnessChainResearchPacketResultReview" in index_text
    assert (
        "v01_alpha_retained_tranche_004_bounded_source_map_witness_chain_research_packet_result_review_selects_bounded_research_attempt"
        in index_text
    )
