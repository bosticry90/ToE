...
from formal.python.tools.v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_result_review_report import (
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_result_review_report.py"
)
...
LEAN_RESULT_REVIEW_PATH = (
    ...
    / "ToeFormal"
    / "Release"
    / "V01DependencyRemediationTranche002BlockerMovementRegistrationResultReview.lean"
)
...
def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_result_review_files_exist() -> None:
...
def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_result_review_consumes_registration() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert review["schema_id"] == (
        "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_BLOCKER_MOVEMENT_REGISTRATION_RESULT_REVIEW_20260515_v0"
    )
    ...
    assert review["consumes_registration_pointer"] == (
        "formal/docs/release/V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_BLOCKER_MOVEMENT_REGISTRATION_20260515_v0.json"
    )


def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_result_review_registered_true() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert review["review_scope"] == (
        "REVIEW_TRANCHE_002_BLOCKER_MOVEMENT_REGISTRATION_RESULT_ONLY_ACCEPT_DOCUMENTED_NONBLOCKING_MOVEMENT_NO_RELEASE_PROMOTION"
    )
...
def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_result_review_exact_movement() -> None:
    review = _json(RESULT_REVIEW_PATH)
    ...
    assert movement["movement_scope"] == "tranche_002_only"
...
def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_result_review_preserves_evidence_policy_documentation_chain() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_result_review_accepts_formal_movement_only() -> None:
    review = _json(RESULT_REVIEW_PATH)
    ...
    assert review["tranche_002_release_blocker_status"] == REGISTERED_BLOCKER_STATUS
    assert review["tranche_002_dependency_policy_remediation_satisfied"] is True
    ...
    assert review["release_blocking_obligation_count_after_review"] == 4
    assert review["remaining_release_blocking_obligation_count_after_review"] == 4


def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_result_review_remaining_four_unmodified() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_result_review_forbidden_effects_false() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_result_review_next_target() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_result_review_acceptance_and_determinism() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_result_review_is_pinned() -> None:
    ...
    refs = [
        ...
        "formal/python/tools/v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_result_review_report.py",
        "formal/python/tests/test_v01_alpha_dependency_remediation_tranche_002_blocker_movement_registration_result_review_gate.py",
        OUTCOME_ID,
        NEXT_TARGET,
    ]
    for ref in refs:
    ...
    assert "V01DependencyRemediationTranche002BlockerMovementRegistrationResultReview" in index_text
    assert (
        "v01_dependency_remediation_tranche_002_blocker_movement_registration_result_review_does_not_promote_release"
        in index_text
    )
