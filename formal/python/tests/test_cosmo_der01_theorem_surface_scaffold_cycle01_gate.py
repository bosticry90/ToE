...
ARTIFACT_PATH = REPO_ROOT / "formal" / "output" / "cosmo_der01_theorem_surface_scaffold_cycle01_v0.json"

EXPECTED_ARTIFACT_ID = "cosmo_der01_theorem_surface_scaffold_cycle01_v0"
EXPECTED_GATE = "ARTIFACT_HASH_ROW_LABEL_AND_CROSS_SURFACE_POINTERS_REQUIRED"
EXPECTED_ROW_BINDING = "TOE_COSMO_DER_01_P_POLICY_THEOREM_SURFACE_SCAFFOLD_PINNED_NONCLAIM"
EXPECTED_ARTIFACT_REL = "formal/output/cosmo_der01_theorem_surface_scaffold_cycle01_v0.json"
EXPECTED_GATE_REL = "formal/python/tests/test_cosmo_der01_theorem_surface_scaffold_cycle01_gate.py"
...
def test_cosmo_der01_theorem_surface_scaffold_cycle01_gate() -> None:
    ...
    for token_name, expected in (
        ("COSMO_DER01_THEOREM_SURFACE_SCAFFOLD_CYCLE01_ARTIFACT_v0", EXPECTED_ARTIFACT_ID),
        ("COSMO_DER01_THEOREM_SURFACE_SCAFFOLD_CYCLE01_GATE_v0", EXPECTED_GATE),
        ("COSMO_DER01_THEOREM_SURFACE_ROW_BINDING_v0", EXPECTED_ROW_BINDING),
    ):
    ...
    assert _extract_token(cosmo_text, "COSMO_DER01_THEOREM_SURFACE_SCAFFOLD_CYCLE01_SHA256_v0") == payload_sha
    assert _extract_token(roadmap_text, "COSMO_DER01_THEOREM_SURFACE_SCAFFOLD_CYCLE01_SHA256_v0") == payload_sha
    assert _extract_token(state_text, "COSMO_DER01_THEOREM_SURFACE_SCAFFOLD_CYCLE01_SHA256_v0") == payload_sha
    ...
    for theorem_token in [
        ...
        assert theorem_token in lean_text, f"Missing Lean theorem surface token `{theorem_token}`."

    assert "TOE-COSMO-DER-01" in results_text
    assert "| TOE-COSMO-DER-01 | `T-CONDITIONAL` |" in results_text
