...
from formal.python.tools.v01_alpha_dependency_remediation_tranche_001_blocker_movement_registration_packet_report import (
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "v01_alpha_dependency_remediation_tranche_001_blocker_movement_registration_packet_report.py"
)
...
LEAN_PACKET_PATH = (
    ...
    / "ToeFormal"
    / "Release"
    / "V01DependencyRemediationTranche001BlockerMovementRegistrationPacket.lean"
)
...
def test_v01_alpha_dependency_remediation_tranche_001_blocker_movement_registration_packet_files_exist() -> None:
...
def test_v01_alpha_dependency_remediation_tranche_001_blocker_movement_registration_packet_consumes_status_result_review() -> None:
    packet = _json(PACKET_PATH)
    assert packet["schema_id"] == (
        "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_BLOCKER_MOVEMENT_REGISTRATION_PACKET_20260515_v0"
    )
...
def test_v01_alpha_dependency_remediation_tranche_001_blocker_movement_registration_packet_preserves_selected_dependency() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_001_blocker_movement_registration_packet_preserves_candidate_and_proposes_movement() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_001_blocker_movement_registration_packet_preserves_evidence_policy_and_documentation() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_001_blocker_movement_registration_packet_prepares_only() -> None:
    packet = _json(PACKET_PATH)
    proposal = packet["movement_proposal"]
...
def test_v01_alpha_dependency_remediation_tranche_001_blocker_movement_registration_packet_other_five_unmodified() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_001_blocker_movement_registration_packet_forbidden_effects_false() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_001_blocker_movement_registration_packet_next_target() -> None:
    packet = _json(PACKET_PATH)
    ...
    assert {row["target"]: row["decision"] for row in packet["candidate_next_targets"]} == {
        "review_v01_alpha_dependency_remediation_tranche_001_blocker_movement_registration_packet_result": "selected",
        "execute_v01_alpha_dependency_remediation_tranche_001_blocker_movement_registration": "deferred",
        "prepare_v01_alpha_release_readiness_adjudication_packet": "deferred",
    }


def test_v01_alpha_dependency_remediation_tranche_001_blocker_movement_registration_packet_acceptance_and_determinism() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_001_blocker_movement_registration_packet_is_pinned() -> None:
    ...
    refs = [
        ...
        "formal/python/tools/v01_alpha_dependency_remediation_tranche_001_blocker_movement_registration_packet_report.py",
        "formal/python/tests/test_v01_alpha_dependency_remediation_tranche_001_blocker_movement_registration_packet_gate.py",
        OUTCOME_ID,
        PROPOSED_MOVEMENT,
        NEXT_TARGET,
    ]
    ...
    assert "V01DependencyRemediationTranche001BlockerMovementRegistrationPacket" in index_text
    assert (
        "v01_dependency_remediation_tranche_001_blocker_movement_registration_packet_does_not_move_blocker"
        in index_text
    )
