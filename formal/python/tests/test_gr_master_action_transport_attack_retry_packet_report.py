...
from formal.python.tools import gr_master_action_transport_attack_retry_packet_report as tool
...
def _write_declaration(path: Path) -> None:
    _write_json(
        path,
        {
            ...
            "retry_binding": {
                "required_prior_packet_outcome": "GR_MASTER_ACTION_TRANSPORT_REQUIRES_UNDECLARED_STRUCTURE",
                "required_obligation_outcome": "GR_TRANSPORT_OBLIGATION_DECLARED",
                "required_obligation_id": "GR_MASTER_ACTION_TO_REGIME_LIMIT_TRANSPORT_OBLIGATION_v0",
                "required_attack_class": "GR_MASTER_ACTION_TRANSPORT_ATTACK",
            ...
            "ruling_contract": {
                ...
                "single_terminal_outcome_rule": "EXACTLY_ONE_ALLOWED_GR_MASTER_ACTION_TRANSPORT_RETRY_OUTCOME",
                "no_loop_rule": "ONE_GR_MASTER_ACTION_TRANSPORT_RETRY_PACKET_ONLY",
...
def _seed_inputs(
    root: Path,
    *,
    prior_packet_outcome: str = "GR_MASTER_ACTION_TRANSPORT_REQUIRES_UNDECLARED_STRUCTURE",
    obligation_outcome: str = "GR_TRANSPORT_OBLIGATION_DECLARED",
...
def test_reports_insufficient_even_with_declared_obligation(tmp_path: Path, monkeypatch) -> None:
    ...
    assert report["summary"]["terminal_outcome"] == "GR_TRANSPORT_OBLIGATION_DECLARED_BUT_STILL_INSUFFICIENT"
...
def test_reports_path_falsified_when_retry_binding_is_broken(tmp_path: Path, monkeypatch) -> None:
    ...
    _write_declaration(declaration_path)
    _seed_inputs(tmp_path, obligation_outcome="GR_TRANSPORT_OBLIGATION_NOT_JUSTIFIED")
