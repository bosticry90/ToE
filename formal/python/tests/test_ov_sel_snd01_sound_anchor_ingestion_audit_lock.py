...
def test_ov_sel_snd01_lock_matches_computed_record() -> None:
    rec = ovsel_snd01_sound_anchor_ingestion_audit_record(status_date="2026-01-24")
    ...
    assert locked["anchor"]["observable_id"] == "OV-SND-01"
