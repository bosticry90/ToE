...
PACKET_PATH = (
    RELEASE_DIR
    / "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_STATUS_ADJUDICATION_PACKET_20260515_v0.json"
)
RESULT_REVIEW_PATH = (
    RELEASE_DIR
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "v01_alpha_dependency_remediation_tranche_005_status_adjudication_packet_result_review_report.py"
)
...
LEAN_RESULT_REVIEW_PATH = (
    ...
    / "ToeFormal"
    / "Release"
    / "V01DependencyRemediationTranche005StatusAdjudicationPacketResultReview.lean"
)
...
def test_v01_alpha_dependency_remediation_tranche_005_status_adjudication_packet_result_review_files_exist() -> None:
...
def test_v01_alpha_dependency_remediation_tranche_005_status_adjudication_packet_result_review_consumes_packet() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert review["schema_id"] == (
        "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_STATUS_ADJUDICATION_PACKET_RESULT_REVIEW_20260515_v0"
    )
...
def test_v01_alpha_dependency_remediation_tranche_005_status_adjudication_packet_result_review_preserves_selected_dependency() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert review["review_scope"] == (
        "REVIEW_TRANCHE_005_STATUS_ADJUDICATION_PACKET_RESULT_ONLY_"
...
def test_v01_alpha_dependency_remediation_tranche_005_status_adjudication_packet_result_review_preserves_evidence_policy_and_documentation() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_005_status_adjudication_packet_result_review_authorizes_execution_only() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert (
    ...
    assert review["status_adjudication_question"] == (
        ...
        "and accepted documentation, can tranche 005 move from release-blocking to a "
...
def test_v01_alpha_dependency_remediation_tranche_005_status_adjudication_packet_result_review_keeps_blocker_unmoved() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_005_status_adjudication_packet_result_review_carries_posture() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_005_status_adjudication_packet_result_review_remaining_blockers_tracked() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_005_status_adjudication_packet_result_review_forbidden_effects_false() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_005_status_adjudication_packet_result_review_next_target() -> None:
    review = _json(RESULT_REVIEW_PATH)
    ...
    assert {row["target"]: row["decision"] for row in review["candidate_next_targets"]} == {
        "execute_v01_alpha_dependency_remediation_tranche_005_status_adjudication": "selected",
...
def test_v01_alpha_dependency_remediation_tranche_005_status_adjudication_packet_result_review_acceptance_and_determinism() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_005_status_adjudication_packet_result_review_is_pinned() -> None:
    roadmap_text = _read(PHYSICS_ROADMAP_PATH)
    refs = [
        REVIEW_ID,
        "formal/docs/release/V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_STATUS_ADJUDICATION_PACKET_RESULT_REVIEW_20260515_v0.json",
        "formal/python/tools/v01_alpha_dependency_remediation_tranche_005_status_adjudication_packet_result_review_report.py",
        "formal/python/tests/test_v01_alpha_dependency_remediation_tranche_005_status_adjudication_packet_result_review_gate.py",
        OUTCOME_ID,
        NEXT_TARGET,
    ]
    for ref in refs:
    ...
    assert "V01DependencyRemediationTranche005StatusAdjudicationPacketResultReview" in index_text
    assert (
        "v01_dependency_remediation_tranche_005_status_adjudication_packet_result_review_does_not_move_blocker"
        in index_text
    )
