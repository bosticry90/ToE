...
from formal.python.tools.v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_packet_result_review_report import (
...
PACKET_PATH = (
    RELEASE_DIR
    / "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_RELEASE_POLICY_ADJUDICATION_PACKET_20260515_v0.json"
)
RESULT_REVIEW_PATH = (
    RELEASE_DIR
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_packet_result_review_report.py"
)
...
LEAN_RESULT_REVIEW_PATH = (
    ...
    / "ToeFormal"
    / "Release"
    / "V01DependencyRemediationTranche003ReleasePolicyAdjudicationPacketResultReview.lean"
)
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_packet_result_review_files_exist() -> None:
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_packet_result_review_consumes_packet() -> None:
    ...
    assert review["consumes_packet_pointer"] == (
        "formal/docs/release/V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_RELEASE_POLICY_ADJUDICATION_PACKET_20260515_v0.json"
    )
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_packet_result_review_preserves_selected_dependency() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert review["review_scope"] == (
        "REVIEW_TRANCHE_003_RELEASE_POLICY_ADJUDICATION_PACKET_ONLY_"
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_packet_result_review_preserves_evidence() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert review["lean_audit_target"]["lean_target"] == LEAN_TARGET
    assert review["lean_audit_target"]["command"] == (
    ...
    assert "finite_transport_theorems_construct_residual_package_v0" in evidence["raw_output"]


def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_packet_result_review_accepts_policy_question_without_deciding() -> None:
    review = _json(RESULT_REVIEW_PATH)
    ...
    assert "standard Lean axiom posture of tranche 003" in review["expert_re_review_requirement"]
    assert review["policy_adjudication_execution_authorized"] is True
    assert review["policy_adjudication_execution_scope"] == (
        "DECIDE_ONLY_WHETHER_STANDARD_LEAN_AXIOMS_ARE_ACCEPTABLE_FOR_TRANCHE_003_"
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_packet_result_review_keeps_blockers_tracked() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_packet_result_review_forbidden_effects_false() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_packet_result_review_next_target() -> None:
    review = _json(RESULT_REVIEW_PATH)
    ...
    assert {row["target"]: row["decision"] for row in review["candidate_next_targets"]} == {
        "execute_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication": "selected",
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_packet_result_review_acceptance_and_determinism() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_packet_result_review_is_pinned() -> None:
    roadmap_text = _read(PHYSICS_ROADMAP_PATH)
    refs = [
        REVIEW_ID,
        "formal/docs/release/V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_RELEASE_POLICY_ADJUDICATION_PACKET_RESULT_REVIEW_20260515_v0.json",
        "formal/python/tools/v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_packet_result_review_report.py",
        "formal/python/tests/test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_packet_result_review_gate.py",
        OUTCOME_ID,
        NEXT_TARGET,
    ]
    for ref in refs:
    ...
    assert "V01DependencyRemediationTranche003ReleasePolicyAdjudicationPacketResultReview" in index_text
    assert (
        "v01_dependency_remediation_tranche_003_release_policy_adjudication_packet_result_review_does_not_make_policy_decision"
        in index_text
    )
