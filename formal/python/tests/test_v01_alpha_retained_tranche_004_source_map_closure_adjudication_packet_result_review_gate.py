...
from formal.python.tools.v01_alpha_retained_tranche_004_source_map_closure_adjudication_packet_result_review_report import (
    ...
    REVIEW_ID,
    SCHEMA_ID,
    build_source_map_closure_adjudication_packet_result_review,
)
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "v01_alpha_retained_tranche_004_source_map_closure_adjudication_packet_result_review_report.py"
)
...
LEAN_REVIEW_PATH = (
    ...
    / "ToeFormal"
    / "Release"
    / "V01RetainedTranche004SourceMapClosureAdjudicationPacketResultReview.lean"
)
...
def test_v01_alpha_retained_tranche_004_source_map_closure_adjudication_packet_result_review_files_exist() -> None:
...
def test_v01_alpha_retained_tranche_004_source_map_closure_adjudication_packet_result_review_consumes_packet_only() -> None:
    ...
    assert review["consumes_source_map_closure_adjudication_packet"] == PACKET_ID
    assert review["consumes_source_map_closure_adjudication_packet_pointer"] == (
        "formal/docs/release/"
...
def test_v01_alpha_retained_tranche_004_source_map_closure_adjudication_packet_result_review_accepts_bounded_execution_only() -> None:
    review = _json(DEFAULT_OUT)
    ...
    assert review["source_map_closure_adjudication_packet_result_reviewed"] is True
    assert review["source_map_closure_adjudication_packet_result_accepted"] is True
    assert (
        review["source_map_closure_adjudication_packet_accepted_for_bounded_execution_only"]
        is True
    )
    assert review["source_map_closure_adjudication_packet_accepted_as_closure_evidence"] is False
    assert review["result_review_classification"] == RESULT_REVIEW_CLASSIFICATION
    assert review["result_classification_count"] == 1
    assert review["bounded_source_map_closure_adjudication_execution_authorized"] is True
    assert review["source_map_closure_adjudication_execution_authorized_by_review"] is True
    assert review["source_map_closure_adjudication_execution_authorized"] is True
    assert review["source_map_closure_adjudication_executed"] is False
    assert review["source_map_closure_adjudication_execution_target"] == NEXT_TARGET


def test_v01_alpha_retained_tranche_004_source_map_closure_adjudication_packet_result_review_preserves_packet_boundary() -> None:
    review = _json(DEFAULT_OUT)
    assert review["source_map_closure_adjudication_packet_prepared"] is True
    assert review["source_map_closure_adjudication_packet_preparation_only"] is True
    assert review["source_map_closure_adjudication_question_prepared"] is True
    assert review["source_map_closure_adjudication_question_answered"] is False
    ...
    assert {
        row["packet_status"] for row in review["closure_adjudication_requirements"]
...
def test_v01_alpha_retained_tranche_004_source_map_closure_adjudication_packet_result_review_preserves_retained_blocker_and_release_hold() -> None:
    review = _json(DEFAULT_OUT)
...
def test_v01_alpha_retained_tranche_004_source_map_closure_adjudication_packet_result_review_no_closure_or_promotion() -> None:
    review = _json(DEFAULT_OUT)
...
def test_v01_alpha_retained_tranche_004_source_map_closure_adjudication_packet_result_review_forbidden_effects_false() -> None:
    review = _json(DEFAULT_OUT)
...
def test_v01_alpha_retained_tranche_004_source_map_closure_adjudication_packet_result_review_selects_exactly_one_next_target() -> None:
    review = _json(DEFAULT_OUT)
    ...
    selected = [row for row in review["candidate_next_targets"] if row["decision"] == "selected"]
    assert len(selected) == 1
    assert selected[0]["target"] == NEXT_TARGET


def test_v01_alpha_retained_tranche_004_source_map_closure_adjudication_packet_result_review_determinism() -> None:
    review = _json(DEFAULT_OUT)
    for key, value in review["acceptance_criteria"].items():
        assert value is True, f"Acceptance criterion failed: {key}"

    generated_1 = build_source_map_closure_adjudication_packet_result_review(
        packet_path=DEFAULT_PACKET_PATH,
        captured_at_utc=DEFAULT_CAPTURED_AT_UTC,
    )
    generated_2 = build_source_map_closure_adjudication_packet_result_review(
        packet_path=DEFAULT_PACKET_PATH,
        captured_at_utc=DEFAULT_CAPTURED_AT_UTC,
    )
...
def test_v01_alpha_retained_tranche_004_source_map_closure_adjudication_packet_result_review_is_pinned() -> None:
    ...
    refs = [
        ...
        "formal/python/tools/v01_alpha_retained_tranche_004_source_map_closure_adjudication_packet_result_review_report.py",
        "formal/python/tests/test_v01_alpha_retained_tranche_004_source_map_closure_adjudication_packet_result_review_gate.py",
        OUTCOME_ID,
        RESULT_REVIEW_CLASSIFICATION,
        PACKET_CLASSIFICATION,
        NEXT_TARGET,
    ...
    assert "V01RetainedTranche004SourceMapClosureAdjudicationPacketResultReview" in index_text
    assert (
        "v01_alpha_retained_tranche_004_source_map_closure_adjudication_packet_result_review_authorizes_bounded_closure_adjudication_execution_only"
        in index_text
    )
