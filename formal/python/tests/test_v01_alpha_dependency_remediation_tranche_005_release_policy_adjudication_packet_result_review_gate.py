...
from formal.python.tools.v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_packet_result_review_report import (
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_packet_result_review_report.py"
)
...
LEAN_RESULT_REVIEW_PATH = (
    ...
    / "ToeFormal"
    / "Release"
    / "V01DependencyRemediationTranche005ReleasePolicyAdjudicationPacketResultReview.lean"
)
...
def test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_packet_result_review_files_exist() -> None:
...
def test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_packet_result_review_consumes_packet() -> None:
    ...
    assert review["consumes_packet_pointer"] == (
        "formal/docs/release/V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_005_RELEASE_POLICY_ADJUDICATION_PACKET_20260515_v0.json"
    )
...
def test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_packet_result_review_preserves_selected_dependency() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_packet_result_review_preserves_evidence() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_packet_result_review_accepts_policy_question_without_deciding() -> None:
    review = _json(RESULT_REVIEW_PATH)
    ...
    assert "standard Lean axiom posture of tranche 005" in review["expert_re_review_requirement"]
...
def test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_packet_result_review_carries_tranche_004_and_006() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_packet_result_review_keeps_blockers_tracked() -> None:
    review = _json(RESULT_REVIEW_PATH)
    ...
    assert rows[1]["status_carry_forward"] == (
        "release_blocking_pending_tranche_005_policy_adjudication_execution"
    )
    ...
    for row in other:
        assert row["modified_by_tranche_005_release_policy_packet_result_review"] is False


def test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_packet_result_review_forbidden_effects_false() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_packet_result_review_next_target() -> None:
    review = _json(RESULT_REVIEW_PATH)
    ...
    assert {row["target"]: row["decision"] for row in review["candidate_next_targets"]} == {
        "execute_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication": "selected",
        "pause_v01_alpha_release_readiness_due_to_retained_tranche_004_blocker": "deferred",
        "prepare_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_005": "deferred",
    }


def test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_packet_result_review_acceptance_and_determinism() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_packet_result_review_is_pinned() -> None:
    ...
    refs = [
        ...
        "formal/python/tools/v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_packet_result_review_report.py",
        "formal/python/tests/test_v01_alpha_dependency_remediation_tranche_005_release_policy_adjudication_packet_result_review_gate.py",
        OUTCOME_ID,
        NEXT_TARGET,
    ]
    for ref in refs:
    ...
    assert (
        "V01DependencyRemediationTranche005ReleasePolicyAdjudicationPacketResultReview"
        in index_text
    )
    assert (
        "v01_dependency_remediation_tranche_005_release_policy_adjudication_packet_result_review_does_not_make_policy_decision"
        in index_text
    )
