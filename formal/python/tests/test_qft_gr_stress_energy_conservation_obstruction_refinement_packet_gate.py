...
from formal.python.tools.qft_gr_stress_energy_conservation_obstruction_refinement_packet_report import (
    ...
    SCHEMA_ID,
    build_qft_gr_stress_energy_conservation_obstruction_refinement_packet,
)
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "qft_gr_stress_energy_conservation_obstruction_refinement_packet_report.py"
)
...
def test_qft_gr_stress_energy_conservation_obstruction_refinement_packet_files_exist() -> None:
...
def test_qft_gr_stress_energy_conservation_obstruction_refinement_packet_consumes_review() -> None:
...
def test_qft_gr_stress_energy_conservation_obstruction_refinement_packet_rows_and_primary() -> None:
    packet = _json(DEFAULT_OUT)
    assert packet["missing_condition_menu"] == REFINEMENT_CANDIDATES
...
def test_qft_gr_stress_energy_conservation_obstruction_refinement_packet_preserves_nonclaim_boundaries() -> None:
    packet = _json(DEFAULT_OUT)
...
def test_qft_gr_stress_energy_conservation_obstruction_refinement_packet_selects_one_next_target() -> None:
    packet = _json(DEFAULT_OUT)
...
def test_qft_gr_stress_energy_conservation_obstruction_refinement_packet_deterministic_and_pinned() -> None:
    packet = _json(DEFAULT_OUT)
    generated = build_qft_gr_stress_energy_conservation_obstruction_refinement_packet(
