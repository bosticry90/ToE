...
from formal.python.tools.v01_alpha_dependency_remediation_tranche_002_release_policy_adjudication_packet_result_review_report import (
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "v01_alpha_dependency_remediation_tranche_002_release_policy_adjudication_packet_result_review_report.py"
)
...
LEAN_RESULT_REVIEW_PATH = (
    ...
    / "ToeFormal"
    / "Release"
    / "V01DependencyRemediationTranche002ReleasePolicyAdjudicationPacketResultReview.lean"
)
...
def test_v01_alpha_dependency_remediation_tranche_002_release_policy_adjudication_packet_result_review_files_exist() -> None:
...
def test_v01_alpha_dependency_remediation_tranche_002_release_policy_adjudication_packet_result_review_consumes_packet() -> None:
    ...
    assert review["consumes_packet_pointer"] == (
        "formal/docs/release/V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_RELEASE_POLICY_ADJUDICATION_PACKET_20260515_v0.json"
    )


def test_v01_alpha_dependency_remediation_tranche_002_release_policy_adjudication_packet_result_review_preserves_selected_dependency() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert review["review_scope"] == (
        "REVIEW_TRANCHE_002_RELEASE_POLICY_ADJUDICATION_PACKET_ONLY_AUTHORIZE_POLICY_ADJUDICATION_EXECUTION_NO_POLICY_DECISION"
    )
...
def test_v01_alpha_dependency_remediation_tranche_002_release_policy_adjudication_packet_result_review_preserves_evidence() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_release_policy_adjudication_packet_result_review_accepts_policy_question_without_deciding() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_release_policy_adjudication_packet_result_review_keeps_blockers_tracked() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_release_policy_adjudication_packet_result_review_forbidden_effects_false() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_release_policy_adjudication_packet_result_review_next_target() -> None:
    review = _json(RESULT_REVIEW_PATH)
    ...
    assert {row["target"]: row["decision"] for row in review["candidate_next_targets"]} == {
        "execute_v01_alpha_dependency_remediation_tranche_002_release_policy_adjudication": "selected",
...
def test_v01_alpha_dependency_remediation_tranche_002_release_policy_adjudication_packet_result_review_acceptance_and_determinism() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_release_policy_adjudication_packet_result_review_is_pinned() -> None:
    roadmap_text = _read(PHYSICS_ROADMAP_PATH)
    refs = [
        REVIEW_ID,
        "formal/docs/release/V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_RELEASE_POLICY_ADJUDICATION_PACKET_RESULT_REVIEW_20260515_v0.json",
        "formal/python/tools/v01_alpha_dependency_remediation_tranche_002_release_policy_adjudication_packet_result_review_report.py",
        "formal/python/tests/test_v01_alpha_dependency_remediation_tranche_002_release_policy_adjudication_packet_result_review_gate.py",
        OUTCOME_ID,
        NEXT_TARGET,
    ]
    for ref in refs:
    ...
    assert "V01DependencyRemediationTranche002ReleasePolicyAdjudicationPacketResultReview" in index_text
    assert (
        "v01_dependency_remediation_tranche_002_release_policy_adjudication_packet_result_review_does_not_make_policy_decision"
        in index_text
    )
