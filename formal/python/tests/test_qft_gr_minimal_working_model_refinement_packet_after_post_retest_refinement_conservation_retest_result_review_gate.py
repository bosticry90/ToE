...
from formal.python.tools.qft_gr_minimal_working_model_refinement_packet_after_post_retest_refinement_conservation_retest_result_review_report import (
    ...
    REVIEW_ID,
    SCHEMA_ID,
    build_qft_gr_minimal_working_model_refinement_packet_after_post_retest_refinement_conservation_retest_result_review,
)
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "qft_gr_minimal_working_model_refinement_packet_after_post_retest_refinement_conservation_retest_result_review_report.py"
)
LEAN_REVIEW_PATH = (
    REPO_ROOT
    / "formal"
    ...
    / "ToeFormal"
    / "Derivation"
    / "QFTGRMinimalWorkingModelRefinementPacketAfterPostRetestRefinementConservationRetestResultReview.lean"
)
...
def test_post_retest_refinement_conservation_retest_packet_result_review_files_exist() -> None:
...
def test_post_retest_refinement_conservation_retest_packet_result_review_consumes_packet() -> None:
    ...
    assert review["consumes_qft_gr_minimal_working_model_refinement_packet"] == PACKET_ID
...
def test_post_retest_refinement_conservation_retest_packet_result_review_accepts_packet_only() -> None:
    review = _json(DEFAULT_OUT)
    assert review["refinement_packet_result_review_accepted"] is True
    assert review["packet_preparation_only_confirmed"] is True
    assert review["repeated_inconclusive_signal_confirmed"] is True
...
def test_post_retest_refinement_conservation_retest_packet_result_review_authorizes_attempt_only() -> None:
    review = _json(DEFAULT_OUT)
...
def test_post_retest_refinement_conservation_retest_packet_result_review_preserves_nonclaims() -> None:
    review = _json(DEFAULT_OUT)
    for key in [
...
def test_post_retest_refinement_conservation_retest_packet_result_review_validation_policy() -> None:
    review = _json(DEFAULT_OUT)
...
def test_post_retest_refinement_conservation_retest_packet_result_review_selects_attempt_only() -> None:
    review = _json(DEFAULT_OUT)
...
def test_post_retest_refinement_conservation_retest_packet_result_review_updates_live_target() -> None:
...
def test_post_retest_refinement_conservation_retest_packet_result_review_deterministic() -> None:
    review = _json(DEFAULT_OUT)
    generated = build_qft_gr_minimal_working_model_refinement_packet_after_post_retest_refinement_conservation_retest_result_review(
...
def test_post_retest_refinement_conservation_retest_packet_result_review_not_manifest_enrolled() -> None:
    assert_focused_gate_not_manifest_enrolled(
        "test_qft_gr_minimal_working_model_refinement_packet_after_post_retest_refinement_conservation_retest_result_review_gate.py"
    )
