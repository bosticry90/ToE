...
register_qm_stat_synthesis_gate_suite(
    ...
    QmStatSynthesisGateSpec(
        ...
        from_artifact_status="CRITERIA_AND_HIGHER_MOMENT_EXCLUSION_PINNED_NONCLAIM",
        to_artifact_status="CRITERIA_AND_FOURTH_MOMENT_EXCLUSION_PINNED_NONCLAIM",
        from_criteria_token="MASS_MEAN_VARIANCE_THIRD_MOMENT_PARITY_REQUIRED",
        to_criteria_token="MASS_MEAN_VARIANCE_THIRD_AND_FOURTH_MOMENT_PARITY_REQUIRED",
        from_criteria_orders=(1, 2, 3),
        to_criteria_orders=(1, 2, 3, 4),
        newly_added_orders=(4,),
