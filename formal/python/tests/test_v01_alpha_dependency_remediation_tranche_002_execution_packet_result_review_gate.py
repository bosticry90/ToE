...
from formal.python.tools.v01_alpha_dependency_remediation_tranche_002_execution_packet_result_review_report import (
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "v01_alpha_dependency_remediation_tranche_002_execution_packet_result_review_report.py"
)
...
LEAN_RESULT_REVIEW_PATH = (
    ...
    / "ToeFormal"
    / "Release"
    / "V01DependencyRemediationTranche002ExecutionPacketResultReview.lean"
)
...
def test_v01_alpha_dependency_remediation_tranche_002_execution_packet_result_review_files_exist() -> None:
...
def test_v01_alpha_dependency_remediation_tranche_002_execution_packet_result_review_consumes_packet() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert review["schema_id"] == (
        "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_EXECUTION_PACKET_RESULT_REVIEW_20260515_v0"
    )
    ...
    assert review["consumes_tranche_002_execution_packet"] == (
        "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_EXECUTION_PACKET_v0"
    )
    assert review["consumes_tranche_002_execution_packet_pointer"] == (
        "formal/docs/release/V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_EXECUTION_PACKET_20260515_v0.json"
    )


def test_v01_alpha_dependency_remediation_tranche_002_execution_packet_result_review_preserves_tranche_001() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_execution_packet_result_review_selects_tranche_002_only() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_execution_packet_result_review_accepts_exact_audit_target() -> None:
    review = _json(RESULT_REVIEW_PATH)
    target = review["lean_dependency_audit_target"]
    required = review["required_evidence_surface"]
    assert review["tranche_002_execution_packet_accepted"] is True
    assert review["tranche_002_audit_target_accepted"] is True
...
def test_v01_alpha_dependency_remediation_tranche_002_execution_packet_result_review_carries_forward_all_blockers() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_execution_packet_result_review_authorizes_audit_only() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert review["execution_packet_result_review_classification"] == (
        "audit_target_accepted_audit_execution_authorized_only"
    )
    assert review["tranche_002_audit_execution_authorized"] is True
...
def test_v01_alpha_dependency_remediation_tranche_002_execution_packet_result_review_forbidden_effects_false() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_execution_packet_result_review_next_target() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert review["selected_next_target"] == NEXT_TARGET
    assert review["selected_next_target_kind"] == "tranche_002_audit_execution_only"
    ...
    assert {row["target"]: row["decision"] for row in review["candidate_next_targets"]} == {
        "execute_v01_alpha_dependency_remediation_tranche_002_audit": "selected",
...
def test_v01_alpha_dependency_remediation_tranche_002_execution_packet_result_review_acceptance_and_determinism() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_execution_packet_result_review_is_pinned() -> None:
    ...
    refs = [
        ...
        "formal/python/tools/v01_alpha_dependency_remediation_tranche_002_execution_packet_result_review_report.py",
        "formal/python/tests/test_v01_alpha_dependency_remediation_tranche_002_execution_packet_result_review_gate.py",
        OUTCOME_ID,
        NEXT_TARGET,
    ]
    for ref in refs:
    ...
    assert "V01DependencyRemediationTranche002ExecutionPacketResultReview" in index_text
    assert (
        "v01_dependency_remediation_tranche_002_execution_packet_result_review_does_not_execute_audit"
        in index_text
    )
