...
from formal.python.tools.qft_gr_minimal_working_model_refinement_attempt_after_post_retest_refinement_conservation_retest_result_review_report import (
    ...
    REVIEW_ID,
    SCHEMA_ID,
    build_qft_gr_minimal_working_model_refinement_attempt_after_post_retest_refinement_conservation_retest_result_review,
)
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "qft_gr_minimal_working_model_refinement_attempt_after_post_retest_refinement_conservation_retest_result_review_report.py"
)
LEAN_REVIEW_PATH = (
    REPO_ROOT
    / "formal"
    ...
    / "ToeFormal"
    / "Derivation"
    / "QFTGRMinimalWorkingModelRefinementAttemptAfterPostRetestRefinementConservationRetestResultReview.lean"
)
...
def test_post_retest_refinement_conservation_retest_refinement_attempt_result_review_consumes_attempt() -> None:
    ...
    assert (
        review[
            "consumes_qft_gr_minimal_working_model_refinement_attempt_after_post_retest_refinement_conservation_retest"
        ]
        == ATTEMPT_ID
    )
...
def test_post_retest_refinement_conservation_retest_refinement_attempt_result_review_accepts_refined_candidate_only() -> None:
    review = _json(DEFAULT_OUT)
    ...
    assert review["model_refinement_executed_confirmed"] is True
...
def test_post_retest_refinement_conservation_retest_refinement_attempt_result_review_authorizes_packet_only() -> None:
    review = _json(DEFAULT_OUT)
...
def test_post_retest_refinement_conservation_retest_refinement_attempt_result_review_preserves_nonclaims() -> None:
    ...
    assert "not freshly Lean-validated" in review["validation_caveat"]


def test_post_retest_refinement_conservation_retest_refinement_attempt_result_review_validation_policy() -> None:
    review = _json(DEFAULT_OUT)
...
def test_post_retest_refinement_conservation_retest_refinement_attempt_result_review_selects_packet_only() -> None:
    review = _json(DEFAULT_OUT)
...
def test_post_retest_refinement_conservation_retest_refinement_attempt_result_review_deterministic() -> None:
    review = _json(DEFAULT_OUT)
    generated = build_qft_gr_minimal_working_model_refinement_attempt_after_post_retest_refinement_conservation_retest_result_review(
...
def test_post_retest_refinement_conservation_retest_refinement_attempt_result_review_not_manifest_enrolled() -> None:
    assert_focused_gate_not_manifest_enrolled(
        "test_qft_gr_minimal_working_model_refinement_attempt_after_post_retest_refinement_conservation_retest_result_review_gate.py"
    )
