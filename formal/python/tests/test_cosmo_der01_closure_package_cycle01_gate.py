...
EXPECTED_GATE_REL = "formal/python/tests/test_cosmo_der01_closure_package_cycle01_gate.py"
EXPECTED_ROW_BINDINGS = {
    "COSMO_DER01_THEOREM_BODY_SCOPE_BOUNDARY": "TOE_COSMO_DER_01_P_POLICY_THEOREM_BODY_SCOPE_BOUNDARY_PINNED_NONCLAIM",
    "COSMO_DER01_THEOREM_BODY_SCAFFOLD": "TOE_COSMO_DER_01_P_POLICY_THEOREM_BODY_SCAFFOLD_PINNED_NONCLAIM",
    "COSMO_DER01_DISCHARGE_SCAFFOLD": "TOE_COSMO_DER_01_P_POLICY_DISCHARGE_SCAFFOLD_PINNED_NONCLAIM",
    "COSMO_DER01_OBJECT_SURFACE_SCAFFOLD": "TOE_COSMO_DER_01_P_POLICY_OBJECT_SURFACE_SCAFFOLD_PINNED_NONCLAIM",
}
ARTIFACT_SPECS = [
    (
        "COSMO_DER01_THEOREM_BODY_SCOPE_BOUNDARY",
        "cosmo_der01_theorem_body_scope_boundary_cycle01_v0",
        "formal/output/cosmo_der01_theorem_body_scope_boundary_cycle01_v0.json",
    ),
    (
        "COSMO_DER01_THEOREM_BODY_SCAFFOLD",
        "cosmo_der01_theorem_body_scaffold_cycle01_v0",
        "formal/output/cosmo_der01_theorem_body_scaffold_cycle01_v0.json",
    ),
    (
        "COSMO_DER01_DISCHARGE_SCAFFOLD",
        "cosmo_der01_discharge_scaffold_cycle01_v0",
        "formal/output/cosmo_der01_discharge_scaffold_cycle01_v0.json",
    ),
    (
        "COSMO_DER01_OBJECT_SURFACE_SCAFFOLD",
        "cosmo_der01_object_surface_scaffold_cycle01_v0",
...
def test_cosmo_der01_closure_package_cycle01_gate() -> None:
