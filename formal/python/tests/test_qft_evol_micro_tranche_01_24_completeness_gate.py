...
TRANCHE_GATE_PATH = "formal/python/tests/test_qft_evol_micro_tranche_01_24_completeness_gate.py"
LEGACY_TRANCHE_GATE_PATH = "formal/python/tests/test_qft_evol_micro_tranche_01_23_completeness_gate.py"
...
def test_qft_evol_umbrella_contains_micro_tranche_01_24_in_order() -> None:
