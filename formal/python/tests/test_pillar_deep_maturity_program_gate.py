...
def test_deep_maturity_registry_covers_all_matrix_pillars() -> None:
    ...
    assert sr_m5_theory_parity.get("artifact_path") == "formal/output/sr_m5_theory_parity_link_cycle07_v0.json"
    assert sr_m5_theory_parity.get("gate_path") == "formal/python/tests/test_sr_m5_theory_parity_link_cycle07_gate.py"
