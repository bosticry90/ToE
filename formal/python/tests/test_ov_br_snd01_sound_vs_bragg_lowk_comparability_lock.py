...
def test_ov_br_snd01_lock_matches_computed_record() -> None:
    rec = ovbr_snd01_sound_vs_bragg_lowk_comparability_record(date="2026-01-24")
    ...
    assert locked["comparability"]["status"] == "not_compared_quantitatively"
    assert locked["sound_anchor"]["observable_id"] == "OV-SND-02"
