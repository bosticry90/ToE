...
def test_qft_gr_seam_packet41_hold_fork_decision_authority_parity_and_freeze() -> None:
    ...
    for ref in refs:
        assert ref in state_text or ref in inventory_text, (
            f"Missing packet41 hold-fork decision pointer in compact-State or central inventory: {ref}"
        )
    ...
    state_status = _extract_token_from_compact_state_or_inventory(
        state_text, inventory_text, "TOE_QFT_GR_SEAM_PACKET41_HOLD_FORK_DECISION_STATUS_v0"
    )
    ...
    state_outcome = _extract_token_from_compact_state_or_inventory(
        state_text, inventory_text, "TOE_QFT_GR_SEAM_PACKET41_HOLD_FORK_DECISION_OUTCOME_v0"
    )
