...
from formal.python.tools.qft_gr_minimal_working_model_refinement_attempt_after_post_retest_refinement_conservation_retest_report import (
    ATTEMPT_ID,
    CONSUMED_TARGET,
    DEFAULT_OUT,
    NEXT_TARGET,
    ...
    SCHEMA_ID,
    build_qft_gr_minimal_working_model_refinement_attempt_after_post_retest_refinement_conservation_retest,
)
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "qft_gr_minimal_working_model_refinement_attempt_after_post_retest_refinement_conservation_retest_report.py"
)
LEAN_ATTEMPT_PATH = (
    REPO_ROOT
    / "formal"
    ...
    / "ToeFormal"
    / "Derivation"
    / "QFTGRMinimalWorkingModelRefinementAttemptAfterPostRetestRefinementConservationRetest.lean"
)
...
def test_post_retest_refinement_conservation_retest_refinement_attempt_executes_authorized_obstruction_refinement_only() -> None:
    ...
    assert attempt["weak_pairing_domain_id"] == "toy_weak_pairing_domain_v3_candidate"
    assert attempt["regularity_structure_id"] == "toy_regular_context_v3_candidate"
    ...
    assert attempt["scope_restriction_id"] == "bounded_toy_weak_pairing_scope_v3"
    assert attempt["obstruction_accounting_id"] == (
        "repeated_inconclusive_obstruction_account_v2"
    )
...
def test_post_retest_refinement_conservation_retest_refinement_attempt_deterministic() -> None:
    attempt = _json(DEFAULT_OUT)
    generated = build_qft_gr_minimal_working_model_refinement_attempt_after_post_retest_refinement_conservation_retest(
...
def test_post_retest_refinement_conservation_retest_refinement_attempt_not_manifest_enrolled() -> None:
    assert_focused_gate_not_manifest_enrolled(
        "test_qft_gr_minimal_working_model_refinement_attempt_after_post_retest_refinement_conservation_retest_gate.py"
    )
