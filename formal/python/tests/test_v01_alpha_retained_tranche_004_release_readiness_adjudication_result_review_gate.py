...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "v01_alpha_retained_tranche_004_release_readiness_adjudication_result_review_report.py"
)
...
def test_v01_alpha_retained_tranche_004_release_readiness_adjudication_result_review_files_exist() -> None:
    assert DEFAULT_ADJUDICATION_PATH.exists()
...
def test_v01_alpha_retained_tranche_004_release_readiness_adjudication_result_review_consumes_execution() -> None:
...
def test_v01_alpha_retained_tranche_004_release_readiness_adjudication_result_review_accepts_hold() -> None:
    review = _json(DEFAULT_OUT)
    assert review["release_readiness_decision_reviewed"] is True
    assert review["release_readiness_decision_status"] == RELEASE_READINESS_DECISION
    assert review["release_readiness_hold_accepted"] is True
    assert review["release_readiness_held"] is True
    assert review["release_readiness_hold_reason"] == "retained_tranche_004_source_map_blocker"
...
def test_v01_alpha_retained_tranche_004_release_readiness_adjudication_result_review_preserves_dependency_queue() -> None:
    review = _json(DEFAULT_OUT)
...
def test_v01_alpha_retained_tranche_004_release_readiness_adjudication_result_review_keeps_tranche_004_retained() -> None:
    review = _json(DEFAULT_OUT)
...
def test_v01_alpha_retained_tranche_004_release_readiness_adjudication_result_review_forbidden_effects_false() -> None:
    review = _json(DEFAULT_OUT)
...
def test_v01_alpha_retained_tranche_004_release_readiness_adjudication_result_review_next_target() -> None:
    review = _json(DEFAULT_OUT)
    assert review["release_hold_packet_preparation_authorized"] is True
    assert review["release_hold_packet_prepared"] is False
    assert review["selected_next_target"] == NEXT_TARGET
    assert review["selected_next_target_kind"] == "release_hold_packet_preparation_only"
...
def test_v01_alpha_retained_tranche_004_release_readiness_adjudication_result_review_acceptance_and_determinism() -> None:
    review = _json(DEFAULT_OUT)
...
def test_v01_alpha_retained_tranche_004_release_readiness_adjudication_result_review_is_pinned() -> None:
    roadmap_text = _read(ROADMAP_PATH)
    refs = [
        REVIEW_ID,
        "formal/docs/release/V01_ALPHA_RETAINED_TRANCHE_004_RELEASE_READINESS_ADJUDICATION_RESULT_REVIEW_20260522_v0.json",
        "formal/python/tools/v01_alpha_retained_tranche_004_release_readiness_adjudication_result_review_report.py",
        "formal/python/tests/test_v01_alpha_retained_tranche_004_release_readiness_adjudication_result_review_gate.py",
        OUTCOME_ID,
        NEXT_TARGET,
        RELEASE_READINESS_DECISION,
    ]
    ...
    assert "V01RetainedTranche004ReleaseReadinessAdjudicationResultReview" in index_text
    assert (
        "v01_retained_tranche_004_release_readiness_adjudication_result_review_accepts_release_hold"
        in index_text
    )
