...
from formal.python.tools.v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_report import (
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_report.py"
)
...
LEAN_PACKET_PATH = (
    ...
    / "ToeFormal"
    / "Release"
    / "V01DependencyRemediationNextTrancheSelectionPacketAfterTranche003Movement.lean"
)
...
def test_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_files_exist() -> None:
...
def test_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_consumes_tranche_003_result_review() -> None:
    packet = _json(PACKET_PATH)
    assert packet["schema_id"] == (
        "V01_ALPHA_DEPENDENCY_REMEDIATION_NEXT_TRANCHE_SELECTION_PACKET_AFTER_TRANCHE_003_MOVEMENT_20260515_v0"
    )
    ...
    assert packet["consumes_tranche_003_result_review"] == (
        "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_BLOCKER_MOVEMENT_REGISTRATION_RESULT_REVIEW_v0"
    )
    assert packet["consumes_tranche_003_result_review_pointer"] == (
        "formal/docs/release/"
        "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_BLOCKER_MOVEMENT_REGISTRATION_RESULT_REVIEW_20260515_v0.json"
    )


def test_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_preserves_tranche_statuses() -> None:
    packet = _json(PACKET_PATH)
    ...
    assert packet["tranche_003_formal_movement_accepted"] is True
    assert packet["tranche_003_dependency_policy_remediation_satisfied"] is True
...
def test_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_tracks_remaining_three() -> None:
    packet = _json(PACKET_PATH)
    rows = packet["remaining_release_blocking_obligations"]
    assert packet["remaining_release_blocking_obligation_count"] == 3
...
def test_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_selects_exactly_one_tranche() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_prepares_selection_only() -> None:
    packet = _json(PACKET_PATH)
    selected = packet["selected_next_remediation_tranche"]
...
def test_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_forbidden_effects_false() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_next_target() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_acceptance_and_determinism() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_is_pinned() -> None:
    roadmap_text = _read(PHYSICS_ROADMAP_PATH)
    refs = [
        PACKET_ID,
        "formal/docs/release/V01_ALPHA_DEPENDENCY_REMEDIATION_NEXT_TRANCHE_SELECTION_PACKET_AFTER_TRANCHE_003_MOVEMENT_20260515_v0.json",
        "formal/python/tools/v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_report.py",
        "formal/python/tests/test_v01_alpha_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_gate.py",
        OUTCOME_ID,
        NEXT_TARGET,
    ]
    for ref in refs:
    ...
    assert "V01DependencyRemediationNextTrancheSelectionPacketAfterTranche003Movement" in index_text
    assert (
        "v01_dependency_remediation_next_tranche_selection_packet_after_tranche_003_movement_does_not_execute_remediation"
        in index_text
    )
