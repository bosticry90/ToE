...
from formal.python.tools.ck_family_theorem_linkage_obligation_selection_after_psi_A_total_conservation_closeout_result_review_report import (
    ...
    build_ck_family_theorem_linkage_obligation_selection_after_psi_A_total_conservation_closeout_result_review,
)
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "ck_family_theorem_linkage_obligation_selection_after_psi_A_total_conservation_closeout_result_review_report.py"
)
...
def test_post_psi_A_total_conservation_selection_result_review_files_exist() -> None:
    for path in [
        DEFAULT_OUT,
        TOOL_PATH,
        LEAN_PACKET_PATH,
...
def test_post_psi_A_total_conservation_selection_result_review_accepts_matter_exchange_selection() -> None:
...
def test_post_psi_A_total_conservation_selection_result_review_preserves_packet_scope_and_boundary() -> None:
    review = _json(DEFAULT_OUT)
...
def test_post_psi_A_total_conservation_selection_result_review_records_lean_status() -> None:
    review = _json(DEFAULT_OUT)
...
def test_post_psi_A_total_conservation_selection_result_review_rotates_to_matter_exchange_packet() -> None:
...
def test_post_psi_A_total_conservation_selection_result_review_mirrors() -> None:
    ...
    for token in [
        ...
        STRICT_REVIEW_RESULT,
        PACKET_CLASSIFICATION,
        "CKFamilyTheoremLinkageObligationSelectionAfterPsiATotalConservationCloseoutResultReview",
        consumed_target(),
        NEXT_TARGET,
        NEXT_TARGET_KIND,
        SELECTED_OBLIGATION,
...
def test_post_psi_A_total_conservation_selection_result_review_not_manifest_enrolled() -> None:
    assert_focused_gate_not_manifest_enrolled(
        "test_ck_family_theorem_linkage_obligation_selection_after_psi_A_total_conservation_closeout_result_review_gate.py"
    )
