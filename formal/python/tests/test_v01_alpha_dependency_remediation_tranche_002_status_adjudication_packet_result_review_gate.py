...
from formal.python.tools.v01_alpha_dependency_remediation_tranche_002_status_adjudication_packet_result_review_report import (
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "v01_alpha_dependency_remediation_tranche_002_status_adjudication_packet_result_review_report.py"
)
...
LEAN_RESULT_REVIEW_PATH = (
    ...
    / "ToeFormal"
    / "Release"
    / "V01DependencyRemediationTranche002StatusAdjudicationPacketResultReview.lean"
)
...
def test_v01_alpha_dependency_remediation_tranche_002_status_adjudication_packet_result_review_files_exist() -> None:
...
def test_v01_alpha_dependency_remediation_tranche_002_status_adjudication_packet_result_review_consumes_packet() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert review["schema_id"] == (
        "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_STATUS_ADJUDICATION_PACKET_RESULT_REVIEW_20260515_v0"
    )
    ...
    assert review["consumes_packet"] == (
        "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_STATUS_ADJUDICATION_PACKET_v0"
    )
    assert review["consumes_packet_pointer"] == (
        "formal/docs/release/V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_002_STATUS_ADJUDICATION_PACKET_20260515_v0.json"
    )


def test_v01_alpha_dependency_remediation_tranche_002_status_adjudication_packet_result_review_preserves_selected_dependency() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert review["review_scope"] == (
        "REVIEW_TRANCHE_002_STATUS_ADJUDICATION_PACKET_RESULT_ONLY_AUTHORIZE_STATUS_ADJUDICATION_EXECUTION_NO_STATUS_DECISION_OR_BLOCKER_MOVEMENT"
    )
...
def test_v01_alpha_dependency_remediation_tranche_002_status_adjudication_packet_result_review_preserves_evidence_policy_and_documentation() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_status_adjudication_packet_result_review_authorizes_execution_only() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert (
    ...
    assert review["status_adjudication_question"] == (
        ...
        "and accepted documentation, can tranche 002 move from release-blocking to a "
...
def test_v01_alpha_dependency_remediation_tranche_002_status_adjudication_packet_result_review_keeps_blocker_unmoved() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_status_adjudication_packet_result_review_remaining_blockers_tracked() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_status_adjudication_packet_result_review_forbidden_effects_false() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_status_adjudication_packet_result_review_next_target() -> None:
    review = _json(RESULT_REVIEW_PATH)
    ...
    assert {row["target"]: row["decision"] for row in review["candidate_next_targets"]} == {
        "execute_v01_alpha_dependency_remediation_tranche_002_status_adjudication": "selected",
...
def test_v01_alpha_dependency_remediation_tranche_002_status_adjudication_packet_result_review_acceptance_and_determinism() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_002_status_adjudication_packet_result_review_is_pinned() -> None:
    ...
    refs = [
        ...
        "formal/python/tools/v01_alpha_dependency_remediation_tranche_002_status_adjudication_packet_result_review_report.py",
        "formal/python/tests/test_v01_alpha_dependency_remediation_tranche_002_status_adjudication_packet_result_review_gate.py",
        OUTCOME_ID,
        NEXT_TARGET,
    ]
    for ref in refs:
    ...
    assert "V01DependencyRemediationTranche002StatusAdjudicationPacketResultReview" in index_text
    assert (
        "v01_dependency_remediation_tranche_002_status_adjudication_packet_result_review_does_not_move_blocker"
        in index_text
    )
