...
def test_ov_snd02b_lock_matches_computed_record() -> None:
    rec = ovsnd02b_sound_speed_from_propagation_record(date="2026-01-24")
    ...
    lock_path = (
        ...
        / "locks"
        / "observables"
        / "OV-SND-02B_sound_speed_from_propagation_seriesB.md"
    )

    if not lock_path.exists():
        write_ovsnd02b_lock(date="2026-01-24")
    ...
    assert locked["observable_id"] == "OV-SND-02B"
