...
from formal.python.tools.v01_alpha_dependency_remediation_tranche_001_release_policy_adjudication_result_review_report import (
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "v01_alpha_dependency_remediation_tranche_001_release_policy_adjudication_result_review_report.py"
)
...
LEAN_RESULT_REVIEW_PATH = (
    ...
    / "ToeFormal"
    / "Release"
    / "V01DependencyRemediationTranche001ReleasePolicyAdjudicationResultReview.lean"
)
...
def test_v01_alpha_dependency_remediation_tranche_001_release_policy_adjudication_result_review_files_exist() -> None:
...
def test_v01_alpha_dependency_remediation_tranche_001_release_policy_adjudication_result_review_consumes_adjudication() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert review["schema_id"] == (
        "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_001_RELEASE_POLICY_ADJUDICATION_RESULT_REVIEW_20260515_v0"
    )
...
def test_v01_alpha_dependency_remediation_tranche_001_release_policy_adjudication_result_review_preserves_selected_dependency() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert review["review_scope"] == (
        "REVIEW_TRANCHE_001_RELEASE_POLICY_ADJUDICATION_RESULT_ONLY_AUTHORIZE_DOCUMENTATION_PACKET_PREPARATION_NO_BLOCKER_MOVEMENT"
    )
...
def test_v01_alpha_dependency_remediation_tranche_001_release_policy_adjudication_result_review_preserves_evidence() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_001_release_policy_adjudication_result_review_accepts_policy_status() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert review["policy_classification"] == POLICY_CLASSIFICATION
    assert review["result_review_classification"] == RESULT_REVIEW_CLASSIFICATION
    assert review["tranche_001_policy_status"] == "policy_acceptable_documentation_required"
...
def test_v01_alpha_dependency_remediation_tranche_001_release_policy_adjudication_result_review_keeps_blocker_uncleared() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_001_release_policy_adjudication_result_review_forbidden_effects_false() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_001_release_policy_adjudication_result_review_next_target() -> None:
    review = _json(RESULT_REVIEW_PATH)
    ...
    assert review["next_action_scope"] == (
        "PREPARE_TRANCHE_001_DOCUMENTATION_PACKET_ONLY_NO_BLOCKER_MOVEMENT_OR_RELEASE_PROMOTION"
    )
    assert {row["target"]: row["decision"] for row in review["candidate_next_targets"]} == {
        "prepare_v01_alpha_dependency_remediation_tranche_001_documentation_packet": "selected",
...
def test_v01_alpha_dependency_remediation_tranche_001_release_policy_adjudication_result_review_acceptance_and_determinism() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_001_release_policy_adjudication_result_review_is_pinned() -> None:
    ...
    refs = [
        ...
        "formal/python/tools/v01_alpha_dependency_remediation_tranche_001_release_policy_adjudication_result_review_report.py",
        "formal/python/tests/test_v01_alpha_dependency_remediation_tranche_001_release_policy_adjudication_result_review_gate.py",
        OUTCOME_ID,
        NEXT_TARGET,
    ]
    for ref in refs:
    ...
    assert "V01DependencyRemediationTranche001ReleasePolicyAdjudicationResultReview" in index_text
    assert (
        "v01_dependency_remediation_tranche_001_release_policy_adjudication_result_review_does_not_clear_blocker"
        in index_text
    )
