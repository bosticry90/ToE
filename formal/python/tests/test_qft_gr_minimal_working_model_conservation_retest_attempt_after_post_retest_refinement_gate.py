...
def test_post_retest_refinement_conservation_retest_attempt_files_exist() -> None:
...
def test_post_retest_refinement_conservation_retest_attempt_consumes_review_and_packet() -> None:
...
def test_post_retest_refinement_conservation_retest_attempt_records_inconclusive_result() -> None:
    attempt = _json(DEFAULT_OUT)
    ...
    assert len(attempt["why_inconclusive"]) >= 6
...
def test_post_retest_refinement_conservation_retest_attempt_preserves_nonclaims() -> None:
    attempt = _json(DEFAULT_OUT)
    for key in [
...
def test_post_retest_refinement_conservation_retest_attempt_selects_result_review_only() -> None:
    attempt = _json(DEFAULT_OUT)
...
def test_post_retest_refinement_conservation_retest_attempt_updates_live_target() -> None:
...
def test_post_retest_refinement_conservation_retest_attempt_deterministic() -> None:
    attempt = _json(DEFAULT_OUT)
    generated = build_qft_gr_minimal_working_model_conservation_retest_attempt_after_post_retest_refinement(
...
def test_post_retest_refinement_conservation_retest_attempt_not_manifest_enrolled() -> None:
    assert_focused_gate_not_manifest_enrolled(
        "test_qft_gr_minimal_working_model_conservation_retest_attempt_after_post_retest_refinement_gate.py"
    )
