...
def test_execution_report_ignores_global_progress_token_without_row_local_signal(
    ...
    assert report["summary"]["execution_classification"] == "ARCHITECTURE_ALIGNMENT_VALID_BUT_NONMOVING"
    assert report["summary"]["blocker_movement_signal_true"] is False
    assert report["summary"]["next_action"] == "EMIT_ARCHITECTURE_SEAM_MASTER_ACTION_ALIGNMENT_RULING"
