...
register_cosmo_nonflip_gate_suite(
    ...
    CosmoNonflipGateSpec(
        micro_id="23",
        micro_doc_relative_path="formal/docs/paper/DERIVATION_TARGET_COSMOLOGY_BACKGROUND_MICRO_23_DRYRUN_NONFLIP_BOUNDED_SCOPE_AUDIT_v0.md",
        artifact_relative_path="formal/output/cosmo_bg_micro23_dryrun_nonflip_bounded_scope_audit_cycle01_v0.json",
        gate_relative_path="formal/python/tests/test_cosmo_bg_micro23_dryrun_nonflip_bounded_scope_audit_gate.py",
        ...
        expected_artifact_id="cosmo_bg_micro23_dryrun_nonflip_bounded_scope_audit_cycle01_v0",
        expected_cycle="CYCLE-023",
        expected_boundary_statement="DRYRUN_NONFLIP_LANE_ONLY_BOUNDED_SCOPE_AUDIT_NO_ADJUDICATION_FLIP_NO_COMPARATOR_AUTHORIZATION",
        matrix_doc_key="dryrun_nonflip_bounded_scope_audit_doc",
        matrix_gate_key="dryrun_nonflip_bounded_scope_audit_gate",
        matrix_policy_key="dryrun_nonflip_bounded_scope_audit_policy",
        matrix_policy_value="CYCLE08_09_10_11_12_13_14_15_16_17_18_19_20_21_22_DRYRUN_NONFLIP_BOUNDED_SCOPE_AUDIT_LOCK_REQUIRED_NO_STATUS_FLIP_NO_COMPARATOR_AUTHORIZATION",
