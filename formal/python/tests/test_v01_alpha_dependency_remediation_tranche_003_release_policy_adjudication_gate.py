...
from formal.python.tools.v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_report import (
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_report.py"
)
...
LEAN_ADJUDICATION_PATH = (
    ...
    / "ToeFormal"
    / "Release"
    / "V01DependencyRemediationTranche003ReleasePolicyAdjudication.lean"
)
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_files_exist() -> None:
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_consumes_result_review() -> None:
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_preserves_selected_dependency() -> None:
    adjudication = _json(ADJUDICATION_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_preserves_evidence() -> None:
    adjudication = _json(ADJUDICATION_PATH)
    assert adjudication["lean_audit_target"]["lean_target"] == LEAN_TARGET
    assert adjudication["lean_audit_target"]["command"] == (
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_decides_narrow_policy_question() -> None:
    adjudication = _json(ADJUDICATION_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_keeps_blockers_tracked() -> None:
    adjudication = _json(ADJUDICATION_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_forbidden_effects_false() -> None:
    adjudication = _json(ADJUDICATION_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_next_target() -> None:
    adjudication = _json(ADJUDICATION_PATH)
    ...
    assert {row["target"]: row["decision"] for row in adjudication["candidate_next_targets"]} == {
        "review_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_result": "selected",
        "prepare_v01_alpha_dependency_remediation_tranche_003_documentation_packet": "deferred",
        "prepare_v01_alpha_release_readiness_adjudication_packet": "deferred",
    }


def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_acceptance_and_determinism() -> None:
    adjudication = _json(ADJUDICATION_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_is_pinned() -> None:
    ...
    refs = [
        ...
        "formal/python/tools/v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_report.py",
        "formal/python/tests/test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_gate.py",
        OUTCOME_ID,
        NEXT_TARGET,
    ]
    for ref in refs:
    ...
    assert "V01DependencyRemediationTranche003ReleasePolicyAdjudication" in index_text
    assert (
        "v01_dependency_remediation_tranche_003_release_policy_adjudication_does_not_promote_release"
        in index_text
    )
