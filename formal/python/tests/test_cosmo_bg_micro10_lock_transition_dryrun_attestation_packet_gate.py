...
def test_cosmo_micro10_artifact_schema_and_token_alignment() -> None:
    ...
    assert payload.get("artifact_id") == "cosmo_bg_micro10_lock_transition_dryrun_attestation_packet_cycle01_v0"
    assert payload.get("artifact_version") == "v0"
    assert payload.get("placeholder_template") is True

    body = payload.get("payload")
    assert isinstance(body, dict)
    assert body.get("checkpoint") == "cosmo_bg_micro10_lock_transition_dryrun_attestation_packet_cycle01"
