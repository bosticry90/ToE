...
from formal.python.tools.v01_alpha_dependency_remediation_tranche_003_documentation_packet_report import (
...
DOCUMENTATION_PATH = (
    PAPER_DIR / "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_DOCUMENTATION_v0.md"
)
TOOL_PATH = (
    REPO_ROOT
    / "formal"
    / "python"
    / "tools"
    / "v01_alpha_dependency_remediation_tranche_003_documentation_packet_report.py"
)
...
LEAN_PACKET_PATH = (
    ...
    / "ToeFormal"
    / "Release"
    / "V01DependencyRemediationTranche003DocumentationPacket.lean"
)
...
def test_v01_alpha_dependency_remediation_tranche_003_documentation_packet_files_exist() -> None:
...
def test_v01_alpha_dependency_remediation_tranche_003_documentation_packet_consumes_result_review() -> None:
    packet = _json(PACKET_PATH)
    assert packet["schema_id"] == (
        "V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_DOCUMENTATION_PACKET_20260515_v0"
    )
...
def test_v01_alpha_dependency_remediation_tranche_003_documentation_packet_preserves_selected_dependency() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_003_documentation_packet_preserves_evidence() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_003_documentation_packet_documentation_surface() -> None:
    packet = _json(PACKET_PATH)
    ...
    assert packet["documentation_surface"] == {
        "surface": "formal/docs/paper/V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_DOCUMENTATION_v0.md",
...
def test_v01_alpha_dependency_remediation_tranche_003_documentation_packet_prepares_only() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_003_documentation_packet_remaining_blockers_unmodified() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_003_documentation_packet_forbidden_effects_false() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_003_documentation_packet_next_target() -> None:
    packet = _json(PACKET_PATH)
    ...
    assert {row["target"]: row["decision"] for row in packet["candidate_next_targets"]} == {
        "review_v01_alpha_dependency_remediation_tranche_003_documentation_packet_result": "selected",
...
def test_v01_alpha_dependency_remediation_tranche_003_documentation_packet_acceptance_and_determinism() -> None:
    packet = _json(PACKET_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_003_documentation_packet_is_pinned() -> None:
    ...
    refs = [
        ...
        "formal/python/tools/v01_alpha_dependency_remediation_tranche_003_documentation_packet_report.py",
        "formal/python/tests/test_v01_alpha_dependency_remediation_tranche_003_documentation_packet_gate.py",
        OUTCOME_ID,
        NEXT_TARGET,
    ]
    for ref in refs:
    ...
    assert "V01DependencyRemediationTranche003DocumentationPacket" in index_text
    assert "v01_dependency_remediation_tranche_003_documentation_packet_does_not_clear_blocker" in index_text
