...
NOTE_PATH = REPO_ROOT / "formal" / "docs" / "paper" / "QM_STAT_RL10_COMPUTATIONAL_ANALYSIS_PACKET_01_FAMILY_PRESERVATION_NOTE_v0.md"
...
REFINEMENT_REPORT_PATH = REPO_ROOT / "formal" / "output" / "reports" / "qm_stat_rl10_computational_analysis_packet_01_refinement_01_20260416_v0.json"
...
def test_qm_stat_rl10_computational_analysis_packet_01_family_preservation_note_gate() -> None:
    ...
    assert _extract_token(note_text, "QM_STAT_RL10_COMPUTATIONAL_ANALYSIS_PACKET_01_FAMILY_STATUS_v0") == "PRESERVED_CLOSED_SUCCESS_WITHOUT_ESCALATION"
    assert _extract_token(note_text, "QM_STAT_RL10_COMPUTATIONAL_ANALYSIS_PACKET_01_FAMILY_OUTCOME_v0") == "RETAIN_REFINEMENT_v0"
    assert _extract_token(note_text, "QM_STAT_RL10_COMPUTATIONAL_ANALYSIS_PACKET_01_FAMILY_CANONICAL_ENDPOINT_v0") == "formal/output/reports/qm_stat_rl10_computational_analysis_packet_01_refinement_01_20260416_v0.json"
