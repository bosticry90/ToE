...
EXPECTED_ROW_BINDINGS = {
    "COSMO_DER02_THEOREM_BODY_SCOPE_BOUNDARY": "TOE_COSMO_DER_02_P_POLICY_THEOREM_BODY_SCOPE_BOUNDARY_PINNED_NONCLAIM",
    "COSMO_DER02_THEOREM_BODY_SCAFFOLD": "TOE_COSMO_DER_02_P_POLICY_THEOREM_BODY_SCAFFOLD_PINNED_NONCLAIM",
    "COSMO_DER02_DISCHARGE_SCAFFOLD": "TOE_COSMO_DER_02_P_POLICY_DISCHARGE_SCAFFOLD_PINNED_NONCLAIM",
    "COSMO_DER02_OBJECT_SURFACE_SCAFFOLD": "TOE_COSMO_DER_02_P_POLICY_OBJECT_SURFACE_SCAFFOLD_PINNED_NONCLAIM",
}
ARTIFACT_SPECS = [
    (
...
def test_cosmo_der02_closure_package_cycle01_gate() -> None:
    ...
    assert "| TOE-COSMO-DER-02 | `T-CONDITIONAL` |" in results_text
