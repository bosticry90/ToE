...
def test_current_authoritative_surfaces_classify_sources_and_mirrors() -> None:
    ...
    for token in {
        "CURRENT_LIVE_NEXT_TARGET_v0: review_qft_gr_state_domain_assumption_reduction_closeout_packet_result",
        "PREVIOUS_LIVE_NEXT_TARGET_v0: prepare_qft_gr_state_domain_assumption_reduction_closeout_packet",
        "ACTIVE_LANE_v0: qft_gr_state_expectation_compatibility_assumption_reduction_attempt",
        "CURRENT_LIVE_TARGET_AUTHORITY_v0: formal/docs/release/LOOP_CONTROL_REGISTRY_v0.json",
        "CURRENT_LIVE_TARGET_FRONTIER_MIRROR_v0: formal/toe_formal/ToeFormal/Derivation/CrossPillarClosureFrontier.lean",
        "CURRENT_LIVE_TARGET_EVIDENCE_v0: formal/toe_formal/ToeFormal/Bridges/QFT_GR_StateDomainAssumptionReductionCloseoutPacket.lean",
