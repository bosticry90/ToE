...
from formal.python.tools.v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_result_review_report import (
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_result_review_report.py"
)
...
LEAN_RESULT_REVIEW_PATH = (
    ...
    / "ToeFormal"
    / "Release"
    / "V01DependencyRemediationTranche003ReleasePolicyAdjudicationResultReview.lean"
)
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_result_review_files_exist() -> None:
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_result_review_consumes_adjudication() -> None:
    ...
    assert review["consumes_adjudication_pointer"] == (
        "formal/docs/release/V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_RELEASE_POLICY_ADJUDICATION_20260515_v0.json"
    )


def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_result_review_preserves_selected_dependency() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert review["review_scope"] == (
        "REVIEW_TRANCHE_003_RELEASE_POLICY_ADJUDICATION_RESULT_ONLY_"
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_result_review_preserves_evidence() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_result_review_accepts_policy_status() -> None:
    review = _json(RESULT_REVIEW_PATH)
    assert review["policy_classification"] == POLICY_CLASSIFICATION
    assert review["result_review_classification"] == RESULT_REVIEW_CLASSIFICATION
    assert review["tranche_003_policy_status"] == "policy_acceptable_documentation_required"
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_result_review_keeps_blocker_uncleared() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_result_review_forbidden_effects_false() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_result_review_next_target() -> None:
    review = _json(RESULT_REVIEW_PATH)
    ...
    assert review["next_action_scope"] == (
        "PREPARE_TRANCHE_003_DOCUMENTATION_PACKET_ONLY_NO_BLOCKER_MOVEMENT_OR_RELEASE_PROMOTION"
    )
    assert {row["target"]: row["decision"] for row in review["candidate_next_targets"]} == {
        "prepare_v01_alpha_dependency_remediation_tranche_003_documentation_packet": "selected",
        "prepare_v01_alpha_dependency_remediation_tranche_003_status_adjudication_packet": "deferred",
        "prepare_v01_alpha_release_readiness_adjudication_packet": "deferred",
    }


def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_result_review_acceptance_and_determinism() -> None:
    review = _json(RESULT_REVIEW_PATH)
...
def test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_result_review_is_pinned() -> None:
    roadmap_text = _read(PHYSICS_ROADMAP_PATH)
    refs = [
        REVIEW_ID,
        "formal/docs/release/V01_ALPHA_DEPENDENCY_REMEDIATION_TRANCHE_003_RELEASE_POLICY_ADJUDICATION_RESULT_REVIEW_20260515_v0.json",
        "formal/python/tools/v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_result_review_report.py",
        "formal/python/tests/test_v01_alpha_dependency_remediation_tranche_003_release_policy_adjudication_result_review_gate.py",
        OUTCOME_ID,
        NEXT_TARGET,
    ]
    for ref in refs:
    ...
    assert "V01DependencyRemediationTranche003ReleasePolicyAdjudicationResultReview" in index_text
    assert (
        "v01_dependency_remediation_tranche_003_release_policy_adjudication_result_review_does_not_clear_blocker"
        in index_text
    )
