...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "qft_gr_renormalized_stress_energy_object_assumption_reduction_packet_result_review_report.py"
)
...
def test_qft_gr_renormalized_stress_energy_object_packet_result_review_files_exist() -> None:
...
def test_qft_gr_renormalized_stress_energy_object_packet_result_review_consumes_packet() -> None:
...
def test_qft_gr_renormalized_stress_energy_object_packet_result_review_confirms_row001() -> None:
    review = _json(DEFAULT_OUT)
    ...
    assert review["renormalized_stress_energy_object_status_tokens"] == [
        "required",
        "supplied",
        "candidate_reducible",
    ]
...
def test_qft_gr_renormalized_stress_energy_object_packet_result_review_preserves_nonclaims() -> None:
    review = _json(DEFAULT_OUT)
    ...
    assert review["renormalized_stress_energy_object_assumption_reduced_by_review"] is False
...
def test_qft_gr_renormalized_stress_energy_object_packet_result_review_selects_one_target() -> None:
    review = _json(DEFAULT_OUT)
...
def test_qft_gr_renormalized_stress_energy_object_packet_result_review_deterministic_and_pinned() -> None:
    review = _json(DEFAULT_OUT)
    generated = build_qft_gr_renormalized_stress_energy_object_assumption_reduction_packet_result_review(
