...
from formal.python.tools.scalar_multi_background_robustness_reports import (
    ...
    GUARDRAIL_OUTCOME as SCALAR_MULTI_BACKGROUND_GUARDRAIL_OUTCOME,
    GUARDRAIL_REPORT_PATH as SCALAR_MULTI_BACKGROUND_GUARDRAIL_REPORT_PATH,
    GUARDRAIL_STRICT_OUTCOME as SCALAR_MULTI_BACKGROUND_GUARDRAIL_STRICT_OUTCOME,
)


FINAL_LIVE_TARGET = SCALAR_MULTI_BACKGROUND_EXECUTION_TARGET
FINAL_PREVIOUS_TARGET = SCALAR_MULTI_BACKGROUND_GUARDRAIL_TARGET
...
FINAL_REPORT = str(
    SCALAR_MULTI_BACKGROUND_GUARDRAIL_REPORT_PATH.relative_to(REPO_ROOT)
).replace("\\", "/")
FINAL_OUTCOME = SCALAR_MULTI_BACKGROUND_GUARDRAIL_OUTCOME
FINAL_STRICT_OUTCOME = SCALAR_MULTI_BACKGROUND_GUARDRAIL_STRICT_OUTCOME
