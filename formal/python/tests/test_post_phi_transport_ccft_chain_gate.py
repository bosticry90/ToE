...
from formal.python.tools.pillar_seam_unit_mapping_ledger_blocker_response_route_selection import (
    PACKET_RESULT as UNIT_ROUTE_SELECTION_PACKET_OUTCOME,
    REPORT_PATH as UNIT_ROUTE_SELECTION_PACKET_REPORT_PATH,
    STRICT_PACKET_RESULT as UNIT_ROUTE_SELECTION_PACKET_STRICT_OUTCOME,
    SUCCESSOR_TARGET as UNIT_ROUTE_SELECTION_REVIEW_TARGET,
    SUCCESSOR_TARGET_KIND as UNIT_ROUTE_SELECTION_REVIEW_TARGET_KIND,
    TARGET as UNIT_ROUTE_SELECTION_PACKET_TARGET,
)


FINAL_LIVE_TARGET = UNIT_ROUTE_SELECTION_REVIEW_TARGET
FINAL_PREVIOUS_TARGET = UNIT_ROUTE_SELECTION_PACKET_TARGET
...
FINAL_REPORT = str(
    UNIT_ROUTE_SELECTION_PACKET_REPORT_PATH.relative_to(REPO_ROOT)
).replace("\\", "/")
FINAL_OUTCOME = UNIT_ROUTE_SELECTION_PACKET_OUTCOME
FINAL_STRICT_OUTCOME = UNIT_ROUTE_SELECTION_PACKET_STRICT_OUTCOME
...
FINAL_KIND = UNIT_ROUTE_SELECTION_REVIEW_TARGET_KIND
NEXT_PACKET_OUTCOME = (
