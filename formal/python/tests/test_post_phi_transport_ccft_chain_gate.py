...
from formal.python.tools.scalar_multi_background_robustness_result_review import (
    REVIEW_OUTCOME as SCALAR_MULTI_BACKGROUND_REVIEW_OUTCOME,
    REVIEW_REPORT_PATH as SCALAR_MULTI_BACKGROUND_REVIEW_REPORT_PATH,
    REVIEW_STRICT_OUTCOME as SCALAR_MULTI_BACKGROUND_REVIEW_STRICT_OUTCOME,
    REVIEW_TARGET as SCALAR_MULTI_BACKGROUND_REVIEW_TARGET,
    SUCCESS_TARGET as SCALAR_MULTI_BACKGROUND_SUCCESS_TARGET,
    SUCCESS_TARGET_KIND as SCALAR_MULTI_BACKGROUND_SUCCESS_TARGET_KIND,
)


FINAL_LIVE_TARGET = SCALAR_MULTI_BACKGROUND_SUCCESS_TARGET
FINAL_PREVIOUS_TARGET = SCALAR_MULTI_BACKGROUND_REVIEW_TARGET
...
FINAL_REPORT = str(
    SCALAR_MULTI_BACKGROUND_REVIEW_REPORT_PATH.relative_to(REPO_ROOT)
).replace("\\", "/")
FINAL_OUTCOME = SCALAR_MULTI_BACKGROUND_REVIEW_OUTCOME
FINAL_STRICT_OUTCOME = SCALAR_MULTI_BACKGROUND_REVIEW_STRICT_OUTCOME
...
FINAL_KIND = SCALAR_MULTI_BACKGROUND_SUCCESS_TARGET_KIND
NEXT_PACKET_OUTCOME = (
