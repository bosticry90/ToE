...
FINAL_LIVE_TARGET = SCALAR_MULTI_BACKGROUND_GUARDRAIL_TARGET
FINAL_PREVIOUS_TARGET = SCALAR_HIGHER_DIMENSIONAL_REVIEW_TARGET
...
FINAL_REPORT = str(
    SCALAR_HIGHER_DIMENSIONAL_REVIEW_REPORT_PATH.relative_to(REPO_ROOT)
).replace("\\", "/")
FINAL_OUTCOME = SCALAR_HIGHER_DIMENSIONAL_REVIEW_OUTCOME
FINAL_STRICT_OUTCOME = SCALAR_HIGHER_DIMENSIONAL_REVIEW_STRICT_OUTCOME
