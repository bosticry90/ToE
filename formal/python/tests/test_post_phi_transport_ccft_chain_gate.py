...
from formal.python.tools.pillar_seam_unit_mapping_ledger_blocker_response_route_selection_packet_result_review import (
    REVIEW_OUTCOME as UNIT_ROUTE_SELECTION_REVIEW_OUTCOME,
    REVIEW_REPORT_PATH as UNIT_ROUTE_SELECTION_REVIEW_REPORT_PATH,
    SELECTED_NEXT_TARGET as UNIT_ROUTE_SELECTION_V1_TARGET,
    SELECTED_NEXT_TARGET_KIND as UNIT_ROUTE_SELECTION_V1_TARGET_KIND,
    STRICT_REVIEW_OUTCOME as UNIT_ROUTE_SELECTION_REVIEW_STRICT_OUTCOME,
)


FINAL_LIVE_TARGET = UNIT_ROUTE_SELECTION_V1_TARGET
...
FINAL_REPORT = str(
    UNIT_ROUTE_SELECTION_REVIEW_REPORT_PATH.relative_to(REPO_ROOT)
).replace("\\", "/")
FINAL_OUTCOME = UNIT_ROUTE_SELECTION_REVIEW_OUTCOME
FINAL_STRICT_OUTCOME = UNIT_ROUTE_SELECTION_REVIEW_STRICT_OUTCOME
...
FINAL_KIND = UNIT_ROUTE_SELECTION_V1_TARGET_KIND
NEXT_PACKET_OUTCOME = (
