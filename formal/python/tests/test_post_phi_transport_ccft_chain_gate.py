...
from formal.python.tools.scalar_higher_dimensional_curved_background_reports import (
    ...
    EXECUTION_TARGET_KIND as SCALAR_HIGHER_DIMENSIONAL_EXECUTION_KIND,
    GUARDRAIL_OUTCOME as SCALAR_HIGHER_DIMENSIONAL_GUARDRAIL_OUTCOME,
    GUARDRAIL_REPORT_PATH as SCALAR_HIGHER_DIMENSIONAL_GUARDRAIL_REPORT_PATH,
    GUARDRAIL_STRICT_OUTCOME as SCALAR_HIGHER_DIMENSIONAL_GUARDRAIL_STRICT_OUTCOME,
    GUARDRAIL_TARGET as SCALAR_HIGHER_DIMENSIONAL_GUARDRAIL_TARGET,
)


FINAL_LIVE_TARGET = SCALAR_HIGHER_DIMENSIONAL_EXECUTION_TARGET
FINAL_PREVIOUS_TARGET = SCALAR_HIGHER_DIMENSIONAL_GUARDRAIL_TARGET
...
FINAL_REPORT = str(
    SCALAR_HIGHER_DIMENSIONAL_GUARDRAIL_REPORT_PATH.relative_to(REPO_ROOT)
).replace("\\", "/")
FINAL_OUTCOME = SCALAR_HIGHER_DIMENSIONAL_GUARDRAIL_OUTCOME
FINAL_STRICT_OUTCOME = SCALAR_HIGHER_DIMENSIONAL_GUARDRAIL_STRICT_OUTCOME
...
FINAL_KIND = (
    SCALAR_HIGHER_DIMENSIONAL_EXECUTION_KIND
)
NEXT_PACKET_OUTCOME = (
