...
from formal.python.tools.scalar_higher_dimensional_curved_background_reports import (
    EXECUTION_OUTCOME as SCALAR_HIGHER_DIMENSIONAL_EXECUTION_OUTCOME,
    EXECUTION_REPORT_PATH as SCALAR_HIGHER_DIMENSIONAL_EXECUTION_REPORT_PATH,
    EXECUTION_STRICT_OUTCOME as SCALAR_HIGHER_DIMENSIONAL_EXECUTION_STRICT_OUTCOME,
    EXECUTION_TARGET as SCALAR_HIGHER_DIMENSIONAL_EXECUTION_TARGET,
    REVIEW_TARGET as SCALAR_HIGHER_DIMENSIONAL_REVIEW_TARGET,
    REVIEW_TARGET_KIND as SCALAR_HIGHER_DIMENSIONAL_REVIEW_KIND,
)


FINAL_LIVE_TARGET = SCALAR_HIGHER_DIMENSIONAL_REVIEW_TARGET
FINAL_PREVIOUS_TARGET = SCALAR_HIGHER_DIMENSIONAL_EXECUTION_TARGET
...
FINAL_REPORT = str(
    SCALAR_HIGHER_DIMENSIONAL_EXECUTION_REPORT_PATH.relative_to(REPO_ROOT)
).replace("\\", "/")
FINAL_OUTCOME = SCALAR_HIGHER_DIMENSIONAL_EXECUTION_OUTCOME
FINAL_STRICT_OUTCOME = SCALAR_HIGHER_DIMENSIONAL_EXECUTION_STRICT_OUTCOME
...
FINAL_KIND = SCALAR_HIGHER_DIMENSIONAL_REVIEW_KIND
NEXT_PACKET_OUTCOME = (
