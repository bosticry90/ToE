...
DOC_PATH = REPO_ROOT / "formal" / "docs" / "paper" / "DERIVATION_TARGET_SR_EMPIRICAL_COMPARISON_PACKET_05_v0.md"
...
def test_sr_empirical_comparison_packet_05_gate() -> None:
    text = _read(DOC_PATH)
    ...
    assert "SR_EMPIRICAL_PACKET_05_STATUS_v0: RUN_BOUNDED_v0_NONCLAIM" in text
    assert "SR_EMPIRICAL_PACKET_05_ARTIFACT_v0: sr_empirical_comparison_packet_05_v0" in text
    assert "SR_EMPIRICAL_PACKET_05_DECISION_v0: RETAIN_v0" in text
    assert "formal/python/tests/test_sr_empirical_comparison_packet_05_gate.py" in text
