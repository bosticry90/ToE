...
def test_qft_cycle14_gate_is_pinned_in_authority_surfaces() -> None:
    ...
    assert CYCLE14_GATE_PATH in state_text, f"State authority surface must pin `{CYCLE14_GATE_PATH}`."
    assert CYCLE14_MILESTONE_TOKEN in state_text, "State authority surface missing cycle-14 milestone token."
    assert CYCLE14_PROGRESS_TOKEN in state_text, "State authority surface missing cycle-14 progress token."
