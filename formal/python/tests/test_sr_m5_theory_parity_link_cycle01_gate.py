...
ARTIFACT_PATH = REPO_ROOT / "formal" / "output" / "sr_m5_theory_parity_link_cycle01_v0.json"

EXPECTED_ARTIFACT_ID = "sr_m5_theory_parity_link_cycle01_v0"
...
def test_sr_m5_theory_parity_link_cycle01_gate() -> None:
    ...
    assert ARTIFACT_PATH.exists(), "SR M5 theory-parity-link artifact is missing."
    ...
    assert registry.get("sr_m5_theory_parity_gate_path") == (
        "formal/python/tests/test_sr_m5_theory_parity_link_cycle01_gate.py"
    )
    ...
    assert m5_parity.get("artifact_path") == "formal/output/sr_m5_theory_parity_link_cycle01_v0.json"
    assert m5_parity.get("gate_path") == "formal/python/tests/test_sr_m5_theory_parity_link_cycle01_gate.py"
    ...
    for path_ref in (
        "formal/output/sr_m5_theory_parity_link_cycle01_v0.json",
        "formal/python/tests/test_sr_m5_theory_parity_link_cycle01_gate.py",
