...
register_qm_stat_synthesis_gate_suite(
    ...
    QmStatSynthesisGateSpec(
        ...
        from_artifact_status="CRITERIA_AND_SIXTEENTH_MOMENT_EXCLUSION_PINNED_NONCLAIM",
        to_artifact_status="CRITERIA_AND_EIGHTEENTH_MOMENT_EXCLUSION_PINNED_NONCLAIM",
        from_criteria_token="MASS_MEAN_VARIANCE_THIRD_FOURTH_SIXTH_EIGHTH_TENTH_TWELFTH_FOURTEENTH_AND_SIXTEENTH_MOMENT_PARITY_REQUIRED",
        to_criteria_token="MASS_MEAN_VARIANCE_THIRD_FOURTH_SIXTH_EIGHTH_TENTH_TWELFTH_FOURTEENTH_SIXTEENTH_AND_EIGHTEENTH_MOMENT_PARITY_REQUIRED",
        from_criteria_orders=(1, 2, 3, 4, 6, 8, 10, 12, 14, 16),
        to_criteria_orders=(1, 2, 3, 4, 6, 8, 10, 12, 14, 16, 18),
        newly_added_orders=(18,),
