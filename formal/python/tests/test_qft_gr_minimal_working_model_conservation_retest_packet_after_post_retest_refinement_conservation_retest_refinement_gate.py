...
from formal.python.tools.qft_gr_minimal_working_model_conservation_retest_packet_after_post_retest_refinement_conservation_retest_refinement_report import (
    ...
    RETEST_CONDITION_ID,
    SCHEMA_ID,
    build_qft_gr_minimal_working_model_conservation_retest_packet_after_post_retest_refinement_conservation_retest_refinement,
)
...
TOOL_PATH = (
    ...
    / "python"
    / "tools"
    / "qft_gr_minimal_working_model_conservation_retest_packet_after_post_retest_refinement_conservation_retest_refinement_report.py"
)
LEAN_PACKET_PATH = (
    REPO_ROOT
    / "formal"
    ...
    / "ToeFormal"
    / "Derivation"
    / "QFTGRMinimalWorkingModelConservationRetestPacketAfterPostRetestRefinementConservationRetestRefinement.lean"
)
...
def test_post_retest_refinement_conservation_retest_refinement_packet_defines_newest_delta() -> None:
    packet = _json(DEFAULT_OUT)
    delta = packet["newest_refinement_delta"]
    assert delta["delta_id"] == (
        "post_retest_refinement_conservation_retest_refined_toy_candidate_delta_v3"
    )
    ...
    assert changes["scope_restriction"]["component_id"] == (
        "bounded_toy_weak_pairing_scope_v3"
    )
...
def test_post_retest_refinement_conservation_retest_refinement_packet_defines_retest_condition() -> None:
    packet = _json(DEFAULT_OUT)
    ...
    assert "toy_weak_pairing_domain_v3_candidate" in condition["statement_template"]
    assert "toy_regular_context_v3_candidate" in condition["statement_template"]


def test_post_retest_refinement_conservation_retest_refinement_packet_defines_outcomes() -> None:
    packet = _json(DEFAULT_OUT)
...
def test_post_retest_refinement_conservation_retest_refinement_packet_validation_policy() -> None:
    packet = _json(DEFAULT_OUT)
...
def test_post_retest_refinement_conservation_retest_refinement_packet_selects_result_review_only() -> None:
    packet = _json(DEFAULT_OUT)
...
def test_post_retest_refinement_conservation_retest_refinement_packet_updates_live_target() -> None:
    ...
    assert active_workstream["post_retest_refinement_conservation_retest_refinement_packet_consumed"] == "yes"
...
def test_post_retest_refinement_conservation_retest_refinement_packet_deterministic() -> None:
    packet = _json(DEFAULT_OUT)
    generated = build_qft_gr_minimal_working_model_conservation_retest_packet_after_post_retest_refinement_conservation_retest_refinement(
...
def test_post_retest_refinement_conservation_retest_refinement_packet_not_manifest_enrolled() -> None:
    assert_focused_gate_not_manifest_enrolled(
        "test_qft_gr_minimal_working_model_conservation_retest_packet_after_post_retest_refinement_conservation_retest_refinement_gate.py"
    )
