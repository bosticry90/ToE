...
LATEST_VALIDATION_CHECKPOINT_v0: focused status-surface-enforcement/current-authoritative/current-target/loop gates `44 passed`; full pytest checkpoint `6597 passed, 230 skipped`; full `lake build ToeFormal` `7983 jobs`, no warnings.
