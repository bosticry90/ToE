...
LATEST_VALIDATION_CHECKPOINT_v0: focused artifact-retention/current-authoritative/current-target/loop/policy gates `27 passed`; full pytest checkpoint `6536 passed, 230 skipped`; full `lake build ToeFormal` `7977 jobs`, no warnings.
