...
LATEST_VALIDATION_CHECKPOINT_v0: focused post-artifact-retention-selector/current-authoritative/current-target/loop gates `30 passed`; full pytest checkpoint `6536 passed, 230 skipped`; full `lake build ToeFormal` `7979 jobs`, no warnings.
