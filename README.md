...
LATEST_VALIDATION_CHECKPOINT_v0: focused status-surface-result-review/current-authoritative/current-target/loop gates `31 passed`; full pytest checkpoint `6536 passed, 230 skipped`; full `lake build ToeFormal` `7981 jobs`, no warnings.
