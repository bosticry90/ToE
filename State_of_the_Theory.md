...
- QFT empirical comparison packet-04 target pointer: `formal/docs/paper/DERIVATION_TARGET_QFT_EMPIRICAL_COMPARISON_PACKET_04_v0.md`.
- SR empirical comparison packet-04 target pointer: `formal/docs/paper/DERIVATION_TARGET_SR_EMPIRICAL_COMPARISON_PACKET_04_v0.md`.
...
- Master action shadow numerics cycle-09 target pointer: `formal/docs/paper/DERIVATION_TARGET_TOE_MASTER_ACTION_SHADOW_NUMERICS_CYCLE09_v0.md`.
- Master action shadow numerics cycle-10 target pointer: `formal/docs/paper/DERIVATION_TARGET_TOE_MASTER_ACTION_SHADOW_NUMERICS_CYCLE10_v0.md`.
- Master action shadow numerics cycle-11 target pointer: `formal/docs/paper/DERIVATION_TARGET_TOE_MASTER_ACTION_SHADOW_NUMERICS_CYCLE11_v0.md`.
- Master action shadow numerics cycle-12 target pointer: `formal/docs/paper/DERIVATION_TARGET_TOE_MASTER_ACTION_SHADOW_NUMERICS_CYCLE12_v0.md`.
- Master action shadow numerics cycle-13 target pointer: `formal/docs/paper/DERIVATION_TARGET_TOE_MASTER_ACTION_SHADOW_NUMERICS_CYCLE13_v0.md`.
- Master action shadow numerics cycle-14 target pointer: `formal/docs/paper/DERIVATION_TARGET_TOE_MASTER_ACTION_SHADOW_NUMERICS_CYCLE14_v0.md`.
- Master action shadow numerics cycle-15 target pointer: `formal/docs/paper/DERIVATION_TARGET_TOE_MASTER_ACTION_SHADOW_NUMERICS_CYCLE15_v0.md`.
...
- QM empirical comparison packet-04 gate pointer: `formal/python/tests/test_qm_empirical_comparison_packet_04_gate.py`.
- GR empirical comparison packet-04 gate pointer: `formal/python/tests/test_gr_empirical_comparison_packet_04_gate.py`.
- STAT empirical comparison packet-04 gate pointer: `formal/python/tests/test_stat_empirical_comparison_packet_04_gate.py`.
- COSMO empirical comparison packet-04 gate pointer: `formal/python/tests/test_cosmo_empirical_comparison_packet_04_gate.py`.
- EM empirical comparison packet-04 gate pointer: `formal/python/tests/test_em_empirical_comparison_packet_04_gate.py`.
- QFT empirical comparison packet-04 gate pointer: `formal/python/tests/test_qft_empirical_comparison_packet_04_gate.py`.
- SR empirical comparison packet-04 gate pointer: `formal/python/tests/test_sr_empirical_comparison_packet_04_gate.py`.
...
- Master action shadow numerics cycle-09 gate pointer: `formal/python/tests/test_toe_master_action_shadow_numerics_cycle09_gate.py`.
- Master action shadow numerics cycle-10 gate pointer: `formal/python/tests/test_toe_master_action_shadow_numerics_cycle10_gate.py`.
- Master action shadow numerics cycle-11 gate pointer: `formal/python/tests/test_toe_master_action_shadow_numerics_cycle11_gate.py`.
- Master action shadow numerics cycle-12 gate pointer: `formal/python/tests/test_toe_master_action_shadow_numerics_cycle12_gate.py`.
- Master action shadow numerics cycle-13 gate pointer: `formal/python/tests/test_toe_master_action_shadow_numerics_cycle13_gate.py`.
- Master action shadow numerics cycle-14 gate pointer: `formal/python/tests/test_toe_master_action_shadow_numerics_cycle14_gate.py`.
- Master action shadow numerics cycle-15 gate pointer: `formal/python/tests/test_toe_master_action_shadow_numerics_cycle15_gate.py`.
...
- Foundational empirical packet-04 matrix consistency gate pointer: `formal/python/tests/test_foundational_empirical_packet04_matrix_consistency_gate.py`.
- Foundational empirical packet-04 decision policy gate pointer: `formal/python/tests/test_foundational_empirical_packet04_decision_policy_gate.py`.
...
- `REQUIRED_QFT_CLOSURE_ROWS: TOE-QFT-PLAN-01,TOE-QFT-PLAN-02`
  ...
  - QFT evolution semantic-hardening cycle-4 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle4_gate.py`
  ...
  - QFT evolution semantic-hardening cycle-5 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle5_gate.py`
  ...
  - QFT evolution semantic-hardening cycle-6 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle6_gate.py`
  ...
  - QFT evolution semantic-hardening cycle-7 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle7_gate.py`
  ...
  - QFT evolution semantic-hardening cycle-8 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle8_gate.py`
  ...
  - QFT evolution semantic-hardening cycle-9 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle9_gate.py`
  ...
  - QFT evolution semantic-hardening cycle-10 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle10_gate.py`
  ...
  - QFT evolution semantic-hardening cycle-11 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle11_gate.py`
  ...
  - QFT evolution semantic-hardening cycle-12 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle12_gate.py`
  ...
  - QFT evolution semantic-hardening cycle-13 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle13_gate.py`
  ...
  - QFT evolution semantic-hardening cycle-14 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle14_gate.py`
  ...
  - QFT evolution semantic-hardening cycle-15 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle15_gate.py`
  ...
  - QFT evolution semantic-hardening cycle-16 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle16_gate.py`
  ...
  - QFT evolution semantic-hardening cycle-17 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle17_gate.py`
  ...
  - QFT evolution semantic-hardening cycle-18 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle18_gate.py`
  ...
  - QFT evolution semantic-hardening cycle-19 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle19_gate.py`
  ...
  - QFT evolution semantic-hardening cycle-20 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle20_gate.py`
  ...
  - QFT evolution semantic-hardening cycle-21 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle21_gate.py`
  ...
  - QFT evolution semantic-hardening cycle-22 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle22_gate.py`
  ...
  - QFT evolution semantic-hardening cycle-23 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle23_gate.py`
  ...
  - QFT evolution semantic-hardening cycle-24 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle24_gate.py`
  ...
  - QFT evolution semantic-hardening cycle-25 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle25_gate.py`
  ...
  - QFT evolution semantic-hardening cycle-26 gate: `formal/python/tests/test_qft_evol_semantic_hardening_cycle26_gate.py`
  ...
  - QFT full-derivation tranche-rollover artifact pointer: `formal/output/qft_full_derivation_tranche_rollover_gate_bundle_cycle27_v0.json`
  - QFT full-derivation tranche-rollover cycle-27 gate: `formal/python/tests/test_qft_full_derivation_tranche_rollover_cycle27_gate.py`
  ...
  - QFT full-derivation exit-row criteria artifact pointer: `formal/output/qft_full_derivation_exit_row_criteria_cycle28_v0.json`
  - QFT full-derivation exit-row criteria cycle-28 gate: `formal/python/tests/test_qft_full_derivation_exit_row_criteria_cycle28_gate.py`
  ...
  - QFT full-derivation pre-discharge transition bundle artifact pointer: `formal/output/qft_full_derivation_predischarge_transition_bundle_cycle29_v0.json`
  - QFT full-derivation pre-discharge transition cycle-29 gate: `formal/python/tests/test_qft_full_derivation_predischarge_transition_cycle29_gate.py`
  ...
  - QFT full-derivation adjudication-criteria artifact pointer: `formal/output/qft_full_derivation_adjudication_criteria_bundle_cycle31_v0.json`
  - QFT full-derivation adjudication-criteria cycle-31 gate: `formal/python/tests/test_qft_full_derivation_adjudication_criteria_cycle31_gate.py`
  ...
  - QFT full-derivation flip-decision packet artifact pointer: `formal/output/qft_full_derivation_flip_decision_packet_cycle32_v0.json`
  - QFT full-derivation flip-decision packet cycle-32 gate: `formal/python/tests/test_qft_full_derivation_flip_decision_packet_cycle32_gate.py`
  ...
  - QFT full-derivation final preflip evidence registry artifact pointer: `formal/output/qft_full_derivation_final_prefip_evidence_registry_cycle33_v0.json`
  - QFT full-derivation final preflip evidence registry cycle-33 gate: `formal/python/tests/test_qft_full_derivation_final_prefip_evidence_registry_cycle33_gate.py`
  ...
  - QFT full-derivation manual flip-authorization packet artifact pointer: `formal/output/qft_full_derivation_manual_flip_authorization_packet_cycle34_v0.json`
  - QFT full-derivation manual flip-authorization packet cycle-34 gate: `formal/python/tests/test_qft_full_derivation_manual_flip_authorization_packet_cycle34_gate.py`
  ...
  - QFT full-derivation adjudication execution guard artifact pointer: `formal/output/qft_full_derivation_adjudication_execution_guard_cycle35_v0.json`
  - QFT full-derivation adjudication execution guard cycle-35 gate: `formal/python/tests/test_qft_full_derivation_adjudication_execution_guard_cycle35_gate.py`
  ...
  - QFT full-derivation post-authorization revalidation packet artifact pointer: `formal/output/qft_full_derivation_post_authorization_revalidation_packet_cycle36_v0.json`
  - QFT full-derivation post-authorization revalidation packet cycle-36 gate: `formal/python/tests/test_qft_full_derivation_post_authorization_revalidation_packet_cycle36_gate.py`
  ...
  - QFT full-derivation token-flip dryrun simulator artifact pointer: `formal/output/qft_full_derivation_token_flip_dryrun_simulator_cycle37_v0.json`
  - QFT full-derivation token-flip dryrun simulator cycle-37 gate: `formal/python/tests/test_qft_full_derivation_token_flip_dryrun_simulator_cycle37_gate.py`
  ...
  - QFT full-derivation token-flip dryrun attestation artifact pointer: `formal/output/qft_full_derivation_token_flip_dryrun_attestation_cycle38_v0.json`
  - QFT full-derivation token-flip dryrun attestation cycle-38 gate: `formal/python/tests/test_qft_full_derivation_token_flip_dryrun_attestation_cycle38_gate.py`
  ...
  - QFT full-derivation token-flip dryrun reconciliation artifact pointer: `formal/output/qft_full_derivation_token_flip_dryrun_reconciliation_cycle39_v0.json`
  - QFT full-derivation token-flip dryrun reconciliation cycle-39 gate: `formal/python/tests/test_qft_full_derivation_token_flip_dryrun_reconciliation_cycle39_gate.py`
  ...
  - QFT full-derivation token-flip dryrun closure artifact pointer: `formal/output/qft_full_derivation_token_flip_dryrun_closure_cycle40_v0.json`
  - QFT full-derivation token-flip dryrun closure cycle-40 gate: `formal/python/tests/test_qft_full_derivation_token_flip_dryrun_closure_cycle40_gate.py`
  ...
  - QFT full-derivation token-flip dryrun archival artifact pointer: `formal/output/qft_full_derivation_token_flip_dryrun_archival_cycle41_v0.json`
  - QFT full-derivation token-flip dryrun archival cycle-41 gate: `formal/python/tests/test_qft_full_derivation_token_flip_dryrun_archival_cycle41_gate.py`
  ...
  - QFT full-derivation token-flip dryrun custody artifact pointer: `formal/output/qft_full_derivation_token_flip_dryrun_custody_cycle43_v0.json`
  - QFT full-derivation token-flip dryrun custody cycle-43 gate: `formal/python/tests/test_qft_full_derivation_token_flip_dryrun_custody_cycle43_gate.py`
  ...
  - QFT full-derivation token-flip dryrun notarization artifact pointer: `formal/output/qft_full_derivation_token_flip_dryrun_notarization_cycle44_v0.json`
  - QFT full-derivation token-flip dryrun notarization cycle-44 gate: `formal/python/tests/test_qft_full_derivation_token_flip_dryrun_notarization_cycle44_gate.py`
  ...
  - QFT full-derivation token-flip dryrun witness artifact pointer: `formal/output/qft_full_derivation_token_flip_dryrun_witness_cycle45_v0.json`
  - QFT full-derivation token-flip dryrun witness cycle-45 gate: `formal/python/tests/test_qft_full_derivation_token_flip_dryrun_witness_cycle45_gate.py`
  ...
  - QFT full-derivation token-flip dryrun ratification artifact pointer: `formal/output/qft_full_derivation_token_flip_dryrun_ratification_cycle46_v0.json`
  - QFT full-derivation token-flip dryrun ratification cycle-46 gate: `formal/python/tests/test_qft_full_derivation_token_flip_dryrun_ratification_cycle46_gate.py`
  ...
  - QFT full-derivation token-flip dryrun concurrence artifact pointer: `formal/output/qft_full_derivation_token_flip_dryrun_concurrence_cycle47_v0.json`
  - QFT full-derivation token-flip dryrun concurrence cycle-47 gate: `formal/python/tests/test_qft_full_derivation_token_flip_dryrun_concurrence_cycle47_gate.py`
  ...
  - QFT full-derivation token-flip dryrun consensus artifact pointer: `formal/output/qft_full_derivation_token_flip_dryrun_consensus_cycle48_v0.json`
  - QFT full-derivation token-flip dryrun consensus cycle-48 gate: `formal/python/tests/test_qft_full_derivation_token_flip_dryrun_consensus_cycle48_gate.py`
  ...
  - QFT full-derivation token-flip dryrun unanimity artifact pointer: `formal/output/qft_full_derivation_token_flip_dryrun_unanimity_cycle49_v0.json`
  - QFT full-derivation token-flip dryrun unanimity cycle-49 gate: `formal/python/tests/test_qft_full_derivation_token_flip_dryrun_unanimity_cycle49_gate.py`
  ...
  - QFT full-derivation token-flip dryrun closure-consensus artifact pointer: `formal/output/qft_full_derivation_token_flip_dryrun_closure_consensus_cycle50_v0.json`
  - QFT full-derivation token-flip dryrun closure-consensus cycle-50 gate: `formal/python/tests/test_qft_full_derivation_token_flip_dryrun_closure_consensus_cycle50_gate.py`
  ...
  - QFT full-derivation two-key auth revalidation transition artifact pointer: `formal/output/qft_full_derivation_two_key_auth_revalidation_transition_cycle51_v0.json`
  - QFT full-derivation two-key auth revalidation transition cycle-51 gate: `formal/python/tests/test_qft_full_derivation_two_key_auth_revalidation_transition_cycle51_gate.py`
  ...
  - QFT full-derivation KeyA auth revalidation replay artifact pointer: `formal/output/qft_full_derivation_keya_auth_revalidation_replay_cycle52_v0.json`
  - QFT full-derivation KeyA auth revalidation replay cycle-52 gate: `formal/python/tests/test_qft_full_derivation_keya_auth_revalidation_replay_cycle52_gate.py`
  ...
  - QFT full-derivation KeyB auth revalidation replay artifact pointer: `formal/output/qft_full_derivation_keyb_auth_revalidation_replay_cycle53_v0.json`
  - QFT full-derivation KeyB auth revalidation replay cycle-53 gate: `formal/python/tests/test_qft_full_derivation_keyb_auth_revalidation_replay_cycle53_gate.py`
  ...
  - QFT full-derivation two-key authorized revalidation closure artifact pointer: `formal/output/qft_full_derivation_two_key_authorized_revalidation_closure_cycle54_v0.json`
  - QFT full-derivation two-key authorized revalidation closure cycle-54 gate: `formal/python/tests/test_qft_full_derivation_two_key_authorized_revalidation_closure_cycle54_gate.py`
...
- legacy NOT_YET state prior to discharge:
  ...
  - QFT full-derivation pre-flip authority attestation packet artifact pointer: `formal/output/qft_full_derivation_preflip_authority_attestation_packet_cycle56_v0.json`
  - QFT full-derivation pre-flip authority attestation packet cycle-56 gate: `formal/python/tests/test_qft_full_derivation_preflip_authority_attestation_packet_cycle56_gate.py`
  ...
  - QFT full-derivation flip-eligibility attestation packet artifact pointer: `formal/output/qft_full_derivation_flip_eligibility_attestation_packet_cycle57_v0.json`
  - QFT full-derivation flip-eligibility attestation packet cycle-57 gate: `formal/python/tests/test_qft_full_derivation_flip_eligibility_attestation_packet_cycle57_gate.py`
  ...
  - QFT full-derivation final pre-execution nonflip attestation packet artifact pointer: `formal/output/qft_full_derivation_final_preexecution_nonflip_attestation_packet_cycle58_v0.json`
  - QFT full-derivation final pre-execution nonflip attestation packet cycle-58 gate: `formal/python/tests/test_qft_full_derivation_final_preexecution_nonflip_attestation_packet_cycle58_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-boundary packet artifact pointer: `formal/output/qft_full_derivation_preexecution_nonflip_execution_boundary_packet_cycle59_v0.json`
  - QFT full-derivation pre-execution nonflip execution-boundary packet cycle-59 gate: `formal/python/tests/test_qft_full_derivation_preexecution_nonflip_execution_boundary_packet_cycle59_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody packet artifact pointer: `formal/output/qft_full_derivation_preexecution_nonflip_execution_custody_packet_cycle60_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody packet cycle-60 gate: `formal/python/tests/test_qft_full_derivation_preexecution_nonflip_execution_custody_packet_cycle60_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation packet artifact pointer: `formal/output/qft_full_derivation_preexecution_nonflip_execution_custody_attestation_packet_cycle61_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation packet cycle-61 gate: `formal/python/tests/test_qft_full_derivation_preexecution_nonflip_execution_custody_attestation_packet_cycle61_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_packet_cycle62_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation packet cycle-62 gate: `formal/python/tests/test_qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_packet_cycle62_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation packet artifact pointer: `formal/output/qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_attestation_packet_cycle63_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation packet cycle-63 gate: `formal/python/tests/test_qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_attestation_packet_cycle63_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_attestation_confirmation_packet_cycle64_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation packet cycle-64 gate: `formal/python/tests/test_qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_attestation_confirmation_packet_cycle64_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation packet artifact pointer: `formal/output/qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_attestation_confirmation_attestation_packet_cycle65_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation packet cycle-65 gate: `formal/python/tests/test_qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_attestation_confirmation_attestation_packet_cycle65_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_attestation_confirmation_attestation_confirmation_packet_cycle66_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation packet cycle-66 gate: `formal/python/tests/test_qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_attestation_confirmation_attestation_confirmation_packet_cycle66_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation packet artifact pointer: `formal/output/qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_packet_cycle67_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation packet cycle-67 gate: `formal/python/tests/test_qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_packet_cycle67_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_packet_cycle68_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet cycle-68 gate: `formal/python/tests/test_qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_packet_cycle68_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation packet artifact pointer: `formal/output/qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_packet_cycle69_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation packet cycle-69 gate: `formal/python/tests/test_qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_packet_cycle69_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_packet_cycle70_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet cycle-70 gate: `formal/python/tests/test_qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_packet_cycle70_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation packet artifact pointer: `formal/output/qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_packet_cycle71_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation packet cycle-71 gate: `formal/python/tests/test_qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_packet_cycle71_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_packet_cycle72_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet cycle-72 gate: `formal/python/tests/test_qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_packet_cycle72_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation packet artifact pointer: `formal/output/qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_packet_cycle73_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation packet cycle-73 gate: `formal/python/tests/test_qft_full_derivation_preexecution_nonflip_execution_custody_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_confirmation_attestation_packet_cycle73_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_cycle74_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet cycle-74 gate: `formal/python/tests/test_qft_full_derivation_cycle74_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_cycle75_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet cycle-75 gate: `formal/python/tests/test_qft_full_derivation_cycle75_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_cycle76_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet cycle-76 gate: `formal/python/tests/test_qft_full_derivation_cycle76_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_cycle77_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet cycle-77 gate: `formal/python/tests/test_qft_full_derivation_cycle77_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_cycle78_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet cycle-78 gate: `formal/python/tests/test_qft_full_derivation_cycle78_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_cycle79_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet cycle-79 gate: `formal/python/tests/test_qft_full_derivation_cycle79_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_cycle80_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet cycle-80 gate: `formal/python/tests/test_qft_full_derivation_cycle80_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_cycle81_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet cycle-81 gate: `formal/python/tests/test_qft_full_derivation_cycle81_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_cycle82_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet cycle-82 gate: `formal/python/tests/test_qft_full_derivation_cycle82_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_cycle83_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet cycle-83 gate: `formal/python/tests/test_qft_full_derivation_cycle83_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_cycle84_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet cycle-84 gate: `formal/python/tests/test_qft_full_derivation_cycle84_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_cycle85_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet cycle-85 gate: `formal/python/tests/test_qft_full_derivation_cycle85_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_cycle86_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet cycle-86 gate: `formal/python/tests/test_qft_full_derivation_cycle86_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_cycle87_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet cycle-87 gate: `formal/python/tests/test_qft_full_derivation_cycle87_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_cycle88_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet cycle-88 gate: `formal/python/tests/test_qft_full_derivation_cycle88_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_cycle89_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet cycle-89 gate: `formal/python/tests/test_qft_full_derivation_cycle89_gate.py`
  ...
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet artifact pointer: `formal/output/qft_full_derivation_cycle90_v0.json`
  - QFT full-derivation pre-execution nonflip execution-custody-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation-attestation-confirmation packet cycle-90 gate: `formal/python/tests/test_qft_full_derivation_cycle90_gate.py`
  ...
  - QFT full-derivation practical action-plan artifact pointer: `formal/output/qft_full_derivation_discharge_practical_action_plan_cycle81_v0.json`
...
Name: DRBR-DOMAIN-01 first empirical comparator domain pin (BEC Bragg)

Category: Governance

Short description: Pinned first comparator domain record for BEC Bragg artifacts, including canonical artifact paths and explicit non-claim posture.

Status: Locked

Evidence: formal/docs/first_empirical_comparator_domain_bec_bragg.md; formal/python/tests/test_first_empirical_comparator_domain_selection.py

Scope / limits: Domain pin only; no truth upgrade; no automatic pruning activation.

Dependencies: DR-01

Notes: Domain-01 is constrained by front-door comparator contracts and blocked-on-missing-input behavior.
