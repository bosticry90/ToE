...
- `RESTART_GOVERNANCE_STOP_STATE_CANONICAL_LAYER_v0: P90_APPROVAL_RECORD_DECLARED_BUT_UNRECORDED`
- `RESTART_GOVERNANCE_STOP_STATE_REMAINING_BLOCKER_v0: policy_standard_approval_not_recorded`
- `RESTART_GOVERNANCE_STOP_STATE_GOVERNANCE_DECISION_v0: PRESERVE_CURRENT_RESTART_NO_GO_ENDPOINT`
- `RESTART_GOVERNANCE_STOP_STATE_RESTART_AUTHORIZATION_v0: DENIED_UNTIL_EXPLICIT_APPROVAL_RECORDATION`
- `RESTART_GOVERNANCE_STOP_STATE_EXECUTION_OPENING_v0: DENIED_UNDER_CURRENT_UNRECORDED_STATE`
...
- `QM_STAT_SEAM_AUTHORIZATION_READINESS_DOSSIER_CURRENT_BLOCKER_v0: policy_standard_approval_not_recorded`
...
- `QM_STAT_SEAM_AUTHORIZATION_READINESS_DOSSIER_RULE_v0: PIN_THE_TOP_RANKED_QM_STAT_ROW_AND_ITS_MINIMUM_POST_AUTHORIZATION_TRANCHE_WITHOUT_OPENING_RESTART_AUTHORIZATION`
...
- `QM_STAT_RL10_DISCRETE_TRANSITION_BRIDGE_POLICY_STANDARD_APPROVAL_RECORDING_PROCEDURE_NEXT_ACTION_v0: WAIT_FOR_REAL_APPROVAL_THEN_RECORD_ON_DECLARED_SURFACE_AND_RERUN_RESTART_CHAIN`
