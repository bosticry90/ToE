...
- SR M5 theory-parity-link gate pointer: `formal/python/tests/test_sr_m5_theory_parity_link_cycle08_gate.py`.
...
- `formal/output/sr_m5_theory_parity_link_cycle08_v0.json`
