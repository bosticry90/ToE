...
- `REDUNDANCY_CONTROL_REGISTRY_PILOT_SCOPE_v0: TOE_MASTER_ACTION_SEAM_REGISTRY_FAMILY_ONLY`
...
- `REDUNDANCY_CONTROL_REGISTRY_PILOT_REQUIRED_FIELDS_v0: CANONICAL_OWNER_PLUS_RETENTION_POLICY_PLUS_ARCHIVE_DESTINATION_PLUS_PARITY_DEPENDENCIES`
...
- `REDUNDANCY_CONTROL_SEAM_PILOT_SCOPE_v0: SEAM_QM_STAT_CLASS_B_PHYSICS_PILOT_FAMILY_ONLY`
- `REDUNDANCY_CONTROL_SEAM_PILOT_INDEX_v0: formal/output/reports/redundancy_control_seam_family_index_20260409_v0.json`
- `REDUNDANCY_CONTROL_SEAM_PILOT_REQUIRED_FIELDS_v0: CANONICAL_OWNER_PLUS_RETENTION_POLICY_PLUS_ARCHIVE_DESTINATION_PLUS_PARITY_DEPENDENCIES`
...
- `REDUNDANCY_CONTROL_ADMISSION_SEMANTICS_SCOPE_v0: REGISTRY_PLUS_SEAM_PILOT_FAMILY_INDEXES`
