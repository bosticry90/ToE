...
Strict scalar/QFT current-state synchronization checkpoint (2026-04-27):
...
- `STRICT_PHYSICS_CURRENT_FORMAL_INCREMENT_v0: SCALAR_QFT_ANALYTIC_BLOCKER_SPLIT_PLUS_QM_STAT_FINITE_TRANSPORT`
