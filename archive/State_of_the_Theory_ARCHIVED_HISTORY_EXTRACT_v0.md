# State of the Theory Archived History Extract v0

Purpose:
- Preserve the historical non-authority block extracted from State_of_the_Theory.md.
- Keep deep chronology available without polluting compact current-state authority posture.

Non-claim boundary:
- archive-only surface.
- no claim promotion by itself.

Canonical archive summaries:
...
Archived-GapID: COMP-FN-REP-NONALIAS-EQUIV-01
Layer: Lean / Governance
